...
const iomux_cfg_t mx28evk_iomux_setup[] = {
	/* DUART */
	/*MX28_PAD_PWM0__DUART_RX*/MX28_PAD_AUART0_CTS__DUART_RX,
	/*MX28_PAD_PWM1__DUART_TX*/MX28_PAD_AUART0_RTS__DUART_TX,
	...
	MX28_PAD_SSP0_DETECT__SSP0_CARD_DETECT | (MXS_PAD_8MA | MXS_PAD_3V3 | MXS_PAD_NOPULL),
	MX28_PAD_SSP0_SCK__SSP0_SCK | (MXS_PAD_12MA | MXS_PAD_3V3 | MXS_PAD_NOPULL),
	#if 0
	/* write protect */
	...
	MX28_PAD_GPMI_CE0N__GPMI_CE0N | MUX_CONFIG_GPMI, /*NAND Chip Enable 0*/
	MX28_PAD_GPMI_RDY0__GPMI_READY0 | MUX_CONFIG_GPMI, /*NAND0 Ready/Busy*/
	MX28_PAD_GPMI_RDN__GPMI_RDN | (MXS_PAD_3V3 | MXS_PAD_8MA | MXS_PAD_PULLUP),/*NAND Read Strobe*/
	MX28_PAD_GPMI_WRN__GPMI_WRN | MUX_CONFIG_GPMI, /*NAND Write Strobe*/
	MX28_PAD_GPMI_ALE__GPMI_ALE | MUX_CONFIG_GPMI, /*NAND ALE*/
	MX28_PAD_GPMI_CLE__GPMI_CLE | MUX_CONFIG_GPMI, /*NAND CLE*/
	MX28_PAD_GPMI_RESETN__GPMI_RESETN | MUX_CONFIG_GPMI, /*NAND Write Protect*/
#endif
	...
	MX28_PAD_ENET0_TX_CLK__ENET0_TX_CLK | MUX_CONFIG_ENET,
	MX28_PAD_ENET0_RX_CLK__ENET0_RX_CLK | MUX_CONFIG_ENET,
	#if 0
	/* FEC0 Enable */
	...
	#else
    /* FEC0 Reset */
	MX28_PAD_LCD_RS__GPIO_1_26 | (MXS_PAD_12MA | MXS_PAD_3V3 | MXS_PAD_PULLUP),
	#endif
	...
	#if 0
	MX28_PAD_EMI_ODT1__EMI_ODT1 | MUX_CONFIG_EMI,/*NO USE*/
	#endif
    MX28_PAD_EMI_DQM0__EMI_DQM0 | MUX_CONFIG_EMI,
	...
	/* SPI2 (for SPI flash) */
	MX28_PAD_SSP2_SCK__SSP2_SCK | MUX_CONFIG_SSP2, /*SSP2_SCK*/
	MX28_PAD_SSP2_MOSI__SSP2_CMD | MUX_CONFIG_SSP2, /*SSP2_MOSI*/
	MX28_PAD_SSP2_MISO__SSP2_D0 | MUX_CONFIG_SSP2, /*SSP2_MISO*/
	MX28_PAD_SSP2_SS0__SSP2_D3 | (MXS_PAD_3V3 | MXS_PAD_8MA | MXS_PAD_PULLUP), /*SSP2_SS0*/
	...
	/* LCD */
    #if 0 /*EasyARM280 Don't Support LCD*/
