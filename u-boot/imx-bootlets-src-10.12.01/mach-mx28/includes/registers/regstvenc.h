...
#define HW_TVENC_CTRL_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_TVENC_CTRL_SET_ADDR) = (v))
#define HW_TVENC_CTRL_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_TVENC_CTRL_CLR_ADDR) = (v))
#define HW_TVENC_CTRL_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_TVENC_CTRL_TOG_ADDR) = (v))
#endif
...
#define BF_TVENC_CTRL_TVENC_MACROVISION_PRESENT(v)                             \
    (((v) << 29) & BM_TVENC_CTRL_TVENC_MACROVISION_PRESENT)
...
#define BF_TVENC_CTRL_TVENC_COMPOSITE_PRESENT(v)                               \
    (((v) << 28) & BM_TVENC_CTRL_TVENC_COMPOSITE_PRESENT)
...
#define BF_TVENC_CTRL_TVENC_SVIDEO_PRESENT(v)                                  \
    (((v) << 27) & BM_TVENC_CTRL_TVENC_SVIDEO_PRESENT)
...
#define BF_TVENC_CTRL_TVENC_COMPONENT_PRESENT(v)                               \
    (((v) << 26) & BM_TVENC_CTRL_TVENC_COMPONENT_PRESENT)
...
#define BF_TVENC_CTRL_DAC_FIFO_NO_WRITE(v)                                     \
    (((v) << 5) & BM_TVENC_CTRL_DAC_FIFO_NO_WRITE)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_CTRL_DAC_FIFO_NO_WRITE(v)                                     \
    BF_CS1(TVENC_CTRL, DAC_FIFO_NO_WRITE, v)
#endif
...
#define BF_TVENC_CTRL_DAC_FIFO_NO_READ(v)                                      \
    (((v) << 4) & BM_TVENC_CTRL_DAC_FIFO_NO_READ)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_CTRL_DAC_FIFO_NO_READ(v)                                      \
    BF_CS1(TVENC_CTRL, DAC_FIFO_NO_READ, v)
#endif
...
#define BF_TVENC_CTRL_DAC_DATA_FIFO_RST(v)                                     \
    (((v) << 3) & BM_TVENC_CTRL_DAC_DATA_FIFO_RST)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_CTRL_DAC_DATA_FIFO_RST(v)                                     \
    BF_CS1(TVENC_CTRL, DAC_DATA_FIFO_RST, v)
#endif
...
#define HW_TVENC_CONFIG_SET(v)                                                 \
    ((*(volatile reg32_t *)HW_TVENC_CONFIG_SET_ADDR) = (v))
#define HW_TVENC_CONFIG_CLR(v)                                                 \
    ((*(volatile reg32_t *)HW_TVENC_CONFIG_CLR_ADDR) = (v))
#define HW_TVENC_CONFIG_TOG(v)                                                 \
    ((*(volatile reg32_t *)HW_TVENC_CONFIG_TOG_ADDR) = (v))
#endif
...
#define BF_TVENC_CONFIG_DEFAULT_PICFORM(v)                                     \
    (((v) << 27) & BM_TVENC_CONFIG_DEFAULT_PICFORM)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_CONFIG_DEFAULT_PICFORM(v)                                     \
    BF_CS1(TVENC_CONFIG, DEFAULT_PICFORM, v)
#endif
...
#define BF_TVENC_CONFIG_ADD_YPBPR_PED(v)                                       \
    (((v) << 21) & BM_TVENC_CONFIG_ADD_YPBPR_PED)
...
#define BF_TVENC_CONFIG_COLOR_BAR_EN(v)                                        \
    (((v) << 18) & BM_TVENC_CONFIG_COLOR_BAR_EN)
...
#define HW_TVENC_FILTCTRL                                                      \
    (*(volatile hw_tvenc_filtctrl_t *)HW_TVENC_FILTCTRL_ADDR)
#define HW_TVENC_FILTCTRL_RD() (HW_TVENC_FILTCTRL.U)
#define HW_TVENC_FILTCTRL_WR(v) (HW_TVENC_FILTCTRL.U = (v))
#define HW_TVENC_FILTCTRL_SET(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_FILTCTRL_SET_ADDR) = (v))
#define HW_TVENC_FILTCTRL_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_FILTCTRL_CLR_ADDR) = (v))
#define HW_TVENC_FILTCTRL_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_FILTCTRL_TOG_ADDR) = (v))
#endif
...
#define BF_TVENC_FILTCTRL_YSHARP_BW(v)                                         \
    (((v) << 19) & BM_TVENC_FILTCTRL_YSHARP_BW)
...
#define BF_TVENC_FILTCTRL_YD_OFFSETSEL(v)                                      \
    (((v) << 18) & BM_TVENC_FILTCTRL_YD_OFFSETSEL)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_FILTCTRL_YD_OFFSETSEL(v)                                      \
    BF_CS1(TVENC_FILTCTRL, YD_OFFSETSEL, v)
#endif
...
#define BF_TVENC_FILTCTRL_SEL_YSHARP(v)                                        \
    (((v) << 15) & BM_TVENC_FILTCTRL_SEL_YSHARP)
...
#define BF_TVENC_FILTCTRL_YLPF_COEFSEL(v)                                      \
    (((v) << 14) & BM_TVENC_FILTCTRL_YLPF_COEFSEL)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_FILTCTRL_YLPF_COEFSEL(v)                                      \
    BF_CS1(TVENC_FILTCTRL, YLPF_COEFSEL, v)
#endif
...
#define BF_TVENC_FILTCTRL_COEFSEL_CLPF(v)                                      \
    (((v) << 13) & BM_TVENC_FILTCTRL_COEFSEL_CLPF)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_FILTCTRL_COEFSEL_CLPF(v)                                      \
    BF_CS1(TVENC_FILTCTRL, COEFSEL_CLPF, v)
#endif
...
#define BF_TVENC_FILTCTRL_YS_GAINSGN(v)                                        \
    (((v) << 12) & BM_TVENC_FILTCTRL_YS_GAINSGN)
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_SYNCOFFSET                                                    \
    (*(volatile hw_tvenc_syncoffset_t *)HW_TVENC_SYNCOFFSET_ADDR)
#define HW_TVENC_SYNCOFFSET_RD() (HW_TVENC_SYNCOFFSET.U)
#define HW_TVENC_SYNCOFFSET_WR(v) (HW_TVENC_SYNCOFFSET.U = (v))
#define HW_TVENC_SYNCOFFSET_SET(v)                                             \
    ((*(volatile reg32_t *)HW_TVENC_SYNCOFFSET_SET_ADDR) = (v))
#define HW_TVENC_SYNCOFFSET_CLR(v)                                             \
    ((*(volatile reg32_t *)HW_TVENC_SYNCOFFSET_CLR_ADDR) = (v))
#define HW_TVENC_SYNCOFFSET_TOG(v)                                             \
    ((*(volatile reg32_t *)HW_TVENC_SYNCOFFSET_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_HTIMINGSYNC0                                                  \
    (*(volatile hw_tvenc_htimingsync0_t *)HW_TVENC_HTIMINGSYNC0_ADDR)
#define HW_TVENC_HTIMINGSYNC0_RD() (HW_TVENC_HTIMINGSYNC0.U)
#define HW_TVENC_HTIMINGSYNC0_WR(v) (HW_TVENC_HTIMINGSYNC0.U = (v))
#define HW_TVENC_HTIMINGSYNC0_SET(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGSYNC0_SET_ADDR) = (v))
#define HW_TVENC_HTIMINGSYNC0_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGSYNC0_CLR_ADDR) = (v))
#define HW_TVENC_HTIMINGSYNC0_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGSYNC0_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGSYNC0_SYNC_END(v)                                      \
    BF_CS1(TVENC_HTIMINGSYNC0, SYNC_END, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGSYNC0_SYNC_STRT(v)                                     \
    BF_CS1(TVENC_HTIMINGSYNC0, SYNC_STRT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_HTIMINGSYNC1                                                  \
    (*(volatile hw_tvenc_htimingsync1_t *)HW_TVENC_HTIMINGSYNC1_ADDR)
#define HW_TVENC_HTIMINGSYNC1_RD() (HW_TVENC_HTIMINGSYNC1.U)
#define HW_TVENC_HTIMINGSYNC1_WR(v) (HW_TVENC_HTIMINGSYNC1.U = (v))
#define HW_TVENC_HTIMINGSYNC1_SET(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGSYNC1_SET_ADDR) = (v))
#define HW_TVENC_HTIMINGSYNC1_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGSYNC1_CLR_ADDR) = (v))
#define HW_TVENC_HTIMINGSYNC1_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGSYNC1_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGSYNC1_SYNC_EQEND(v)                                    \
    BF_CS1(TVENC_HTIMINGSYNC1, SYNC_EQEND, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGSYNC1_SYNC_SREND(v)                                    \
    BF_CS1(TVENC_HTIMINGSYNC1, SYNC_SREND, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_HTIMINGACTIVE                                                 \
    (*(volatile hw_tvenc_htimingactive_t *)HW_TVENC_HTIMINGACTIVE_ADDR)
#define HW_TVENC_HTIMINGACTIVE_RD() (HW_TVENC_HTIMINGACTIVE.U)
#define HW_TVENC_HTIMINGACTIVE_WR(v) (HW_TVENC_HTIMINGACTIVE.U = (v))
#define HW_TVENC_HTIMINGACTIVE_SET(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGACTIVE_SET_ADDR) = (v))
#define HW_TVENC_HTIMINGACTIVE_CLR(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGACTIVE_CLR_ADDR) = (v))
#define HW_TVENC_HTIMINGACTIVE_TOG(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGACTIVE_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGACTIVE_ACTV_END(v)                                     \
    BF_CS1(TVENC_HTIMINGACTIVE, ACTV_END, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGACTIVE_ACTV_STRT(v)                                    \
    BF_CS1(TVENC_HTIMINGACTIVE, ACTV_STRT, v)
#endif

////////////////////////////////////////////////////////////////////////////////
//// HW_TVENC_HTIMINGBURST0 - TV Encoder Horizontal Timing Color Burst Register
/// 0
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_HTIMINGBURST0                                                 \
    (*(volatile hw_tvenc_htimingburst0_t *)HW_TVENC_HTIMINGBURST0_ADDR)
#define HW_TVENC_HTIMINGBURST0_RD() (HW_TVENC_HTIMINGBURST0.U)
#define HW_TVENC_HTIMINGBURST0_WR(v) (HW_TVENC_HTIMINGBURST0.U = (v))
#define HW_TVENC_HTIMINGBURST0_SET(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGBURST0_SET_ADDR) = (v))
#define HW_TVENC_HTIMINGBURST0_CLR(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGBURST0_CLR_ADDR) = (v))
#define HW_TVENC_HTIMINGBURST0_TOG(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGBURST0_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGBURST0_WBRST_STRT(v)                                   \
    BF_CS1(TVENC_HTIMINGBURST0, WBRST_STRT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGBURST0_NBRST_STRT(v)                                   \
    BF_CS1(TVENC_HTIMINGBURST0, NBRST_STRT, v)
#endif

////////////////////////////////////////////////////////////////////////////////
//// HW_TVENC_HTIMINGBURST1 - TV Encoder Horizontal Timing Color Burst Register
/// 1
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_HTIMINGBURST1                                                 \
    (*(volatile hw_tvenc_htimingburst1_t *)HW_TVENC_HTIMINGBURST1_ADDR)
#define HW_TVENC_HTIMINGBURST1_RD() (HW_TVENC_HTIMINGBURST1.U)
#define HW_TVENC_HTIMINGBURST1_WR(v) (HW_TVENC_HTIMINGBURST1.U = (v))
#define HW_TVENC_HTIMINGBURST1_SET(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGBURST1_SET_ADDR) = (v))
#define HW_TVENC_HTIMINGBURST1_CLR(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGBURST1_CLR_ADDR) = (v))
#define HW_TVENC_HTIMINGBURST1_TOG(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_HTIMINGBURST1_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_HTIMINGBURST1_BRST_END(v)                                     \
    BF_CS1(TVENC_HTIMINGBURST1, BRST_END, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_VTIMING0                                                      \
    (*(volatile hw_tvenc_vtiming0_t *)HW_TVENC_VTIMING0_ADDR)
#define HW_TVENC_VTIMING0_RD() (HW_TVENC_VTIMING0.U)
#define HW_TVENC_VTIMING0_WR(v) (HW_TVENC_VTIMING0.U = (v))
#define HW_TVENC_VTIMING0_SET(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VTIMING0_SET_ADDR) = (v))
#define HW_TVENC_VTIMING0_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VTIMING0_CLR_ADDR) = (v))
#define HW_TVENC_VTIMING0_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VTIMING0_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_VTIMING1                                                      \
    (*(volatile hw_tvenc_vtiming1_t *)HW_TVENC_VTIMING1_ADDR)
#define HW_TVENC_VTIMING1_RD() (HW_TVENC_VTIMING1.U)
#define HW_TVENC_VTIMING1_WR(v) (HW_TVENC_VTIMING1.U = (v))
#define HW_TVENC_VTIMING1_SET(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VTIMING1_SET_ADDR) = (v))
#define HW_TVENC_VTIMING1_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VTIMING1_CLR_ADDR) = (v))
#define HW_TVENC_VTIMING1_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VTIMING1_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_VTIMING1_VSTRT_POSTEQ(v)                                      \
    BF_CS1(TVENC_VTIMING1, VSTRT_POSTEQ, v)
#endif
...
#define HW_TVENC_MISC_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_TVENC_MISC_SET_ADDR) = (v))
#define HW_TVENC_MISC_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_TVENC_MISC_CLR_ADDR) = (v))
#define HW_TVENC_MISC_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_TVENC_MISC_TOG_ADDR) = (v))
#endif
...
#define BF_TVENC_MISC_PAL_FSC_PHASE_ALT(v)                                     \
    (((v) << 10) & BM_TVENC_MISC_PAL_FSC_PHASE_ALT)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_MISC_PAL_FSC_PHASE_ALT(v)                                     \
    BF_CS1(TVENC_MISC, PAL_FSC_PHASE_ALT, v)
#endif
...
#define BF_TVENC_MISC_CS_INVERT_CTRL(v)                                        \
    (((v) << 2) & BM_TVENC_MISC_CS_INVERT_CTRL)
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_COLORSUB0                                                     \
    (*(volatile hw_tvenc_colorsub0_t *)HW_TVENC_COLORSUB0_ADDR)
#define HW_TVENC_COLORSUB0_RD() (HW_TVENC_COLORSUB0.U)
#define HW_TVENC_COLORSUB0_WR(v) (HW_TVENC_COLORSUB0.U = (v))
#define HW_TVENC_COLORSUB0_SET(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_COLORSUB0_SET_ADDR) = (v))
#define HW_TVENC_COLORSUB0_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_COLORSUB0_CLR_ADDR) = (v))
#define HW_TVENC_COLORSUB0_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_COLORSUB0_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_COLORSUB1                                                     \
    (*(volatile hw_tvenc_colorsub1_t *)HW_TVENC_COLORSUB1_ADDR)
#define HW_TVENC_COLORSUB1_RD() (HW_TVENC_COLORSUB1.U)
#define HW_TVENC_COLORSUB1_WR(v) (HW_TVENC_COLORSUB1.U = (v))
#define HW_TVENC_COLORSUB1_SET(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_COLORSUB1_SET_ADDR) = (v))
#define HW_TVENC_COLORSUB1_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_COLORSUB1_CLR_ADDR) = (v))
#define HW_TVENC_COLORSUB1_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_COLORSUB1_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_COLORSUB1_PHASE_OFFSET(v)                                     \
    (HW_TVENC_COLORSUB1.B.PHASE_OFFSET = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_COPYPROTECT                                                   \
    (*(volatile hw_tvenc_copyprotect_t *)HW_TVENC_COPYPROTECT_ADDR)
#define HW_TVENC_COPYPROTECT_RD() (HW_TVENC_COPYPROTECT.U)
#define HW_TVENC_COPYPROTECT_WR(v) (HW_TVENC_COPYPROTECT.U = (v))
#define HW_TVENC_COPYPROTECT_SET(v)                                            \
    ((*(volatile reg32_t *)HW_TVENC_COPYPROTECT_SET_ADDR) = (v))
#define HW_TVENC_COPYPROTECT_CLR(v)                                            \
    ((*(volatile reg32_t *)HW_TVENC_COPYPROTECT_CLR_ADDR) = (v))
#define HW_TVENC_COPYPROTECT_TOG(v)                                            \
    ((*(volatile reg32_t *)HW_TVENC_COPYPROTECT_TOG_ADDR) = (v))
#endif
...
#define BF_TVENC_COPYPROTECT_WSS_ENBL(v)                                       \
    (((v) << 15) & BM_TVENC_COPYPROTECT_WSS_ENBL)
...
#define BF_TVENC_COPYPROTECT_CGMS_ENBL(v)                                      \
    (((v) << 14) & BM_TVENC_COPYPROTECT_CGMS_ENBL)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_COPYPROTECT_CGMS_ENBL(v)                                      \
    BF_CS1(TVENC_COPYPROTECT, CGMS_ENBL, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_COPYPROTECT_WSS_CGMS_DATA(v)                                  \
    BF_CS1(TVENC_COPYPROTECT, WSS_CGMS_DATA, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_CLOSEDCAPTION                                                 \
    (*(volatile hw_tvenc_closedcaption_t *)HW_TVENC_CLOSEDCAPTION_ADDR)
#define HW_TVENC_CLOSEDCAPTION_RD() (HW_TVENC_CLOSEDCAPTION.U)
#define HW_TVENC_CLOSEDCAPTION_WR(v) (HW_TVENC_CLOSEDCAPTION.U = (v))
#define HW_TVENC_CLOSEDCAPTION_SET(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_CLOSEDCAPTION_SET_ADDR) = (v))
#define HW_TVENC_CLOSEDCAPTION_CLR(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_CLOSEDCAPTION_CLR_ADDR) = (v))
#define HW_TVENC_CLOSEDCAPTION_TOG(v)                                          \
    ((*(volatile reg32_t *)HW_TVENC_CLOSEDCAPTION_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_CLOSEDCAPTION_CC_ENBL(v)                                      \
    BF_CS1(TVENC_CLOSEDCAPTION, CC_ENBL, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_CLOSEDCAPTION_CC_FILL(v)                                      \
    BF_CS1(TVENC_CLOSEDCAPTION, CC_FILL, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_CLOSEDCAPTION_CC_DATA(v)                                      \
    (HW_TVENC_CLOSEDCAPTION.B.CC_DATA = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_COLORBURST                                                    \
    (*(volatile hw_tvenc_colorburst_t *)HW_TVENC_COLORBURST_ADDR)
#define HW_TVENC_COLORBURST_RD() (HW_TVENC_COLORBURST.U)
#define HW_TVENC_COLORBURST_WR(v) (HW_TVENC_COLORBURST.U = (v))
#define HW_TVENC_COLORBURST_SET(v)                                             \
    ((*(volatile reg32_t *)HW_TVENC_COLORBURST_SET_ADDR) = (v))
#define HW_TVENC_COLORBURST_CLR(v)                                             \
    ((*(volatile reg32_t *)HW_TVENC_COLORBURST_CLR_ADDR) = (v))
#define HW_TVENC_COLORBURST_TOG(v)                                             \
    ((*(volatile reg32_t *)HW_TVENC_COLORBURST_TOG_ADDR) = (v))
#endif
...
#define BF_TVENC_COLORBURST_NBA(v)                                             \
    ((((reg32_t)v) << 24) & BM_TVENC_COLORBURST_NBA)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_MACROVISION0                                                  \
    (*(volatile hw_tvenc_macrovision0_t *)HW_TVENC_MACROVISION0_ADDR)
#define HW_TVENC_MACROVISION0_RD() (HW_TVENC_MACROVISION0.U)
#define HW_TVENC_MACROVISION0_WR(v) (HW_TVENC_MACROVISION0.U = (v))
#define HW_TVENC_MACROVISION0_SET(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION0_SET_ADDR) = (v))
#define HW_TVENC_MACROVISION0_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION0_CLR_ADDR) = (v))
#define HW_TVENC_MACROVISION0_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION0_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_MACROVISION1                                                  \
    (*(volatile hw_tvenc_macrovision1_t *)HW_TVENC_MACROVISION1_ADDR)
#define HW_TVENC_MACROVISION1_RD() (HW_TVENC_MACROVISION1.U)
#define HW_TVENC_MACROVISION1_WR(v) (HW_TVENC_MACROVISION1.U = (v))
#define HW_TVENC_MACROVISION1_SET(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION1_SET_ADDR) = (v))
#define HW_TVENC_MACROVISION1_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION1_CLR_ADDR) = (v))
#define HW_TVENC_MACROVISION1_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION1_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_MACROVISION2                                                  \
    (*(volatile hw_tvenc_macrovision2_t *)HW_TVENC_MACROVISION2_ADDR)
#define HW_TVENC_MACROVISION2_RD() (HW_TVENC_MACROVISION2.U)
#define HW_TVENC_MACROVISION2_WR(v) (HW_TVENC_MACROVISION2.U = (v))
#define HW_TVENC_MACROVISION2_SET(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION2_SET_ADDR) = (v))
#define HW_TVENC_MACROVISION2_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION2_CLR_ADDR) = (v))
#define HW_TVENC_MACROVISION2_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION2_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_MACROVISION3                                                  \
    (*(volatile hw_tvenc_macrovision3_t *)HW_TVENC_MACROVISION3_ADDR)
#define HW_TVENC_MACROVISION3_RD() (HW_TVENC_MACROVISION3.U)
#define HW_TVENC_MACROVISION3_WR(v) (HW_TVENC_MACROVISION3.U = (v))
#define HW_TVENC_MACROVISION3_SET(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION3_SET_ADDR) = (v))
#define HW_TVENC_MACROVISION3_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION3_CLR_ADDR) = (v))
#define HW_TVENC_MACROVISION3_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION3_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_MACROVISION4                                                  \
    (*(volatile hw_tvenc_macrovision4_t *)HW_TVENC_MACROVISION4_ADDR)
#define HW_TVENC_MACROVISION4_RD() (HW_TVENC_MACROVISION4.U)
#define HW_TVENC_MACROVISION4_WR(v) (HW_TVENC_MACROVISION4.U = (v))
#define HW_TVENC_MACROVISION4_SET(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION4_SET_ADDR) = (v))
#define HW_TVENC_MACROVISION4_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION4_CLR_ADDR) = (v))
#define HW_TVENC_MACROVISION4_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_TVENC_MACROVISION4_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TVENC_MACROVISION4_MACV_TST(v)                                      \
    (HW_TVENC_MACROVISION4.B.MACV_TST = (v))
#endif
...
#define HW_TVENC_DACCTRL_SET(v)                                                \
    ((*(volatile reg32_t *)HW_TVENC_DACCTRL_SET_ADDR) = (v))
#define HW_TVENC_DACCTRL_CLR(v)                                                \
    ((*(volatile reg32_t *)HW_TVENC_DACCTRL_CLR_ADDR) = (v))
#define HW_TVENC_DACCTRL_TOG(v)                                                \
    ((*(volatile reg32_t *)HW_TVENC_DACCTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_TVENC_DACCTRL_TEST3(v)                                              \
    ((((reg32_t)v) << 31) & BM_TVENC_DACCTRL_TEST3)
#else
...
#define BF_TVENC_DACCTRL_JACK1_DIS_DET_EN(v)                                   \
    (((v) << 28) & BM_TVENC_DACCTRL_JACK1_DIS_DET_EN)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_DACCTRL_JACK1_DIS_DET_EN(v)                                   \
    BF_CS1(TVENC_DACCTRL, JACK1_DIS_DET_EN, v)
#endif
...
#define BF_TVENC_DACCTRL_JACK1_DET_EN(v)                                       \
    (((v) << 24) & BM_TVENC_DACCTRL_JACK1_DET_EN)
...
#define BF_TVENC_DACCTRL_DISABLE_GND_DETECT(v)                                 \
    (((v) << 22) & BM_TVENC_DACCTRL_DISABLE_GND_DETECT)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_DACCTRL_DISABLE_GND_DETECT(v)                                 \
    BF_CS1(TVENC_DACCTRL, DISABLE_GND_DETECT, v)
#endif
...
#define BF_TVENC_DACCTRL_INVERT_CLK(v)                                         \
    (((v) << 17) & BM_TVENC_DACCTRL_INVERT_CLK)
...
#define BF_TVENC_DACCTRL_SELECT_CLK(v)                                         \
    (((v) << 16) & BM_TVENC_DACCTRL_SELECT_CLK)
...
#define BF_TVENC_DACCTRL_BYPASS_ACT_CASCODE(v)                                 \
    (((v) << 15) & BM_TVENC_DACCTRL_BYPASS_ACT_CASCODE)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_DACCTRL_BYPASS_ACT_CASCODE(v)                                 \
    BF_CS1(TVENC_DACCTRL, BYPASS_ACT_CASCODE, v)
#endif
...
#define BF_TVENC_DACCTRL_WELL_TOVDD(v)                                         \
    (((v) << 11) & BM_TVENC_DACCTRL_WELL_TOVDD)
...
#define BF_TVENC_DACCTRL_DUMP_TOVDD1(v)                                        \
    (((v) << 8) & BM_TVENC_DACCTRL_DUMP_TOVDD1)
...
#define BF_TVENC_DACCTRL_LOWER_SIGNAL(v)                                       \
    (((v) << 7) & BM_TVENC_DACCTRL_LOWER_SIGNAL)
...
#define BF_TVENC_DACCTRL_NO_INTERNAL_TERM(v)                                   \
    (((v) << 3) & BM_TVENC_DACCTRL_NO_INTERNAL_TERM)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_DACCTRL_NO_INTERNAL_TERM(v)                                   \
    BF_CS1(TVENC_DACCTRL, NO_INTERNAL_TERM, v)
#endif
...
#define BF_TVENC_DACCTRL_HALF_CURRENT(v)                                       \
    (((v) << 2) & BM_TVENC_DACCTRL_HALF_CURRENT)
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_DACSTATUS                                                     \
    (*(volatile hw_tvenc_dacstatus_t *)HW_TVENC_DACSTATUS_ADDR)
#define HW_TVENC_DACSTATUS_RD() (HW_TVENC_DACSTATUS.U)
#define HW_TVENC_DACSTATUS_WR(v) (HW_TVENC_DACSTATUS.U = (v))
#define HW_TVENC_DACSTATUS_SET(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_DACSTATUS_SET_ADDR) = (v))
#define HW_TVENC_DACSTATUS_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_DACSTATUS_CLR_ADDR) = (v))
#define HW_TVENC_DACSTATUS_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_TVENC_DACSTATUS_TOG_ADDR) = (v))
#endif
...
#define BF_TVENC_DACSTATUS_JACK1_DET_STATUS(v)                                 \
    (((v) << 10) & BM_TVENC_DACSTATUS_JACK1_DET_STATUS)
...
#define BF_TVENC_DACSTATUS_JACK1_GROUNDED(v)                                   \
    (((v) << 7) & BM_TVENC_DACSTATUS_JACK1_GROUNDED)
...
#define BF_TVENC_DACSTATUS_JACK1_DIS_DET_IRQ(v)                                \
    (((v) << 4) & BM_TVENC_DACSTATUS_JACK1_DIS_DET_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_DACSTATUS_JACK1_DIS_DET_IRQ(v)                                \
    BF_CS1(TVENC_DACSTATUS, JACK1_DIS_DET_IRQ, v)
#endif
...
#define BF_TVENC_DACSTATUS_JACK1_DET_IRQ(v)                                    \
    (((v) << 1) & BM_TVENC_DACSTATUS_JACK1_DET_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_DACSTATUS_JACK1_DET_IRQ(v)                                    \
    BF_CS1(TVENC_DACSTATUS, JACK1_DET_IRQ, v)
#endif
...
#define BF_TVENC_DACSTATUS_ENIRQ_JACK(v)                                       \
    (((v) << 0) & BM_TVENC_DACSTATUS_ENIRQ_JACK)
...
#ifndef __LANGUAGE_ASM__
#define HW_TVENC_VDACTEST                                                      \
    (*(volatile hw_tvenc_vdactest_t *)HW_TVENC_VDACTEST_ADDR)
#define HW_TVENC_VDACTEST_RD() (HW_TVENC_VDACTEST.U)
#define HW_TVENC_VDACTEST_WR(v) (HW_TVENC_VDACTEST.U = (v))
#define HW_TVENC_VDACTEST_SET(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VDACTEST_SET_ADDR) = (v))
#define HW_TVENC_VDACTEST_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VDACTEST_CLR_ADDR) = (v))
#define HW_TVENC_VDACTEST_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_TVENC_VDACTEST_TOG_ADDR) = (v))
#endif
...
#define BF_TVENC_VDACTEST_ENABLE_PIX_INT_GAIN(v)                               \
    (((v) << 13) & BM_TVENC_VDACTEST_ENABLE_PIX_INT_GAIN)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_VDACTEST_ENABLE_PIX_INT_GAIN(v)                               \
    BF_CS1(TVENC_VDACTEST, ENABLE_PIX_INT_GAIN, v)
#endif
...
#define BF_TVENC_VDACTEST_BYPASS_PIX_INT(v)                                    \
    (((v) << 12) & BM_TVENC_VDACTEST_BYPASS_PIX_INT)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_VDACTEST_BYPASS_PIX_INT(v)                                    \
    BF_CS1(TVENC_VDACTEST, BYPASS_PIX_INT, v)
#endif
...
#define BF_TVENC_VDACTEST_BYPASS_PIX_INT_DROOP(v)                              \
    (((v) << 11) & BM_TVENC_VDACTEST_BYPASS_PIX_INT_DROOP)

#ifndef __LANGUAGE_ASM__
#define BW_TVENC_VDACTEST_BYPASS_PIX_INT_DROOP(v)                              \
    BF_CS1(TVENC_VDACTEST, BYPASS_PIX_INT_DROOP, v)
#endif
...
#define BF_TVENC_VDACTEST_TEST_FIFO_FULL(v)                                    \
    (((v) << 10) & BM_TVENC_VDACTEST_TEST_FIFO_FULL)
...
#define BF_TVENC_VERSION_MAJOR(v)                                              \
    ((((reg32_t)v) << 24) & BM_TVENC_VERSION_MAJOR)
#else
