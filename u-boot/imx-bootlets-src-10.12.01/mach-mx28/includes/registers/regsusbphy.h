...
#define REGS_USBPHY_BASE(x)                                                    \
    (x == 0 ? REGS_USBPHY0_BASE : x == 1 ? REGS_USBPHY1_BASE : 0xffff0000)
#endif
...
#define HW_USBPHY_PWD_SET(x, v)                                                \
    ((*(volatile reg32_t *)HW_USBPHY_PWD_SET_ADDR(x)) = (v))
#define HW_USBPHY_PWD_CLR(x, v)                                                \
    ((*(volatile reg32_t *)HW_USBPHY_PWD_CLR_ADDR(x)) = (v))
#define HW_USBPHY_PWD_TOG(x, v)                                                \
    ((*(volatile reg32_t *)HW_USBPHY_PWD_TOG_ADDR(x)) = (v))
#endif
...
#define HW_USBPHY_TX_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_TX_SET_ADDR(x)) = (v))
#define HW_USBPHY_TX_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_TX_CLR_ADDR(x)) = (v))
#define HW_USBPHY_TX_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_TX_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_TX_USBPHY_TX_EDGECTRL(n, v)                                  \
    BFn_CS1(USBPHY_TX, n, USBPHY_TX_EDGECTRL, v)
#endif
...
#define BF_USBPHY_TX_USBPHY_TX_SYNC_INVERT(v)                                  \
    (((v) << 25) & BM_USBPHY_TX_USBPHY_TX_SYNC_INVERT)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_TX_USBPHY_TX_SYNC_INVERT(n, v)                               \
    BFn_CS1(USBPHY_TX, n, USBPHY_TX_SYNC_INVERT, v)
#endif
...
#define BF_USBPHY_TX_USBPHY_TX_SYNC_MUX(v)                                     \
    (((v) << 24) & BM_USBPHY_TX_USBPHY_TX_SYNC_MUX)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_TX_USBPHY_TX_SYNC_MUX(n, v)                                  \
    BFn_CS1(USBPHY_TX, n, USBPHY_TX_SYNC_MUX, v)
#endif
...
#define HW_USBPHY_RX_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_RX_SET_ADDR(x)) = (v))
#define HW_USBPHY_RX_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_RX_CLR_ADDR(x)) = (v))
#define HW_USBPHY_RX_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_RX_TOG_ADDR(x)) = (v))
#endif
...
#define HW_USBPHY_CTRL_SET(x, v)                                               \
    ((*(volatile reg32_t *)HW_USBPHY_CTRL_SET_ADDR(x)) = (v))
#define HW_USBPHY_CTRL_CLR(x, v)                                               \
    ((*(volatile reg32_t *)HW_USBPHY_CTRL_CLR_ADDR(x)) = (v))
#define HW_USBPHY_CTRL_TOG(x, v)                                               \
    ((*(volatile reg32_t *)HW_USBPHY_CTRL_TOG_ADDR(x)) = (v))
#endif
...
#define BF_USBPHY_CTRL_UTMI_SUSPENDM(v)                                        \
    (((v) << 29) & BM_USBPHY_CTRL_UTMI_SUSPENDM)
...
#define BF_USBPHY_CTRL_HOST_FORCE_LS_SE0(v)                                    \
    (((v) << 28) & BM_USBPHY_CTRL_HOST_FORCE_LS_SE0)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_HOST_FORCE_LS_SE0(n, v)                                 \
    BFn_CS1(USBPHY_CTRL, n, HOST_FORCE_LS_SE0, v)
#endif
...
#define BF_USBPHY_CTRL_ENAUTOSET_USBCLKS(v)                                    \
    (((v) << 26) & BM_USBPHY_CTRL_ENAUTOSET_USBCLKS)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENAUTOSET_USBCLKS(n, v)                                 \
    BFn_CS1(USBPHY_CTRL, n, ENAUTOSET_USBCLKS, v)
#endif
...
#define BF_USBPHY_CTRL_ENAUTOCLR_USBCLKGATE(v)                                 \
    (((v) << 25) & BM_USBPHY_CTRL_ENAUTOCLR_USBCLKGATE)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENAUTOCLR_USBCLKGATE(n, v)                              \
    BFn_CS1(USBPHY_CTRL, n, ENAUTOCLR_USBCLKGATE, v)
#endif
...
#define BF_USBPHY_CTRL_FSDLL_RST_EN(v)                                         \
    (((v) << 24) & BM_USBPHY_CTRL_FSDLL_RST_EN)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_FSDLL_RST_EN(n, v)                                      \
    BFn_CS1(USBPHY_CTRL, n, FSDLL_RST_EN, v)
#endif
...
#define BF_USBPHY_CTRL_ENVBUSCHG_WKUP(v)                                       \
    (((v) << 23) & BM_USBPHY_CTRL_ENVBUSCHG_WKUP)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENVBUSCHG_WKUP(n, v)                                    \
    BFn_CS1(USBPHY_CTRL, n, ENVBUSCHG_WKUP, v)
#endif
...
#define BF_USBPHY_CTRL_ENIDCHG_WKUP(v)                                         \
    (((v) << 22) & BM_USBPHY_CTRL_ENIDCHG_WKUP)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENIDCHG_WKUP(n, v)                                      \
    BFn_CS1(USBPHY_CTRL, n, ENIDCHG_WKUP, v)
#endif
...
#define BF_USBPHY_CTRL_ENDPDMCHG_WKUP(v)                                       \
    (((v) << 21) & BM_USBPHY_CTRL_ENDPDMCHG_WKUP)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENDPDMCHG_WKUP(n, v)                                    \
    BFn_CS1(USBPHY_CTRL, n, ENDPDMCHG_WKUP, v)
#endif
...
#define BF_USBPHY_CTRL_ENAUTOCLR_PHY_PWD(v)                                    \
    (((v) << 20) & BM_USBPHY_CTRL_ENAUTOCLR_PHY_PWD)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENAUTOCLR_PHY_PWD(n, v)                                 \
    BFn_CS1(USBPHY_CTRL, n, ENAUTOCLR_PHY_PWD, v)
#endif
...
#define BF_USBPHY_CTRL_ENAUTOCLR_CLKGATE(v)                                    \
    (((v) << 19) & BM_USBPHY_CTRL_ENAUTOCLR_CLKGATE)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENAUTOCLR_CLKGATE(n, v)                                 \
    BFn_CS1(USBPHY_CTRL, n, ENAUTOCLR_CLKGATE, v)
#endif
...
#define BF_USBPHY_CTRL_ENAUTO_PWRON_PLL(v)                                     \
    (((v) << 18) & BM_USBPHY_CTRL_ENAUTO_PWRON_PLL)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENAUTO_PWRON_PLL(n, v)                                  \
    BFn_CS1(USBPHY_CTRL, n, ENAUTO_PWRON_PLL, v)
#endif
...
#define BF_USBPHY_CTRL_ENUTMILEVEL3(v)                                         \
    (((v) << 15) & BM_USBPHY_CTRL_ENUTMILEVEL3)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENUTMILEVEL3(n, v)                                      \
    BFn_CS1(USBPHY_CTRL, n, ENUTMILEVEL3, v)
#endif
...
#define BF_USBPHY_CTRL_ENUTMILEVEL2(v)                                         \
    (((v) << 14) & BM_USBPHY_CTRL_ENUTMILEVEL2)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENUTMILEVEL2(n, v)                                      \
    BFn_CS1(USBPHY_CTRL, n, ENUTMILEVEL2, v)
#endif
...
#define BF_USBPHY_CTRL_DATA_ON_LRADC(v)                                        \
    (((v) << 13) & BM_USBPHY_CTRL_DATA_ON_LRADC)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_DATA_ON_LRADC(n, v)                                     \
    BFn_CS1(USBPHY_CTRL, n, DATA_ON_LRADC, v)
#endif
...
#define BF_USBPHY_CTRL_DEVPLUGIN_IRQ(v)                                        \
    (((v) << 12) & BM_USBPHY_CTRL_DEVPLUGIN_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_DEVPLUGIN_IRQ(n, v)                                     \
    BFn_CS1(USBPHY_CTRL, n, DEVPLUGIN_IRQ, v)
#endif
...
#define BF_USBPHY_CTRL_ENIRQDEVPLUGIN(v)                                       \
    (((v) << 11) & BM_USBPHY_CTRL_ENIRQDEVPLUGIN)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENIRQDEVPLUGIN(n, v)                                    \
    BFn_CS1(USBPHY_CTRL, n, ENIRQDEVPLUGIN, v)
#endif
...
#define BF_USBPHY_CTRL_ENIRQRESUMEDETECT(v)                                    \
    (((v) << 9) & BM_USBPHY_CTRL_ENIRQRESUMEDETECT)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENIRQRESUMEDETECT(n, v)                                 \
    BFn_CS1(USBPHY_CTRL, n, ENIRQRESUMEDETECT, v)
#endif
...
#define BF_USBPHY_CTRL_RESUMEIRQSTICKY(v)                                      \
    (((v) << 8) & BM_USBPHY_CTRL_RESUMEIRQSTICKY)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_RESUMEIRQSTICKY(n, v)                                   \
    BFn_CS1(USBPHY_CTRL, n, RESUMEIRQSTICKY, v)
#endif
...
#define BF_USBPHY_CTRL_ENOTGIDDETECT(v)                                        \
    (((v) << 7) & BM_USBPHY_CTRL_ENOTGIDDETECT)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENOTGIDDETECT(n, v)                                     \
    BFn_CS1(USBPHY_CTRL, n, ENOTGIDDETECT, v)
#endif
...
#define BF_USBPHY_CTRL_DEVPLUGIN_POLARITY(v)                                   \
    (((v) << 5) & BM_USBPHY_CTRL_DEVPLUGIN_POLARITY)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_DEVPLUGIN_POLARITY(n, v)                                \
    BFn_CS1(USBPHY_CTRL, n, DEVPLUGIN_POLARITY, v)
#endif
...
#define BF_USBPHY_CTRL_ENDEVPLUGINDETECT(v)                                    \
    (((v) << 4) & BM_USBPHY_CTRL_ENDEVPLUGINDETECT)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENDEVPLUGINDETECT(n, v)                                 \
    BFn_CS1(USBPHY_CTRL, n, ENDEVPLUGINDETECT, v)
#endif
...
#define BF_USBPHY_CTRL_HOSTDISCONDETECT_IRQ(v)                                 \
    (((v) << 3) & BM_USBPHY_CTRL_HOSTDISCONDETECT_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_HOSTDISCONDETECT_IRQ(n, v)                              \
    BFn_CS1(USBPHY_CTRL, n, HOSTDISCONDETECT_IRQ, v)
#endif
...
#define BF_USBPHY_CTRL_ENIRQHOSTDISCON(v)                                      \
    (((v) << 2) & BM_USBPHY_CTRL_ENIRQHOSTDISCON)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENIRQHOSTDISCON(n, v)                                   \
    BFn_CS1(USBPHY_CTRL, n, ENIRQHOSTDISCON, v)
#endif
...
#define BF_USBPHY_CTRL_ENHOSTDISCONDETECT(v)                                   \
    (((v) << 1) & BM_USBPHY_CTRL_ENHOSTDISCONDETECT)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_CTRL_ENHOSTDISCONDETECT(n, v)                                \
    BFn_CS1(USBPHY_CTRL, n, ENHOSTDISCONDETECT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBPHY_STATUS(x)                                                    \
    (*(volatile hw_usbphy_status_t *)HW_USBPHY_STATUS_ADDR(x))
#define HW_USBPHY_STATUS_RD(x) (HW_USBPHY_STATUS(x).U)
#define HW_USBPHY_STATUS_WR(x, v) (HW_USBPHY_STATUS(x).U = (v))
#define HW_USBPHY_STATUS_SET(x, v)                                             \
    (HW_USBPHY_STATUS_WR(x, HW_USBPHY_STATUS_RD(x) | (v)))
#define HW_USBPHY_STATUS_CLR(x, v)                                             \
    (HW_USBPHY_STATUS_WR(x, HW_USBPHY_STATUS_RD(x) & ~(v)))
#define HW_USBPHY_STATUS_TOG(x, v)                                             \
    (HW_USBPHY_STATUS_WR(x, HW_USBPHY_STATUS_RD(x) ^ (v)))
#endif
...
#define BF_USBPHY_STATUS_RSVD4(v)                                              \
    ((((reg32_t)v) << 11) & BM_USBPHY_STATUS_RSVD4)
#else
...
#define BF_USBPHY_STATUS_RESUME_STATUS(v)                                      \
    (((v) << 10) & BM_USBPHY_STATUS_RESUME_STATUS)
...
#define BF_USBPHY_STATUS_OTGID_STATUS(v)                                       \
    (((v) << 8) & BM_USBPHY_STATUS_OTGID_STATUS)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_STATUS_OTGID_STATUS(n, v)                                    \
    BFn_CS1(USBPHY_STATUS, n, OTGID_STATUS, v)
#endif
...
#define BF_USBPHY_STATUS_DEVPLUGIN_STATUS(v)                                   \
    (((v) << 6) & BM_USBPHY_STATUS_DEVPLUGIN_STATUS)
...
#define BF_USBPHY_STATUS_HOSTDISCONDETECT_STATUS(v)                            \
    (((v) << 3) & BM_USBPHY_STATUS_HOSTDISCONDETECT_STATUS)
...
#ifndef __LANGUAGE_ASM__
#define HW_USBPHY_DEBUG(x)                                                     \
    (*(volatile hw_usbphy_debug_t *)HW_USBPHY_DEBUG_ADDR(x))
#define HW_USBPHY_DEBUG_RD(x) (HW_USBPHY_DEBUG(x).U)
#define HW_USBPHY_DEBUG_WR(x, v) (HW_USBPHY_DEBUG(x).U = (v))
#define HW_USBPHY_DEBUG_SET(x, v)                                              \
    ((*(volatile reg32_t *)HW_USBPHY_DEBUG_SET_ADDR(x)) = (v))
#define HW_USBPHY_DEBUG_CLR(x, v)                                              \
    ((*(volatile reg32_t *)HW_USBPHY_DEBUG_CLR_ADDR(x)) = (v))
#define HW_USBPHY_DEBUG_TOG(x, v)                                              \
    ((*(volatile reg32_t *)HW_USBPHY_DEBUG_TOG_ADDR(x)) = (v))
#endif
...
#define BF_USBPHY_DEBUG_HOST_RESUME_DEBUG(v)                                   \
    (((v) << 29) & BM_USBPHY_DEBUG_HOST_RESUME_DEBUG)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_HOST_RESUME_DEBUG(n, v)                                \
    BFn_CS1(USBPHY_DEBUG, n, HOST_RESUME_DEBUG, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_SQUELCHRESETLENGTH(n, v)                               \
    BFn_CS1(USBPHY_DEBUG, n, SQUELCHRESETLENGTH, v)
#endif
...
#define BF_USBPHY_DEBUG_ENSQUELCHRESET(v)                                      \
    (((v) << 24) & BM_USBPHY_DEBUG_ENSQUELCHRESET)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_ENSQUELCHRESET(n, v)                                   \
    BFn_CS1(USBPHY_DEBUG, n, ENSQUELCHRESET, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_SQUELCHRESETCOUNT(n, v)                                \
    BFn_CS1(USBPHY_DEBUG, n, SQUELCHRESETCOUNT, v)
#endif
...
#define BF_USBPHY_DEBUG_ENTX2RXCOUNT(v)                                        \
    (((v) << 12) & BM_USBPHY_DEBUG_ENTX2RXCOUNT)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_ENTX2RXCOUNT(n, v)                                     \
    BFn_CS1(USBPHY_DEBUG, n, ENTX2RXCOUNT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_ENHSTPULLDOWN(n, v)                                    \
    BFn_CS1(USBPHY_DEBUG, n, ENHSTPULLDOWN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_HSTPULLDOWN(n, v)                                      \
    BFn_CS1(USBPHY_DEBUG, n, HSTPULLDOWN, v)
#endif
...
#define BF_USBPHY_DEBUG_DEBUG_INTERFACE_HOLD(v)                                \
    (((v) << 1) & BM_USBPHY_DEBUG_DEBUG_INTERFACE_HOLD)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_DEBUG_INTERFACE_HOLD(n, v)                             \
    BFn_CS1(USBPHY_DEBUG, n, DEBUG_INTERFACE_HOLD, v)
#endif
...
#define BF_USBPHY_DEBUG_OTGIDPIOLOCK(v)                                        \
    (((v) << 0) & BM_USBPHY_DEBUG_OTGIDPIOLOCK)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG_OTGIDPIOLOCK(n, v)                                     \
    BFn_CS1(USBPHY_DEBUG, n, OTGIDPIOLOCK, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBPHY_DEBUG0_STATUS(x)                                             \
    (*(volatile hw_usbphy_debug0_status_t *)HW_USBPHY_DEBUG0_STATUS_ADDR(x))
...
#define BF_USBPHY_DEBUG0_STATUS_SQUELCH_COUNT(v)                               \
    ((((reg32_t)v) << 26) & BM_USBPHY_DEBUG0_STATUS_SQUELCH_COUNT)
#else
#define BF_USBPHY_DEBUG0_STATUS_SQUELCH_COUNT(v)                               \
...
#ifndef __LANGUAGE_ASM__
#define HW_USBPHY_DEBUG1(x)                                                    \
    (*(volatile hw_usbphy_debug1_t *)HW_USBPHY_DEBUG1_ADDR(x))
#define HW_USBPHY_DEBUG1_RD(x) (HW_USBPHY_DEBUG1(x).U)
#define HW_USBPHY_DEBUG1_WR(x, v) (HW_USBPHY_DEBUG1(x).U = (v))
#define HW_USBPHY_DEBUG1_SET(x, v)                                             \
    ((*(volatile reg32_t *)HW_USBPHY_DEBUG1_SET_ADDR(x)) = (v))
#define HW_USBPHY_DEBUG1_CLR(x, v)                                             \
    ((*(volatile reg32_t *)HW_USBPHY_DEBUG1_CLR_ADDR(x)) = (v))
#define HW_USBPHY_DEBUG1_TOG(x, v)                                             \
    ((*(volatile reg32_t *)HW_USBPHY_DEBUG1_TOG_ADDR(x)) = (v))
#endif
...
#define BF_USBPHY_DEBUG1_RSVD1(v)                                              \
    ((((reg32_t)v) << 15) & BM_USBPHY_DEBUG1_RSVD1)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG1_ENTAILADJVD(n, v)                                     \
    BFn_CS1(USBPHY_DEBUG1, n, ENTAILADJVD, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_DEBUG1_DBG_ADDRESS(n, v)                                     \
    BFn_CS1(USBPHY_DEBUG1, n, DBG_ADDRESS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBPHY_VERSION(x)                                                   \
    (*(volatile hw_usbphy_version_t *)HW_USBPHY_VERSION_ADDR(x))
...
#define BF_USBPHY_VERSION_MAJOR(v)                                             \
    ((((reg32_t)v) << 24) & BM_USBPHY_VERSION_MAJOR)
#else
...
#define HW_USBPHY_IP_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_IP_SET_ADDR(x)) = (v))
#define HW_USBPHY_IP_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_IP_CLR_ADDR(x)) = (v))
#define HW_USBPHY_IP_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_USBPHY_IP_TOG_ADDR(x)) = (v))
#endif
...
#define BF_USBPHY_IP_ANALOG_TESTMODE(v)                                        \
    (((v) << 16) & BM_USBPHY_IP_ANALOG_TESTMODE)
#ifndef __LANGUAGE_ASM__
#define BW_USBPHY_IP_ANALOG_TESTMODE(n, v)                                     \
    BFn_CS1(USBPHY_IP, n, ANALOG_TESTMODE, v)
#endif
