...
#define BF_UARTDBGDR_UNAVAILABLE(v)                                            \
    ((((reg32_t)v) << 16) & BM_UARTDBGDR_UNAVAILABLE)
#else
...
/*
 * HW_UARTDBGRSR_ECR - UART Receive Status Register (Read) / Error Clear
 * Register (Write)
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTDBGRSR_ECR                                                      \
    (*(volatile hw_uartdbgrsr_ecr_t *)HW_UARTDBGRSR_ECR_ADDR)
#define HW_UARTDBGRSR_ECR_RD() (HW_UARTDBGRSR_ECR.U)
#define HW_UARTDBGRSR_ECR_WR(v) (HW_UARTDBGRSR_ECR.U = (v))
#define HW_UARTDBGRSR_ECR_SET(v)                                               \
    (HW_UARTDBGRSR_ECR_WR(HW_UARTDBGRSR_ECR_RD() | (v)))
#define HW_UARTDBGRSR_ECR_CLR(v)                                               \
    (HW_UARTDBGRSR_ECR_WR(HW_UARTDBGRSR_ECR_RD() & ~(v)))
#define HW_UARTDBGRSR_ECR_TOG(v)                                               \
    (HW_UARTDBGRSR_ECR_WR(HW_UARTDBGRSR_ECR_RD() ^ (v)))
#endif
...
#define BF_UARTDBGRSR_ECR_UNAVAILABLE(v)                                       \
    ((((reg32_t)v) << 8) & BM_UARTDBGRSR_ECR_UNAVAILABLE)
#else
#define BF_UARTDBGRSR_ECR_UNAVAILABLE(v)                                       \
...
#define BF_UARTDBGFR_UNAVAILABLE(v)                                            \
    ((((reg32_t)v) << 16) & BM_UARTDBGFR_UNAVAILABLE)
#else
...
#define BF_UARTDBGILPR_UNAVAILABLE(v)                                          \
    ((((reg32_t)v) << 8) & BM_UARTDBGILPR_UNAVAILABLE)
#else
...
#define BF_UARTDBGIBRD_UNAVAILABLE(v)                                          \
    ((((reg32_t)v) << 16) & BM_UARTDBGIBRD_UNAVAILABLE)
#else
...
#define BF_UARTDBGFBRD_UNAVAILABLE(v)                                          \
    ((((reg32_t)v) << 8) & BM_UARTDBGFBRD_UNAVAILABLE)
#else
...
#define BF_UARTDBGLCR_H_UNAVAILABLE(v)                                         \
    ((((reg32_t)v) << 16) & BM_UARTDBGLCR_H_UNAVAILABLE)
#else
#define BF_UARTDBGLCR_H_UNAVAILABLE(v)                                         \
...
#define BF_UARTDBGCR_UNAVAILABLE(v)                                            \
    ((((reg32_t)v) << 16) & BM_UARTDBGCR_UNAVAILABLE)
#else
...
#define BF_UARTDBGIFLS_UNAVAILABLE(v)                                          \
    ((((reg32_t)v) << 16) & BM_UARTDBGIFLS_UNAVAILABLE)
#else
...
#define BF_UARTDBGIMSC_UNAVAILABLE(v)                                          \
    ((((reg32_t)v) << 16) & BM_UARTDBGIMSC_UNAVAILABLE)
#else
...
#define BF_UARTDBGRIS_UNAVAILABLE(v)                                           \
    ((((reg32_t)v) << 16) & BM_UARTDBGRIS_UNAVAILABLE)
#else
...
#define BF_UARTDBGMIS_UNAVAILABLE(v)                                           \
    ((((reg32_t)v) << 16) & BM_UARTDBGMIS_UNAVAILABLE)
#else
...
#define BF_UARTDBGICR_UNAVAILABLE(v)                                           \
    ((((reg32_t)v) << 16) & BM_UARTDBGICR_UNAVAILABLE)
#else
...
#define BF_UARTDBGDMACR_UNAVAILABLE(v)                                         \
    ((((reg32_t)v) << 16) & BM_UARTDBGDMACR_UNAVAILABLE)
#else
#define BF_UARTDBGDMACR_UNAVAILABLE(v)                                         \
