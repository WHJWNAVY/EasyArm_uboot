...
#define HW_OCOTP_CTRL_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_OCOTP_CTRL_SET_ADDR) = (v))
#define HW_OCOTP_CTRL_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_OCOTP_CTRL_CLR_ADDR) = (v))
#define HW_OCOTP_CTRL_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_OCOTP_CTRL_TOG_ADDR) = (v))
#endif
...
#define BF_OCOTP_CTRL_WR_UNLOCK(v)                                             \
    ((((reg32_t)v) << 16) & BM_OCOTP_CTRL_WR_UNLOCK)
#else
...
#define BF_OCOTP_CTRL_RELOAD_SHADOWS(v)                                        \
    (((v) << 13) & BM_OCOTP_CTRL_RELOAD_SHADOWS)
#ifndef __LANGUAGE_ASM__
...
#ifndef __LANGUAGE_ASM__
#define HW_OCOTP_CRYPTOn(n)                                                    \
    (*(volatile hw_ocotp_crypton_t *)HW_OCOTP_CRYPTOn_ADDR(n))
...
#ifndef __LANGUAGE_ASM__
#define HW_OCOTP_HWCAPn(n)                                                     \
    (*(volatile hw_ocotp_hwcapn_t *)HW_OCOTP_HWCAPn_ADDR(n))
#define HW_OCOTP_HWCAPn_RD(n) (HW_OCOTP_HWCAPn(n).U)
#define HW_OCOTP_HWCAPn_WR(n, v) (HW_OCOTP_HWCAPn(n).U = (v))
#define HW_OCOTP_HWCAPn_SET(n, v)                                              \
    (HW_OCOTP_HWCAPn_WR(n, HW_OCOTP_HWCAPn_RD(n) | (v)))
#define HW_OCOTP_HWCAPn_CLR(n, v)                                              \
    (HW_OCOTP_HWCAPn_WR(n, HW_OCOTP_HWCAPn_RD(n) & ~(v)))
#define HW_OCOTP_HWCAPn_TOG(n, v)                                              \
    (HW_OCOTP_HWCAPn_WR(n, HW_OCOTP_HWCAPn_RD(n) ^ (v)))
#endif
...
#define HW_OCOTP_CUSTCAP_SET(v)                                                \
    (HW_OCOTP_CUSTCAP_WR(HW_OCOTP_CUSTCAP_RD() | (v)))
#define HW_OCOTP_CUSTCAP_CLR(v)                                                \
    (HW_OCOTP_CUSTCAP_WR(HW_OCOTP_CUSTCAP_RD() & ~(v)))
#define HW_OCOTP_CUSTCAP_TOG(v)                                                \
    (HW_OCOTP_CUSTCAP_WR(HW_OCOTP_CUSTCAP_RD() ^ (v)))
#endif
...
#define BF_OCOTP_CUSTCAP_RSRVD1(v)                                             \
    ((((reg32_t)v) << 3) & BM_OCOTP_CUSTCAP_RSRVD1)
#else
...
#define BF_OCOTP_CUSTCAP_RTC_XTAL_32768_PRESENT(v)                             \
    (((v) << 2) & BM_OCOTP_CUSTCAP_RTC_XTAL_32768_PRESENT)
#ifndef __LANGUAGE_ASM__
#define BW_OCOTP_CUSTCAP_RTC_XTAL_32768_PRESENT(v)                             \
    BF_CS1(OCOTP_CUSTCAP, RTC_XTAL_32768_PRESENT, v)
#endif
...
#define BF_OCOTP_CUSTCAP_RTC_XTAL_32000_PRESENT(v)                             \
    (((v) << 1) & BM_OCOTP_CUSTCAP_RTC_XTAL_32000_PRESENT)
#ifndef __LANGUAGE_ASM__
#define BW_OCOTP_CUSTCAP_RTC_XTAL_32000_PRESENT(v)                             \
    BF_CS1(OCOTP_CUSTCAP, RTC_XTAL_32000_PRESENT, v)
#endif
...
#define BF_OCOTP_LOCK_HWSW_SHADOW_ALT(v)                                       \
    (((v) << 23) & BM_OCOTP_LOCK_HWSW_SHADOW_ALT)
...
#define BF_OCOTP_LOCK_CRYPTODCP_ALT(v)                                         \
    (((v) << 22) & BM_OCOTP_LOCK_CRYPTODCP_ALT)
...
#define BF_OCOTP_LOCK_CRYPTOKEY_ALT(v)                                         \
    (((v) << 21) & BM_OCOTP_LOCK_CRYPTOKEY_ALT)
...
#define BF_OCOTP_LOCK_CUSTCAP_SHADOW(v)                                        \
    (((v) << 7) & BM_OCOTP_LOCK_CUSTCAP_SHADOW)
...
#define HW_OCOTP_ROMn_CLR(n, v)                                                \
    (HW_OCOTP_ROMn_WR(n, HW_OCOTP_ROMn_RD(n) & ~(v)))
...
#define BF_OCOTP_ROMn_BOOT_MODE(v)                                             \
    ((((reg32_t)v) << 24) & BM_OCOTP_ROMn_BOOT_MODE)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_OCOTP_ROMn_SD_POWER_GATE_GPIO(n, v)                                 \
    BF_CS1n(OCOTP_ROMn, n, SD_POWER_GATE_GPIO, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_OCOTP_ROMn_SD_POWER_UP_DELAY(n, v)                                  \
    BF_CS1n(OCOTP_ROMn, n, SD_POWER_UP_DELAY, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_OCOTP_ROMn_SSP_SCK_INDEX(n, v)                                      \
    BF_CS1n(OCOTP_ROMn, n, SSP_SCK_INDEX, v)
#endif
...
#define BF_OCOTP_ROMn_DISABLE_SPI_NOR_FAST_READ(v)                             \
    (((v) << 6) & BM_OCOTP_ROMn_DISABLE_SPI_NOR_FAST_READ)
#ifndef __LANGUAGE_ASM__
#define BW_OCOTP_ROMn_DISABLE_SPI_NOR_FAST_READ(n, v)                          \
    BF_CS1n(OCOTP_ROMn, n, DISABLE_SPI_NOR_FAST_READ, v)
#endif
...
#define BF_OCOTP_ROMn_ENABLE_USB_BOOT_SERIAL_NUM(v)                            \
    (((v) << 5) & BM_OCOTP_ROMn_ENABLE_USB_BOOT_SERIAL_NUM)
#ifndef __LANGUAGE_ASM__
#define BW_OCOTP_ROMn_ENABLE_USB_BOOT_SERIAL_NUM(n, v)                         \
    BF_CS1n(OCOTP_ROMn, n, ENABLE_USB_BOOT_SERIAL_NUM, v)
#endif
...
#define BF_OCOTP_ROMn_ENABLE_UNENCRYPTED_BOOT(v)                               \
    (((v) << 4) & BM_OCOTP_ROMn_ENABLE_UNENCRYPTED_BOOT)
#ifndef __LANGUAGE_ASM__
#define BW_OCOTP_ROMn_ENABLE_UNENCRYPTED_BOOT(n, v)                            \
    BF_CS1n(OCOTP_ROMn, n, ENABLE_UNENCRYPTED_BOOT, v)
#endif
...
#define HW_OCOTP_SRKn_CLR(n, v)                                                \
    (HW_OCOTP_SRKn_WR(n, HW_OCOTP_SRKn_RD(n) & ~(v)))
...
#define BF_OCOTP_VERSION_MAJOR(v)                                              \
    ((((reg32_t)v) << 24) & BM_OCOTP_VERSION_MAJOR)
#else
