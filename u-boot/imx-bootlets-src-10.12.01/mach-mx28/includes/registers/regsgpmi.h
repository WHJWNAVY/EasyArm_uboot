...
#define BF_GPMI_ECCCOUNT_RSVD2(v)                                              \
    ((((reg32_t)v) << 16) & BM_GPMI_ECCCOUNT_RSVD2)
#else
...
#define BF_GPMI_CTRL1_TIMEOUT_IRQ_EN(v)                                        \
    (((v) << 20) & BM_GPMI_CTRL1_TIMEOUT_IRQ_EN)
#ifndef __LANGUAGE_ASM__
...
#define BF_GPMI_CTRL1_ABORT_WAIT_REQUEST(v)                                    \
    (((v) << 7) & BM_GPMI_CTRL1_ABORT_WAIT_REQUEST)
#ifndef __LANGUAGE_ASM__
#define BW_GPMI_CTRL1_ABORT_WAIT_REQUEST(v)                                    \
    BF_CS1(GPMI_CTRL1, ABORT_WAIT_REQUEST, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_GPMI_CTRL1_ABORT_WAIT_FOR_READY_CHANNEL(v)                          \
    BF_CS1(GPMI_CTRL1, ABORT_WAIT_FOR_READY_CHANNEL, v)
#endif
...
#define BF_GPMI_STAT_INVALID_BUFFER_MASK(v)                                    \
    (((v) << 3) & BM_GPMI_STAT_INVALID_BUFFER_MASK)
...
#define BF_GPMI_DEBUG_WAIT_FOR_READY_END(v)                                    \
    ((((reg32_t)v) << 24) & BM_GPMI_DEBUG_WAIT_FOR_READY_END)
#else
#define BF_GPMI_DEBUG_WAIT_FOR_READY_END(v)                                    \
