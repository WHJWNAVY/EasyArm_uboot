...
#define REGS_CAN_BASE(x)                                                       \
    (x == 0 ? REGS_CAN0_BASE : x == 1 ? REGS_CAN1_BASE : 0xffff0000)
#endif
...
#define HW_CAN_RXGMASK_SET(x, v)                                               \
    (HW_CAN_RXGMASK_WR(x, HW_CAN_RXGMASK_RD(x) | (v)))
#define HW_CAN_RXGMASK_CLR(x, v)                                               \
    (HW_CAN_RXGMASK_WR(x, HW_CAN_RXGMASK_RD(x) & ~(v)))
#define HW_CAN_RXGMASK_TOG(x, v)                                               \
    (HW_CAN_RXGMASK_WR(x, HW_CAN_RXGMASK_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_CAN_RX14MASK(x)                                                     \
    (*(volatile hw_can_rx14mask_t *)HW_CAN_RX14MASK_ADDR(x))
#define HW_CAN_RX14MASK_RD(x) (HW_CAN_RX14MASK(x).U)
#define HW_CAN_RX14MASK_WR(x, v) (HW_CAN_RX14MASK(x).U = (v))
#define HW_CAN_RX14MASK_SET(x, v)                                              \
    (HW_CAN_RX14MASK_WR(x, HW_CAN_RX14MASK_RD(x) | (v)))
#define HW_CAN_RX14MASK_CLR(x, v)                                              \
    (HW_CAN_RX14MASK_WR(x, HW_CAN_RX14MASK_RD(x) & ~(v)))
#define HW_CAN_RX14MASK_TOG(x, v)                                              \
    (HW_CAN_RX14MASK_WR(x, HW_CAN_RX14MASK_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_CAN_RX15MASK(x)                                                     \
    (*(volatile hw_can_rx15mask_t *)HW_CAN_RX15MASK_ADDR(x))
#define HW_CAN_RX15MASK_RD(x) (HW_CAN_RX15MASK(x).U)
#define HW_CAN_RX15MASK_WR(x, v) (HW_CAN_RX15MASK(x).U = (v))
#define HW_CAN_RX15MASK_SET(x, v)                                              \
    (HW_CAN_RX15MASK_WR(x, HW_CAN_RX15MASK_RD(x) | (v)))
#define HW_CAN_RX15MASK_CLR(x, v)                                              \
    (HW_CAN_RX15MASK_WR(x, HW_CAN_RX15MASK_RD(x) & ~(v)))
#define HW_CAN_RX15MASK_TOG(x, v)                                              \
    (HW_CAN_RX15MASK_WR(x, HW_CAN_RX15MASK_RD(x) ^ (v)))
#endif
...
#define HW_CAN_IMASK2_CLR(x, v)                                                \
    (HW_CAN_IMASK2_WR(x, HW_CAN_IMASK2_RD(x) & ~(v)))
...
#define HW_CAN_IMASK1_CLR(x, v)                                                \
    (HW_CAN_IMASK1_WR(x, HW_CAN_IMASK1_RD(x) & ~(v)))
...
#define HW_CAN_IFLAG2_CLR(x, v)                                                \
    (HW_CAN_IFLAG2_WR(x, HW_CAN_IFLAG2_RD(x) & ~(v)))
...
#define HW_CAN_IFLAG1_CLR(x, v)                                                \
    (HW_CAN_IFLAG1_WR(x, HW_CAN_IFLAG1_RD(x) & ~(v)))
...
#define HW_CAN_RXIMRn_CLR(x, v)                                                \
    (HW_CAN_RXIMRn_WR(x, HW_CAN_RXIMRn_RD(x) & ~(v)))
