...
#define BF_CS1(reg, f1, v1)                                                    \
    (HW_##reg##_CLR(BM_##reg##_##f1), HW_##reg##_SET(BF_##reg##_##f1(v1)))

#define BF_CS2(reg, f1, v1, f2, v2)                                            \
    (HW_##reg##_CLR(BM_##reg##_##f1 | BM_##reg##_##f2),                        \
     HW_##reg##_SET(BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2)))

#define BF_CS3(reg, f1, v1, f2, v2, f3, v3)                                    \
    (HW_##reg##_CLR(BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3),      \
     HW_##reg##_SET(BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |                \
                    BF_##reg##_##f3(v3)))
...
#define BF_CS4(reg, f1, v1, f2, v2, f3, v3, f4, v4)                            \
    (HW_##reg##_CLR(BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |      \
                    BM_##reg##_##f4),                                          \
     HW_##reg##_SET(BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |                \
                    BF_##reg##_##f3(v3) | BF_##reg##_##f4(v4)))

#define BF_CS5(reg, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5)                    \
    (HW_##reg##_CLR(BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |      \
                    BM_##reg##_##f4 | BM_##reg##_##f5),                        \
     HW_##reg##_SET(BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |                \
                    BF_##reg##_##f3(v3) | BF_##reg##_##f4(v4) |                \
                    BF_##reg##_##f5(v5)))
...
#define BF_CS6(reg, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6)            \
    (HW_##reg##_CLR(BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |      \
                    BM_##reg##_##f4 | BM_##reg##_##f5 | BM_##reg##_##f6),      \
     HW_##reg##_SET(BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |                \
                    BF_##reg##_##f3(v3) | BF_##reg##_##f4(v4) |                \
                    BF_##reg##_##f5(v5) | BF_##reg##_##f6(v6)))
...
#define BF_CS8(reg, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6, f7, v7,    \
               f8, v8)                                                         \
    (HW_##reg##_CLR(BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |      \
                    BM_##reg##_##f4 | BM_##reg##_##f5 | BM_##reg##_##f6 |      \
                    BM_##reg##_##f7 | BM_##reg##_##f8),                        \
     HW_##reg##_SET(BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |                \
                    BF_##reg##_##f3(v3) | BF_##reg##_##f4(v4) |                \
                    BF_##reg##_##f5(v5) | BF_##reg##_##f6(v6) |                \
                    BF_##reg##_##f7(v7) | BF_##reg##_##f8(v8)))
...
#define BV_FLDn(reg, n, field, sym)                                            \
    BF_##reg##_##field(BV_##reg##_##field##__##sym)
...
#define BF_CS2n(reg, n, f1, v1, f2, v2)                                        \
    (HW_##reg##_CLR(n, (BM_##reg##_##f1 | BM_##reg##_##f2)),                   \
     HW_##reg##_SET(n, (BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2))))

#define BF_CS3n(reg, n, f1, v1, f2, v2, f3, v3)                                \
    (HW_##reg##_CLR(n, (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3)), \
     HW_##reg##_SET(n, (BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |            \
                        BF_##reg##_##f3(v3))))
...
#define BF_CS7n(reg, n, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6, f7,    \
                v7)                                                            \
    (HW_##reg##_CLR(n, (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |  \
                        BM_##reg##_##f4 | BM_##reg##_##f5 | BM_##reg##_##f6 |  \
                        BM_##reg##_##f7)),                                     \
...
#define BF_CS8n(reg, n, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6, f7,    \
                v7, f8, v8)                                                    \
    (HW_##reg##_CLR(n, (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |  \
                        BM_##reg##_##f4 | BM_##reg##_##f5 | BM_##reg##_##f6 |  \
                        BM_##reg##_##f7 | BM_##reg##_##f8)),                   \
...
#define BFn_CS2(reg, blk, f1, v1, f2, v2)                                      \
    (HW_##reg##_CLR(blk, BM_##reg##_##f1 | BM_##reg##_##f2),                   \
     HW_##reg##_SET(blk, BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2)))

#define BFn_CS3(reg, blk, f1, v1, f2, v2, f3, v3)                              \
    (HW_##reg##_CLR(blk, BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3), \
     HW_##reg##_SET(blk, BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |           \
                             BF_##reg##_##f3(v3)))
...
#define BFn_CS7(reg, blk, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6, f7,  \
                v7)                                                            \
    (HW_##reg##_CLR(blk, BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 | \
                             BM_##reg##_##f4 | BM_##reg##_##f5 |               \
                             BM_##reg##_##f6 | BM_##reg##_##f7),               \
     HW_##reg##_SET(blk, BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |           \
                             BF_##reg##_##f3(v3) | BF_##reg##_##f4(v4) |       \
                             BF_##reg##_##f5(v5) | BF_##reg##_##f6(v6) |       \
                             BF_##reg##_##f7(v7)))

#define BFn_CS8(reg, blk, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6, f7,  \
                v7, f8, v8)                                                    \
    (HW_##reg##_CLR(blk, BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 | \
                             BM_##reg##_##f4 | BM_##reg##_##f5 |               \
                             BM_##reg##_##f6 | BM_##reg##_##f7 |               \
...
#define BFn_SETVn(reg, blk, n, field, v)                                       \
    HW_##reg##_SET(blk, n, BF_##reg##_##field(v))
#define BFn_CLRVn(reg, blk, n, field, v)                                       \
    HW_##reg##_CLR(blk, n, BF_##reg##_##field(v))
#define BFn_TOGVn(reg, blk, n, field, v)                                       \
    HW_##reg##_TOG(blk, n, BF_##reg##_##field(v))

#define BVn_FLDn(reg, blk, n, field, sym)                                      \
    BF_##reg##_##field(BV_##reg##_##field##__##sym)
...
#define BFn_CS2n(reg, blk, n, f1, v1, f2, v2)                                  \
    (HW_##reg##_CLR(blk, n, (BM_##reg##_##f1 | BM_##reg##_##f2)),              \
     HW_##reg##_SET(blk, n, (BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2))))

#define BFn_CS3n(reg, blk, n, f1, v1, f2, v2, f3, v3)                          \
    (HW_##reg##_CLR(blk, n,                                                    \
                    (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3)),    \
     HW_##reg##_SET(                                                           \
         blk, n,                                                               \
         (BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) | BF_##reg##_##f3(v3))))
...
#define BFn_CS4n(reg, blk, n, f1, v1, f2, v2, f3, v3, f4, v4)                  \
    (HW_##reg##_CLR(blk, n,                                                    \
                    (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |     \
                     BM_##reg##_##f4)),                                        \
     HW_##reg##_SET(blk, n,                                                    \
                    (BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |               \
                     BF_##reg##_##f3(v3) | BF_##reg##_##f4(v4))))
...
#define BFn_CS7n(reg, blk, n, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6,  \
                 f7, v7)                                                       \
    (HW_##reg##_CLR(blk, n,                                                    \
                    (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |     \
                     BM_##reg##_##f4 | BM_##reg##_##f5 | BM_##reg##_##f6 |     \
...
#define BFn_CS8n(reg, blk, n, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6,  \
                 f7, v7, f8, v8)                                               \
    (HW_##reg##_CLR(blk, n,                                                    \
                    (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |     \
                     BM_##reg##_##f4 | BM_##reg##_##f5 | BM_##reg##_##f6 |     \
