...
#define BF_LCDIF_CTRL1_COMBINE_MPU_WR_STRB(v)                                  \
    (((v) << 27) & BM_LCDIF_CTRL1_COMBINE_MPU_WR_STRB)
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_COMBINE_MPU_WR_STRB(v)                                  \
    BF_CS1(LCDIF_CTRL1, COMBINE_MPU_WR_STRB, v)
#endif
...
#define HW_LCDIF_CTRL2_SET(v)                                                  \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL2_SET_ADDR) = (v))
#define HW_LCDIF_CTRL2_CLR(v)                                                  \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL2_CLR_ADDR) = (v))
#define HW_LCDIF_CTRL2_TOG(v)                                                  \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL2_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL2_OUTSTANDING_REQS(v)                                     \
    BF_CS1(LCDIF_CTRL2, OUTSTANDING_REQS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL2_ODD_LINE_PATTERN(v)                                     \
    BF_CS1(LCDIF_CTRL2, ODD_LINE_PATTERN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL2_EVEN_LINE_PATTERN(v)                                    \
    BF_CS1(LCDIF_CTRL2, EVEN_LINE_PATTERN, v)
#endif
...
#define BF_LCDIF_CTRL2_READ_PACK_DIR(v)                                        \
    (((v) << 10) & BM_LCDIF_CTRL2_READ_PACK_DIR)
#ifndef __LANGUAGE_ASM__
...
#define BF_LCDIF_CTRL2_READ_MODE_OUTPUT_IN_RGB_FORMAT(v)                       \
    (((v) << 9) & BM_LCDIF_CTRL2_READ_MODE_OUTPUT_IN_RGB_FORMAT)
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL2_READ_MODE_OUTPUT_IN_RGB_FORMAT(v)                       \
    BF_CS1(LCDIF_CTRL2, READ_MODE_OUTPUT_IN_RGB_FORMAT, v)
#endif
...
#define BF_LCDIF_CTRL2_READ_MODE_6_BIT_INPUT(v)                                \
    (((v) << 8) & BM_LCDIF_CTRL2_READ_MODE_6_BIT_INPUT)
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL2_READ_MODE_6_BIT_INPUT(v)                                \
    BF_CS1(LCDIF_CTRL2, READ_MODE_6_BIT_INPUT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL2_READ_MODE_NUM_PACKED_SUBWORDS(v)                        \
    BF_CS1(LCDIF_CTRL2, READ_MODE_NUM_PACKED_SUBWORDS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL2_INITIAL_DUMMY_READ(v)                                   \
    BF_CS1(LCDIF_CTRL2, INITIAL_DUMMY_READ, v)
#endif
...
#define BF_LCDIF_VDCTRL0_RSRVD2(v)                                             \
    ((((reg32_t)v) << 30) & BM_LCDIF_VDCTRL0_RSRVD2)
#else
...
#define BF_LCDIF_VDCTRL2_HSYNC_PULSE_WIDTH(v)                                  \
    ((((reg32_t)v) << 18) & BM_LCDIF_VDCTRL2_HSYNC_PULSE_WIDTH)
#else
#define BF_LCDIF_VDCTRL2_HSYNC_PULSE_WIDTH(v)                                  \
...
#define BW_LCDIF_VDCTRL2_HSYNC_PULSE_WIDTH(v)                                  \
    BF_CS1(LCDIF_VDCTRL2, HSYNC_PULSE_WIDTH, v)
#endif
...
#define BF_LCDIF_VDCTRL3_RSRVD0(v)                                             \
    ((((reg32_t)v) << 30) & BM_LCDIF_VDCTRL3_RSRVD0)
#else
...
#define BF_LCDIF_VDCTRL4_DOTCLK_DLY_SEL(v)                                     \
    ((((reg32_t)v) << 29) & BM_LCDIF_VDCTRL4_DOTCLK_DLY_SEL)
#else
#define BF_LCDIF_VDCTRL4_DOTCLK_DLY_SEL(v)                                     \
    (((v) << 29) & BM_LCDIF_VDCTRL4_DOTCLK_DLY_SEL)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL4_DOTCLK_DLY_SEL(v)                                     \
    BF_CS1(LCDIF_VDCTRL4, DOTCLK_DLY_SEL, v)
#endif
...
#define BF_LCDIF_DVICTRL0_RSRVD1(v)                                            \
    ((((reg32_t)v) << 28) & BM_LCDIF_DVICTRL0_RSRVD1)
#else
...
#define BF_LCDIF_DVICTRL1_RSRVD0(v)                                            \
    ((((reg32_t)v) << 30) & BM_LCDIF_DVICTRL1_RSRVD0)
#else
...
#define BF_LCDIF_DVICTRL2_RSRVD0(v)                                            \
    ((((reg32_t)v) << 30) & BM_LCDIF_DVICTRL2_RSRVD0)
#else
...
#define BF_LCDIF_DVICTRL3_RSRVD0(v)                                            \
    ((((reg32_t)v) << 30) & BM_LCDIF_DVICTRL3_RSRVD0)
#else
...
#define BF_LCDIF_CSC_COEFF0_RSRVD1(v)                                          \
    ((((reg32_t)v) << 26) & BM_LCDIF_CSC_COEFF0_RSRVD1)
#else
...
#define BF_LCDIF_CSC_COEFF1_RSRVD1(v)                                          \
    ((((reg32_t)v) << 26) & BM_LCDIF_CSC_COEFF1_RSRVD1)
#else
...
#define BF_LCDIF_CSC_COEFF2_RSRVD1(v)                                          \
    ((((reg32_t)v) << 26) & BM_LCDIF_CSC_COEFF2_RSRVD1)
#else
...
#define BF_LCDIF_CSC_COEFF3_RSRVD1(v)                                          \
    ((((reg32_t)v) << 26) & BM_LCDIF_CSC_COEFF3_RSRVD1)
#else
...
#define BF_LCDIF_CSC_COEFF4_RSRVD1(v)                                          \
    ((((reg32_t)v) << 26) & BM_LCDIF_CSC_COEFF4_RSRVD1)
#else
...
#define BF_LCDIF_CSC_OFFSET_RSRVD1(v)                                          \
    ((((reg32_t)v) << 25) & BM_LCDIF_CSC_OFFSET_RSRVD1)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_CRC_STAT                                                      \
    (*(volatile hw_lcdif_crc_stat_t *)HW_LCDIF_CRC_STAT_ADDR)
#define HW_LCDIF_CRC_STAT_RD() (HW_LCDIF_CRC_STAT.U)
#define HW_LCDIF_CRC_STAT_WR(v) (HW_LCDIF_CRC_STAT.U = (v))
#define HW_LCDIF_CRC_STAT_SET(v)                                               \
    (HW_LCDIF_CRC_STAT_WR(HW_LCDIF_CRC_STAT_RD() | (v)))
#define HW_LCDIF_CRC_STAT_CLR(v)                                               \
    (HW_LCDIF_CRC_STAT_WR(HW_LCDIF_CRC_STAT_RD() & ~(v)))
#define HW_LCDIF_CRC_STAT_TOG(v)                                               \
    (HW_LCDIF_CRC_STAT_WR(HW_LCDIF_CRC_STAT_RD() ^ (v)))
#endif
