...
#define HW_PERFMON_CTRL_SET(v)                                                 \
    ((*(volatile reg32_t *)HW_PERFMON_CTRL_SET_ADDR) = (v))
#define HW_PERFMON_CTRL_CLR(v)                                                 \
    ((*(volatile reg32_t *)HW_PERFMON_CTRL_CLR_ADDR) = (v))
#define HW_PERFMON_CTRL_TOG(v)                                                 \
    ((*(volatile reg32_t *)HW_PERFMON_CTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_PERFMON_CTRL_SFTRST(v)                                              \
    ((((reg32_t)v) << 31) & BM_PERFMON_CTRL_SFTRST)
#else
...
#define BF_PERFMON_CTRL_BUS_ERR_IRQ(v)                                         \
    (((v) << 12) & BM_PERFMON_CTRL_BUS_ERR_IRQ)
#ifndef __LANGUAGE_ASM__
...
#define BF_PERFMON_CTRL_LATENCY_IRQ(v)                                         \
    (((v) << 11) & BM_PERFMON_CTRL_LATENCY_IRQ)
#ifndef __LANGUAGE_ASM__
...
#define BF_PERFMON_CTRL_BUS_ERR_IRQ_EN(v)                                      \
    (((v) << 9) & BM_PERFMON_CTRL_BUS_ERR_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_PERFMON_CTRL_BUS_ERR_IRQ_EN(v)                                      \
    BF_CS1(PERFMON_CTRL, BUS_ERR_IRQ_EN, v)
#endif
...
#define BF_PERFMON_CTRL_LATENCY_IRQ_EN(v)                                      \
    (((v) << 8) & BM_PERFMON_CTRL_LATENCY_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_PERFMON_CTRL_LATENCY_IRQ_EN(v)                                      \
    BF_CS1(PERFMON_CTRL, LATENCY_IRQ_EN, v)
#endif
...
#define BF_PERFMON_CTRL_TRAP_IRQ_EN(v)                                         \
    (((v) << 7) & BM_PERFMON_CTRL_TRAP_IRQ_EN)
#ifndef __LANGUAGE_ASM__
...
#define BF_PERFMON_CTRL_LATENCY_ENABLE(v)                                      \
    (((v) << 6) & BM_PERFMON_CTRL_LATENCY_ENABLE)
#ifndef __LANGUAGE_ASM__
#define BW_PERFMON_CTRL_LATENCY_ENABLE(v)                                      \
    BF_CS1(PERFMON_CTRL, LATENCY_ENABLE, v)
#endif
...
#define BF_PERFMON_CTRL_TRAP_IN_RANGE(v)                                       \
    (((v) << 5) & BM_PERFMON_CTRL_TRAP_IN_RANGE)
#ifndef __LANGUAGE_ASM__
...
#define BF_PERFMON_CTRL_TRAP_ENABLE(v)                                         \
    (((v) << 4) & BM_PERFMON_CTRL_TRAP_ENABLE)
#ifndef __LANGUAGE_ASM__
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_MASTER_EN                                                   \
    (*(volatile hw_perfmon_master_en_t *)HW_PERFMON_MASTER_EN_ADDR)
#define HW_PERFMON_MASTER_EN_RD() (HW_PERFMON_MASTER_EN.U)
#define HW_PERFMON_MASTER_EN_WR(v) (HW_PERFMON_MASTER_EN.U = (v))
#define HW_PERFMON_MASTER_EN_SET(v)                                            \
    (HW_PERFMON_MASTER_EN_WR(HW_PERFMON_MASTER_EN_RD() | (v)))
#define HW_PERFMON_MASTER_EN_CLR(v)                                            \
    (HW_PERFMON_MASTER_EN_WR(HW_PERFMON_MASTER_EN_RD() & ~(v)))
#define HW_PERFMON_MASTER_EN_TOG(v)                                            \
    (HW_PERFMON_MASTER_EN_WR(HW_PERFMON_MASTER_EN_RD() ^ (v)))
#endif
...
#define BF_PERFMON_MASTER_EN_RSVD0(v)                                          \
    ((((reg32_t)v) << 16) & BM_PERFMON_MASTER_EN_RSVD0)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_TRAP_ADDR_LOW                                               \
    (*(volatile hw_perfmon_trap_addr_low_t *)HW_PERFMON_TRAP_ADDR_LOW_ADDR)
...
#define HW_PERFMON_TRAP_ADDR_LOW_SET(v)                                        \
    (HW_PERFMON_TRAP_ADDR_LOW_WR(HW_PERFMON_TRAP_ADDR_LOW_RD() | (v)))
#define HW_PERFMON_TRAP_ADDR_LOW_CLR(v)                                        \
    (HW_PERFMON_TRAP_ADDR_LOW_WR(HW_PERFMON_TRAP_ADDR_LOW_RD() & ~(v)))
#define HW_PERFMON_TRAP_ADDR_LOW_TOG(v)                                        \
    (HW_PERFMON_TRAP_ADDR_LOW_WR(HW_PERFMON_TRAP_ADDR_LOW_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_TRAP_ADDR_HIGH                                              \
    (*(volatile hw_perfmon_trap_addr_high_t *)HW_PERFMON_TRAP_ADDR_HIGH_ADDR)
...
#define HW_PERFMON_TRAP_ADDR_HIGH_SET(v)                                       \
    (HW_PERFMON_TRAP_ADDR_HIGH_WR(HW_PERFMON_TRAP_ADDR_HIGH_RD() | (v)))
#define HW_PERFMON_TRAP_ADDR_HIGH_CLR(v)                                       \
    (HW_PERFMON_TRAP_ADDR_HIGH_WR(HW_PERFMON_TRAP_ADDR_HIGH_RD() & ~(v)))
#define HW_PERFMON_TRAP_ADDR_HIGH_TOG(v)                                       \
    (HW_PERFMON_TRAP_ADDR_HIGH_WR(HW_PERFMON_TRAP_ADDR_HIGH_RD() ^ (v)))
#endif
...
#endif
#ifndef __LANGUAGE_ASM__
#define BW_PERFMON_TRAP_ADDR_HIGH_ADDR(v)                                      \
    (HW_PERFMON_TRAP_ADDR_HIGH.B.ADDR = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_LAT_THRESHOLD                                               \
    (*(volatile hw_perfmon_lat_threshold_t *)HW_PERFMON_LAT_THRESHOLD_ADDR)
...
#define HW_PERFMON_LAT_THRESHOLD_SET(v)                                        \
    (HW_PERFMON_LAT_THRESHOLD_WR(HW_PERFMON_LAT_THRESHOLD_RD() | (v)))
#define HW_PERFMON_LAT_THRESHOLD_CLR(v)                                        \
    (HW_PERFMON_LAT_THRESHOLD_WR(HW_PERFMON_LAT_THRESHOLD_RD() & ~(v)))
#define HW_PERFMON_LAT_THRESHOLD_TOG(v)                                        \
    (HW_PERFMON_LAT_THRESHOLD_WR(HW_PERFMON_LAT_THRESHOLD_RD() ^ (v)))
#endif
...
#define BF_PERFMON_LAT_THRESHOLD_RSVD0(v)                                      \
    ((((reg32_t)v) << 12) & BM_PERFMON_LAT_THRESHOLD_RSVD0)
#else
#define BF_PERFMON_LAT_THRESHOLD_RSVD0(v)                                      \
...
#ifndef __LANGUAGE_ASM__
#define BW_PERFMON_LAT_THRESHOLD_VALUE(v)                                      \
    BF_CS1(PERFMON_LAT_THRESHOLD, VALUE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_ACTIVE_CYCLE                                                \
    (*(volatile hw_perfmon_active_cycle_t *)HW_PERFMON_ACTIVE_CYCLE_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_TRANSFER_COUNT                                              \
    (*(volatile hw_perfmon_transfer_count_t *)HW_PERFMON_TRANSFER_COUNT_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_TOTAL_LATENCY                                               \
    (*(volatile hw_perfmon_total_latency_t *)HW_PERFMON_TOTAL_LATENCY_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_DATA_COUNT                                                  \
    (*(volatile hw_perfmon_data_count_t *)HW_PERFMON_DATA_COUNT_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_MAX_LATENCY                                                 \
    (*(volatile hw_perfmon_max_latency_t *)HW_PERFMON_MAX_LATENCY_ADDR)
...
#define BF_PERFMON_MAX_LATENCY_ABURST(v)                                       \
    ((((reg32_t)v) << 30) & BM_PERFMON_MAX_LATENCY_ABURST)
#else
#define BF_PERFMON_MAX_LATENCY_ABURST(v)                                       \
...
#define HW_PERFMON_DEBUG_SET(v)                                                \
    (HW_PERFMON_DEBUG_WR(HW_PERFMON_DEBUG_RD() | (v)))
#define HW_PERFMON_DEBUG_CLR(v)                                                \
    (HW_PERFMON_DEBUG_WR(HW_PERFMON_DEBUG_RD() & ~(v)))
#define HW_PERFMON_DEBUG_TOG(v)                                                \
    (HW_PERFMON_DEBUG_WR(HW_PERFMON_DEBUG_RD() ^ (v)))
#endif
...
#define BF_PERFMON_DEBUG_TOTAL_CYCLE_CLR_EN(v)                                 \
    (((v) << 1) & BM_PERFMON_DEBUG_TOTAL_CYCLE_CLR_EN)
#ifndef __LANGUAGE_ASM__
#define BW_PERFMON_DEBUG_TOTAL_CYCLE_CLR_EN(v)                                 \
    BF_CS1(PERFMON_DEBUG, TOTAL_CYCLE_CLR_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_PERFMON_VERSION                                                     \
    (*(volatile hw_perfmon_version_t *)HW_PERFMON_VERSION_ADDR)
...
#define BF_PERFMON_VERSION_MAJOR(v)                                            \
    ((((reg32_t)v) << 24) & BM_PERFMON_VERSION_MAJOR)
#else
