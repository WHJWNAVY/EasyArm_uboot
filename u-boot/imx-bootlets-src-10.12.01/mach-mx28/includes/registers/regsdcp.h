...
#define BF_DCP_CTRL_RSVD_CSC_INTERRUPT_ENABLE(v)                               \
    (((v) << 8) & BM_DCP_CTRL_RSVD_CSC_INTERRUPT_ENABLE)
...
#define BF_DCP_CHANNELCTRL_RSVD(v)                                             \
    ((((reg32_t)v) << 17) & BM_DCP_CHANNELCTRL_RSVD)
#else
...
#define BF_DCP_CAPABILITY0_DISABLE_UNIQUE_KEY(v)                               \
    (((v) << 29) & BM_DCP_CAPABILITY0_DISABLE_UNIQUE_KEY)
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CAPABILITY0_DISABLE_UNIQUE_KEY(v)                               \
    BF_CS1(DCP_CAPABILITY0, DISABLE_UNIQUE_KEY, v)
#endif
...
#define BF_DCP_CHnSTAT_RSVD_COMPLETE(v)                                        \
    (((v) << 0) & BM_DCP_CHnSTAT_RSVD_COMPLETE)
