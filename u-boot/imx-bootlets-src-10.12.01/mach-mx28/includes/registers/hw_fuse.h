...
#define HW_FUSE_LRADC_BUTTON0_DISABLE_ADDR                                     \
    0x008 // addr=C0A0[18]    , bit=018:018
#define HW_FUSE_LRADC_BUTTON0_DISABLE_BM 0x00040000
#define HW_FUSE_LRADC_BUTTON1_DISABLE_ADDR                                     \
    0x008 // addr=C0A0[19]    , bit=019:019
...
#define HW_FUSE_RTC_WATCHDOG_DISABLE_ADDR                                      \
    0x008 // addr=C0A0[30]    , bit=030:030
...
#define HW_FUSE_APPUART0_HI_SPEED_DISABLE_ADDR                                 \
    0x009 // addr=C0B0[11]    , bit=043:043
...
#define HW_FUSE_APPUART1_HI_SPEED_DISABLE_ADDR                                 \
    0x009 // addr=C0B0[13]    , bit=045:045
...
#define HW_FUSE_APPUART2_HI_SPEED_DISABLE_ADDR                                 \
    0x009 // addr=C0B0[15]    , bit=047:047
...
#define HW_FUSE_APPUART3_HI_SPEED_DISABLE_ADDR                                 \
    0x009 // addr=C0B0[17]    , bit=049:049
...
#define HW_FUSE_APPUART4_HI_SPEED_DISABLE_ADDR                                 \
    0x009 // addr=C0B0[19]    , bit=051:051
...
#define HW_FUSE_EMI_LARGE_DRAM_DISABLE_ADDR                                    \
    0x00b // addr=C0D0[7]     , bit=103:103
#define HW_FUSE_EMI_LARGE_DRAM_DISABLE_BM 0x00000080
#define HW_FUSE_ENET_SWITCH_RESET_BY_SW_ADDR                                   \
    0x00b // addr=C0D0[11]    , bit=107:107
#define HW_FUSE_ENET_SWITCH_RESET_BY_SW_BM 0x00000800
#define HW_FUSE_ENET_SWITCH_RESET_BY_SW_CHIP_ADDR                              \
    0x00b // addr=C0D0[12]    , bit=108:108
...
#define HW_FUSE_RTC_XTAL_32000_PRESENT_ADDR                                    \
    0x00f // addr=C110[1]     , bit=225:225
#define HW_FUSE_RTC_XTAL_32000_PRESENT_BM 0x00000002
#define HW_FUSE_RTC_XTAL_32768_PRESENT_ADDR                                    \
    0x00f // addr=C110[2]     , bit=226:226
#define HW_FUSE_RTC_XTAL_32768_PRESENT_BM 0x00000004
#define HW_FUSE_CUST_DISABLE_JANUSDRM10_ADDR                                   \
    0x00f // addr=C110[30]    , bit=254:254
#define HW_FUSE_CUST_DISABLE_JANUSDRM10_BM 0x40000000
#define HW_FUSE_CUST_DISABLE_WMADRM9_ADDR                                      \
    0x00f // addr=C110[31]    , bit=255:255
