...
#define REGS_SAIF_BASE(x)                                                      \
    (x == 0 ? REGS_SAIF0_BASE : x == 1 ? REGS_SAIF1_BASE : 0xffff0000)
#endif
...
#define HW_SAIF_CTRL_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_CTRL_SET_ADDR(x)) = (v))
#define HW_SAIF_CTRL_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_CTRL_CLR_ADDR(x)) = (v))
#define HW_SAIF_CTRL_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_CTRL_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_CTRL_BITCLK_MULT_RATE(n, v)                                    \
    BFn_CS1(SAIF_CTRL, n, BITCLK_MULT_RATE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_CTRL_BITCLK_BASE_RATE(n, v)                                    \
    BFn_CS1(SAIF_CTRL, n, BITCLK_BASE_RATE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_CTRL_FIFO_ERROR_IRQ_EN(n, v)                                   \
    BFn_CS1(SAIF_CTRL, n, FIFO_ERROR_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_CTRL_FIFO_SERVICE_IRQ_EN(n, v)                                 \
    BFn_CS1(SAIF_CTRL, n, FIFO_SERVICE_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_CTRL_CHANNEL_NUM_SELECT(n, v)                                  \
    BFn_CS1(SAIF_CTRL, n, CHANNEL_NUM_SELECT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_CTRL_LRCLK_POLARITY(n, v)                                      \
    BFn_CS1(SAIF_CTRL, n, LRCLK_POLARITY, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_CTRL_BITCLK_48XFS_ENABLE(n, v)                                 \
    BFn_CS1(SAIF_CTRL, n, BITCLK_48XFS_ENABLE, v)
#endif
...
#define HW_SAIF_STAT_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_STAT_SET_ADDR(x)) = (v))
#define HW_SAIF_STAT_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_STAT_CLR_ADDR(x)) = (v))
#define HW_SAIF_STAT_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_STAT_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_STAT_FIFO_UNDERFLOW_IRQ(n, v)                                  \
    BFn_CS1(SAIF_STAT, n, FIFO_UNDERFLOW_IRQ, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SAIF_STAT_FIFO_OVERFLOW_IRQ(n, v)                                   \
    BFn_CS1(SAIF_STAT, n, FIFO_OVERFLOW_IRQ, v)
#endif
...
#define HW_SAIF_DATA_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_DATA_SET_ADDR(x)) = (v))
#define HW_SAIF_DATA_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_DATA_CLR_ADDR(x)) = (v))
#define HW_SAIF_DATA_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SAIF_DATA_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_SAIF_VERSION(x)                                                     \
    (*(volatile hw_saif_version_t *)HW_SAIF_VERSION_ADDR(x))
