...
#define REGS_I2C_BASE(x)                                                       \
    (x == 0 ? REGS_I2C0_BASE : x == 1 ? REGS_I2C1_BASE : 0xffff0000)
#endif
...
#define HW_I2C_CTRL0_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_I2C_CTRL0_SET_ADDR(x)) = (v))
#define HW_I2C_CTRL0_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_I2C_CTRL0_CLR_ADDR(x)) = (v))
#define HW_I2C_CTRL0_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_I2C_CTRL0_TOG_ADDR(x)) = (v))
#endif
...
#define BF_I2C_CTRL0_SEND_NAK_ON_LAST(v)                                       \
    (((v) << 25) & BM_I2C_CTRL0_SEND_NAK_ON_LAST)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL0_SEND_NAK_ON_LAST(n, v)                                    \
    BFn_CS1(I2C_CTRL0, n, SEND_NAK_ON_LAST, v)
#endif
...
#define BF_I2C_CTRL0_POST_SEND_STOP(v)                                         \
    (((v) << 20) & BM_I2C_CTRL0_POST_SEND_STOP)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL0_POST_SEND_STOP(n, v)                                      \
    BFn_CS1(I2C_CTRL0, n, POST_SEND_STOP, v)
#endif
...
#define BF_I2C_CTRL0_PRE_SEND_START(v)                                         \
    (((v) << 19) & BM_I2C_CTRL0_PRE_SEND_START)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL0_PRE_SEND_START(n, v)                                      \
    BFn_CS1(I2C_CTRL0, n, PRE_SEND_START, v)
#endif
...
#define BF_I2C_CTRL0_SLAVE_ADDRESS_ENABLE(v)                                   \
    (((v) << 18) & BM_I2C_CTRL0_SLAVE_ADDRESS_ENABLE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL0_SLAVE_ADDRESS_ENABLE(n, v)                                \
    BFn_CS1(I2C_CTRL0, n, SLAVE_ADDRESS_ENABLE, v)
#endif
...
#define HW_I2C_TIMING0_SET(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING0_SET_ADDR(x)) = (v))
#define HW_I2C_TIMING0_CLR(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING0_CLR_ADDR(x)) = (v))
#define HW_I2C_TIMING0_TOG(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING0_TOG_ADDR(x)) = (v))
#endif
...
#define HW_I2C_TIMING1_SET(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING1_SET_ADDR(x)) = (v))
#define HW_I2C_TIMING1_CLR(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING1_CLR_ADDR(x)) = (v))
#define HW_I2C_TIMING1_TOG(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING1_TOG_ADDR(x)) = (v))
#endif
...
#define HW_I2C_TIMING2_SET(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING2_SET_ADDR(x)) = (v))
#define HW_I2C_TIMING2_CLR(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING2_CLR_ADDR(x)) = (v))
#define HW_I2C_TIMING2_TOG(x, v)                                               \
    ((*(volatile reg32_t *)HW_I2C_TIMING2_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_TIMING2_LEADIN_COUNT(n, v)                                      \
    BFn_CS1(I2C_TIMING2, n, LEADIN_COUNT, v)
#endif
...
#define HW_I2C_CTRL1_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_I2C_CTRL1_SET_ADDR(x)) = (v))
#define HW_I2C_CTRL1_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_I2C_CTRL1_CLR_ADDR(x)) = (v))
#define HW_I2C_CTRL1_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_I2C_CTRL1_TOG_ADDR(x)) = (v))
#endif
...
#define BF_I2C_CTRL1_FORCE_DATA_IDLE(v)                                        \
    (((v) << 26) & BM_I2C_CTRL1_FORCE_DATA_IDLE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_FORCE_DATA_IDLE(n, v)                                     \
    BFn_CS1(I2C_CTRL1, n, FORCE_DATA_IDLE, v)
#endif
...
#define BF_I2C_CTRL1_FORCE_CLK_IDLE(v)                                         \
    (((v) << 25) & BM_I2C_CTRL1_FORCE_CLK_IDLE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_FORCE_CLK_IDLE(n, v)                                      \
    BFn_CS1(I2C_CTRL1, n, FORCE_CLK_IDLE, v)
#endif
...
#define BF_I2C_CTRL1_BCAST_SLAVE_EN(v)                                         \
    (((v) << 24) & BM_I2C_CTRL1_BCAST_SLAVE_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_BCAST_SLAVE_EN(n, v)                                      \
    BFn_CS1(I2C_CTRL1, n, BCAST_SLAVE_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_SLAVE_ADDRESS_BYTE(n, v)                                  \
    (HW_I2C_CTRL1(n).B.SLAVE_ADDRESS_BYTE = (v))
#endif
...
#define BF_I2C_CTRL1_BUS_FREE_IRQ_EN(v)                                        \
    (((v) << 15) & BM_I2C_CTRL1_BUS_FREE_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_BUS_FREE_IRQ_EN(n, v)                                     \
    BFn_CS1(I2C_CTRL1, n, BUS_FREE_IRQ_EN, v)
#endif
...
#define BF_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ_EN(v)                               \
    (((v) << 14) & BM_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ_EN(n, v)                            \
    BFn_CS1(I2C_CTRL1, n, DATA_ENGINE_CMPLT_IRQ_EN, v)
#endif
...
#define BF_I2C_CTRL1_NO_SLAVE_ACK_IRQ_EN(v)                                    \
    (((v) << 13) & BM_I2C_CTRL1_NO_SLAVE_ACK_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_NO_SLAVE_ACK_IRQ_EN(n, v)                                 \
    BFn_CS1(I2C_CTRL1, n, NO_SLAVE_ACK_IRQ_EN, v)
#endif
...
#define BF_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ_EN(v)                              \
    (((v) << 12) & BM_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ_EN(n, v)                           \
    BFn_CS1(I2C_CTRL1, n, OVERSIZE_XFER_TERM_IRQ_EN, v)
#endif
...
#define BF_I2C_CTRL1_EARLY_TERM_IRQ_EN(v)                                      \
    (((v) << 11) & BM_I2C_CTRL1_EARLY_TERM_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_EARLY_TERM_IRQ_EN(n, v)                                   \
    BFn_CS1(I2C_CTRL1, n, EARLY_TERM_IRQ_EN, v)
#endif
...
#define BF_I2C_CTRL1_MASTER_LOSS_IRQ_EN(v)                                     \
    (((v) << 10) & BM_I2C_CTRL1_MASTER_LOSS_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_MASTER_LOSS_IRQ_EN(n, v)                                  \
    BFn_CS1(I2C_CTRL1, n, MASTER_LOSS_IRQ_EN, v)
#endif
...
#define BF_I2C_CTRL1_SLAVE_STOP_IRQ_EN(v)                                      \
    (((v) << 9) & BM_I2C_CTRL1_SLAVE_STOP_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_SLAVE_STOP_IRQ_EN(n, v)                                   \
    BFn_CS1(I2C_CTRL1, n, SLAVE_STOP_IRQ_EN, v)
#endif
...
#define BF_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ(v)                                  \
    (((v) << 6) & BM_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ(n, v)                               \
    BFn_CS1(I2C_CTRL1, n, DATA_ENGINE_CMPLT_IRQ, v)
#endif
...
#define BF_I2C_CTRL1_NO_SLAVE_ACK_IRQ(v)                                       \
    (((v) << 5) & BM_I2C_CTRL1_NO_SLAVE_ACK_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_NO_SLAVE_ACK_IRQ(n, v)                                    \
    BFn_CS1(I2C_CTRL1, n, NO_SLAVE_ACK_IRQ, v)
#endif
...
#define BF_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ(v)                                 \
    (((v) << 4) & BM_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ(n, v)                              \
    BFn_CS1(I2C_CTRL1, n, OVERSIZE_XFER_TERM_IRQ, v)
#endif
...
#define BF_I2C_CTRL1_EARLY_TERM_IRQ(v)                                         \
    (((v) << 3) & BM_I2C_CTRL1_EARLY_TERM_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_EARLY_TERM_IRQ(n, v)                                      \
    BFn_CS1(I2C_CTRL1, n, EARLY_TERM_IRQ, v)
#endif
...
#define BF_I2C_CTRL1_MASTER_LOSS_IRQ(v)                                        \
    (((v) << 2) & BM_I2C_CTRL1_MASTER_LOSS_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_MASTER_LOSS_IRQ(n, v)                                     \
    BFn_CS1(I2C_CTRL1, n, MASTER_LOSS_IRQ, v)
#endif
...
#define BF_I2C_CTRL1_SLAVE_STOP_IRQ(v)                                         \
    (((v) << 1) & BM_I2C_CTRL1_SLAVE_STOP_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_SLAVE_STOP_IRQ(n, v)                                      \
    BFn_CS1(I2C_CTRL1, n, SLAVE_STOP_IRQ, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_I2C_STAT_MASTER_PRESENT(v)                                          \
    ((((reg32_t)v) << 31) & BM_I2C_STAT_MASTER_PRESENT)
#else
...
#define BF_I2C_STAT_ANY_ENABLED_IRQ(v)                                         \
    (((v) << 29) & BM_I2C_STAT_ANY_ENABLED_IRQ)
...
#define BF_I2C_STAT_SLAVE_ADDR_EQ_ZERO(v)                                      \
    (((v) << 15) & BM_I2C_STAT_SLAVE_ADDR_EQ_ZERO)
...
#define BF_I2C_STAT_SLAVE_SEARCHING(v)                                         \
    (((v) << 13) & BM_I2C_STAT_SLAVE_SEARCHING)
...
#define BF_I2C_STAT_DATA_ENGINE_DMA_WAIT(v)                                    \
    (((v) << 12) & BM_I2C_STAT_DATA_ENGINE_DMA_WAIT)
...
#define BF_I2C_STAT_DATA_ENGINE_BUSY(v)                                        \
    (((v) << 9) & BM_I2C_STAT_DATA_ENGINE_BUSY)
...
#define BF_I2C_STAT_BUS_FREE_IRQ_SUMMARY(v)                                    \
    (((v) << 7) & BM_I2C_STAT_BUS_FREE_IRQ_SUMMARY)
...
#define BF_I2C_STAT_DATA_ENGINE_CMPLT_IRQ_SUMMARY(v)                           \
    (((v) << 6) & BM_I2C_STAT_DATA_ENGINE_CMPLT_IRQ_SUMMARY)
...
#define BF_I2C_STAT_NO_SLAVE_ACK_IRQ_SUMMARY(v)                                \
    (((v) << 5) & BM_I2C_STAT_NO_SLAVE_ACK_IRQ_SUMMARY)
...
#define BF_I2C_STAT_OVERSIZE_XFER_TERM_IRQ_SUMMARY(v)                          \
    (((v) << 4) & BM_I2C_STAT_OVERSIZE_XFER_TERM_IRQ_SUMMARY)
...
#define BF_I2C_STAT_EARLY_TERM_IRQ_SUMMARY(v)                                  \
    (((v) << 3) & BM_I2C_STAT_EARLY_TERM_IRQ_SUMMARY)
...
#define BF_I2C_STAT_MASTER_LOSS_IRQ_SUMMARY(v)                                 \
    (((v) << 2) & BM_I2C_STAT_MASTER_LOSS_IRQ_SUMMARY)
...
#define BF_I2C_STAT_SLAVE_STOP_IRQ_SUMMARY(v)                                  \
    (((v) << 1) & BM_I2C_STAT_SLAVE_STOP_IRQ_SUMMARY)
...
#define BF_I2C_STAT_SLAVE_IRQ_SUMMARY(v)                                       \
    (((v) << 0) & BM_I2C_STAT_SLAVE_IRQ_SUMMARY)
...
#ifndef __LANGUAGE_ASM__
#define HW_I2C_QUEUECTRL(x)                                                    \
    (*(volatile hw_i2c_queuectrl_t *)HW_I2C_QUEUECTRL_ADDR(x))
#define HW_I2C_QUEUECTRL_RD(x) (HW_I2C_QUEUECTRL(x).U)
#define HW_I2C_QUEUECTRL_WR(x, v) (HW_I2C_QUEUECTRL(x).U = (v))
#define HW_I2C_QUEUECTRL_SET(x, v)                                             \
    ((*(volatile reg32_t *)HW_I2C_QUEUECTRL_SET_ADDR(x)) = (v))
#define HW_I2C_QUEUECTRL_CLR(x, v)                                             \
    ((*(volatile reg32_t *)HW_I2C_QUEUECTRL_CLR_ADDR(x)) = (v))
#define HW_I2C_QUEUECTRL_TOG(x, v)                                             \
    ((*(volatile reg32_t *)HW_I2C_QUEUECTRL_TOG_ADDR(x)) = (v))
#endif
...
#define BF_I2C_QUEUECTRL_RSVD3(v)                                              \
    ((((reg32_t)v) << 21) & BM_I2C_QUEUECTRL_RSVD3)
#else
...
#define BF_I2C_QUEUECTRL_PIO_QUEUE_MODE(v)                                     \
    (((v) << 2) & BM_I2C_QUEUECTRL_PIO_QUEUE_MODE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_PIO_QUEUE_MODE(n, v)                                  \
    BFn_CS1(I2C_QUEUECTRL, n, PIO_QUEUE_MODE, v)
#endif
...
#define BF_I2C_QUEUECTRL_RD_QUEUE_IRQ_EN(v)                                    \
    (((v) << 1) & BM_I2C_QUEUECTRL_RD_QUEUE_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_RD_QUEUE_IRQ_EN(n, v)                                 \
    BFn_CS1(I2C_QUEUECTRL, n, RD_QUEUE_IRQ_EN, v)
#endif
...
#define BF_I2C_QUEUECTRL_WR_QUEUE_IRQ_EN(v)                                    \
    (((v) << 0) & BM_I2C_QUEUECTRL_WR_QUEUE_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECTRL_WR_QUEUE_IRQ_EN(n, v)                                 \
    BFn_CS1(I2C_QUEUECTRL, n, WR_QUEUE_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_I2C_QUEUESTAT(x)                                                    \
    (*(volatile hw_i2c_queuestat_t *)HW_I2C_QUEUESTAT_ADDR(x))
...
#define BF_I2C_QUEUESTAT_RSVD2(v)                                              \
    ((((reg32_t)v) << 15) & BM_I2C_QUEUESTAT_RSVD2)
#else
...
#define BF_I2C_QUEUESTAT_RD_QUEUE_FULL(v)                                      \
    (((v) << 14) & BM_I2C_QUEUESTAT_RD_QUEUE_FULL)
...
#define BF_I2C_QUEUESTAT_RD_QUEUE_EMPTY(v)                                     \
    (((v) << 13) & BM_I2C_QUEUESTAT_RD_QUEUE_EMPTY)
...
#define BF_I2C_QUEUESTAT_WR_QUEUE_FULL(v)                                      \
    (((v) << 6) & BM_I2C_QUEUESTAT_WR_QUEUE_FULL)
...
#define BF_I2C_QUEUESTAT_WR_QUEUE_EMPTY(v)                                     \
    (((v) << 5) & BM_I2C_QUEUESTAT_WR_QUEUE_EMPTY)
...
#ifndef __LANGUAGE_ASM__
#define HW_I2C_QUEUECMD(x)                                                     \
    (*(volatile hw_i2c_queuecmd_t *)HW_I2C_QUEUECMD_ADDR(x))
#define HW_I2C_QUEUECMD_RD(x) (HW_I2C_QUEUECMD(x).U)
#define HW_I2C_QUEUECMD_WR(x, v) (HW_I2C_QUEUECMD(x).U = (v))
#define HW_I2C_QUEUECMD_SET(x, v)                                              \
    ((*(volatile reg32_t *)HW_I2C_QUEUECMD_SET_ADDR(x)) = (v))
#define HW_I2C_QUEUECMD_CLR(x, v)                                              \
    ((*(volatile reg32_t *)HW_I2C_QUEUECMD_CLR_ADDR(x)) = (v))
#define HW_I2C_QUEUECMD_TOG(x, v)                                              \
    ((*(volatile reg32_t *)HW_I2C_QUEUECMD_TOG_ADDR(x)) = (v))
#endif
...
#define BF_I2C_QUEUECMD_ACKNOWLEDGE(v)                                         \
    (((v) << 26) & BM_I2C_QUEUECMD_ACKNOWLEDGE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_ACKNOWLEDGE(n, v)                                      \
    BFn_CS1(I2C_QUEUECMD, n, ACKNOWLEDGE, v)
#endif
...
#define BF_I2C_QUEUECMD_SEND_NAK_ON_LAST(v)                                    \
    (((v) << 25) & BM_I2C_QUEUECMD_SEND_NAK_ON_LAST)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_SEND_NAK_ON_LAST(n, v)                                 \
    BFn_CS1(I2C_QUEUECMD, n, SEND_NAK_ON_LAST, v)
#endif
...
#define BF_I2C_QUEUECMD_MULTI_MASTER(v)                                        \
    (((v) << 23) & BM_I2C_QUEUECMD_MULTI_MASTER)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_MULTI_MASTER(n, v)                                     \
    BFn_CS1(I2C_QUEUECMD, n, MULTI_MASTER, v)
#endif
...
#define BF_I2C_QUEUECMD_RETAIN_CLOCK(v)                                        \
    (((v) << 21) & BM_I2C_QUEUECMD_RETAIN_CLOCK)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_RETAIN_CLOCK(n, v)                                     \
    BFn_CS1(I2C_QUEUECMD, n, RETAIN_CLOCK, v)
#endif
...
#define BF_I2C_QUEUECMD_POST_SEND_STOP(v)                                      \
    (((v) << 20) & BM_I2C_QUEUECMD_POST_SEND_STOP)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_POST_SEND_STOP(n, v)                                   \
    BFn_CS1(I2C_QUEUECMD, n, POST_SEND_STOP, v)
#endif
...
#define BF_I2C_QUEUECMD_PRE_SEND_START(v)                                      \
    (((v) << 19) & BM_I2C_QUEUECMD_PRE_SEND_START)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_PRE_SEND_START(n, v)                                   \
    BFn_CS1(I2C_QUEUECMD, n, PRE_SEND_START, v)
#endif
...
#define BF_I2C_QUEUECMD_SLAVE_ADDRESS_ENABLE(v)                                \
    (((v) << 18) & BM_I2C_QUEUECMD_SLAVE_ADDRESS_ENABLE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_SLAVE_ADDRESS_ENABLE(n, v)                             \
    BFn_CS1(I2C_QUEUECMD, n, SLAVE_ADDRESS_ENABLE, v)
#endif
...
#define BF_I2C_QUEUECMD_MASTER_MODE(v)                                         \
    (((v) << 17) & BM_I2C_QUEUECMD_MASTER_MODE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_QUEUECMD_MASTER_MODE(n, v)                                      \
    BFn_CS1(I2C_QUEUECMD, n, MASTER_MODE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_I2C_QUEUEDATA(x)                                                    \
    (*(volatile hw_i2c_queuedata_t *)HW_I2C_QUEUEDATA_ADDR(x))
...
#define HW_I2C_DEBUG0_SET(x, v)                                                \
    ((*(volatile reg32_t *)HW_I2C_DEBUG0_SET_ADDR(x)) = (v))
#define HW_I2C_DEBUG0_CLR(x, v)                                                \
    ((*(volatile reg32_t *)HW_I2C_DEBUG0_CLR_ADDR(x)) = (v))
#define HW_I2C_DEBUG0_TOG(x, v)                                                \
    ((*(volatile reg32_t *)HW_I2C_DEBUG0_TOG_ADDR(x)) = (v))
#endif
...
#define BF_I2C_DEBUG0_CHANGE_TOGGLE(v)                                         \
    (((v) << 12) & BM_I2C_DEBUG0_CHANGE_TOGGLE)
...
#define BF_I2C_DEBUG0_SLAVE_HOLD_CLK(v)                                        \
    (((v) << 10) & BM_I2C_DEBUG0_SLAVE_HOLD_CLK)
...
#define HW_I2C_DEBUG1_SET(x, v)                                                \
    ((*(volatile reg32_t *)HW_I2C_DEBUG1_SET_ADDR(x)) = (v))
#define HW_I2C_DEBUG1_CLR(x, v)                                                \
    ((*(volatile reg32_t *)HW_I2C_DEBUG1_CLR_ADDR(x)) = (v))
#define HW_I2C_DEBUG1_TOG(x, v)                                                \
    ((*(volatile reg32_t *)HW_I2C_DEBUG1_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_I2C_DEBUG1_I2C_CLK_IN(v)                                            \
    ((((reg32_t)v) << 31) & BM_I2C_DEBUG1_I2C_CLK_IN)
#else
...
#define BF_I2C_DEBUG1_LOCAL_SLAVE_TEST(v)                                      \
    (((v) << 8) & BM_I2C_DEBUG1_LOCAL_SLAVE_TEST)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_LOCAL_SLAVE_TEST(n, v)                                   \
    BFn_CS1(I2C_DEBUG1, n, LOCAL_SLAVE_TEST, v)
#endif
...
#define BF_I2C_DEBUG1_FORCE_ARB_LOSS(v)                                        \
    (((v) << 3) & BM_I2C_DEBUG1_FORCE_ARB_LOSS)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_FORCE_ARB_LOSS(n, v)                                     \
    BFn_CS1(I2C_DEBUG1, n, FORCE_ARB_LOSS, v)
#endif
...
#define BF_I2C_DEBUG1_FORCE_RCV_ACK(v)                                         \
    (((v) << 2) & BM_I2C_DEBUG1_FORCE_RCV_ACK)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_FORCE_RCV_ACK(n, v)                                      \
    BFn_CS1(I2C_DEBUG1, n, FORCE_RCV_ACK, v)
#endif
...
#define BF_I2C_DEBUG1_FORCE_I2C_DATA_OE(v)                                     \
    (((v) << 1) & BM_I2C_DEBUG1_FORCE_I2C_DATA_OE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_FORCE_I2C_DATA_OE(n, v)                                  \
    BFn_CS1(I2C_DEBUG1, n, FORCE_I2C_DATA_OE, v)
#endif
...
#define BF_I2C_DEBUG1_FORCE_I2C_CLK_OE(v)                                      \
    (((v) << 0) & BM_I2C_DEBUG1_FORCE_I2C_CLK_OE)
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_FORCE_I2C_CLK_OE(n, v)                                   \
    BFn_CS1(I2C_DEBUG1, n, FORCE_I2C_CLK_OE, v)
#endif
