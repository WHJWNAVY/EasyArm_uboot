...
#define HW_SPDIF_CTRL_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_SPDIF_CTRL_SET_ADDR) = (v))
#define HW_SPDIF_CTRL_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_SPDIF_CTRL_CLR_ADDR) = (v))
#define HW_SPDIF_CTRL_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_SPDIF_CTRL_TOG_ADDR) = (v))
#endif
...
#define BF_SPDIF_CTRL_WAIT_END_XFER(v)                                         \
    (((v) << 5) & BM_SPDIF_CTRL_WAIT_END_XFER)
#ifndef __LANGUAGE_ASM__
...
#define BF_SPDIF_CTRL_FIFO_UNDERFLOW_IRQ(v)                                    \
    (((v) << 3) & BM_SPDIF_CTRL_FIFO_UNDERFLOW_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_SPDIF_CTRL_FIFO_UNDERFLOW_IRQ(v)                                    \
    BF_CS1(SPDIF_CTRL, FIFO_UNDERFLOW_IRQ, v)
#endif
...
#define BF_SPDIF_CTRL_FIFO_OVERFLOW_IRQ(v)                                     \
    (((v) << 2) & BM_SPDIF_CTRL_FIFO_OVERFLOW_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_SPDIF_CTRL_FIFO_OVERFLOW_IRQ(v)                                     \
    BF_CS1(SPDIF_CTRL, FIFO_OVERFLOW_IRQ, v)
#endif
...
#define BF_SPDIF_CTRL_FIFO_ERROR_IRQ_EN(v)                                     \
    (((v) << 1) & BM_SPDIF_CTRL_FIFO_ERROR_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SPDIF_CTRL_FIFO_ERROR_IRQ_EN(v)                                     \
    BF_CS1(SPDIF_CTRL, FIFO_ERROR_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_SPDIF_FRAMECTRL                                                     \
    (*(volatile hw_spdif_framectrl_t *)HW_SPDIF_FRAMECTRL_ADDR)
#define HW_SPDIF_FRAMECTRL_RD() (HW_SPDIF_FRAMECTRL.U)
#define HW_SPDIF_FRAMECTRL_WR(v) (HW_SPDIF_FRAMECTRL.U = (v))
#define HW_SPDIF_FRAMECTRL_SET(v)                                              \
    ((*(volatile reg32_t *)HW_SPDIF_FRAMECTRL_SET_ADDR) = (v))
#define HW_SPDIF_FRAMECTRL_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_SPDIF_FRAMECTRL_CLR_ADDR) = (v))
#define HW_SPDIF_FRAMECTRL_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_SPDIF_FRAMECTRL_TOG_ADDR) = (v))
#endif
...
#define BF_SPDIF_FRAMECTRL_RSRVD2(v)                                           \
    ((((reg32_t)v) << 18) & BM_SPDIF_FRAMECTRL_RSRVD2)
#else
...
#define BF_SPDIF_FRAMECTRL_V_CONFIG(v)                                         \
    (((v) << 17) & BM_SPDIF_FRAMECTRL_V_CONFIG)
#ifndef __LANGUAGE_ASM__
...
#define BF_SPDIF_FRAMECTRL_AUTO_MUTE(v)                                        \
    (((v) << 16) & BM_SPDIF_FRAMECTRL_AUTO_MUTE)
#ifndef __LANGUAGE_ASM__
...
#define BF_SPDIF_FRAMECTRL_USER_DATA(v)                                        \
    (((v) << 14) & BM_SPDIF_FRAMECTRL_USER_DATA)
#ifndef __LANGUAGE_ASM__
...
#define HW_SPDIF_DATA_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_SPDIF_DATA_SET_ADDR) = (v))
#define HW_SPDIF_DATA_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_SPDIF_DATA_CLR_ADDR) = (v))
#define HW_SPDIF_DATA_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_SPDIF_DATA_TOG_ADDR) = (v))
#endif
...
#define BF_SPDIF_VERSION_MAJOR(v)                                              \
    ((((reg32_t)v) << 24) & BM_SPDIF_VERSION_MAJOR)
#else
