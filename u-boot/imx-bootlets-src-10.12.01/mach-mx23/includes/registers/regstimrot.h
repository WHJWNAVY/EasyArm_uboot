...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_TIMROT_TIMCTRLn : base 0x80068020 : count 3 :
/// offset 0x20
////////////////////////////////////////////////////////////////////////////////
...
#define HW_TIMROT_TIMCTRLn_SET_ADDR(n)                                         \
    (REGS_TIMROT_BASE + 0x00000024 + ((n)*0x20))
#define HW_TIMROT_TIMCTRLn_CLR_ADDR(n)                                         \
    (REGS_TIMROT_BASE + 0x00000028 + ((n)*0x20))
#define HW_TIMROT_TIMCTRLn_TOG_ADDR(n)                                         \
    (REGS_TIMROT_BASE + 0x0000002C + ((n)*0x20))
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_TIMROT_TIMCOUNTn : base 0x80068030 : count 3
///: offset 0x20
////////////////////////////////////////////////////////////////////////////////
...
#define HW_TIMROT_TIMCOUNTn(n)                                                 \
    (*(volatile hw_timrot_timcountn_t *)HW_TIMROT_TIMCOUNTn_ADDR(n))
#define HW_TIMROT_TIMCOUNTn_RD(n) (HW_TIMROT_TIMCOUNTn(n).U)
#define HW_TIMROT_TIMCOUNTn_WR(n, v) (HW_TIMROT_TIMCOUNTn(n).U = (v))
#define HW_TIMROT_TIMCOUNTn_SET(n, v)                                          \
    (HW_TIMROT_TIMCOUNTn_WR(n, HW_TIMROT_TIMCOUNTn_RD(n) | (v)))
#define HW_TIMROT_TIMCOUNTn_CLR(n, v)                                          \
    (HW_TIMROT_TIMCOUNTn_WR(n, HW_TIMROT_TIMCOUNTn_RD(n) & ~(v)))
#define HW_TIMROT_TIMCOUNTn_TOG(n, v)                                          \
    (HW_TIMROT_TIMCOUNTn_WR(n, HW_TIMROT_TIMCOUNTn_RD(n) ^ (v)))
#endif

//
// constants & macros for individual HW_TIMROT_TIMCOUNTn multi-register
// bitfields
//
...
#define BF_TIMROT_TIMCOUNTn_RUNNING_COUNT(v)                                   \
    ((((reg32_t)v) << 16) & BM_TIMROT_TIMCOUNTn_RUNNING_COUNT)
#else
#define BF_TIMROT_TIMCOUNTn_RUNNING_COUNT(v)                                   \
...
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_TIMCOUNTn_FIXED_COUNT(n, v)                                  \
    (HW_TIMROT_TIMCOUNTn(n).B.FIXED_COUNT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TIMROT_TIMCOUNT3                                                    \
    (*(volatile hw_timrot_timcount3_t *)HW_TIMROT_TIMCOUNT3_ADDR)
#define HW_TIMROT_TIMCOUNT3_RD() (HW_TIMROT_TIMCOUNT3.U)
#define HW_TIMROT_TIMCOUNT3_WR(v) (HW_TIMROT_TIMCOUNT3.U = (v))
#define HW_TIMROT_TIMCOUNT3_SET(v)                                             \
    (HW_TIMROT_TIMCOUNT3_WR(HW_TIMROT_TIMCOUNT3_RD() | (v)))
#define HW_TIMROT_TIMCOUNT3_CLR(v)                                             \
    (HW_TIMROT_TIMCOUNT3_WR(HW_TIMROT_TIMCOUNT3_RD() & ~(v)))
#define HW_TIMROT_TIMCOUNT3_TOG(v)                                             \
    (HW_TIMROT_TIMCOUNT3_WR(HW_TIMROT_TIMCOUNT3_RD() ^ (v)))
#endif
...
#define BF_TIMROT_TIMCOUNT3_LOW_RUNNING_COUNT(v)                               \
    ((((reg32_t)v) << 16) & BM_TIMROT_TIMCOUNT3_LOW_RUNNING_COUNT)
#else
#define BF_TIMROT_TIMCOUNT3_LOW_RUNNING_COUNT(v)                               \
...
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_TIMCOUNT3_HIGH_FIXED_COUNT(v)                                \
    (HW_TIMROT_TIMCOUNT3.B.HIGH_FIXED_COUNT = (v))
#endif
