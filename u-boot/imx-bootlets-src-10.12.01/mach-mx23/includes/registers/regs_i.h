...
#define BFi_CS2(i, reg, f1, v1, f2, v2)                                        \
    (HWi_##reg##_CLR(i, BM_##reg##_##f1 | BM_##reg##_##f2),                    \
     HWi_##reg##_SET(i, BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2)))

#define BFi_CS3(i, reg, f1, v1, f2, v2, f3, v3)                                \
    (HWi_##reg##_CLR(i, BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3),  \
     HWi_##reg##_SET(i, BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2) |            \
                            BF_##reg##_##f3(v3)))
...
#define BFi_CS7(i, reg, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6, f7,    \
                v7)                                                            \
    (HWi_##reg##_CLR(i, BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |  \
                            BM_##reg##_##f4 | BM_##reg##_##f5 |                \
...
#define BFi_CS8(i, reg, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6, f7,    \
                v7, f8, v8)                                                    \
    (HWi_##reg##_CLR(i, BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |  \
                            BM_##reg##_##f4 | BM_##reg##_##f5 |                \
                            BM_##reg##_##f6 | BM_##reg##_##f7 |                \
...
#define BFi_SETVn(i, reg, n, field, v)                                         \
    HWi_##reg##_SET(i, n, BF_##reg##_##field(v))
#define BFi_CLRVn(i, reg, n, field, v)                                         \
    HWi_##reg##_CLR(i, n, BF_##reg##_##field(v))
#define BFi_TOGVn(i, reg, n, field, v)                                         \
    HWi_##reg##_TOG(i, n, BF_##reg##_##field(v))
...
#define BFi_CS2n(i, reg, n, f1, v1, f2, v2)                                    \
    (HWi_##reg##_CLR(i, n, (BM_##reg##_##f1 | BM_##reg##_##f2)),               \
     HWi_##reg##_SET(i, n, (BF_##reg##_##f1(v1) | BF_##reg##_##f2(v2))))
...
#define BFi_CS7n(i, reg, n, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6,    \
                 f7, v7)                                                       \
    (HWi_##reg##_CLR(i, n,                                                     \
                     (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |    \
                      BM_##reg##_##f4 | BM_##reg##_##f5 | BM_##reg##_##f6 |    \
...
#define BFi_CS8n(i, reg, n, f1, v1, f2, v2, f3, v3, f4, v4, f5, v5, f6, v6,    \
                 f7, v7, f8, v8)                                               \
    (HWi_##reg##_CLR(i, n,                                                     \
                     (BM_##reg##_##f1 | BM_##reg##_##f2 | BM_##reg##_##f3 |    \
                      BM_##reg##_##f4 | BM_##reg##_##f5 | BM_##reg##_##f6 |    \
