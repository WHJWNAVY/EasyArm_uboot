...
#define BF_PXP_CTRL_ENABLE_LCD_HANDSHAKE(v)                                    \
    (((v) << 2) & BM_PXP_CTRL_ENABLE_LCD_HANDSHAKE)

#ifndef __LANGUAGE_ASM__
#define BW_PXP_CTRL_ENABLE_LCD_HANDSHAKE(v)                                    \
    BF_CS1(PXP_CTRL, ENABLE_LCD_HANDSHAKE, v)
#endif
...
#define BF_PXP_STAT_AXI_WRITE_ERROR(v)                                         \
    (((v) << 1) & BM_PXP_STAT_AXI_WRITE_ERROR)
...
#ifndef __LANGUAGE_ASM__
#define HW_PXP_S0BACKGROUND                                                    \
    (*(volatile hw_pxp_s0background_t *)HW_PXP_S0BACKGROUND_ADDR)
#define HW_PXP_S0BACKGROUND_RD() (HW_PXP_S0BACKGROUND.U)
#define HW_PXP_S0BACKGROUND_WR(v) (HW_PXP_S0BACKGROUND.U = (v))
#define HW_PXP_S0BACKGROUND_SET(v)                                             \
    (HW_PXP_S0BACKGROUND_WR(HW_PXP_S0BACKGROUND_RD() | (v)))
#define HW_PXP_S0BACKGROUND_CLR(v)                                             \
    (HW_PXP_S0BACKGROUND_WR(HW_PXP_S0BACKGROUND_RD() & ~(v)))
#define HW_PXP_S0BACKGROUND_TOG(v)                                             \
    (HW_PXP_S0BACKGROUND_WR(HW_PXP_S0BACKGROUND_RD() ^ (v)))
#endif
...
#define HW_PXP_CSCCOEFF0_SET(v)                                                \
    (HW_PXP_CSCCOEFF0_WR(HW_PXP_CSCCOEFF0_RD() | (v)))
#define HW_PXP_CSCCOEFF0_CLR(v)                                                \
    (HW_PXP_CSCCOEFF0_WR(HW_PXP_CSCCOEFF0_RD() & ~(v)))
#define HW_PXP_CSCCOEFF0_TOG(v)                                                \
    (HW_PXP_CSCCOEFF0_WR(HW_PXP_CSCCOEFF0_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_PXP_CSCCOEFF0_YCBCR_MODE(v)                                         \
    ((((reg32_t)v) << 31) & BM_PXP_CSCCOEFF0_YCBCR_MODE)
#else
#define BF_PXP_CSCCOEFF0_YCBCR_MODE(v)                                         \
    (((v) << 31) & BM_PXP_CSCCOEFF0_YCBCR_MODE)
#endif
...
#define HW_PXP_CSCCOEFF1_SET(v)                                                \
    (HW_PXP_CSCCOEFF1_WR(HW_PXP_CSCCOEFF1_RD() | (v)))
#define HW_PXP_CSCCOEFF1_CLR(v)                                                \
    (HW_PXP_CSCCOEFF1_WR(HW_PXP_CSCCOEFF1_RD() & ~(v)))
#define HW_PXP_CSCCOEFF1_TOG(v)                                                \
    (HW_PXP_CSCCOEFF1_WR(HW_PXP_CSCCOEFF1_RD() ^ (v)))
#endif
...
#define HW_PXP_CSCCOEFF2_SET(v)                                                \
    (HW_PXP_CSCCOEFF2_WR(HW_PXP_CSCCOEFF2_RD() | (v)))
#define HW_PXP_CSCCOEFF2_CLR(v)                                                \
    (HW_PXP_CSCCOEFF2_WR(HW_PXP_CSCCOEFF2_RD() & ~(v)))
#define HW_PXP_CSCCOEFF2_TOG(v)                                                \
    (HW_PXP_CSCCOEFF2_WR(HW_PXP_CSCCOEFF2_RD() ^ (v)))
#endif
...
#define HW_PXP_PAGETABLE_SET(v)                                                \
    (HW_PXP_PAGETABLE_WR(HW_PXP_PAGETABLE_RD() | (v)))
#define HW_PXP_PAGETABLE_CLR(v)                                                \
    (HW_PXP_PAGETABLE_WR(HW_PXP_PAGETABLE_RD() & ~(v)))
#define HW_PXP_PAGETABLE_TOG(v)                                                \
    (HW_PXP_PAGETABLE_WR(HW_PXP_PAGETABLE_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_PXP_S0COLORKEYLOW                                                   \
    (*(volatile hw_pxp_s0colorkeylow_t *)HW_PXP_S0COLORKEYLOW_ADDR)
#define HW_PXP_S0COLORKEYLOW_RD() (HW_PXP_S0COLORKEYLOW.U)
#define HW_PXP_S0COLORKEYLOW_WR(v) (HW_PXP_S0COLORKEYLOW.U = (v))
#define HW_PXP_S0COLORKEYLOW_SET(v)                                            \
    (HW_PXP_S0COLORKEYLOW_WR(HW_PXP_S0COLORKEYLOW_RD() | (v)))
#define HW_PXP_S0COLORKEYLOW_CLR(v)                                            \
    (HW_PXP_S0COLORKEYLOW_WR(HW_PXP_S0COLORKEYLOW_RD() & ~(v)))
#define HW_PXP_S0COLORKEYLOW_TOG(v)                                            \
    (HW_PXP_S0COLORKEYLOW_WR(HW_PXP_S0COLORKEYLOW_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_PXP_S0COLORKEYHIGH                                                  \
    (*(volatile hw_pxp_s0colorkeyhigh_t *)HW_PXP_S0COLORKEYHIGH_ADDR)
#define HW_PXP_S0COLORKEYHIGH_RD() (HW_PXP_S0COLORKEYHIGH.U)
#define HW_PXP_S0COLORKEYHIGH_WR(v) (HW_PXP_S0COLORKEYHIGH.U = (v))
#define HW_PXP_S0COLORKEYHIGH_SET(v)                                           \
    (HW_PXP_S0COLORKEYHIGH_WR(HW_PXP_S0COLORKEYHIGH_RD() | (v)))
#define HW_PXP_S0COLORKEYHIGH_CLR(v)                                           \
    (HW_PXP_S0COLORKEYHIGH_WR(HW_PXP_S0COLORKEYHIGH_RD() & ~(v)))
#define HW_PXP_S0COLORKEYHIGH_TOG(v)                                           \
    (HW_PXP_S0COLORKEYHIGH_WR(HW_PXP_S0COLORKEYHIGH_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_PXP_OLCOLORKEYLOW                                                   \
    (*(volatile hw_pxp_olcolorkeylow_t *)HW_PXP_OLCOLORKEYLOW_ADDR)
#define HW_PXP_OLCOLORKEYLOW_RD() (HW_PXP_OLCOLORKEYLOW.U)
#define HW_PXP_OLCOLORKEYLOW_WR(v) (HW_PXP_OLCOLORKEYLOW.U = (v))
#define HW_PXP_OLCOLORKEYLOW_SET(v)                                            \
    (HW_PXP_OLCOLORKEYLOW_WR(HW_PXP_OLCOLORKEYLOW_RD() | (v)))
#define HW_PXP_OLCOLORKEYLOW_CLR(v)                                            \
    (HW_PXP_OLCOLORKEYLOW_WR(HW_PXP_OLCOLORKEYLOW_RD() & ~(v)))
#define HW_PXP_OLCOLORKEYLOW_TOG(v)                                            \
    (HW_PXP_OLCOLORKEYLOW_WR(HW_PXP_OLCOLORKEYLOW_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_PXP_OLCOLORKEYHIGH                                                  \
    (*(volatile hw_pxp_olcolorkeyhigh_t *)HW_PXP_OLCOLORKEYHIGH_ADDR)
#define HW_PXP_OLCOLORKEYHIGH_RD() (HW_PXP_OLCOLORKEYHIGH.U)
#define HW_PXP_OLCOLORKEYHIGH_WR(v) (HW_PXP_OLCOLORKEYHIGH.U = (v))
#define HW_PXP_OLCOLORKEYHIGH_SET(v)                                           \
    (HW_PXP_OLCOLORKEYHIGH_WR(HW_PXP_OLCOLORKEYHIGH_RD() | (v)))
#define HW_PXP_OLCOLORKEYHIGH_CLR(v)                                           \
    (HW_PXP_OLCOLORKEYHIGH_WR(HW_PXP_OLCOLORKEYHIGH_RD() & ~(v)))
#define HW_PXP_OLCOLORKEYHIGH_TOG(v)                                           \
    (HW_PXP_OLCOLORKEYHIGH_WR(HW_PXP_OLCOLORKEYHIGH_RD() ^ (v)))
#endif
...
#define HW_PXP_DEBUGCTRL_SET(v)                                                \
    (HW_PXP_DEBUGCTRL_WR(HW_PXP_DEBUGCTRL_RD() | (v)))
#define HW_PXP_DEBUGCTRL_CLR(v)                                                \
    (HW_PXP_DEBUGCTRL_WR(HW_PXP_DEBUGCTRL_RD() & ~(v)))
#define HW_PXP_DEBUGCTRL_TOG(v)                                                \
    (HW_PXP_DEBUGCTRL_WR(HW_PXP_DEBUGCTRL_RD() ^ (v)))
#endif
...
#define BF_PXP_DEBUGCTRL_RESET_TLB_STATS(v)                                    \
    (((v) << 8) & BM_PXP_DEBUGCTRL_RESET_TLB_STATS)

#ifndef __LANGUAGE_ASM__
#define BW_PXP_DEBUGCTRL_RESET_TLB_STATS(v)                                    \
    BF_CS1(PXP_DEBUGCTRL, RESET_TLB_STATS, v)
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_PXP_OLn : base 0x8002A200 : count 8 : offset
/// 0x40
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_PXP_OLnSIZE : base 0x8002A210 : count 8 :
/// offset 0x40
////////////////////////////////////////////////////////////////////////////////
...
#define HW_PXP_OLnSIZE_SET(n, v)                                               \
    (HW_PXP_OLnSIZE_WR(n, HW_PXP_OLnSIZE_RD(n) | (v)))
#define HW_PXP_OLnSIZE_CLR(n, v)                                               \
    (HW_PXP_OLnSIZE_WR(n, HW_PXP_OLnSIZE_RD(n) & ~(v)))
#define HW_PXP_OLnSIZE_TOG(n, v)                                               \
    (HW_PXP_OLnSIZE_WR(n, HW_PXP_OLnSIZE_RD(n) ^ (v)))
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_PXP_OLnPARAM : base 0x8002A220 : count 8 :
/// offset 0x40
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_PXP_OLnPARAM(n)                                                     \
    (*(volatile hw_pxp_olnparam_t *)HW_PXP_OLnPARAM_ADDR(n))
#define HW_PXP_OLnPARAM_RD(n) (HW_PXP_OLnPARAM(n).U)
#define HW_PXP_OLnPARAM_WR(n, v) (HW_PXP_OLnPARAM(n).U = (v))
#define HW_PXP_OLnPARAM_SET(n, v)                                              \
    (HW_PXP_OLnPARAM_WR(n, HW_PXP_OLnPARAM_RD(n) | (v)))
#define HW_PXP_OLnPARAM_CLR(n, v)                                              \
    (HW_PXP_OLnPARAM_WR(n, HW_PXP_OLnPARAM_RD(n) & ~(v)))
#define HW_PXP_OLnPARAM_TOG(n, v)                                              \
    (HW_PXP_OLnPARAM_WR(n, HW_PXP_OLnPARAM_RD(n) ^ (v)))
#endif
...
#define BF_PXP_OLnPARAM_ENABLE_COLORKEY(v)                                     \
    (((v) << 3) & BM_PXP_OLnPARAM_ENABLE_COLORKEY)

#ifndef __LANGUAGE_ASM__
#define BW_PXP_OLnPARAM_ENABLE_COLORKEY(n, v)                                  \
    BF_CS1n(PXP_OLnPARAM, n, ENABLE_COLORKEY, v)
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_PXP_OLnPARAM2 : base 0x8002A230 : count 8 :
/// offset 0x40
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_PXP_OLnPARAM2(n)                                                    \
    (*(volatile hw_pxp_olnparam2_t *)HW_PXP_OLnPARAM2_ADDR(n))
