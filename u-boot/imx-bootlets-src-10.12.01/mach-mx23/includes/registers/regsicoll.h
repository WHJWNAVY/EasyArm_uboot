...
#define HW_ICOLL_VECTOR_SET(v)                                                 \
    ((*(volatile reg32_t *)HW_ICOLL_VECTOR_SET_ADDR) = (v))
#define HW_ICOLL_VECTOR_CLR(v)                                                 \
    ((*(volatile reg32_t *)HW_ICOLL_VECTOR_CLR_ADDR) = (v))
#define HW_ICOLL_VECTOR_TOG(v)                                                 \
    ((*(volatile reg32_t *)HW_ICOLL_VECTOR_TOG_ADDR) = (v))
#endif
...
#define BF_ICOLL_VECTOR_IRQVECTOR(v)                                           \
    ((((reg32_t)v) << 2) & BM_ICOLL_VECTOR_IRQVECTOR)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_ICOLL_LEVELACK                                                      \
    (*(volatile hw_icoll_levelack_t *)HW_ICOLL_LEVELACK_ADDR)
#define HW_ICOLL_LEVELACK_RD() (HW_ICOLL_LEVELACK.U)
#define HW_ICOLL_LEVELACK_WR(v) (HW_ICOLL_LEVELACK.U = (v))
#define HW_ICOLL_LEVELACK_SET(v)                                               \
    (HW_ICOLL_LEVELACK_WR(HW_ICOLL_LEVELACK_RD() | (v)))
#define HW_ICOLL_LEVELACK_CLR(v)                                               \
    (HW_ICOLL_LEVELACK_WR(HW_ICOLL_LEVELACK_RD() & ~(v)))
#define HW_ICOLL_LEVELACK_TOG(v)                                               \
    (HW_ICOLL_LEVELACK_WR(HW_ICOLL_LEVELACK_RD() ^ (v)))
#endif
...
#define HW_ICOLL_CTRL_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_ICOLL_CTRL_SET_ADDR) = (v))
#define HW_ICOLL_CTRL_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_ICOLL_CTRL_CLR_ADDR) = (v))
#define HW_ICOLL_CTRL_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_ICOLL_CTRL_TOG_ADDR) = (v))
#endif
...
#define BF_ICOLL_CTRL_FIQ_FINAL_ENABLE(v)                                      \
    (((v) << 17) & BM_ICOLL_CTRL_FIQ_FINAL_ENABLE)

#ifndef __LANGUAGE_ASM__
#define BW_ICOLL_CTRL_FIQ_FINAL_ENABLE(v)                                      \
    BF_CS1(ICOLL_CTRL, FIQ_FINAL_ENABLE, v)
#endif
...
#define BF_ICOLL_CTRL_IRQ_FINAL_ENABLE(v)                                      \
    (((v) << 16) & BM_ICOLL_CTRL_IRQ_FINAL_ENABLE)

#ifndef __LANGUAGE_ASM__
#define BW_ICOLL_CTRL_IRQ_FINAL_ENABLE(v)                                      \
    BF_CS1(ICOLL_CTRL, IRQ_FINAL_ENABLE, v)
#endif
...
#define HW_ICOLL_VBASE_SET(v)                                                  \
    ((*(volatile reg32_t *)HW_ICOLL_VBASE_SET_ADDR) = (v))
#define HW_ICOLL_VBASE_CLR(v)                                                  \
    ((*(volatile reg32_t *)HW_ICOLL_VBASE_CLR_ADDR) = (v))
#define HW_ICOLL_VBASE_TOG(v)                                                  \
    ((*(volatile reg32_t *)HW_ICOLL_VBASE_TOG_ADDR) = (v))
#endif
...
#define BF_ICOLL_VBASE_TABLE_ADDRESS(v)                                        \
    ((((reg32_t)v) << 2) & BM_ICOLL_VBASE_TABLE_ADDRESS)
#else
#define BF_ICOLL_VBASE_TABLE_ADDRESS(v)                                        \
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_ICOLL_RAWn : base 0x800000A0 : count 4 :
/// offset 0x10
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_ICOLL_INTERRUPTn : base 0x80000120 : count
/// 128 : offset 0x10
////////////////////////////////////////////////////////////////////////////////
...
#define HW_ICOLL_INTERRUPTn_SET_ADDR(n)                                        \
    (REGS_ICOLL_BASE + 0x00000124 + ((n)*0x10))
#define HW_ICOLL_INTERRUPTn_CLR_ADDR(n)                                        \
    (REGS_ICOLL_BASE + 0x00000128 + ((n)*0x10))
#define HW_ICOLL_INTERRUPTn_TOG_ADDR(n)                                        \
    (REGS_ICOLL_BASE + 0x0000012C + ((n)*0x10))

#ifndef __LANGUAGE_ASM__
#define HW_ICOLL_INTERRUPTn(n)                                                 \
    (*(volatile hw_icoll_interruptn_t *)HW_ICOLL_INTERRUPTn_ADDR(n))
#define HW_ICOLL_INTERRUPTn_RD(n) (HW_ICOLL_INTERRUPTn(n).U)
#define HW_ICOLL_INTERRUPTn_WR(n, v) (HW_ICOLL_INTERRUPTn(n).U = (v))
#define HW_ICOLL_INTERRUPTn_SET(n, v)                                          \
    ((*(volatile reg32_t *)HW_ICOLL_INTERRUPTn_SET_ADDR(n)) = (v))
#define HW_ICOLL_INTERRUPTn_CLR(n, v)                                          \
    ((*(volatile reg32_t *)HW_ICOLL_INTERRUPTn_CLR_ADDR(n)) = (v))
#define HW_ICOLL_INTERRUPTn_TOG(n, v)                                          \
    ((*(volatile reg32_t *)HW_ICOLL_INTERRUPTn_TOG_ADDR(n)) = (v))
#endif

//
// constants & macros for individual HW_ICOLL_INTERRUPTn multi-register
// bitfields
//
...
#define BF_ICOLL_INTERRUPTn_SOFTIRQ(v)                                         \
    (((v) << 3) & BM_ICOLL_INTERRUPTn_SOFTIRQ)

#ifndef __LANGUAGE_ASM__
#define BW_ICOLL_INTERRUPTn_SOFTIRQ(n, v)                                      \
    BF_CS1n(ICOLL_INTERRUPTn, n, SOFTIRQ, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_ICOLL_INTERRUPTn_PRIORITY(n, v)                                     \
    BF_CS1n(ICOLL_INTERRUPTn, n, PRIORITY, v)
#endif
...
#define BF_ICOLL_DEBUG_INSERVICE(v)                                            \
    ((((reg32_t)v) << 28) & BM_ICOLL_DEBUG_INSERVICE)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_ICOLL_DBGREAD0                                                      \
    (*(volatile hw_icoll_dbgread0_t *)HW_ICOLL_DBGREAD0_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_ICOLL_DBGREAD1                                                      \
    (*(volatile hw_icoll_dbgread1_t *)HW_ICOLL_DBGREAD1_ADDR)
...
#define HW_ICOLL_DBGFLAG_SET(v)                                                \
    ((*(volatile reg32_t *)HW_ICOLL_DBGFLAG_SET_ADDR) = (v))
#define HW_ICOLL_DBGFLAG_CLR(v)                                                \
    ((*(volatile reg32_t *)HW_ICOLL_DBGFLAG_CLR_ADDR) = (v))
#define HW_ICOLL_DBGFLAG_TOG(v)                                                \
    ((*(volatile reg32_t *)HW_ICOLL_DBGFLAG_TOG_ADDR) = (v))
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_ICOLL_DBGREQUESTn : base 0x80001160 : count 4
///: offset 0x10
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_ICOLL_DBGREQUESTn(n)                                                \
    (*(volatile hw_icoll_dbgrequestn_t *)HW_ICOLL_DBGREQUESTn_ADDR(n))
#define HW_ICOLL_DBGREQUESTn_RD(n) (HW_ICOLL_DBGREQUESTn(n).U)
#endif

//
// constants & macros for individual HW_ICOLL_DBGREQUESTn multi-register
// bitfields
//
...
#define BF_ICOLL_VERSION_MAJOR(v)                                              \
    ((((reg32_t)v) << 24) & BM_ICOLL_VERSION_MAJOR)
#else
