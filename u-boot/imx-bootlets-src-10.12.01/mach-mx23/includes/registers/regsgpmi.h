...
#define HW_GPMI_CTRL0_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_GPMI_CTRL0_SET_ADDR) = (v))
#define HW_GPMI_CTRL0_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_GPMI_CTRL0_CLR_ADDR) = (v))
#define HW_GPMI_CTRL0_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_GPMI_CTRL0_TOG_ADDR) = (v))
#endif
...
#define BF_GPMI_CTRL0_TIMEOUT_IRQ_EN(v)                                        \
    (((v) << 27) & BM_GPMI_CTRL0_TIMEOUT_IRQ_EN)
...
#define BF_GPMI_CTRL0_ADDRESS_INCREMENT(v)                                     \
    (((v) << 16) & BM_GPMI_CTRL0_ADDRESS_INCREMENT)

#ifndef __LANGUAGE_ASM__
#define BW_GPMI_CTRL0_ADDRESS_INCREMENT(v)                                     \
    BF_CS1(GPMI_CTRL0, ADDRESS_INCREMENT, v)
#endif
...
#define HW_GPMI_ECCCTRL_SET(v)                                                 \
    ((*(volatile reg32_t *)HW_GPMI_ECCCTRL_SET_ADDR) = (v))
#define HW_GPMI_ECCCTRL_CLR(v)                                                 \
    ((*(volatile reg32_t *)HW_GPMI_ECCCTRL_CLR_ADDR) = (v))
#define HW_GPMI_ECCCTRL_TOG(v)                                                 \
    ((*(volatile reg32_t *)HW_GPMI_ECCCTRL_TOG_ADDR) = (v))
#endif
...
#define BF_GPMI_ECCCTRL_HANDLE(v)                                              \
    ((((reg32_t)v) << 16) & BM_GPMI_ECCCTRL_HANDLE)
#else
...
#define HW_GPMI_ECCCOUNT_SET(v)                                                \
    (HW_GPMI_ECCCOUNT_WR(HW_GPMI_ECCCOUNT_RD() | (v)))
#define HW_GPMI_ECCCOUNT_CLR(v)                                                \
    (HW_GPMI_ECCCOUNT_WR(HW_GPMI_ECCCOUNT_RD() & ~(v)))
#define HW_GPMI_ECCCOUNT_TOG(v)                                                \
    (HW_GPMI_ECCCOUNT_WR(HW_GPMI_ECCCOUNT_RD() ^ (v)))
#endif
...
#define BF_GPMI_PAYLOAD_ADDRESS(v)                                             \
    ((((reg32_t)v) << 2) & BM_GPMI_PAYLOAD_ADDRESS)
#else
...
#define HW_GPMI_AUXILIARY                                                      \
    (*(volatile hw_gpmi_auxiliary_t *)HW_GPMI_AUXILIARY_ADDR)
#define HW_GPMI_AUXILIARY_RD() (HW_GPMI_AUXILIARY.U)
#define HW_GPMI_AUXILIARY_WR(v) (HW_GPMI_AUXILIARY.U = (v))
#define HW_GPMI_AUXILIARY_SET(v)                                               \
    (HW_GPMI_AUXILIARY_WR(HW_GPMI_AUXILIARY_RD() | (v)))
#define HW_GPMI_AUXILIARY_CLR(v)                                               \
    (HW_GPMI_AUXILIARY_WR(HW_GPMI_AUXILIARY_RD() & ~(v)))
#define HW_GPMI_AUXILIARY_TOG(v)                                               \
    (HW_GPMI_AUXILIARY_WR(HW_GPMI_AUXILIARY_RD() ^ (v)))
#endif
...
#define BF_GPMI_AUXILIARY_ADDRESS(v)                                           \
    ((((reg32_t)v) << 2) & BM_GPMI_AUXILIARY_ADDRESS)
#else
...
#define HW_GPMI_CTRL1_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_GPMI_CTRL1_SET_ADDR) = (v))
#define HW_GPMI_CTRL1_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_GPMI_CTRL1_CLR_ADDR) = (v))
#define HW_GPMI_CTRL1_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_GPMI_CTRL1_TOG_ADDR) = (v))
#endif
...
#define BF_GPMI_CTRL1_GANGED_RDYBUSY(v)                                        \
    (((v) << 19) & BM_GPMI_CTRL1_GANGED_RDYBUSY)
...
#define BF_GPMI_CTRL1_ABORT_WAIT_FOR_READY3(v)                                 \
    (((v) << 7) & BM_GPMI_CTRL1_ABORT_WAIT_FOR_READY3)

#ifndef __LANGUAGE_ASM__
#define BW_GPMI_CTRL1_ABORT_WAIT_FOR_READY3(v)                                 \
    BF_CS1(GPMI_CTRL1, ABORT_WAIT_FOR_READY3, v)
#endif
...
#define BF_GPMI_CTRL1_ABORT_WAIT_FOR_READY2(v)                                 \
    (((v) << 6) & BM_GPMI_CTRL1_ABORT_WAIT_FOR_READY2)

#ifndef __LANGUAGE_ASM__
#define BW_GPMI_CTRL1_ABORT_WAIT_FOR_READY2(v)                                 \
    BF_CS1(GPMI_CTRL1, ABORT_WAIT_FOR_READY2, v)
#endif
...
#define BF_GPMI_CTRL1_ABORT_WAIT_FOR_READY1(v)                                 \
    (((v) << 5) & BM_GPMI_CTRL1_ABORT_WAIT_FOR_READY1)

#ifndef __LANGUAGE_ASM__
#define BW_GPMI_CTRL1_ABORT_WAIT_FOR_READY1(v)                                 \
    BF_CS1(GPMI_CTRL1, ABORT_WAIT_FOR_READY1, v)
#endif
...
#define BF_GPMI_CTRL1_ABORT_WAIT_FOR_READY0(v)                                 \
    (((v) << 4) & BM_GPMI_CTRL1_ABORT_WAIT_FOR_READY0)

#ifndef __LANGUAGE_ASM__
#define BW_GPMI_CTRL1_ABORT_WAIT_FOR_READY0(v)                                 \
    BF_CS1(GPMI_CTRL1, ABORT_WAIT_FOR_READY0, v)
#endif
...
#define BF_GPMI_CTRL1_ATA_IRQRDY_POLARITY(v)                                   \
    (((v) << 2) & BM_GPMI_CTRL1_ATA_IRQRDY_POLARITY)

#ifndef __LANGUAGE_ASM__
#define BW_GPMI_CTRL1_ATA_IRQRDY_POLARITY(v)                                   \
    BF_CS1(GPMI_CTRL1, ATA_IRQRDY_POLARITY, v)
#endif
...
#define BF_GPMI_TIMING1_DEVICE_BUSY_TIMEOUT(v)                                 \
    ((((reg32_t)v) << 16) & BM_GPMI_TIMING1_DEVICE_BUSY_TIMEOUT)
#else
#define BF_GPMI_TIMING1_DEVICE_BUSY_TIMEOUT(v)                                 \
...
#ifndef __LANGUAGE_ASM__
#define BW_GPMI_TIMING1_DEVICE_BUSY_TIMEOUT(v)                                 \
    (HW_GPMI_TIMING1.B.DEVICE_BUSY_TIMEOUT = (v))
#endif
...
#define BF_GPMI_TIMING2_UDMA_TRP(v)                                            \
    ((((reg32_t)v) << 24) & BM_GPMI_TIMING2_UDMA_TRP)
#else
...
#define BF_GPMI_STAT_INVALID_BUFFER_MASK(v)                                    \
    (((v) << 6) & BM_GPMI_STAT_INVALID_BUFFER_MASK)
...
#define BF_GPMI_DEBUG_WAIT_FOR_READY_END3(v)                                   \
    (((v) << 27) & BM_GPMI_DEBUG_WAIT_FOR_READY_END3)
...
#define BF_GPMI_DEBUG_WAIT_FOR_READY_END2(v)                                   \
    (((v) << 26) & BM_GPMI_DEBUG_WAIT_FOR_READY_END2)
...
#define BF_GPMI_DEBUG_WAIT_FOR_READY_END1(v)                                   \
    (((v) << 25) & BM_GPMI_DEBUG_WAIT_FOR_READY_END1)
...
#define BF_GPMI_DEBUG_WAIT_FOR_READY_END0(v)                                   \
    (((v) << 24) & BM_GPMI_DEBUG_WAIT_FOR_READY_END0)
...
#define BF_GPMI_DEBUG2_GPMI2SYND_VALID(v)                                      \
    (((v) << 11) & BM_GPMI_DEBUG2_GPMI2SYND_VALID)
...
#define BF_GPMI_DEBUG2_GPMI2SYND_READY(v)                                      \
    (((v) << 10) & BM_GPMI_DEBUG2_GPMI2SYND_READY)
...
#define BF_GPMI_DEBUG2_SYND2GPMI_VALID(v)                                      \
    (((v) << 9) & BM_GPMI_DEBUG2_SYND2GPMI_VALID)
...
#define BF_GPMI_DEBUG2_SYND2GPMI_READY(v)                                      \
    (((v) << 8) & BM_GPMI_DEBUG2_SYND2GPMI_READY)
...
#define BF_GPMI_DEBUG2_VIEW_DELAYED_RDN(v)                                     \
    (((v) << 7) & BM_GPMI_DEBUG2_VIEW_DELAYED_RDN)

#ifndef __LANGUAGE_ASM__
#define BW_GPMI_DEBUG2_VIEW_DELAYED_RDN(v)                                     \
    BF_CS1(GPMI_DEBUG2, VIEW_DELAYED_RDN, v)
#endif
...
#define BF_GPMI_DEBUG2_UPDATE_WINDOW(v)                                        \
    (((v) << 6) & BM_GPMI_DEBUG2_UPDATE_WINDOW)
...
#define BF_GPMI_DEBUG3_APB_WORD_CNTR(v)                                        \
    ((((reg32_t)v) << 16) & BM_GPMI_DEBUG3_APB_WORD_CNTR)
#else
#define BF_GPMI_DEBUG3_APB_WORD_CNTR(v)                                        \
