...
#define REGSi_SSP_BASE(i)                                                      \
    ((REGS_SSP1_BASE - HWi_SSP_OFFSET) + HWi_SSP_OFFSET * (i))
...
#define HWi_SSP_CTRL0_SET(i, v)                                                \
    ((*(volatile reg32_t *)HWi_SSP_CTRL0_SET_ADDR(i)) = (v))
#define HWi_SSP_CTRL0_CLR(i, v)                                                \
    ((*(volatile reg32_t *)HWi_SSP_CTRL0_CLR_ADDR(i)) = (v))
#define HWi_SSP_CTRL0_TOG(i, v)                                                \
    ((*(volatile reg32_t *)HWi_SSP_CTRL0_TOG_ADDR(i)) = (v))
...
#define BWi_SSP_CTRL0_SDIO_IRQ_CHECK(i, v)                                     \
    BFi_CS1(i, SSP_CTRL0, SDIO_IRQ_CHECK, v)
...
#define HWi_SSP_CMD0_SET(i, v)                                                 \
    ((*(volatile reg32_t *)HWi_SSP_CMD0_SET_ADDR(i)) = (v))
#define HWi_SSP_CMD0_CLR(i, v)                                                 \
    ((*(volatile reg32_t *)HWi_SSP_CMD0_CLR_ADDR(i)) = (v))
#define HWi_SSP_CMD0_TOG(i, v)                                                 \
    ((*(volatile reg32_t *)HWi_SSP_CMD0_TOG_ADDR(i)) = (v))
...
#define BWi_SSP_CMD0_CONT_CLKING_EN(i, v)                                      \
    (HWi_SSP_CMD0(i).B.CONT_CLKING_EN = (v))
...
#define HWi_SSP_COMPREF(i)                                                     \
    (*(volatile hw_ssp_compref_t *)HWi_SSP_COMPREF_ADDR(i))
#define HWi_SSP_COMPREF_RD(i) (HWi_SSP_COMPREF(i).U)
#define HWi_SSP_COMPREF_WR(i, v) (HWi_SSP_COMPREF(i).U = (v))
#define HWi_SSP_COMPREF_SET(i, v)                                              \
    (HWi_SSP_COMPREF_WR(i, HWi_SSP_COMPREF_RD(i) | (v)))
#define HWi_SSP_COMPREF_CLR(i, v)                                              \
    (HWi_SSP_COMPREF_WR(i, HWi_SSP_COMPREF_RD(i) & ~(v)))
#define HWi_SSP_COMPREF_TOG(i, v)                                              \
    (HWi_SSP_COMPREF_WR(i, HWi_SSP_COMPREF_RD(i) ^ (v)))
...
#define HWi_SSP_COMPMASK(i)                                                    \
    (*(volatile hw_ssp_compmask_t *)HWi_SSP_COMPMASK_ADDR(i))
#define HWi_SSP_COMPMASK_RD(i) (HWi_SSP_COMPMASK(i).U)
#define HWi_SSP_COMPMASK_WR(i, v) (HWi_SSP_COMPMASK(i).U = (v))
#define HWi_SSP_COMPMASK_SET(i, v)                                             \
    (HWi_SSP_COMPMASK_WR(i, HWi_SSP_COMPMASK_RD(i) | (v)))
#define HWi_SSP_COMPMASK_CLR(i, v)                                             \
    (HWi_SSP_COMPMASK_WR(i, HWi_SSP_COMPMASK_RD(i) & ~(v)))
#define HWi_SSP_COMPMASK_TOG(i, v)                                             \
    (HWi_SSP_COMPMASK_WR(i, HWi_SSP_COMPMASK_RD(i) ^ (v)))
...
#define HWi_SSP_TIMING_SET(i, v)                                               \
    (HWi_SSP_TIMING_WR(i, HWi_SSP_TIMING_RD(i) | (v)))
#define HWi_SSP_TIMING_CLR(i, v)                                               \
    (HWi_SSP_TIMING_WR(i, HWi_SSP_TIMING_RD(i) & ~(v)))
#define HWi_SSP_TIMING_TOG(i, v)                                               \
    (HWi_SSP_TIMING_WR(i, HWi_SSP_TIMING_RD(i) ^ (v)))

#define BWi_SSP_TIMING_TIMEOUT(i, v) (HWi_SSP_TIMING(i).B.TIMEOUT = (v))
#define BWi_SSP_TIMING_CLOCK_DIVIDE(i, v)                                      \
    (HWi_SSP_TIMING(i).B.CLOCK_DIVIDE = (v))
...
#define HWi_SSP_CTRL1_SET(i, v)                                                \
    ((*(volatile reg32_t *)HWi_SSP_CTRL1_SET_ADDR(i)) = (v))
#define HWi_SSP_CTRL1_CLR(i, v)                                                \
    ((*(volatile reg32_t *)HWi_SSP_CTRL1_CLR_ADDR(i)) = (v))
#define HWi_SSP_CTRL1_TOG(i, v)                                                \
    ((*(volatile reg32_t *)HWi_SSP_CTRL1_TOG_ADDR(i)) = (v))
...
#define BWi_SSP_CTRL1_RESP_ERR_IRQ_EN(i, v)                                    \
    BFi_CS1(i, SSP_CTRL1, RESP_ERR_IRQ_EN, v)
#define BWi_SSP_CTRL1_RESP_TIMEOUT_IRQ(i, v)                                   \
    BFi_CS1(i, SSP_CTRL1, RESP_TIMEOUT_IRQ, v)
#define BWi_SSP_CTRL1_RESP_TIMEOUT_IRQ_EN(i, v)                                \
    BFi_CS1(i, SSP_CTRL1, RESP_TIMEOUT_IRQ_EN, v)
#define BWi_SSP_CTRL1_DATA_TIMEOUT_IRQ(i, v)                                   \
    BFi_CS1(i, SSP_CTRL1, DATA_TIMEOUT_IRQ, v)
#define BWi_SSP_CTRL1_DATA_TIMEOUT_IRQ_EN(i, v)                                \
    BFi_CS1(i, SSP_CTRL1, DATA_TIMEOUT_IRQ_EN, v)
#define BWi_SSP_CTRL1_DATA_CRC_IRQ(i, v) BFi_CS1(i, SSP_CTRL1, DATA_CRC_IRQ, v)
#define BWi_SSP_CTRL1_DATA_CRC_IRQ_EN(i, v)                                    \
    BFi_CS1(i, SSP_CTRL1, DATA_CRC_IRQ_EN, v)
#define BWi_SSP_CTRL1_FIFO_UNDERRUN_IRQ(i, v)                                  \
    BFi_CS1(i, SSP_CTRL1, FIFO_UNDERRUN_IRQ, v)
#define BWi_SSP_CTRL1_FIFO_UNDERRUN_EN(i, v)                                   \
    BFi_CS1(i, SSP_CTRL1, FIFO_UNDERRUN_EN, v)
#define BWi_SSP_CTRL1_CEATA_CCS_ERR_IRQ(i, v)                                  \
    BFi_CS1(i, SSP_CTRL1, CEATA_CCS_ERR_IRQ, v)
#define BWi_SSP_CTRL1_CEATA_CCS_ERR_IRQ_EN(i, v)                               \
    BFi_CS1(i, SSP_CTRL1, CEATA_CCS_ERR_IRQ_EN, v)
#define BWi_SSP_CTRL1_RECV_TIMEOUT_IRQ(i, v)                                   \
    BFi_CS1(i, SSP_CTRL1, RECV_TIMEOUT_IRQ, v)
#define BWi_SSP_CTRL1_RECV_TIMEOUT_IRQ_EN(i, v)                                \
    BFi_CS1(i, SSP_CTRL1, RECV_TIMEOUT_IRQ_EN, v)
#define BWi_SSP_CTRL1_FIFO_OVERRUN_IRQ(i, v)                                   \
    BFi_CS1(i, SSP_CTRL1, FIFO_OVERRUN_IRQ, v)
#define BWi_SSP_CTRL1_FIFO_OVERRUN_IRQ_EN(i, v)                                \
    BFi_CS1(i, SSP_CTRL1, FIFO_OVERRUN_IRQ_EN, v)
#define BWi_SSP_CTRL1_DMA_ENABLE(i, v) BFi_CS1(i, SSP_CTRL1, DMA_ENABLE, v)
#define BWi_SSP_CTRL1_CEATA_CCS_ERR_EN(i, v)                                   \
    BFi_CS1(i, SSP_CTRL1, CEATA_CCS_ERR_EN, v)
#define BWi_SSP_CTRL1_SLAVE_OUT_DISABLE(i, v)                                  \
    BFi_CS1(i, SSP_CTRL1, SLAVE_OUT_DISABLE, v)
...
#define HWi_SSP_SDRESP0(i)                                                     \
    (*(volatile hw_ssp_sdresp0_t *)HWi_SSP_SDRESP0_ADDR(i))
...
#define HWi_SSP_SDRESP1(i)                                                     \
    (*(volatile hw_ssp_sdresp1_t *)HWi_SSP_SDRESP1_ADDR(i))
...
#define HWi_SSP_SDRESP2(i)                                                     \
    (*(volatile hw_ssp_sdresp2_t *)HWi_SSP_SDRESP2_ADDR(i))
...
#define HWi_SSP_SDRESP3(i)                                                     \
    (*(volatile hw_ssp_sdresp3_t *)HWi_SSP_SDRESP3_ADDR(i))
...
#define HWi_SSP_VERSION(i)                                                     \
    (*(volatile hw_ssp_version_t *)HWi_SSP_VERSION_ADDR(i))
