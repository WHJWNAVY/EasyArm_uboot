...
#define BF_DCP_CTRL_GATHER_RESIDUAL_WRITES(v)                                  \
    (((v) << 23) & BM_DCP_CTRL_GATHER_RESIDUAL_WRITES)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CTRL_GATHER_RESIDUAL_WRITES(v)                                  \
    BF_CS1(DCP_CTRL, GATHER_RESIDUAL_WRITES, v)
#endif
...
#define BF_DCP_CTRL_ENABLE_CONTEXT_CACHING(v)                                  \
    (((v) << 22) & BM_DCP_CTRL_ENABLE_CONTEXT_CACHING)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CTRL_ENABLE_CONTEXT_CACHING(v)                                  \
    BF_CS1(DCP_CTRL, ENABLE_CONTEXT_CACHING, v)
#endif
...
#define BF_DCP_CTRL_ENABLE_CONTEXT_SWITCHING(v)                                \
    (((v) << 21) & BM_DCP_CTRL_ENABLE_CONTEXT_SWITCHING)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CTRL_ENABLE_CONTEXT_SWITCHING(v)                                \
    BF_CS1(DCP_CTRL, ENABLE_CONTEXT_SWITCHING, v)
#endif
...
#define BF_DCP_CTRL_CSC_INTERRUPT_ENABLE(v)                                    \
    (((v) << 8) & BM_DCP_CTRL_CSC_INTERRUPT_ENABLE)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CTRL_CSC_INTERRUPT_ENABLE(v)                                    \
    BF_CS1(DCP_CTRL, CSC_INTERRUPT_ENABLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CTRL_CHANNEL_INTERRUPT_ENABLE(v)                                \
    (HW_DCP_CTRL.B.CHANNEL_INTERRUPT_ENABLE = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DCP_CHANNELCTRL                                                     \
    (*(volatile hw_dcp_channelctrl_t *)HW_DCP_CHANNELCTRL_ADDR)
#define HW_DCP_CHANNELCTRL_RD() (HW_DCP_CHANNELCTRL.U)
#define HW_DCP_CHANNELCTRL_WR(v) (HW_DCP_CHANNELCTRL.U = (v))
#define HW_DCP_CHANNELCTRL_SET(v)                                              \
    ((*(volatile reg32_t *)HW_DCP_CHANNELCTRL_SET_ADDR) = (v))
#define HW_DCP_CHANNELCTRL_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_DCP_CHANNELCTRL_CLR_ADDR) = (v))
#define HW_DCP_CHANNELCTRL_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_DCP_CHANNELCTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CHANNELCTRL_CSC_PRIORITY(v)                                     \
    BF_CS1(DCP_CHANNELCTRL, CSC_PRIORITY, v)
#endif
...
#define BF_DCP_CHANNELCTRL_CH0_IRQ_MERGED(v)                                   \
    (((v) << 16) & BM_DCP_CHANNELCTRL_CH0_IRQ_MERGED)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CHANNELCTRL_CH0_IRQ_MERGED(v)                                   \
    BF_CS1(DCP_CHANNELCTRL, CH0_IRQ_MERGED, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CHANNELCTRL_HIGH_PRIORITY_CHANNEL(v)                            \
    (HW_DCP_CHANNELCTRL.B.HIGH_PRIORITY_CHANNEL = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CHANNELCTRL_ENABLE_CHANNEL(v)                                   \
    (HW_DCP_CHANNELCTRL.B.ENABLE_CHANNEL = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DCP_CAPABILITY0                                                     \
    (*(volatile hw_dcp_capability0_t *)HW_DCP_CAPABILITY0_ADDR)
#define HW_DCP_CAPABILITY0_RD() (HW_DCP_CAPABILITY0.U)
#define HW_DCP_CAPABILITY0_WR(v) (HW_DCP_CAPABILITY0.U = (v))
#define HW_DCP_CAPABILITY0_SET(v)                                              \
    (HW_DCP_CAPABILITY0_WR(HW_DCP_CAPABILITY0_RD() | (v)))
#define HW_DCP_CAPABILITY0_CLR(v)                                              \
    (HW_DCP_CAPABILITY0_WR(HW_DCP_CAPABILITY0_RD() & ~(v)))
#define HW_DCP_CAPABILITY0_TOG(v)                                              \
    (HW_DCP_CAPABILITY0_WR(HW_DCP_CAPABILITY0_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_DCP_CAPABILITY0_DISABLE_DECRYPT(v)                                  \
    ((((reg32_t)v) << 31) & BM_DCP_CAPABILITY0_DISABLE_DECRYPT)
#else
#define BF_DCP_CAPABILITY0_DISABLE_DECRYPT(v)                                  \
    (((v) << 31) & BM_DCP_CAPABILITY0_DISABLE_DECRYPT)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CAPABILITY0_DISABLE_DECRYPT(v)                                  \
    BF_CS1(DCP_CAPABILITY0, DISABLE_DECRYPT, v)
#endif
...
#define BF_DCP_CAPABILITY0_ENABLE_TZONE(v)                                     \
    (((v) << 30) & BM_DCP_CAPABILITY0_ENABLE_TZONE)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CAPABILITY0_ENABLE_TZONE(v)                                     \
    BF_CS1(DCP_CAPABILITY0, ENABLE_TZONE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DCP_CAPABILITY1                                                     \
    (*(volatile hw_dcp_capability1_t *)HW_DCP_CAPABILITY1_ADDR)
...
#define BF_DCP_CAPABILITY1_HASH_ALGORITHMS(v)                                  \
    ((((reg32_t)v) << 16) & BM_DCP_CAPABILITY1_HASH_ALGORITHMS)
#else
#define BF_DCP_CAPABILITY1_HASH_ALGORITHMS(v)                                  \
...
#define BF_DCP_PACKET1_OUTPUT_WORDSWAP(v)                                      \
    (((v) << 23) & BM_DCP_PACKET1_OUTPUT_WORDSWAP)
...
#define BF_DCP_PACKET1_OUTPUT_BYTESWAP(v)                                      \
    (((v) << 22) & BM_DCP_PACKET1_OUTPUT_BYTESWAP)
...
#define BF_DCP_PACKET1_INPUT_WORDSWAP(v)                                       \
    (((v) << 21) & BM_DCP_PACKET1_INPUT_WORDSWAP)
...
#define BF_DCP_PACKET1_INPUT_BYTESWAP(v)                                       \
    (((v) << 20) & BM_DCP_PACKET1_INPUT_BYTESWAP)
...
#define BF_DCP_PACKET1_KEY_WORDSWAP(v)                                         \
    (((v) << 19) & BM_DCP_PACKET1_KEY_WORDSWAP)
...
#define BF_DCP_PACKET1_KEY_BYTESWAP(v)                                         \
    (((v) << 18) & BM_DCP_PACKET1_KEY_BYTESWAP)
...
#define BF_DCP_PACKET1_TEST_SEMA_IRQ(v)                                        \
    (((v) << 17) & BM_DCP_PACKET1_TEST_SEMA_IRQ)
...
#define BF_DCP_PACKET1_CONSTANT_FILL(v)                                        \
    (((v) << 16) & BM_DCP_PACKET1_CONSTANT_FILL)
...
#define BF_DCP_PACKET1_CIPHER_ENCRYPT(v)                                       \
    (((v) << 8) & BM_DCP_PACKET1_CIPHER_ENCRYPT)
...
#define BF_DCP_PACKET1_ENABLE_CIPHER(v)                                        \
    (((v) << 5) & BM_DCP_PACKET1_ENABLE_CIPHER)
...
#define BF_DCP_PACKET1_ENABLE_MEMCOPY(v)                                       \
    (((v) << 4) & BM_DCP_PACKET1_ENABLE_MEMCOPY)
...
#define BF_DCP_PACKET1_CHAIN_CONTIGUOUS(v)                                     \
    (((v) << 3) & BM_DCP_PACKET1_CHAIN_CONTIGUOUS)
...
#define BF_DCP_PACKET1_DECR_SEMAPHORE(v)                                       \
    (((v) << 1) & BM_DCP_PACKET1_DECR_SEMAPHORE)
...
#define BF_DCP_PACKET2_CIPHER_CFG(v)                                           \
    ((((reg32_t)v) << 24) & BM_DCP_PACKET2_CIPHER_CFG)
#else
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_DCP_CHnCMDPTR : base 0x80028100 : count 4 :
/// offset 0x40
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_DCP_CHnCMDPTR(n)                                                    \
    (*(volatile hw_dcp_chncmdptr_t *)HW_DCP_CHnCMDPTR_ADDR(n))
#define HW_DCP_CHnCMDPTR_RD(n) (HW_DCP_CHnCMDPTR(n).U)
#define HW_DCP_CHnCMDPTR_WR(n, v) (HW_DCP_CHnCMDPTR(n).U = (v))
#define HW_DCP_CHnCMDPTR_SET(n, v)                                             \
    (HW_DCP_CHnCMDPTR_WR(n, HW_DCP_CHnCMDPTR_RD(n) | (v)))
#define HW_DCP_CHnCMDPTR_CLR(n, v)                                             \
    (HW_DCP_CHnCMDPTR_WR(n, HW_DCP_CHnCMDPTR_RD(n) & ~(v)))
#define HW_DCP_CHnCMDPTR_TOG(n, v)                                             \
    (HW_DCP_CHnCMDPTR_WR(n, HW_DCP_CHnCMDPTR_RD(n) ^ (v)))
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_DCP_CHnSEMA : base 0x80028110 : count 4 :
/// offset 0x40
////////////////////////////////////////////////////////////////////////////////
...
#define HW_DCP_CHnSEMA_SET(n, v)                                               \
    (HW_DCP_CHnSEMA_WR(n, HW_DCP_CHnSEMA_RD(n) | (v)))
#define HW_DCP_CHnSEMA_CLR(n, v)                                               \
    (HW_DCP_CHnSEMA_WR(n, HW_DCP_CHnSEMA_RD(n) & ~(v)))
#define HW_DCP_CHnSEMA_TOG(n, v)                                               \
    (HW_DCP_CHnSEMA_WR(n, HW_DCP_CHnSEMA_RD(n) ^ (v)))
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_DCP_CHnSTAT : base 0x80028120 : count 4 :
/// offset 0x40
////////////////////////////////////////////////////////////////////////////////
...
#define HW_DCP_CHnSTAT_SET(n, v)                                               \
    ((*(volatile reg32_t *)HW_DCP_CHnSTAT_SET_ADDR(n)) = (v))
#define HW_DCP_CHnSTAT_CLR(n, v)                                               \
    ((*(volatile reg32_t *)HW_DCP_CHnSTAT_CLR_ADDR(n)) = (v))
#define HW_DCP_CHnSTAT_TOG(n, v)                                               \
    ((*(volatile reg32_t *)HW_DCP_CHnSTAT_TOG_ADDR(n)) = (v))
#endif
...
#define BF_DCP_CHnSTAT_ERROR_PAGEFAULT(v)                                      \
    (((v) << 6) & BM_DCP_CHnSTAT_ERROR_PAGEFAULT)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CHnSTAT_ERROR_PAGEFAULT(n, v)                                   \
    BF_CS1n(DCP_CHnSTAT, n, ERROR_PAGEFAULT, v)
#endif
...
#define BF_DCP_CHnSTAT_ERROR_PACKET(v)                                         \
    (((v) << 3) & BM_DCP_CHnSTAT_ERROR_PACKET)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CHnSTAT_ERROR_PACKET(n, v)                                      \
    BF_CS1n(DCP_CHnSTAT, n, ERROR_PACKET, v)
#endif
...
#define BF_DCP_CHnSTAT_HASH_MISMATCH(v)                                        \
    (((v) << 1) & BM_DCP_CHnSTAT_HASH_MISMATCH)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CHnSTAT_HASH_MISMATCH(n, v)                                     \
    BF_CS1n(DCP_CHnSTAT, n, HASH_MISMATCH, v)
#endif

////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_DCP_CHnOPTS : base 0x80028130 : count 4 :
/// offset 0x40
////////////////////////////////////////////////////////////////////////////////
...
#define HW_DCP_CHnOPTS_SET(n, v)                                               \
    ((*(volatile reg32_t *)HW_DCP_CHnOPTS_SET_ADDR(n)) = (v))
#define HW_DCP_CHnOPTS_CLR(n, v)                                               \
    ((*(volatile reg32_t *)HW_DCP_CHnOPTS_CLR_ADDR(n)) = (v))
#define HW_DCP_CHnOPTS_TOG(n, v)                                               \
    ((*(volatile reg32_t *)HW_DCP_CHnOPTS_TOG_ADDR(n)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CHnOPTS_RECOVERY_TIMER(n, v)                                    \
    (HW_DCP_CHnOPTS(n).B.RECOVERY_TIMER = (v))
#endif
...
#define HW_DCP_CSCCTRL0_SET(v)                                                 \
    ((*(volatile reg32_t *)HW_DCP_CSCCTRL0_SET_ADDR) = (v))
#define HW_DCP_CSCCTRL0_CLR(v)                                                 \
    ((*(volatile reg32_t *)HW_DCP_CSCCTRL0_CLR_ADDR) = (v))
#define HW_DCP_CSCCTRL0_TOG(v)                                                 \
    ((*(volatile reg32_t *)HW_DCP_CSCCTRL0_TOG_ADDR) = (v))
#endif
...
#define HW_DCP_CSCSTAT_SET(v)                                                  \
    ((*(volatile reg32_t *)HW_DCP_CSCSTAT_SET_ADDR) = (v))
#define HW_DCP_CSCSTAT_CLR(v)                                                  \
    ((*(volatile reg32_t *)HW_DCP_CSCSTAT_CLR_ADDR) = (v))
#define HW_DCP_CSCSTAT_TOG(v)                                                  \
    ((*(volatile reg32_t *)HW_DCP_CSCSTAT_TOG_ADDR) = (v))
#endif
...
#define BF_DCP_CSCSTAT_ERROR_PAGEFAULT(v)                                      \
    (((v) << 6) & BM_DCP_CSCSTAT_ERROR_PAGEFAULT)

#ifndef __LANGUAGE_ASM__
#define BW_DCP_CSCSTAT_ERROR_PAGEFAULT(v)                                      \
    BF_CS1(DCP_CSCSTAT, ERROR_PAGEFAULT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DCP_CSCOUTBUFPARAM                                                  \
    (*(volatile hw_dcp_cscoutbufparam_t *)HW_DCP_CSCOUTBUFPARAM_ADDR)
#define HW_DCP_CSCOUTBUFPARAM_RD() (HW_DCP_CSCOUTBUFPARAM.U)
#define HW_DCP_CSCOUTBUFPARAM_WR(v) (HW_DCP_CSCOUTBUFPARAM.U = (v))
#define HW_DCP_CSCOUTBUFPARAM_SET(v)                                           \
    (HW_DCP_CSCOUTBUFPARAM_WR(HW_DCP_CSCOUTBUFPARAM_RD() | (v)))
#define HW_DCP_CSCOUTBUFPARAM_CLR(v)                                           \
    (HW_DCP_CSCOUTBUFPARAM_WR(HW_DCP_CSCOUTBUFPARAM_RD() & ~(v)))
#define HW_DCP_CSCOUTBUFPARAM_TOG(v)                                           \
    (HW_DCP_CSCOUTBUFPARAM_WR(HW_DCP_CSCOUTBUFPARAM_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CSCOUTBUFPARAM_FIELD_SIZE(v)                                    \
    BF_CS1(DCP_CSCOUTBUFPARAM, FIELD_SIZE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CSCOUTBUFPARAM_LINE_SIZE(v)                                     \
    BF_CS1(DCP_CSCOUTBUFPARAM, LINE_SIZE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DCP_CSCINBUFPARAM                                                   \
    (*(volatile hw_dcp_cscinbufparam_t *)HW_DCP_CSCINBUFPARAM_ADDR)
#define HW_DCP_CSCINBUFPARAM_RD() (HW_DCP_CSCINBUFPARAM.U)
#define HW_DCP_CSCINBUFPARAM_WR(v) (HW_DCP_CSCINBUFPARAM.U = (v))
#define HW_DCP_CSCINBUFPARAM_SET(v)                                            \
    (HW_DCP_CSCINBUFPARAM_WR(HW_DCP_CSCINBUFPARAM_RD() | (v)))
#define HW_DCP_CSCINBUFPARAM_CLR(v)                                            \
    (HW_DCP_CSCINBUFPARAM_WR(HW_DCP_CSCINBUFPARAM_RD() & ~(v)))
#define HW_DCP_CSCINBUFPARAM_TOG(v)                                            \
    (HW_DCP_CSCINBUFPARAM_WR(HW_DCP_CSCINBUFPARAM_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DCP_CSCINBUFPARAM_LINE_SIZE(v)                                      \
    BF_CS1(DCP_CSCINBUFPARAM, LINE_SIZE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DCP_CSCCHROMAU                                                      \
    (*(volatile hw_dcp_cscchromau_t *)HW_DCP_CSCCHROMAU_ADDR)
#define HW_DCP_CSCCHROMAU_RD() (HW_DCP_CSCCHROMAU.U)
#define HW_DCP_CSCCHROMAU_WR(v) (HW_DCP_CSCCHROMAU.U = (v))
#define HW_DCP_CSCCHROMAU_SET(v)                                               \
    (HW_DCP_CSCCHROMAU_WR(HW_DCP_CSCCHROMAU_RD() | (v)))
#define HW_DCP_CSCCHROMAU_CLR(v)                                               \
    (HW_DCP_CSCCHROMAU_WR(HW_DCP_CSCCHROMAU_RD() & ~(v)))
#define HW_DCP_CSCCHROMAU_TOG(v)                                               \
    (HW_DCP_CSCCHROMAU_WR(HW_DCP_CSCCHROMAU_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DCP_CSCCHROMAV                                                      \
    (*(volatile hw_dcp_cscchromav_t *)HW_DCP_CSCCHROMAV_ADDR)
#define HW_DCP_CSCCHROMAV_RD() (HW_DCP_CSCCHROMAV.U)
#define HW_DCP_CSCCHROMAV_WR(v) (HW_DCP_CSCCHROMAV.U = (v))
#define HW_DCP_CSCCHROMAV_SET(v)                                               \
    (HW_DCP_CSCCHROMAV_WR(HW_DCP_CSCCHROMAV_RD() | (v)))
#define HW_DCP_CSCCHROMAV_CLR(v)                                               \
    (HW_DCP_CSCCHROMAV_WR(HW_DCP_CSCCHROMAV_RD() & ~(v)))
#define HW_DCP_CSCCHROMAV_TOG(v)                                               \
    (HW_DCP_CSCCHROMAV_WR(HW_DCP_CSCCHROMAV_RD() ^ (v)))
#endif
...
#define HW_DCP_CSCCOEFF0_SET(v)                                                \
    (HW_DCP_CSCCOEFF0_WR(HW_DCP_CSCCOEFF0_RD() | (v)))
#define HW_DCP_CSCCOEFF0_CLR(v)                                                \
    (HW_DCP_CSCCOEFF0_WR(HW_DCP_CSCCOEFF0_RD() & ~(v)))
#define HW_DCP_CSCCOEFF0_TOG(v)                                                \
    (HW_DCP_CSCCOEFF0_WR(HW_DCP_CSCCOEFF0_RD() ^ (v)))
#endif
...
#define HW_DCP_CSCCOEFF1_SET(v)                                                \
    (HW_DCP_CSCCOEFF1_WR(HW_DCP_CSCCOEFF1_RD() | (v)))
#define HW_DCP_CSCCOEFF1_CLR(v)                                                \
    (HW_DCP_CSCCOEFF1_WR(HW_DCP_CSCCOEFF1_RD() & ~(v)))
#define HW_DCP_CSCCOEFF1_TOG(v)                                                \
    (HW_DCP_CSCCOEFF1_WR(HW_DCP_CSCCOEFF1_RD() ^ (v)))
#endif
...
#define HW_DCP_CSCCOEFF2_SET(v)                                                \
    (HW_DCP_CSCCOEFF2_WR(HW_DCP_CSCCOEFF2_RD() | (v)))
#define HW_DCP_CSCCOEFF2_CLR(v)                                                \
    (HW_DCP_CSCCOEFF2_WR(HW_DCP_CSCCOEFF2_RD() & ~(v)))
#define HW_DCP_CSCCOEFF2_TOG(v)                                                \
    (HW_DCP_CSCCOEFF2_WR(HW_DCP_CSCCOEFF2_RD() ^ (v)))
#endif
...
#define HW_DCP_CSCXSCALE_SET(v)                                                \
    (HW_DCP_CSCXSCALE_WR(HW_DCP_CSCXSCALE_RD() | (v)))
#define HW_DCP_CSCXSCALE_CLR(v)                                                \
    (HW_DCP_CSCXSCALE_WR(HW_DCP_CSCXSCALE_RD() & ~(v)))
#define HW_DCP_CSCXSCALE_TOG(v)                                                \
    (HW_DCP_CSCXSCALE_WR(HW_DCP_CSCXSCALE_RD() ^ (v)))
#endif
...
#define HW_DCP_CSCYSCALE_SET(v)                                                \
    (HW_DCP_CSCYSCALE_WR(HW_DCP_CSCYSCALE_RD() | (v)))
#define HW_DCP_CSCYSCALE_CLR(v)                                                \
    (HW_DCP_CSCYSCALE_WR(HW_DCP_CSCYSCALE_RD() & ~(v)))
#define HW_DCP_CSCYSCALE_TOG(v)                                                \
    (HW_DCP_CSCYSCALE_WR(HW_DCP_CSCYSCALE_RD() ^ (v)))
#endif
...
#define HW_DCP_DBGSELECT_SET(v)                                                \
    (HW_DCP_DBGSELECT_WR(HW_DCP_DBGSELECT_RD() | (v)))
#define HW_DCP_DBGSELECT_CLR(v)                                                \
    (HW_DCP_DBGSELECT_WR(HW_DCP_DBGSELECT_RD() & ~(v)))
#define HW_DCP_DBGSELECT_TOG(v)                                                \
    (HW_DCP_DBGSELECT_WR(HW_DCP_DBGSELECT_RD() ^ (v)))
#endif
...
#define HW_DCP_PAGETABLE_SET(v)                                                \
    (HW_DCP_PAGETABLE_WR(HW_DCP_PAGETABLE_RD() | (v)))
#define HW_DCP_PAGETABLE_CLR(v)                                                \
    (HW_DCP_PAGETABLE_WR(HW_DCP_PAGETABLE_RD() & ~(v)))
#define HW_DCP_PAGETABLE_TOG(v)                                                \
    (HW_DCP_PAGETABLE_WR(HW_DCP_PAGETABLE_RD() ^ (v)))
#endif
