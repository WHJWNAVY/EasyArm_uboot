...
#define HW_AUDIOIN_CTRL_SET(v)                                                 \
    ((*(volatile reg32_t *)HW_AUDIOIN_CTRL_SET_ADDR) = (v))
#define HW_AUDIOIN_CTRL_CLR(v)                                                 \
    ((*(volatile reg32_t *)HW_AUDIOIN_CTRL_CLR_ADDR) = (v))
#define HW_AUDIOIN_CTRL_TOG(v)                                                 \
    ((*(volatile reg32_t *)HW_AUDIOIN_CTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOIN_CTRL_SFTRST(v)                                              \
    ((((reg32_t)v) << 31) & BM_AUDIOIN_CTRL_SFTRST)
#else
...
#define BF_AUDIOIN_CTRL_INVERT_1BIT(v)                                         \
    (((v) << 8) & BM_AUDIOIN_CTRL_INVERT_1BIT)
...
#define BF_AUDIOIN_CTRL_OFFSET_ENABLE(v)                                       \
    (((v) << 7) & BM_AUDIOIN_CTRL_OFFSET_ENABLE)
...
#define BF_AUDIOIN_CTRL_WORD_LENGTH(v)                                         \
    (((v) << 5) & BM_AUDIOIN_CTRL_WORD_LENGTH)
...
#define BF_AUDIOIN_CTRL_FIFO_UNDERFLOW_IRQ(v)                                  \
    (((v) << 3) & BM_AUDIOIN_CTRL_FIFO_UNDERFLOW_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_CTRL_FIFO_UNDERFLOW_IRQ(v)                                  \
    BF_CS1(AUDIOIN_CTRL, FIFO_UNDERFLOW_IRQ, v)
#endif
...
#define BF_AUDIOIN_CTRL_FIFO_OVERFLOW_IRQ(v)                                   \
    (((v) << 2) & BM_AUDIOIN_CTRL_FIFO_OVERFLOW_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_CTRL_FIFO_OVERFLOW_IRQ(v)                                   \
    BF_CS1(AUDIOIN_CTRL, FIFO_OVERFLOW_IRQ, v)
#endif
...
#define BF_AUDIOIN_CTRL_FIFO_ERROR_IRQ_EN(v)                                   \
    (((v) << 1) & BM_AUDIOIN_CTRL_FIFO_ERROR_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_CTRL_FIFO_ERROR_IRQ_EN(v)                                   \
    BF_CS1(AUDIOIN_CTRL, FIFO_ERROR_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOIN_STAT_ADC_PRESENT(v)                                         \
    ((((reg32_t)v) << 31) & BM_AUDIOIN_STAT_ADC_PRESENT)
#else
#define BF_AUDIOIN_STAT_ADC_PRESENT(v)                                         \
    (((v) << 31) & BM_AUDIOIN_STAT_ADC_PRESENT)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOIN_ADCSRR                                                      \
    (*(volatile hw_audioin_adcsrr_t *)HW_AUDIOIN_ADCSRR_ADDR)
#define HW_AUDIOIN_ADCSRR_RD() (HW_AUDIOIN_ADCSRR.U)
#define HW_AUDIOIN_ADCSRR_WR(v) (HW_AUDIOIN_ADCSRR.U = (v))
#define HW_AUDIOIN_ADCSRR_SET(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCSRR_SET_ADDR) = (v))
#define HW_AUDIOIN_ADCSRR_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCSRR_CLR_ADDR) = (v))
#define HW_AUDIOIN_ADCSRR_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCSRR_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOIN_ADCVOLUME                                                   \
    (*(volatile hw_audioin_adcvolume_t *)HW_AUDIOIN_ADCVOLUME_ADDR)
#define HW_AUDIOIN_ADCVOLUME_RD() (HW_AUDIOIN_ADCVOLUME.U)
#define HW_AUDIOIN_ADCVOLUME_WR(v) (HW_AUDIOIN_ADCVOLUME.U = (v))
#define HW_AUDIOIN_ADCVOLUME_SET(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCVOLUME_SET_ADDR) = (v))
#define HW_AUDIOIN_ADCVOLUME_CLR(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCVOLUME_CLR_ADDR) = (v))
#define HW_AUDIOIN_ADCVOLUME_TOG(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCVOLUME_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOIN_ADCVOLUME_VOLUME_UPDATE_LEFT(v)                             \
    (((v) << 28) & BM_AUDIOIN_ADCVOLUME_VOLUME_UPDATE_LEFT)
...
#define BF_AUDIOIN_ADCVOLUME_EN_ZCD(v)                                         \
    (((v) << 25) & BM_AUDIOIN_ADCVOLUME_EN_ZCD)
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_ADCVOLUME_VOLUME_LEFT(v)                                    \
    (HW_AUDIOIN_ADCVOLUME.B.VOLUME_LEFT = (v))
#endif
...
#define BF_AUDIOIN_ADCVOLUME_VOLUME_UPDATE_RIGHT(v)                            \
    (((v) << 12) & BM_AUDIOIN_ADCVOLUME_VOLUME_UPDATE_RIGHT)
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_ADCVOLUME_VOLUME_RIGHT(v)                                   \
    (HW_AUDIOIN_ADCVOLUME.B.VOLUME_RIGHT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOIN_ADCDEBUG                                                    \
    (*(volatile hw_audioin_adcdebug_t *)HW_AUDIOIN_ADCDEBUG_ADDR)
#define HW_AUDIOIN_ADCDEBUG_RD() (HW_AUDIOIN_ADCDEBUG.U)
#define HW_AUDIOIN_ADCDEBUG_WR(v) (HW_AUDIOIN_ADCDEBUG.U = (v))
#define HW_AUDIOIN_ADCDEBUG_SET(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCDEBUG_SET_ADDR) = (v))
#define HW_AUDIOIN_ADCDEBUG_CLR(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCDEBUG_CLR_ADDR) = (v))
#define HW_AUDIOIN_ADCDEBUG_TOG(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCDEBUG_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOIN_ADCDEBUG_ENABLE_ADCDMA(v)                                   \
    ((((reg32_t)v) << 31) & BM_AUDIOIN_ADCDEBUG_ENABLE_ADCDMA)
#else
#define BF_AUDIOIN_ADCDEBUG_ENABLE_ADCDMA(v)                                   \
    (((v) << 31) & BM_AUDIOIN_ADCDEBUG_ENABLE_ADCDMA)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_ADCDEBUG_ENABLE_ADCDMA(v)                                   \
    BF_CS1(AUDIOIN_ADCDEBUG, ENABLE_ADCDMA, v)
#endif
...
#define BF_AUDIOIN_ADCDEBUG_ADC_DMA_REQ_HAND_SHAKE_CLK_CROSS(v)                \
    (((v) << 3) & BM_AUDIOIN_ADCDEBUG_ADC_DMA_REQ_HAND_SHAKE_CLK_CROSS)
...
#define BF_AUDIOIN_ADCDEBUG_SET_INTERRUPT3_HAND_SHAKE(v)                       \
    (((v) << 2) & BM_AUDIOIN_ADCDEBUG_SET_INTERRUPT3_HAND_SHAKE)
...
#define BF_AUDIOIN_ADCDEBUG_DMA_PREQ(v)                                        \
    (((v) << 1) & BM_AUDIOIN_ADCDEBUG_DMA_PREQ)
...
#define BF_AUDIOIN_ADCDEBUG_FIFO_STATUS(v)                                     \
    (((v) << 0) & BM_AUDIOIN_ADCDEBUG_FIFO_STATUS)
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOIN_ADCVOL                                                      \
    (*(volatile hw_audioin_adcvol_t *)HW_AUDIOIN_ADCVOL_ADDR)
#define HW_AUDIOIN_ADCVOL_RD() (HW_AUDIOIN_ADCVOL.U)
#define HW_AUDIOIN_ADCVOL_WR(v) (HW_AUDIOIN_ADCVOL.U = (v))
#define HW_AUDIOIN_ADCVOL_SET(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCVOL_SET_ADDR) = (v))
#define HW_AUDIOIN_ADCVOL_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCVOL_CLR_ADDR) = (v))
#define HW_AUDIOIN_ADCVOL_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOIN_ADCVOL_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOIN_ADCVOL_VOLUME_UPDATE_PENDING(v)                             \
    (((v) << 28) & BM_AUDIOIN_ADCVOL_VOLUME_UPDATE_PENDING)
...
#define BF_AUDIOIN_ADCVOL_EN_ADC_ZCD(v)                                        \
    (((v) << 25) & BM_AUDIOIN_ADCVOL_EN_ADC_ZCD)
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_ADCVOL_SELECT_RIGHT(v)                                      \
    BF_CS1(AUDIOIN_ADCVOL, SELECT_RIGHT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOIN_MICLINE                                                     \
    (*(volatile hw_audioin_micline_t *)HW_AUDIOIN_MICLINE_ADDR)
#define HW_AUDIOIN_MICLINE_RD() (HW_AUDIOIN_MICLINE.U)
#define HW_AUDIOIN_MICLINE_WR(v) (HW_AUDIOIN_MICLINE.U = (v))
#define HW_AUDIOIN_MICLINE_SET(v)                                              \
    ((*(volatile reg32_t *)HW_AUDIOIN_MICLINE_SET_ADDR) = (v))
#define HW_AUDIOIN_MICLINE_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_AUDIOIN_MICLINE_CLR_ADDR) = (v))
#define HW_AUDIOIN_MICLINE_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_AUDIOIN_MICLINE_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOIN_MICLINE_DIVIDE_LINE1(v)                                     \
    (((v) << 29) & BM_AUDIOIN_MICLINE_DIVIDE_LINE1)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_MICLINE_DIVIDE_LINE1(v)                                     \
    BF_CS1(AUDIOIN_MICLINE, DIVIDE_LINE1, v)
#endif
...
#define BF_AUDIOIN_MICLINE_DIVIDE_LINE2(v)                                     \
    (((v) << 28) & BM_AUDIOIN_MICLINE_DIVIDE_LINE2)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_MICLINE_DIVIDE_LINE2(v)                                     \
    BF_CS1(AUDIOIN_MICLINE, DIVIDE_LINE2, v)
#endif
...
#define BF_AUDIOIN_MICLINE_MIC_SELECT(v)                                       \
    (((v) << 24) & BM_AUDIOIN_MICLINE_MIC_SELECT)
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_MICLINE_MIC_RESISTOR(v)                                     \
    BF_CS1(AUDIOIN_MICLINE, MIC_RESISTOR, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_MICLINE_MIC_CHOPCLK(v)                                      \
    BF_CS1(AUDIOIN_MICLINE, MIC_CHOPCLK, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOIN_ANACLKCTRL                                                  \
    (*(volatile hw_audioin_anaclkctrl_t *)HW_AUDIOIN_ANACLKCTRL_ADDR)
#define HW_AUDIOIN_ANACLKCTRL_RD() (HW_AUDIOIN_ANACLKCTRL.U)
#define HW_AUDIOIN_ANACLKCTRL_WR(v) (HW_AUDIOIN_ANACLKCTRL.U = (v))
#define HW_AUDIOIN_ANACLKCTRL_SET(v)                                           \
    ((*(volatile reg32_t *)HW_AUDIOIN_ANACLKCTRL_SET_ADDR) = (v))
#define HW_AUDIOIN_ANACLKCTRL_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_AUDIOIN_ANACLKCTRL_CLR_ADDR) = (v))
#define HW_AUDIOIN_ANACLKCTRL_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_AUDIOIN_ANACLKCTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOIN_ANACLKCTRL_CLKGATE(v)                                       \
    ((((reg32_t)v) << 31) & BM_AUDIOIN_ANACLKCTRL_CLKGATE)
#else
#define BF_AUDIOIN_ANACLKCTRL_CLKGATE(v)                                       \
    (((v) << 31) & BM_AUDIOIN_ANACLKCTRL_CLKGATE)
#endif
...
#define BF_AUDIOIN_ANACLKCTRL_DITHER_OFF(v)                                    \
    (((v) << 10) & BM_AUDIOIN_ANACLKCTRL_DITHER_OFF)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_ANACLKCTRL_DITHER_OFF(v)                                    \
    BF_CS1(AUDIOIN_ANACLKCTRL, DITHER_OFF, v)
#endif
...
#define BF_AUDIOIN_ANACLKCTRL_SLOW_DITHER(v)                                   \
    (((v) << 9) & BM_AUDIOIN_ANACLKCTRL_SLOW_DITHER)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_ANACLKCTRL_SLOW_DITHER(v)                                   \
    BF_CS1(AUDIOIN_ANACLKCTRL, SLOW_DITHER, v)
#endif
...
#define BF_AUDIOIN_ANACLKCTRL_INVERT_ADCCLK(v)                                 \
    (((v) << 8) & BM_AUDIOIN_ANACLKCTRL_INVERT_ADCCLK)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_ANACLKCTRL_INVERT_ADCCLK(v)                                 \
    BF_CS1(AUDIOIN_ANACLKCTRL, INVERT_ADCCLK, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOIN_ANACLKCTRL_ADCCLK_SHIFT(v)                                  \
    BF_CS1(AUDIOIN_ANACLKCTRL, ADCCLK_SHIFT, v)
#endif
