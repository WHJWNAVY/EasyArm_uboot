...
static char const *const chipStr[] = {
    "TA1", "TA2", "TA3", "TA4", "TA5", "TA6", "TB1", "TC1", "???",
};
...
////////////////////////////////////////////////////////////////////////////////
uint32_t hw_digctl_GetCurrentTime(void) { return HW_DIGCTL_MICROSECONDS_RD(); }
...
const char *hw_digctl_getChipRevStr(uint32_t revision) {
    ...
    switch (revision) {
    case 0x00:
        return chipStr[CHIP_STR_TA1];
    case 0x01:
        return chipStr[CHIP_STR_TA2];
    case 0x02:
        return chipStr[CHIP_STR_TA3];
    case 0x03:
        return chipStr[CHIP_STR_TA4];
    }
