...
#define BF_POWER_CHARGE_ENABLE_CHARGER_RESISTORS(v)                            \
    (((v) << 21) & BM_POWER_CHARGE_ENABLE_CHARGER_RESISTORS)

#ifndef __LANGUAGE_ASM__
#define BW_POWER_CHARGE_ENABLE_CHARGER_RESISTORS(v)                            \
    BF_CS1(POWER_CHARGE, ENABLE_CHARGER_RESISTORS, v)
#endif
...
#define BF_POWER_CHARGE_USE_EXTERN_R(v)                                        \
    (((v) << 17) & BM_POWER_CHARGE_USE_EXTERN_R)
...
#define BF_POWER_STS_VBUSVALID_STATUS(v)                                       \
    (((v) << 15) & BM_POWER_STS_VBUSVALID_STATUS)
...
#define BF_POWER_STS_SESSEND_STATUS(v)                                         \
    (((v) << 14) & BM_POWER_STS_SESSEND_STATUS)
