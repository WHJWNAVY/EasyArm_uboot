...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL0_SLAVE_ADDRESS_ENABLE(v)                                   \
    BF_CS1(I2C_CTRL0, SLAVE_ADDRESS_ENABLE, v)
#endif
...
#define HW_I2C_TIMING0_SET(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING0_SET_ADDR) = (v))
#define HW_I2C_TIMING0_CLR(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING0_CLR_ADDR) = (v))
#define HW_I2C_TIMING0_TOG(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING0_TOG_ADDR) = (v))
#endif
...
#define HW_I2C_TIMING1_SET(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING1_SET_ADDR) = (v))
#define HW_I2C_TIMING1_CLR(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING1_CLR_ADDR) = (v))
#define HW_I2C_TIMING1_TOG(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING1_TOG_ADDR) = (v))
#endif
...
#define HW_I2C_TIMING2_SET(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING2_SET_ADDR) = (v))
#define HW_I2C_TIMING2_CLR(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING2_CLR_ADDR) = (v))
#define HW_I2C_TIMING2_TOG(v)                                                  \
    ((*(volatile reg32_t *)HW_I2C_TIMING2_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_SLAVE_ADDRESS_BYTE(v)                                     \
    (HW_I2C_CTRL1.B.SLAVE_ADDRESS_BYTE = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ_EN(v)                               \
    BF_CS1(I2C_CTRL1, DATA_ENGINE_CMPLT_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_NO_SLAVE_ACK_IRQ_EN(v)                                    \
    BF_CS1(I2C_CTRL1, NO_SLAVE_ACK_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ_EN(v)                              \
    BF_CS1(I2C_CTRL1, OVERSIZE_XFER_TERM_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_EARLY_TERM_IRQ_EN(v)                                      \
    BF_CS1(I2C_CTRL1, EARLY_TERM_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_MASTER_LOSS_IRQ_EN(v)                                     \
    BF_CS1(I2C_CTRL1, MASTER_LOSS_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_SLAVE_STOP_IRQ_EN(v)                                      \
    BF_CS1(I2C_CTRL1, SLAVE_STOP_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_DATA_ENGINE_CMPLT_IRQ(v)                                  \
    BF_CS1(I2C_CTRL1, DATA_ENGINE_CMPLT_IRQ, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_CTRL1_OVERSIZE_XFER_TERM_IRQ(v)                                 \
    BF_CS1(I2C_CTRL1, OVERSIZE_XFER_TERM_IRQ, v)
#endif
...
#define HW_I2C_DEBUG0_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_I2C_DEBUG0_SET_ADDR) = (v))
#define HW_I2C_DEBUG0_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_I2C_DEBUG0_CLR_ADDR) = (v))
#define HW_I2C_DEBUG0_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_I2C_DEBUG0_TOG_ADDR) = (v))
#endif
...
#define HW_I2C_DEBUG1_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_I2C_DEBUG1_SET_ADDR) = (v))
#define HW_I2C_DEBUG1_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_I2C_DEBUG1_CLR_ADDR) = (v))
#define HW_I2C_DEBUG1_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_I2C_DEBUG1_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_LOCAL_SLAVE_TEST(v)                                      \
    BF_CS1(I2C_DEBUG1, LOCAL_SLAVE_TEST, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_FORCE_I2C_DATA_OE(v)                                     \
    BF_CS1(I2C_DEBUG1, FORCE_I2C_DATA_OE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_I2C_DEBUG1_FORCE_I2C_CLK_OE(v)                                      \
    BF_CS1(I2C_DEBUG1, FORCE_I2C_CLK_OE, v)
#endif
