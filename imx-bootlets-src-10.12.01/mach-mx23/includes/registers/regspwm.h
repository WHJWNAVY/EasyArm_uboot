...
#define BF_PWM_CTRL_OUTPUT_CUTOFF_EN(v)                                        \
    (((v) << 6) & BM_PWM_CTRL_OUTPUT_CUTOFF_EN)
...
#define BF_PWM_CTRL_PWM2_ANA_CTRL_ENABLE(v)                                    \
    (((v) << 5) & BM_PWM_CTRL_PWM2_ANA_CTRL_ENABLE)

#ifndef __LANGUAGE_ASM__
#define BW_PWM_CTRL_PWM2_ANA_CTRL_ENABLE(v)                                    \
    BF_CS1(PWM_CTRL, PWM2_ANA_CTRL_ENABLE, v)
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_PWM_ACTIVEn : base 0x80064010 : count 5 :
/// offset 0x20
////////////////////////////////////////////////////////////////////////////////
...
#define HW_PWM_ACTIVEn_SET(n, v)                                               \
    ((*(volatile reg32_t *)HW_PWM_ACTIVEn_SET_ADDR(n)) = (v))
#define HW_PWM_ACTIVEn_CLR(n, v)                                               \
    ((*(volatile reg32_t *)HW_PWM_ACTIVEn_CLR_ADDR(n)) = (v))
#define HW_PWM_ACTIVEn_TOG(n, v)                                               \
    ((*(volatile reg32_t *)HW_PWM_ACTIVEn_TOG_ADDR(n)) = (v))
#endif
...
#define BF_PWM_ACTIVEn_INACTIVE(v)                                             \
    ((((reg32_t)v) << 16) & BM_PWM_ACTIVEn_INACTIVE)
#else
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_PWM_PERIODn : base 0x80064020 : count 5 :
/// offset 0x20
////////////////////////////////////////////////////////////////////////////////
...
#define HW_PWM_PERIODn_SET(n, v)                                               \
    ((*(volatile reg32_t *)HW_PWM_PERIODn_SET_ADDR(n)) = (v))
#define HW_PWM_PERIODn_CLR(n, v)                                               \
    ((*(volatile reg32_t *)HW_PWM_PERIODn_CLR_ADDR(n)) = (v))
#define HW_PWM_PERIODn_TOG(n, v)                                               \
    ((*(volatile reg32_t *)HW_PWM_PERIODn_TOG_ADDR(n)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_PWM_PERIODn_INACTIVE_STATE(n, v)                                    \
    BF_CS1n(PWM_PERIODn, n, INACTIVE_STATE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_PWM_PERIODn_ACTIVE_STATE(n, v)                                      \
    BF_CS1n(PWM_PERIODn, n, ACTIVE_STATE, v)
#endif
