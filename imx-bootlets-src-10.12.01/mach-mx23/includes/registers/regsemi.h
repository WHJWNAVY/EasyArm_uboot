...
#define BF_EMI_CTRL_DLL_SHIFT_RESET(v)                                         \
    (((v) << 25) & BM_EMI_CTRL_DLL_SHIFT_RESET)
...
#ifndef __LANGUAGE_ASM__
#define BW_EMI_CTRL_PORT_PRIORITY_ORDER(v)                                     \
    BF_CS1(EMI_CTRL, PORT_PRIORITY_ORDER, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_EMI_CTRL_PRIORITY_WRITE_ITER(v)                                     \
    BF_CS1(EMI_CTRL, PRIORITY_WRITE_ITER, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_EMI_CTRL_HIGH_PRIORITY_WRITE(v)                                     \
    BF_CS1(EMI_CTRL, HIGH_PRIORITY_WRITE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_EMI_STAT_DRAM_PRESENT(v)                                            \
    ((((reg32_t)v) << 31) & BM_EMI_STAT_DRAM_PRESENT)
#else
...
#define BF_EMI_STAT_LARGE_DRAM_ENABLED(v)                                      \
    (((v) << 29) & BM_EMI_STAT_LARGE_DRAM_ENABLED)
...
#ifndef __LANGUAGE_ASM__
#define HW_EMI_DDR_TEST_MODE_CSR                                               \
    (*(volatile hw_emi_ddr_test_mode_csr_t *)HW_EMI_DDR_TEST_MODE_CSR_ADDR)
...
#define HW_EMI_DDR_TEST_MODE_CSR_SET(v)                                        \
    ((*(volatile reg32_t *)HW_EMI_DDR_TEST_MODE_CSR_SET_ADDR) = (v))
#define HW_EMI_DDR_TEST_MODE_CSR_CLR(v)                                        \
    ((*(volatile reg32_t *)HW_EMI_DDR_TEST_MODE_CSR_CLR_ADDR) = (v))
#define HW_EMI_DDR_TEST_MODE_CSR_TOG(v)                                        \
    ((*(volatile reg32_t *)HW_EMI_DDR_TEST_MODE_CSR_TOG_ADDR) = (v))
#endif
...
#define BF_EMI_DDR_TEST_MODE_CSR_DONE(v)                                       \
    (((v) << 1) & BM_EMI_DDR_TEST_MODE_CSR_DONE)
...
#define BF_EMI_DDR_TEST_MODE_CSR_START(v)                                      \
    (((v) << 0) & BM_EMI_DDR_TEST_MODE_CSR_START)

#ifndef __LANGUAGE_ASM__
#define BW_EMI_DDR_TEST_MODE_CSR_START(v)                                      \
    BF_CS1(EMI_DDR_TEST_MODE_CSR, START, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_EMI_DDR_TEST_MODE_STATUS0                                           \
    (*(volatile hw_emi_ddr_test_mode_status0_t *)                              \
         HW_EMI_DDR_TEST_MODE_STATUS0_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_EMI_DDR_TEST_MODE_STATUS1                                           \
    (*(volatile hw_emi_ddr_test_mode_status1_t *)                              \
         HW_EMI_DDR_TEST_MODE_STATUS1_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_EMI_DDR_TEST_MODE_STATUS2                                           \
    (*(volatile hw_emi_ddr_test_mode_status2_t *)                              \
         HW_EMI_DDR_TEST_MODE_STATUS2_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_EMI_DDR_TEST_MODE_STATUS3                                           \
    (*(volatile hw_emi_ddr_test_mode_status3_t *)                              \
