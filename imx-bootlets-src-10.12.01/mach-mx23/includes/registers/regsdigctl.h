...
#define BF_DIGCTL_CTRL_CACHE_BIST_TMODE(v)                                     \
    (((v) << 26) & BM_DIGCTL_CTRL_CACHE_BIST_TMODE)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_CTRL_CACHE_BIST_TMODE(v)                                     \
    BF_CS1(DIGCTL_CTRL, CACHE_BIST_TMODE, v)
#endif
...
#define BF_DIGCTL_CTRL_LCD_BIST_CLKEN(v)                                       \
    (((v) << 25) & BM_DIGCTL_CTRL_LCD_BIST_CLKEN)
...
#define BF_DIGCTL_CTRL_LCD_BIST_START(v)                                       \
    (((v) << 24) & BM_DIGCTL_CTRL_LCD_BIST_START)
...
#define BF_DIGCTL_CTRL_DCP_BIST_CLKEN(v)                                       \
    (((v) << 23) & BM_DIGCTL_CTRL_DCP_BIST_CLKEN)
...
#define BF_DIGCTL_CTRL_DCP_BIST_START(v)                                       \
    (((v) << 22) & BM_DIGCTL_CTRL_DCP_BIST_START)
...
#define BF_DIGCTL_CTRL_ARM_BIST_CLKEN(v)                                       \
    (((v) << 21) & BM_DIGCTL_CTRL_ARM_BIST_CLKEN)
...
#define BF_DIGCTL_CTRL_USB_TESTMODE(v)                                         \
    (((v) << 20) & BM_DIGCTL_CTRL_USB_TESTMODE)
...
#define BF_DIGCTL_CTRL_ANALOG_TESTMODE(v)                                      \
    (((v) << 19) & BM_DIGCTL_CTRL_ANALOG_TESTMODE)
...
#define BF_DIGCTL_CTRL_DIGITAL_TESTMODE(v)                                     \
    (((v) << 18) & BM_DIGCTL_CTRL_DIGITAL_TESTMODE)
...
#define BF_DIGCTL_CTRL_ARM_BIST_START(v)                                       \
    (((v) << 17) & BM_DIGCTL_CTRL_ARM_BIST_START)
...
#define BF_DIGCTL_CTRL_UART_LOOPBACK(v)                                        \
    (((v) << 16) & BM_DIGCTL_CTRL_UART_LOOPBACK)
...
#define BF_DIGCTL_CTRL_SAIF_CLKMST_SEL(v)                                      \
    (((v) << 12) & BM_DIGCTL_CTRL_SAIF_CLKMST_SEL)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_CTRL_SAIF_CLKMST_SEL(v)                                      \
    BF_CS1(DIGCTL_CTRL, SAIF_CLKMST_SEL, v)
#endif
...
#define BF_DIGCTL_CTRL_SAIF_ALT_BITCLK_SEL(v)                                  \
    (((v) << 11) & BM_DIGCTL_CTRL_SAIF_ALT_BITCLK_SEL)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_CTRL_SAIF_ALT_BITCLK_SEL(v)                                  \
    BF_CS1(DIGCTL_CTRL, SAIF_ALT_BITCLK_SEL, v)
#endif
...
#define BF_DIGCTL_CTRL_USE_SERIAL_JTAG(v)                                      \
    (((v) << 6) & BM_DIGCTL_CTRL_USE_SERIAL_JTAG)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_CTRL_USE_SERIAL_JTAG(v)                                      \
    BF_CS1(DIGCTL_CTRL, USE_SERIAL_JTAG, v)
#endif
...
#define BF_DIGCTL_CTRL_TRAP_IN_RANGE(v)                                        \
    (((v) << 5) & BM_DIGCTL_CTRL_TRAP_IN_RANGE)
...
#ifndef __LANGUAGE_ASM__
#define BF_DIGCTL_STATUS_USB_HS_PRESENT(v)                                     \
    ((((reg32_t)v) << 31) & BM_DIGCTL_STATUS_USB_HS_PRESENT)
#else
#define BF_DIGCTL_STATUS_USB_HS_PRESENT(v)                                     \
    (((v) << 31) & BM_DIGCTL_STATUS_USB_HS_PRESENT)
#endif
...
#define BF_DIGCTL_STATUS_USB_OTG_PRESENT(v)                                    \
    (((v) << 30) & BM_DIGCTL_STATUS_USB_OTG_PRESENT)
...
#define BF_DIGCTL_STATUS_USB_HOST_PRESENT(v)                                   \
    (((v) << 29) & BM_DIGCTL_STATUS_USB_HOST_PRESENT)
...
#define BF_DIGCTL_STATUS_USB_DEVICE_PRESENT(v)                                 \
    (((v) << 28) & BM_DIGCTL_STATUS_USB_DEVICE_PRESENT)
...
#define BF_DIGCTL_STATUS_DCP_BIST_FAIL(v)                                      \
    (((v) << 10) & BM_DIGCTL_STATUS_DCP_BIST_FAIL)
...
#define BF_DIGCTL_STATUS_DCP_BIST_PASS(v)                                      \
    (((v) << 9) & BM_DIGCTL_STATUS_DCP_BIST_PASS)
...
#define BF_DIGCTL_STATUS_DCP_BIST_DONE(v)                                      \
    (((v) << 8) & BM_DIGCTL_STATUS_DCP_BIST_DONE)
...
#define BF_DIGCTL_STATUS_LCD_BIST_FAIL(v)                                      \
    (((v) << 7) & BM_DIGCTL_STATUS_LCD_BIST_FAIL)
...
#define BF_DIGCTL_STATUS_LCD_BIST_PASS(v)                                      \
    (((v) << 6) & BM_DIGCTL_STATUS_LCD_BIST_PASS)
...
#define BF_DIGCTL_STATUS_LCD_BIST_DONE(v)                                      \
    (((v) << 5) & BM_DIGCTL_STATUS_LCD_BIST_DONE)
...
#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_RAMCTRL_SPEED_SELECT(v)                                      \
    BF_CS1(DIGCTL_RAMCTRL, SPEED_SELECT, v)
#endif
...
#define BF_DIGCTL_RAMCTRL_RAM_REPAIR_EN(v)                                     \
    (((v) << 0) & BM_DIGCTL_RAMCTRL_RAM_REPAIR_EN)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_RAMCTRL_RAM_REPAIR_EN(v)                                     \
    BF_CS1(DIGCTL_RAMCTRL, RAM_REPAIR_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_RAMREPAIR                                                    \
    (*(volatile hw_digctl_ramrepair_t *)HW_DIGCTL_RAMREPAIR_ADDR)
#define HW_DIGCTL_RAMREPAIR_RD() (HW_DIGCTL_RAMREPAIR.U)
#define HW_DIGCTL_RAMREPAIR_WR(v) (HW_DIGCTL_RAMREPAIR.U = (v))
#define HW_DIGCTL_RAMREPAIR_SET(v)                                             \
    ((*(volatile reg32_t *)HW_DIGCTL_RAMREPAIR_SET_ADDR) = (v))
#define HW_DIGCTL_RAMREPAIR_CLR(v)                                             \
    ((*(volatile reg32_t *)HW_DIGCTL_RAMREPAIR_CLR_ADDR) = (v))
#define HW_DIGCTL_RAMREPAIR_TOG(v)                                             \
    ((*(volatile reg32_t *)HW_DIGCTL_RAMREPAIR_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_ROMCTRL                                                      \
    (*(volatile hw_digctl_romctrl_t *)HW_DIGCTL_ROMCTRL_ADDR)
#define HW_DIGCTL_ROMCTRL_RD() (HW_DIGCTL_ROMCTRL.U)
#define HW_DIGCTL_ROMCTRL_WR(v) (HW_DIGCTL_ROMCTRL.U = (v))
#define HW_DIGCTL_ROMCTRL_SET(v)                                               \
    ((*(volatile reg32_t *)HW_DIGCTL_ROMCTRL_SET_ADDR) = (v))
#define HW_DIGCTL_ROMCTRL_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_DIGCTL_ROMCTRL_CLR_ADDR) = (v))
#define HW_DIGCTL_ROMCTRL_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_DIGCTL_ROMCTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_SJTAGDBG                                                     \
    (*(volatile hw_digctl_sjtagdbg_t *)HW_DIGCTL_SJTAGDBG_ADDR)
#define HW_DIGCTL_SJTAGDBG_RD() (HW_DIGCTL_SJTAGDBG.U)
#define HW_DIGCTL_SJTAGDBG_WR(v) (HW_DIGCTL_SJTAGDBG.U = (v))
#define HW_DIGCTL_SJTAGDBG_SET(v)                                              \
    ((*(volatile reg32_t *)HW_DIGCTL_SJTAGDBG_SET_ADDR) = (v))
#define HW_DIGCTL_SJTAGDBG_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_DIGCTL_SJTAGDBG_CLR_ADDR) = (v))
#define HW_DIGCTL_SJTAGDBG_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_DIGCTL_SJTAGDBG_TOG_ADDR) = (v))
#endif
...
#define BF_DIGCTL_SJTAGDBG_SJTAG_TDO(v)                                        \
    (((v) << 10) & BM_DIGCTL_SJTAGDBG_SJTAG_TDO)
...
#define BF_DIGCTL_SJTAGDBG_SJTAG_TDI(v)                                        \
    (((v) << 9) & BM_DIGCTL_SJTAGDBG_SJTAG_TDI)
...
#define BF_DIGCTL_SJTAGDBG_SJTAG_MODE(v)                                       \
    (((v) << 8) & BM_DIGCTL_SJTAGDBG_SJTAG_MODE)
...
#define BF_DIGCTL_SJTAGDBG_SJTAG_PIN_STATE(v)                                  \
    (((v) << 2) & BM_DIGCTL_SJTAGDBG_SJTAG_PIN_STATE)
...
#define BF_DIGCTL_SJTAGDBG_SJTAG_DEBUG_DATA(v)                                 \
    (((v) << 1) & BM_DIGCTL_SJTAGDBG_SJTAG_DEBUG_DATA)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_SJTAGDBG_SJTAG_DEBUG_DATA(v)                                 \
    BF_CS1(DIGCTL_SJTAGDBG, SJTAG_DEBUG_DATA, v)
#endif
...
#define BF_DIGCTL_SJTAGDBG_SJTAG_DEBUG_OE(v)                                   \
    (((v) << 0) & BM_DIGCTL_SJTAGDBG_SJTAG_DEBUG_OE)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_SJTAGDBG_SJTAG_DEBUG_OE(v)                                   \
    BF_CS1(DIGCTL_SJTAGDBG, SJTAG_DEBUG_OE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_OCRAM_BIST_CSR                                               \
    (*(volatile hw_digctl_ocram_bist_csr_t *)HW_DIGCTL_OCRAM_BIST_CSR_ADDR)
...
#define HW_DIGCTL_OCRAM_BIST_CSR_SET(v)                                        \
    ((*(volatile reg32_t *)HW_DIGCTL_OCRAM_BIST_CSR_SET_ADDR) = (v))
#define HW_DIGCTL_OCRAM_BIST_CSR_CLR(v)                                        \
    ((*(volatile reg32_t *)HW_DIGCTL_OCRAM_BIST_CSR_CLR_ADDR) = (v))
#define HW_DIGCTL_OCRAM_BIST_CSR_TOG(v)                                        \
    ((*(volatile reg32_t *)HW_DIGCTL_OCRAM_BIST_CSR_TOG_ADDR) = (v))
#endif
...
#define BF_DIGCTL_OCRAM_BIST_CSR_BIST_DEBUG_MODE(v)                            \
    (((v) << 10) & BM_DIGCTL_OCRAM_BIST_CSR_BIST_DEBUG_MODE)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_OCRAM_BIST_CSR_BIST_DEBUG_MODE(v)                            \
    BF_CS1(DIGCTL_OCRAM_BIST_CSR, BIST_DEBUG_MODE, v)
#endif
...
#define BF_DIGCTL_OCRAM_BIST_CSR_BIST_DATA_CHANGE(v)                           \
    (((v) << 9) & BM_DIGCTL_OCRAM_BIST_CSR_BIST_DATA_CHANGE)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_OCRAM_BIST_CSR_BIST_DATA_CHANGE(v)                           \
    BF_CS1(DIGCTL_OCRAM_BIST_CSR, BIST_DATA_CHANGE, v)
#endif
...
#define BF_DIGCTL_OCRAM_BIST_CSR_BIST_CLKEN(v)                                 \
    (((v) << 8) & BM_DIGCTL_OCRAM_BIST_CSR_BIST_CLKEN)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_OCRAM_BIST_CSR_BIST_CLKEN(v)                                 \
    BF_CS1(DIGCTL_OCRAM_BIST_CSR, BIST_CLKEN, v)
#endif
...
#define BF_DIGCTL_OCRAM_BIST_CSR_FAIL(v)                                       \
    (((v) << 3) & BM_DIGCTL_OCRAM_BIST_CSR_FAIL)
...
#define BF_DIGCTL_OCRAM_BIST_CSR_PASS(v)                                       \
    (((v) << 2) & BM_DIGCTL_OCRAM_BIST_CSR_PASS)
...
#define BF_DIGCTL_OCRAM_BIST_CSR_DONE(v)                                       \
    (((v) << 1) & BM_DIGCTL_OCRAM_BIST_CSR_DONE)
...
#define BF_DIGCTL_OCRAM_BIST_CSR_START(v)                                      \
    (((v) << 0) & BM_DIGCTL_OCRAM_BIST_CSR_START)

#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_OCRAM_BIST_CSR_START(v)                                      \
    BF_CS1(DIGCTL_OCRAM_BIST_CSR, START, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_DEBUG_TRAP_ADDR_LOW                                          \
    (*(volatile hw_digctl_debug_trap_addr_low_t *)                             \
         HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_ADDR)
#define HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_RD() (HW_DIGCTL_DEBUG_TRAP_ADDR_LOW.U)
#define HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_WR(v)                                    \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_LOW.U = (v))
#define HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_SET(v)                                   \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_WR(HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_RD() | (v)))
#define HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_CLR(v)                                   \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_WR(HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_RD() &     \
                                      ~(v)))
#define HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_TOG(v)                                   \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_WR(HW_DIGCTL_DEBUG_TRAP_ADDR_LOW_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_DEBUG_TRAP_ADDR_LOW_ADDR(v)                                  \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_LOW.B.ADDR = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH                                         \
    (*(volatile hw_digctl_debug_trap_addr_high_t *)                            \
         HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_ADDR)
#define HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_RD() (HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH.U)
#define HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_WR(v)                                   \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH.U = (v))
#define HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_SET(v)                                  \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_WR(HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_RD() |   \
                                       (v)))
#define HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_CLR(v)                                  \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_WR(HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_RD() &   \
                                       ~(v)))
#define HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_TOG(v)                                  \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_WR(HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_RD() ^   \
                                       (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_DEBUG_TRAP_ADDR_HIGH_ADDR(v)                                 \
    (HW_DIGCTL_DEBUG_TRAP_ADDR_HIGH.B.ADDR = (v))
#endif
...
#define BW_DIGCTL_AHB_STATS_SELECT_L3_MASTER_SELECT(v)                         \
    BF_CS1(DIGCTL_AHB_STATS_SELECT, L3_MASTER_SELECT, v)
#endif
...
#define BW_DIGCTL_AHB_STATS_SELECT_L2_MASTER_SELECT(v)                         \
    BF_CS1(DIGCTL_AHB_STATS_SELECT, L2_MASTER_SELECT, v)
#endif
...
#define BW_DIGCTL_AHB_STATS_SELECT_L1_MASTER_SELECT(v)                         \
    BF_CS1(DIGCTL_AHB_STATS_SELECT, L1_MASTER_SELECT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_AHB_STATS_SELECT_L0_MASTER_SELECT(v)                         \
    BF_CS1(DIGCTL_AHB_STATS_SELECT, L0_MASTER_SELECT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_L0_AHB_ACTIVE_CYCLES                                         \
    (*(volatile hw_digctl_l0_ahb_active_cycles_t *)                            \
         HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_ADDR)
#define HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_RD() (HW_DIGCTL_L0_AHB_ACTIVE_CYCLES.U)
#define HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_WR(v)                                   \
    (HW_DIGCTL_L0_AHB_ACTIVE_CYCLES.U = (v))
#define HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_SET(v)                                  \
    (HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_WR(HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_RD() |   \
                                       (v)))
#define HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_CLR(v)                                  \
    (HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_WR(HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_RD() &   \
                                       ~(v)))
#define HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_TOG(v)                                  \
    (HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_WR(HW_DIGCTL_L0_AHB_ACTIVE_CYCLES_RD() ^   \
                                       (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_L0_AHB_ACTIVE_CYCLES_COUNT(v)                                \
    (HW_DIGCTL_L0_AHB_ACTIVE_CYCLES.B.COUNT = (v))
#endif

////////////////////////////////////////////////////////////////////////////////
//// HW_DIGCTL_L0_AHB_DATA_STALLED - AHB Layer 0 Performance Metric for Stalled
/// Bus Cycles Register
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_L0_AHB_DATA_STALLED                                          \
    (*(volatile hw_digctl_l0_ahb_data_stalled_t *)                             \
         HW_DIGCTL_L0_AHB_DATA_STALLED_ADDR)
#define HW_DIGCTL_L0_AHB_DATA_STALLED_RD() (HW_DIGCTL_L0_AHB_DATA_STALLED.U)
#define HW_DIGCTL_L0_AHB_DATA_STALLED_WR(v)                                    \
    (HW_DIGCTL_L0_AHB_DATA_STALLED.U = (v))
#define HW_DIGCTL_L0_AHB_DATA_STALLED_SET(v)                                   \
    (HW_DIGCTL_L0_AHB_DATA_STALLED_WR(HW_DIGCTL_L0_AHB_DATA_STALLED_RD() | (v)))
#define HW_DIGCTL_L0_AHB_DATA_STALLED_CLR(v)                                   \
    (HW_DIGCTL_L0_AHB_DATA_STALLED_WR(HW_DIGCTL_L0_AHB_DATA_STALLED_RD() &     \
                                      ~(v)))
#define HW_DIGCTL_L0_AHB_DATA_STALLED_TOG(v)                                   \
    (HW_DIGCTL_L0_AHB_DATA_STALLED_WR(HW_DIGCTL_L0_AHB_DATA_STALLED_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_L0_AHB_DATA_STALLED_COUNT(v)                                 \
    (HW_DIGCTL_L0_AHB_DATA_STALLED.B.COUNT = (v))
#endif

////////////////////////////////////////////////////////////////////////////////
//// HW_DIGCTL_L0_AHB_DATA_CYCLES - AHB Layer 0 Performance Metric for Valid Bus
/// Cycles Register
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_L0_AHB_DATA_CYCLES                                           \
    (*(volatile hw_digctl_l0_ahb_data_cycles_t *)                              \
         HW_DIGCTL_L0_AHB_DATA_CYCLES_ADDR)
#define HW_DIGCTL_L0_AHB_DATA_CYCLES_RD() (HW_DIGCTL_L0_AHB_DATA_CYCLES.U)
#define HW_DIGCTL_L0_AHB_DATA_CYCLES_WR(v)                                     \
    (HW_DIGCTL_L0_AHB_DATA_CYCLES.U = (v))
#define HW_DIGCTL_L0_AHB_DATA_CYCLES_SET(v)                                    \
    (HW_DIGCTL_L0_AHB_DATA_CYCLES_WR(HW_DIGCTL_L0_AHB_DATA_CYCLES_RD() | (v)))
#define HW_DIGCTL_L0_AHB_DATA_CYCLES_CLR(v)                                    \
    (HW_DIGCTL_L0_AHB_DATA_CYCLES_WR(HW_DIGCTL_L0_AHB_DATA_CYCLES_RD() & ~(v)))
#define HW_DIGCTL_L0_AHB_DATA_CYCLES_TOG(v)                                    \
    (HW_DIGCTL_L0_AHB_DATA_CYCLES_WR(HW_DIGCTL_L0_AHB_DATA_CYCLES_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_L0_AHB_DATA_CYCLES_COUNT(v)                                  \
    (HW_DIGCTL_L0_AHB_DATA_CYCLES.B.COUNT = (v))
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_DIGCTL_MPTEn_LOC : base 0x8001C400 : count 16
///: offset 0x10
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_DIGCTL_EMICLK_DELAY                                                 \
    (*(volatile hw_digctl_emiclk_delay_t *)HW_DIGCTL_EMICLK_DELAY_ADDR)
#define HW_DIGCTL_EMICLK_DELAY_RD() (HW_DIGCTL_EMICLK_DELAY.U)
#define HW_DIGCTL_EMICLK_DELAY_WR(v) (HW_DIGCTL_EMICLK_DELAY.U = (v))
#define HW_DIGCTL_EMICLK_DELAY_SET(v)                                          \
    (HW_DIGCTL_EMICLK_DELAY_WR(HW_DIGCTL_EMICLK_DELAY_RD() | (v)))
#define HW_DIGCTL_EMICLK_DELAY_CLR(v)                                          \
    (HW_DIGCTL_EMICLK_DELAY_WR(HW_DIGCTL_EMICLK_DELAY_RD() & ~(v)))
#define HW_DIGCTL_EMICLK_DELAY_TOG(v)                                          \
    (HW_DIGCTL_EMICLK_DELAY_WR(HW_DIGCTL_EMICLK_DELAY_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DIGCTL_EMICLK_DELAY_NUM_TAPS(v)                                     \
    BF_CS1(DIGCTL_EMICLK_DELAY, NUM_TAPS, v)
#endif
