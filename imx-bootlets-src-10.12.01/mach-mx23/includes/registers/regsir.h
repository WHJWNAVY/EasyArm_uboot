...
#define HW_IR_DBGCTRL_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_IR_DBGCTRL_SET_ADDR) = (v))
#define HW_IR_DBGCTRL_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_IR_DBGCTRL_CLR_ADDR) = (v))
#define HW_IR_DBGCTRL_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_IR_DBGCTRL_TOG_ADDR) = (v))
#endif
