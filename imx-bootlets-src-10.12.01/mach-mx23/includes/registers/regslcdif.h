...
#define HW_LCDIF_CTRL_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL_SET_ADDR) = (v))
#define HW_LCDIF_CTRL_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL_CLR_ADDR) = (v))
#define HW_LCDIF_CTRL_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL_TOG_ADDR) = (v))
#endif
...
#define BF_LCDIF_CTRL_YCBCR422_INPUT(v)                                        \
    (((v) << 29) & BM_LCDIF_CTRL_YCBCR422_INPUT)
...
#define BF_LCDIF_CTRL_WAIT_FOR_VSYNC_EDGE(v)                                   \
    (((v) << 27) & BM_LCDIF_CTRL_WAIT_FOR_VSYNC_EDGE)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_WAIT_FOR_VSYNC_EDGE(v)                                   \
    BF_CS1(LCDIF_CTRL, WAIT_FOR_VSYNC_EDGE, v)
#endif
...
#define BF_LCDIF_CTRL_DATA_SHIFT_DIR(v)                                        \
    (((v) << 26) & BM_LCDIF_CTRL_DATA_SHIFT_DIR)
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_INPUT_DATA_SWIZZLE(v)                                    \
    BF_CS1(LCDIF_CTRL, INPUT_DATA_SWIZZLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_CSC_DATA_SWIZZLE(v)                                      \
    BF_CS1(LCDIF_CTRL, CSC_DATA_SWIZZLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_LCD_DATABUS_WIDTH(v)                                     \
    BF_CS1(LCDIF_CTRL, LCD_DATABUS_WIDTH, v)
#endif
...
#define BF_LCDIF_CTRL_RGB_TO_YCBCR422_CSC(v)                                   \
    (((v) << 7) & BM_LCDIF_CTRL_RGB_TO_YCBCR422_CSC)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_RGB_TO_YCBCR422_CSC(v)                                   \
    BF_CS1(LCDIF_CTRL, RGB_TO_YCBCR422_CSC, v)
#endif
...
#define BF_LCDIF_CTRL_ENABLE_PXP_HANDSHAKE(v)                                  \
    (((v) << 6) & BM_LCDIF_CTRL_ENABLE_PXP_HANDSHAKE)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_ENABLE_PXP_HANDSHAKE(v)                                  \
    BF_CS1(LCDIF_CTRL, ENABLE_PXP_HANDSHAKE, v)
#endif
...
#define BF_LCDIF_CTRL_DMA_BURST_LENGTH(v)                                      \
    (((v) << 4) & BM_LCDIF_CTRL_DMA_BURST_LENGTH)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_DMA_BURST_LENGTH(v)                                      \
    BF_CS1(LCDIF_CTRL, DMA_BURST_LENGTH, v)
#endif
...
#define BF_LCDIF_CTRL_DATA_FORMAT_16_BIT(v)                                    \
    (((v) << 3) & BM_LCDIF_CTRL_DATA_FORMAT_16_BIT)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_DATA_FORMAT_16_BIT(v)                                    \
    BF_CS1(LCDIF_CTRL, DATA_FORMAT_16_BIT, v)
#endif
...
#define BF_LCDIF_CTRL_DATA_FORMAT_18_BIT(v)                                    \
    (((v) << 2) & BM_LCDIF_CTRL_DATA_FORMAT_18_BIT)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_DATA_FORMAT_18_BIT(v)                                    \
    BF_CS1(LCDIF_CTRL, DATA_FORMAT_18_BIT, v)
#endif
...
#define BF_LCDIF_CTRL_DATA_FORMAT_24_BIT(v)                                    \
    (((v) << 1) & BM_LCDIF_CTRL_DATA_FORMAT_24_BIT)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL_DATA_FORMAT_24_BIT(v)                                    \
    BF_CS1(LCDIF_CTRL, DATA_FORMAT_24_BIT, v)
#endif
...
#define HW_LCDIF_CTRL1_SET(v)                                                  \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL1_SET_ADDR) = (v))
#define HW_LCDIF_CTRL1_CLR(v)                                                  \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL1_CLR_ADDR) = (v))
#define HW_LCDIF_CTRL1_TOG(v)                                                  \
    ((*(volatile reg32_t *)HW_LCDIF_CTRL1_TOG_ADDR) = (v))
#endif
...
#define BF_LCDIF_CTRL1_BM_ERROR_IRQ_EN(v)                                      \
    (((v) << 26) & BM_LCDIF_CTRL1_BM_ERROR_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_BM_ERROR_IRQ_EN(v)                                      \
    BF_CS1(LCDIF_CTRL1, BM_ERROR_IRQ_EN, v)
#endif
...
#define BF_LCDIF_CTRL1_BM_ERROR_IRQ(v)                                         \
    (((v) << 25) & BM_LCDIF_CTRL1_BM_ERROR_IRQ)
...
#define BF_LCDIF_CTRL1_RECOVER_ON_UNDERFLOW(v)                                 \
    (((v) << 24) & BM_LCDIF_CTRL1_RECOVER_ON_UNDERFLOW)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_RECOVER_ON_UNDERFLOW(v)                                 \
    BF_CS1(LCDIF_CTRL1, RECOVER_ON_UNDERFLOW, v)
#endif
...
#define BF_LCDIF_CTRL1_INTERLACE_FIELDS(v)                                     \
    (((v) << 23) & BM_LCDIF_CTRL1_INTERLACE_FIELDS)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_INTERLACE_FIELDS(v)                                     \
    BF_CS1(LCDIF_CTRL1, INTERLACE_FIELDS, v)
#endif
...
#define BF_LCDIF_CTRL1_START_INTERLACE_FROM_SECOND_FIELD(v)                    \
    (((v) << 22) & BM_LCDIF_CTRL1_START_INTERLACE_FROM_SECOND_FIELD)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_START_INTERLACE_FROM_SECOND_FIELD(v)                    \
    BF_CS1(LCDIF_CTRL1, START_INTERLACE_FROM_SECOND_FIELD, v)
#endif
...
#define BF_LCDIF_CTRL1_IRQ_ON_ALTERNATE_FIELDS(v)                              \
    (((v) << 20) & BM_LCDIF_CTRL1_IRQ_ON_ALTERNATE_FIELDS)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_IRQ_ON_ALTERNATE_FIELDS(v)                              \
    BF_CS1(LCDIF_CTRL1, IRQ_ON_ALTERNATE_FIELDS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_BYTE_PACKING_FORMAT(v)                                  \
    BF_CS1(LCDIF_CTRL1, BYTE_PACKING_FORMAT, v)
#endif
...
#define BF_LCDIF_CTRL1_OVERFLOW_IRQ_EN(v)                                      \
    (((v) << 15) & BM_LCDIF_CTRL1_OVERFLOW_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_OVERFLOW_IRQ_EN(v)                                      \
    BF_CS1(LCDIF_CTRL1, OVERFLOW_IRQ_EN, v)
#endif
...
#define BF_LCDIF_CTRL1_UNDERFLOW_IRQ_EN(v)                                     \
    (((v) << 14) & BM_LCDIF_CTRL1_UNDERFLOW_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_UNDERFLOW_IRQ_EN(v)                                     \
    BF_CS1(LCDIF_CTRL1, UNDERFLOW_IRQ_EN, v)
#endif
...
#define BF_LCDIF_CTRL1_CUR_FRAME_DONE_IRQ_EN(v)                                \
    (((v) << 13) & BM_LCDIF_CTRL1_CUR_FRAME_DONE_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_CUR_FRAME_DONE_IRQ_EN(v)                                \
    BF_CS1(LCDIF_CTRL1, CUR_FRAME_DONE_IRQ_EN, v)
#endif
...
#define BF_LCDIF_CTRL1_VSYNC_EDGE_IRQ_EN(v)                                    \
    (((v) << 12) & BM_LCDIF_CTRL1_VSYNC_EDGE_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_VSYNC_EDGE_IRQ_EN(v)                                    \
    BF_CS1(LCDIF_CTRL1, VSYNC_EDGE_IRQ_EN, v)
#endif
...
#define BF_LCDIF_CTRL1_OVERFLOW_IRQ(v)                                         \
    (((v) << 11) & BM_LCDIF_CTRL1_OVERFLOW_IRQ)
...
#define BF_LCDIF_CTRL1_UNDERFLOW_IRQ(v)                                        \
    (((v) << 10) & BM_LCDIF_CTRL1_UNDERFLOW_IRQ)
...
#define BF_LCDIF_CTRL1_CUR_FRAME_DONE_IRQ(v)                                   \
    (((v) << 9) & BM_LCDIF_CTRL1_CUR_FRAME_DONE_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_CUR_FRAME_DONE_IRQ(v)                                   \
    BF_CS1(LCDIF_CTRL1, CUR_FRAME_DONE_IRQ, v)
#endif
...
#define BF_LCDIF_CTRL1_VSYNC_EDGE_IRQ(v)                                       \
    (((v) << 8) & BM_LCDIF_CTRL1_VSYNC_EDGE_IRQ)
...
#define BF_LCDIF_CTRL1_PAUSE_TRANSFER(v)                                       \
    (((v) << 6) & BM_LCDIF_CTRL1_PAUSE_TRANSFER)
...
#define BF_LCDIF_CTRL1_PAUSE_TRANSFER_IRQ_EN(v)                                \
    (((v) << 5) & BM_LCDIF_CTRL1_PAUSE_TRANSFER_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_PAUSE_TRANSFER_IRQ_EN(v)                                \
    BF_CS1(LCDIF_CTRL1, PAUSE_TRANSFER_IRQ_EN, v)
#endif
...
#define BF_LCDIF_CTRL1_PAUSE_TRANSFER_IRQ(v)                                   \
    (((v) << 4) & BM_LCDIF_CTRL1_PAUSE_TRANSFER_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CTRL1_PAUSE_TRANSFER_IRQ(v)                                   \
    BF_CS1(LCDIF_CTRL1, PAUSE_TRANSFER_IRQ, v)
#endif
...
////////////////////////////////////////////////////////////////////////////////
//// HW_LCDIF_TRANSFER_COUNT - LCDIF Horizontal and Vertical Valid Data Count
/// Register
////////////////////////////////////////////////////////////////////////////////
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_TRANSFER_COUNT                                                \
    (*(volatile hw_lcdif_transfer_count_t *)HW_LCDIF_TRANSFER_COUNT_ADDR)
...
#define HW_LCDIF_TRANSFER_COUNT_SET(v)                                         \
    (HW_LCDIF_TRANSFER_COUNT_WR(HW_LCDIF_TRANSFER_COUNT_RD() | (v)))
#define HW_LCDIF_TRANSFER_COUNT_CLR(v)                                         \
    (HW_LCDIF_TRANSFER_COUNT_WR(HW_LCDIF_TRANSFER_COUNT_RD() & ~(v)))
#define HW_LCDIF_TRANSFER_COUNT_TOG(v)                                         \
    (HW_LCDIF_TRANSFER_COUNT_WR(HW_LCDIF_TRANSFER_COUNT_RD() ^ (v)))
#endif
...
#define BF_LCDIF_TRANSFER_COUNT_V_COUNT(v)                                     \
    ((((reg32_t)v) << 16) & BM_LCDIF_TRANSFER_COUNT_V_COUNT)
#else
#define BF_LCDIF_TRANSFER_COUNT_V_COUNT(v)                                     \
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_TRANSFER_COUNT_V_COUNT(v)                                     \
    (HW_LCDIF_TRANSFER_COUNT.B.V_COUNT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_TRANSFER_COUNT_H_COUNT(v)                                     \
    (HW_LCDIF_TRANSFER_COUNT.B.H_COUNT = (v))
#endif
...
#define HW_LCDIF_CUR_BUF_SET(v)                                                \
    (HW_LCDIF_CUR_BUF_WR(HW_LCDIF_CUR_BUF_RD() | (v)))
#define HW_LCDIF_CUR_BUF_CLR(v)                                                \
    (HW_LCDIF_CUR_BUF_WR(HW_LCDIF_CUR_BUF_RD() & ~(v)))
#define HW_LCDIF_CUR_BUF_TOG(v)                                                \
    (HW_LCDIF_CUR_BUF_WR(HW_LCDIF_CUR_BUF_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_NEXT_BUF                                                      \
    (*(volatile hw_lcdif_next_buf_t *)HW_LCDIF_NEXT_BUF_ADDR)
#define HW_LCDIF_NEXT_BUF_RD() (HW_LCDIF_NEXT_BUF.U)
#define HW_LCDIF_NEXT_BUF_WR(v) (HW_LCDIF_NEXT_BUF.U = (v))
#define HW_LCDIF_NEXT_BUF_SET(v)                                               \
    (HW_LCDIF_NEXT_BUF_WR(HW_LCDIF_NEXT_BUF_RD() | (v)))
#define HW_LCDIF_NEXT_BUF_CLR(v)                                               \
    (HW_LCDIF_NEXT_BUF_WR(HW_LCDIF_NEXT_BUF_RD() & ~(v)))
#define HW_LCDIF_NEXT_BUF_TOG(v)                                               \
    (HW_LCDIF_NEXT_BUF_WR(HW_LCDIF_NEXT_BUF_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_PAGETABLE                                                     \
    (*(volatile hw_lcdif_pagetable_t *)HW_LCDIF_PAGETABLE_ADDR)
#define HW_LCDIF_PAGETABLE_RD() (HW_LCDIF_PAGETABLE.U)
#define HW_LCDIF_PAGETABLE_WR(v) (HW_LCDIF_PAGETABLE.U = (v))
#define HW_LCDIF_PAGETABLE_SET(v)                                              \
    (HW_LCDIF_PAGETABLE_WR(HW_LCDIF_PAGETABLE_RD() | (v)))
#define HW_LCDIF_PAGETABLE_CLR(v)                                              \
    (HW_LCDIF_PAGETABLE_WR(HW_LCDIF_PAGETABLE_RD() & ~(v)))
#define HW_LCDIF_PAGETABLE_TOG(v)                                              \
    (HW_LCDIF_PAGETABLE_WR(HW_LCDIF_PAGETABLE_RD() ^ (v)))
#endif
...
#define BF_LCDIF_PAGETABLE_BASE(v)                                             \
    ((((reg32_t)v) << 14) & BM_LCDIF_PAGETABLE_BASE)
#else
...
#define BF_LCDIF_TIMING_CMD_HOLD(v)                                            \
    ((((reg32_t)v) << 24) & BM_LCDIF_TIMING_CMD_HOLD)
#else
...
#define HW_LCDIF_VDCTRL0_SET(v)                                                \
    ((*(volatile reg32_t *)HW_LCDIF_VDCTRL0_SET_ADDR) = (v))
#define HW_LCDIF_VDCTRL0_CLR(v)                                                \
    ((*(volatile reg32_t *)HW_LCDIF_VDCTRL0_CLR_ADDR) = (v))
#define HW_LCDIF_VDCTRL0_TOG(v)                                                \
    ((*(volatile reg32_t *)HW_LCDIF_VDCTRL0_TOG_ADDR) = (v))
#endif
...
#define BF_LCDIF_VDCTRL0_ENABLE_PRESENT(v)                                     \
    (((v) << 28) & BM_LCDIF_VDCTRL0_ENABLE_PRESENT)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL0_ENABLE_PRESENT(v)                                     \
    BF_CS1(LCDIF_VDCTRL0, ENABLE_PRESENT, v)
#endif
...
#define BF_LCDIF_VDCTRL0_DOTCLK_POL(v)                                         \
    (((v) << 25) & BM_LCDIF_VDCTRL0_DOTCLK_POL)
...
#define BF_LCDIF_VDCTRL0_ENABLE_POL(v)                                         \
    (((v) << 24) & BM_LCDIF_VDCTRL0_ENABLE_POL)
...
#define BF_LCDIF_VDCTRL0_VSYNC_PERIOD_UNIT(v)                                  \
    (((v) << 21) & BM_LCDIF_VDCTRL0_VSYNC_PERIOD_UNIT)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL0_VSYNC_PERIOD_UNIT(v)                                  \
    BF_CS1(LCDIF_VDCTRL0, VSYNC_PERIOD_UNIT, v)
#endif
...
#define BF_LCDIF_VDCTRL0_VSYNC_PULSE_WIDTH_UNIT(v)                             \
    (((v) << 20) & BM_LCDIF_VDCTRL0_VSYNC_PULSE_WIDTH_UNIT)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL0_VSYNC_PULSE_WIDTH_UNIT(v)                             \
    BF_CS1(LCDIF_VDCTRL0, VSYNC_PULSE_WIDTH_UNIT, v)
#endif
...
#define BF_LCDIF_VDCTRL0_HALF_LINE_MODE(v)                                     \
    (((v) << 18) & BM_LCDIF_VDCTRL0_HALF_LINE_MODE)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL0_HALF_LINE_MODE(v)                                     \
    BF_CS1(LCDIF_VDCTRL0, HALF_LINE_MODE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL0_VSYNC_PULSE_WIDTH(v)                                  \
    BF_CS1(LCDIF_VDCTRL0, VSYNC_PULSE_WIDTH, v)
#endif
...
#define HW_LCDIF_VDCTRL1_SET(v)                                                \
    (HW_LCDIF_VDCTRL1_WR(HW_LCDIF_VDCTRL1_RD() | (v)))
#define HW_LCDIF_VDCTRL1_CLR(v)                                                \
    (HW_LCDIF_VDCTRL1_WR(HW_LCDIF_VDCTRL1_RD() & ~(v)))
#define HW_LCDIF_VDCTRL1_TOG(v)                                                \
    (HW_LCDIF_VDCTRL1_WR(HW_LCDIF_VDCTRL1_RD() ^ (v)))
#endif
...
#define HW_LCDIF_VDCTRL2_SET(v)                                                \
    (HW_LCDIF_VDCTRL2_WR(HW_LCDIF_VDCTRL2_RD() | (v)))
#define HW_LCDIF_VDCTRL2_CLR(v)                                                \
    (HW_LCDIF_VDCTRL2_WR(HW_LCDIF_VDCTRL2_RD() & ~(v)))
#define HW_LCDIF_VDCTRL2_TOG(v)                                                \
    (HW_LCDIF_VDCTRL2_WR(HW_LCDIF_VDCTRL2_RD() ^ (v)))
#endif
...
#define BF_LCDIF_VDCTRL2_HSYNC_PULSE_WIDTH(v)                                  \
    ((((reg32_t)v) << 24) & BM_LCDIF_VDCTRL2_HSYNC_PULSE_WIDTH)
#else
#define BF_LCDIF_VDCTRL2_HSYNC_PULSE_WIDTH(v)                                  \
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL2_HSYNC_PULSE_WIDTH(v)                                  \
    (HW_LCDIF_VDCTRL2.B.HSYNC_PULSE_WIDTH = (v))
#endif
...
#define HW_LCDIF_VDCTRL3_SET(v)                                                \
    (HW_LCDIF_VDCTRL3_WR(HW_LCDIF_VDCTRL3_RD() | (v)))
#define HW_LCDIF_VDCTRL3_CLR(v)                                                \
    (HW_LCDIF_VDCTRL3_WR(HW_LCDIF_VDCTRL3_RD() & ~(v)))
#define HW_LCDIF_VDCTRL3_TOG(v)                                                \
    (HW_LCDIF_VDCTRL3_WR(HW_LCDIF_VDCTRL3_RD() ^ (v)))
#endif
...
#define BF_LCDIF_VDCTRL3_MUX_SYNC_SIGNALS(v)                                   \
    (((v) << 29) & BM_LCDIF_VDCTRL3_MUX_SYNC_SIGNALS)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL3_MUX_SYNC_SIGNALS(v)                                   \
    BF_CS1(LCDIF_VDCTRL3, MUX_SYNC_SIGNALS, v)
#endif
...
#define BF_LCDIF_VDCTRL3_VSYNC_ONLY(v)                                         \
    (((v) << 28) & BM_LCDIF_VDCTRL3_VSYNC_ONLY)
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL3_HORIZONTAL_WAIT_CNT(v)                                \
    BF_CS1(LCDIF_VDCTRL3, HORIZONTAL_WAIT_CNT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL3_VERTICAL_WAIT_CNT(v)                                  \
    (HW_LCDIF_VDCTRL3.B.VERTICAL_WAIT_CNT = (v))
#endif
...
#define HW_LCDIF_VDCTRL4_SET(v)                                                \
    (HW_LCDIF_VDCTRL4_WR(HW_LCDIF_VDCTRL4_RD() | (v)))
#define HW_LCDIF_VDCTRL4_CLR(v)                                                \
    (HW_LCDIF_VDCTRL4_WR(HW_LCDIF_VDCTRL4_RD() & ~(v)))
#define HW_LCDIF_VDCTRL4_TOG(v)                                                \
    (HW_LCDIF_VDCTRL4_WR(HW_LCDIF_VDCTRL4_RD() ^ (v)))
#endif
...
#define BF_LCDIF_VDCTRL4_SYNC_SIGNALS_ON(v)                                    \
    (((v) << 18) & BM_LCDIF_VDCTRL4_SYNC_SIGNALS_ON)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL4_SYNC_SIGNALS_ON(v)                                    \
    BF_CS1(LCDIF_VDCTRL4, SYNC_SIGNALS_ON, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_VDCTRL4_DOTCLK_H_VALID_DATA_CNT(v)                            \
    BF_CS1(LCDIF_VDCTRL4, DOTCLK_H_VALID_DATA_CNT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_DVICTRL0                                                      \
    (*(volatile hw_lcdif_dvictrl0_t *)HW_LCDIF_DVICTRL0_ADDR)
#define HW_LCDIF_DVICTRL0_RD() (HW_LCDIF_DVICTRL0.U)
#define HW_LCDIF_DVICTRL0_WR(v) (HW_LCDIF_DVICTRL0.U = (v))
#define HW_LCDIF_DVICTRL0_SET(v)                                               \
    (HW_LCDIF_DVICTRL0_WR(HW_LCDIF_DVICTRL0_RD() | (v)))
#define HW_LCDIF_DVICTRL0_CLR(v)                                               \
    (HW_LCDIF_DVICTRL0_WR(HW_LCDIF_DVICTRL0_RD() & ~(v)))
#define HW_LCDIF_DVICTRL0_TOG(v)                                               \
    (HW_LCDIF_DVICTRL0_WR(HW_LCDIF_DVICTRL0_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_LCDIF_DVICTRL0_START_TRS(v)                                         \
    ((((reg32_t)v) << 31) & BM_LCDIF_DVICTRL0_START_TRS)
#else
#define BF_LCDIF_DVICTRL0_START_TRS(v)                                         \
    (((v) << 31) & BM_LCDIF_DVICTRL0_START_TRS)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL0_H_ACTIVE_CNT(v)                                      \
    BF_CS1(LCDIF_DVICTRL0, H_ACTIVE_CNT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL0_H_BLANKING_CNT(v)                                    \
    BF_CS1(LCDIF_DVICTRL0, H_BLANKING_CNT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_DVICTRL1                                                      \
    (*(volatile hw_lcdif_dvictrl1_t *)HW_LCDIF_DVICTRL1_ADDR)
#define HW_LCDIF_DVICTRL1_RD() (HW_LCDIF_DVICTRL1.U)
#define HW_LCDIF_DVICTRL1_WR(v) (HW_LCDIF_DVICTRL1.U = (v))
#define HW_LCDIF_DVICTRL1_SET(v)                                               \
    (HW_LCDIF_DVICTRL1_WR(HW_LCDIF_DVICTRL1_RD() | (v)))
#define HW_LCDIF_DVICTRL1_CLR(v)                                               \
    (HW_LCDIF_DVICTRL1_WR(HW_LCDIF_DVICTRL1_RD() & ~(v)))
#define HW_LCDIF_DVICTRL1_TOG(v)                                               \
    (HW_LCDIF_DVICTRL1_WR(HW_LCDIF_DVICTRL1_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL1_F1_START_LINE(v)                                     \
    BF_CS1(LCDIF_DVICTRL1, F1_START_LINE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL1_F2_START_LINE(v)                                     \
    BF_CS1(LCDIF_DVICTRL1, F2_START_LINE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_DVICTRL2                                                      \
    (*(volatile hw_lcdif_dvictrl2_t *)HW_LCDIF_DVICTRL2_ADDR)
#define HW_LCDIF_DVICTRL2_RD() (HW_LCDIF_DVICTRL2.U)
#define HW_LCDIF_DVICTRL2_WR(v) (HW_LCDIF_DVICTRL2.U = (v))
#define HW_LCDIF_DVICTRL2_SET(v)                                               \
    (HW_LCDIF_DVICTRL2_WR(HW_LCDIF_DVICTRL2_RD() | (v)))
#define HW_LCDIF_DVICTRL2_CLR(v)                                               \
    (HW_LCDIF_DVICTRL2_WR(HW_LCDIF_DVICTRL2_RD() & ~(v)))
#define HW_LCDIF_DVICTRL2_TOG(v)                                               \
    (HW_LCDIF_DVICTRL2_WR(HW_LCDIF_DVICTRL2_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL2_V1_BLANK_START_LINE(v)                               \
    BF_CS1(LCDIF_DVICTRL2, V1_BLANK_START_LINE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL2_V1_BLANK_END_LINE(v)                                 \
    BF_CS1(LCDIF_DVICTRL2, V1_BLANK_END_LINE, v)
#endif
...
#define HW_LCDIF_DVICTRL3                                                      \
    (*(volatile hw_lcdif_dvictrl3_t *)HW_LCDIF_DVICTRL3_ADDR)
#define HW_LCDIF_DVICTRL3_RD() (HW_LCDIF_DVICTRL3.U)
#define HW_LCDIF_DVICTRL3_WR(v) (HW_LCDIF_DVICTRL3.U = (v))
#define HW_LCDIF_DVICTRL3_SET(v)                                               \
    (HW_LCDIF_DVICTRL3_WR(HW_LCDIF_DVICTRL3_RD() | (v)))
#define HW_LCDIF_DVICTRL3_CLR(v)                                               \
    (HW_LCDIF_DVICTRL3_WR(HW_LCDIF_DVICTRL3_RD() & ~(v)))
#define HW_LCDIF_DVICTRL3_TOG(v)                                               \
    (HW_LCDIF_DVICTRL3_WR(HW_LCDIF_DVICTRL3_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL3_V2_BLANK_START_LINE(v)                               \
    BF_CS1(LCDIF_DVICTRL3, V2_BLANK_START_LINE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL3_V2_BLANK_END_LINE(v)                                 \
    BF_CS1(LCDIF_DVICTRL3, V2_BLANK_END_LINE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_DVICTRL4                                                      \
    (*(volatile hw_lcdif_dvictrl4_t *)HW_LCDIF_DVICTRL4_ADDR)
#define HW_LCDIF_DVICTRL4_RD() (HW_LCDIF_DVICTRL4.U)
#define HW_LCDIF_DVICTRL4_WR(v) (HW_LCDIF_DVICTRL4.U = (v))
#define HW_LCDIF_DVICTRL4_SET(v)                                               \
    (HW_LCDIF_DVICTRL4_WR(HW_LCDIF_DVICTRL4_RD() | (v)))
#define HW_LCDIF_DVICTRL4_CLR(v)                                               \
    (HW_LCDIF_DVICTRL4_WR(HW_LCDIF_DVICTRL4_RD() & ~(v)))
#define HW_LCDIF_DVICTRL4_TOG(v)                                               \
    (HW_LCDIF_DVICTRL4_WR(HW_LCDIF_DVICTRL4_RD() ^ (v)))
#endif
...
#define BF_LCDIF_DVICTRL4_Y_FILL_VALUE(v)                                      \
    ((((reg32_t)v) << 24) & BM_LCDIF_DVICTRL4_Y_FILL_VALUE)
#else
#define BF_LCDIF_DVICTRL4_Y_FILL_VALUE(v)                                      \
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL4_Y_FILL_VALUE(v)                                      \
    (HW_LCDIF_DVICTRL4.B.Y_FILL_VALUE = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL4_CB_FILL_VALUE(v)                                     \
    (HW_LCDIF_DVICTRL4.B.CB_FILL_VALUE = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_DVICTRL4_CR_FILL_VALUE(v)                                     \
    (HW_LCDIF_DVICTRL4.B.CR_FILL_VALUE = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_CSC_COEFF0                                                    \
    (*(volatile hw_lcdif_csc_coeff0_t *)HW_LCDIF_CSC_COEFF0_ADDR)
#define HW_LCDIF_CSC_COEFF0_RD() (HW_LCDIF_CSC_COEFF0.U)
#define HW_LCDIF_CSC_COEFF0_WR(v) (HW_LCDIF_CSC_COEFF0.U = (v))
#define HW_LCDIF_CSC_COEFF0_SET(v)                                             \
    (HW_LCDIF_CSC_COEFF0_WR(HW_LCDIF_CSC_COEFF0_RD() | (v)))
#define HW_LCDIF_CSC_COEFF0_CLR(v)                                             \
    (HW_LCDIF_CSC_COEFF0_WR(HW_LCDIF_CSC_COEFF0_RD() & ~(v)))
#define HW_LCDIF_CSC_COEFF0_TOG(v)                                             \
    (HW_LCDIF_CSC_COEFF0_WR(HW_LCDIF_CSC_COEFF0_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CSC_COEFF0_CSC_SUBSAMPLE_FILTER(v)                            \
    BF_CS1(LCDIF_CSC_COEFF0, CSC_SUBSAMPLE_FILTER, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_CSC_COEFF1                                                    \
    (*(volatile hw_lcdif_csc_coeff1_t *)HW_LCDIF_CSC_COEFF1_ADDR)
#define HW_LCDIF_CSC_COEFF1_RD() (HW_LCDIF_CSC_COEFF1.U)
#define HW_LCDIF_CSC_COEFF1_WR(v) (HW_LCDIF_CSC_COEFF1.U = (v))
#define HW_LCDIF_CSC_COEFF1_SET(v)                                             \
    (HW_LCDIF_CSC_COEFF1_WR(HW_LCDIF_CSC_COEFF1_RD() | (v)))
#define HW_LCDIF_CSC_COEFF1_CLR(v)                                             \
    (HW_LCDIF_CSC_COEFF1_WR(HW_LCDIF_CSC_COEFF1_RD() & ~(v)))
#define HW_LCDIF_CSC_COEFF1_TOG(v)                                             \
    (HW_LCDIF_CSC_COEFF1_WR(HW_LCDIF_CSC_COEFF1_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_CSC_COEFF2                                                    \
    (*(volatile hw_lcdif_csc_coeff2_t *)HW_LCDIF_CSC_COEFF2_ADDR)
#define HW_LCDIF_CSC_COEFF2_RD() (HW_LCDIF_CSC_COEFF2.U)
#define HW_LCDIF_CSC_COEFF2_WR(v) (HW_LCDIF_CSC_COEFF2.U = (v))
#define HW_LCDIF_CSC_COEFF2_SET(v)                                             \
    (HW_LCDIF_CSC_COEFF2_WR(HW_LCDIF_CSC_COEFF2_RD() | (v)))
#define HW_LCDIF_CSC_COEFF2_CLR(v)                                             \
    (HW_LCDIF_CSC_COEFF2_WR(HW_LCDIF_CSC_COEFF2_RD() & ~(v)))
#define HW_LCDIF_CSC_COEFF2_TOG(v)                                             \
    (HW_LCDIF_CSC_COEFF2_WR(HW_LCDIF_CSC_COEFF2_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_CSC_COEFF3                                                    \
    (*(volatile hw_lcdif_csc_coeff3_t *)HW_LCDIF_CSC_COEFF3_ADDR)
#define HW_LCDIF_CSC_COEFF3_RD() (HW_LCDIF_CSC_COEFF3.U)
#define HW_LCDIF_CSC_COEFF3_WR(v) (HW_LCDIF_CSC_COEFF3.U = (v))
#define HW_LCDIF_CSC_COEFF3_SET(v)                                             \
    (HW_LCDIF_CSC_COEFF3_WR(HW_LCDIF_CSC_COEFF3_RD() | (v)))
#define HW_LCDIF_CSC_COEFF3_CLR(v)                                             \
    (HW_LCDIF_CSC_COEFF3_WR(HW_LCDIF_CSC_COEFF3_RD() & ~(v)))
#define HW_LCDIF_CSC_COEFF3_TOG(v)                                             \
    (HW_LCDIF_CSC_COEFF3_WR(HW_LCDIF_CSC_COEFF3_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_CSC_COEFF4                                                    \
    (*(volatile hw_lcdif_csc_coeff4_t *)HW_LCDIF_CSC_COEFF4_ADDR)
#define HW_LCDIF_CSC_COEFF4_RD() (HW_LCDIF_CSC_COEFF4.U)
#define HW_LCDIF_CSC_COEFF4_WR(v) (HW_LCDIF_CSC_COEFF4.U = (v))
#define HW_LCDIF_CSC_COEFF4_SET(v)                                             \
    (HW_LCDIF_CSC_COEFF4_WR(HW_LCDIF_CSC_COEFF4_RD() | (v)))
#define HW_LCDIF_CSC_COEFF4_CLR(v)                                             \
    (HW_LCDIF_CSC_COEFF4_WR(HW_LCDIF_CSC_COEFF4_RD() & ~(v)))
#define HW_LCDIF_CSC_COEFF4_TOG(v)                                             \
    (HW_LCDIF_CSC_COEFF4_WR(HW_LCDIF_CSC_COEFF4_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_CSC_OFFSET                                                    \
    (*(volatile hw_lcdif_csc_offset_t *)HW_LCDIF_CSC_OFFSET_ADDR)
#define HW_LCDIF_CSC_OFFSET_RD() (HW_LCDIF_CSC_OFFSET.U)
#define HW_LCDIF_CSC_OFFSET_WR(v) (HW_LCDIF_CSC_OFFSET.U = (v))
#define HW_LCDIF_CSC_OFFSET_SET(v)                                             \
    (HW_LCDIF_CSC_OFFSET_WR(HW_LCDIF_CSC_OFFSET_RD() | (v)))
#define HW_LCDIF_CSC_OFFSET_CLR(v)                                             \
    (HW_LCDIF_CSC_OFFSET_WR(HW_LCDIF_CSC_OFFSET_RD() & ~(v)))
#define HW_LCDIF_CSC_OFFSET_TOG(v)                                             \
    (HW_LCDIF_CSC_OFFSET_WR(HW_LCDIF_CSC_OFFSET_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_CSC_OFFSET_CBCR_OFFSET(v)                                     \
    BF_CS1(LCDIF_CSC_OFFSET, CBCR_OFFSET, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_CSC_LIMIT                                                     \
    (*(volatile hw_lcdif_csc_limit_t *)HW_LCDIF_CSC_LIMIT_ADDR)
#define HW_LCDIF_CSC_LIMIT_RD() (HW_LCDIF_CSC_LIMIT.U)
#define HW_LCDIF_CSC_LIMIT_WR(v) (HW_LCDIF_CSC_LIMIT.U = (v))
#define HW_LCDIF_CSC_LIMIT_SET(v)                                              \
    (HW_LCDIF_CSC_LIMIT_WR(HW_LCDIF_CSC_LIMIT_RD() | (v)))
#define HW_LCDIF_CSC_LIMIT_CLR(v)                                              \
    (HW_LCDIF_CSC_LIMIT_WR(HW_LCDIF_CSC_LIMIT_RD() & ~(v)))
#define HW_LCDIF_CSC_LIMIT_TOG(v)                                              \
    (HW_LCDIF_CSC_LIMIT_WR(HW_LCDIF_CSC_LIMIT_RD() ^ (v)))
#endif
...
#define BF_LCDIF_CSC_LIMIT_CBCR_MIN(v)                                         \
    ((((reg32_t)v) << 24) & BM_LCDIF_CSC_LIMIT_CBCR_MIN)
#else
#define BF_LCDIF_CSC_LIMIT_CBCR_MIN(v)                                         \
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_PIN_SHARING_CTRL0                                             \
    (*(volatile hw_lcdif_pin_sharing_ctrl0_t *)HW_LCDIF_PIN_SHARING_CTRL0_ADDR)
...
#define HW_LCDIF_PIN_SHARING_CTRL0_SET(v)                                      \
    ((*(volatile reg32_t *)HW_LCDIF_PIN_SHARING_CTRL0_SET_ADDR) = (v))
#define HW_LCDIF_PIN_SHARING_CTRL0_CLR(v)                                      \
    ((*(volatile reg32_t *)HW_LCDIF_PIN_SHARING_CTRL0_CLR_ADDR) = (v))
#define HW_LCDIF_PIN_SHARING_CTRL0_TOG(v)                                      \
    ((*(volatile reg32_t *)HW_LCDIF_PIN_SHARING_CTRL0_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_PIN_SHARING_CTRL0_MUX_OVERRIDE(v)                             \
    BF_CS1(LCDIF_PIN_SHARING_CTRL0, MUX_OVERRIDE, v)
#endif
...
#define BF_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_IRQ_EN(v)                       \
    (((v) << 2) & BM_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_IRQ_EN(v)                       \
    BF_CS1(LCDIF_PIN_SHARING_CTRL0, PIN_SHARING_IRQ_EN, v)
#endif
...
#define BF_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_IRQ(v)                          \
    (((v) << 1) & BM_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_IRQ(v)                          \
    BF_CS1(LCDIF_PIN_SHARING_CTRL0, PIN_SHARING_IRQ, v)
#endif
...
#define BF_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_ENABLE(v)                       \
    (((v) << 0) & BM_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_ENABLE)

#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_PIN_SHARING_CTRL0_PIN_SHARING_ENABLE(v)                       \
    BF_CS1(LCDIF_PIN_SHARING_CTRL0, PIN_SHARING_ENABLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_PIN_SHARING_CTRL1                                             \
    (*(volatile hw_lcdif_pin_sharing_ctrl1_t *)HW_LCDIF_PIN_SHARING_CTRL1_ADDR)
...
#define HW_LCDIF_PIN_SHARING_CTRL1_SET(v)                                      \
    (HW_LCDIF_PIN_SHARING_CTRL1_WR(HW_LCDIF_PIN_SHARING_CTRL1_RD() | (v)))
#define HW_LCDIF_PIN_SHARING_CTRL1_CLR(v)                                      \
    (HW_LCDIF_PIN_SHARING_CTRL1_WR(HW_LCDIF_PIN_SHARING_CTRL1_RD() & ~(v)))
#define HW_LCDIF_PIN_SHARING_CTRL1_TOG(v)                                      \
    (HW_LCDIF_PIN_SHARING_CTRL1_WR(HW_LCDIF_PIN_SHARING_CTRL1_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_PIN_SHARING_CTRL1_THRESHOLD1(v)                               \
    (HW_LCDIF_PIN_SHARING_CTRL1.B.THRESHOLD1 = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_LCDIF_PIN_SHARING_CTRL2                                             \
    (*(volatile hw_lcdif_pin_sharing_ctrl2_t *)HW_LCDIF_PIN_SHARING_CTRL2_ADDR)
...
#define HW_LCDIF_PIN_SHARING_CTRL2_SET(v)                                      \
    (HW_LCDIF_PIN_SHARING_CTRL2_WR(HW_LCDIF_PIN_SHARING_CTRL2_RD() | (v)))
#define HW_LCDIF_PIN_SHARING_CTRL2_CLR(v)                                      \
    (HW_LCDIF_PIN_SHARING_CTRL2_WR(HW_LCDIF_PIN_SHARING_CTRL2_RD() & ~(v)))
#define HW_LCDIF_PIN_SHARING_CTRL2_TOG(v)                                      \
    (HW_LCDIF_PIN_SHARING_CTRL2_WR(HW_LCDIF_PIN_SHARING_CTRL2_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_LCDIF_PIN_SHARING_CTRL2_THRESHOLD2(v)                               \
    (HW_LCDIF_PIN_SHARING_CTRL2.B.THRESHOLD2 = (v))
#endif
...
#define BF_LCDIF_DATA_DATA_THREE(v)                                            \
    ((((reg32_t)v) << 24) & BM_LCDIF_DATA_DATA_THREE)
#else
...
#define HW_LCDIF_BM_ERROR_STAT                                                 \
    (*(volatile hw_lcdif_bm_error_stat_t *)HW_LCDIF_BM_ERROR_STAT_ADDR)
#define HW_LCDIF_BM_ERROR_STAT_RD() (HW_LCDIF_BM_ERROR_STAT.U)
#define HW_LCDIF_BM_ERROR_STAT_WR(v) (HW_LCDIF_BM_ERROR_STAT.U = (v))
#define HW_LCDIF_BM_ERROR_STAT_SET(v)                                          \
    (HW_LCDIF_BM_ERROR_STAT_WR(HW_LCDIF_BM_ERROR_STAT_RD() | (v)))
#define HW_LCDIF_BM_ERROR_STAT_CLR(v)                                          \
    (HW_LCDIF_BM_ERROR_STAT_WR(HW_LCDIF_BM_ERROR_STAT_RD() & ~(v)))
#define HW_LCDIF_BM_ERROR_STAT_TOG(v)                                          \
    (HW_LCDIF_BM_ERROR_STAT_WR(HW_LCDIF_BM_ERROR_STAT_RD() ^ (v)))
#endif
...
#define BF_LCDIF_STAT_DVI_CURRENT_FIELD(v)                                     \
    (((v) << 24) & BM_LCDIF_STAT_DVI_CURRENT_FIELD)
...
#define BF_LCDIF_VERSION_MAJOR(v)                                              \
    ((((reg32_t)v) << 24) & BM_LCDIF_VERSION_MAJOR)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_LCDIF_DEBUG0_STREAMING_END_DETECTED(v)                              \
    ((((reg32_t)v) << 31) & BM_LCDIF_DEBUG0_STREAMING_END_DETECTED)
#else
#define BF_LCDIF_DEBUG0_STREAMING_END_DETECTED(v)                              \
    (((v) << 31) & BM_LCDIF_DEBUG0_STREAMING_END_DETECTED)
#endif
...
#define BF_LCDIF_DEBUG0_WAIT_FOR_VSYNC_EDGE_OUT(v)                             \
    (((v) << 30) & BM_LCDIF_DEBUG0_WAIT_FOR_VSYNC_EDGE_OUT)
...
#define BF_LCDIF_DEBUG0_SYNC_SIGNALS_ON_REG(v)                                 \
    (((v) << 29) & BM_LCDIF_DEBUG0_SYNC_SIGNALS_ON_REG)
...
#define BF_LCDIF_DEBUG0_CUR_FRAME_TX(v)                                        \
    (((v) << 24) & BM_LCDIF_DEBUG0_CUR_FRAME_TX)
...
#define BF_LCDIF_DEBUG0_PXP_LCDIF_B0_READY(v)                                  \
    (((v) << 15) & BM_LCDIF_DEBUG0_PXP_LCDIF_B0_READY)
...
#define BF_LCDIF_DEBUG0_LCDIF_PXP_B0_DONE(v)                                   \
    (((v) << 14) & BM_LCDIF_DEBUG0_LCDIF_PXP_B0_DONE)
...
#define BF_LCDIF_DEBUG0_PXP_LCDIF_B1_READY(v)                                  \
    (((v) << 13) & BM_LCDIF_DEBUG0_PXP_LCDIF_B1_READY)
...
#define BF_LCDIF_DEBUG0_LCDIF_PXP_B1_DONE(v)                                   \
    (((v) << 12) & BM_LCDIF_DEBUG0_LCDIF_PXP_B1_DONE)
...
#define BF_LCDIF_DEBUG0_GPMI_LCDIF_REQ(v)                                      \
    (((v) << 11) & BM_LCDIF_DEBUG0_GPMI_LCDIF_REQ)
...
#define BF_LCDIF_DEBUG0_LCDIF_GPMI_GRANT(v)                                    \
    (((v) << 10) & BM_LCDIF_DEBUG0_LCDIF_GPMI_GRANT)
...
#define BF_LCDIF_DEBUG1_H_DATA_COUNT(v)                                        \
    ((((reg32_t)v) << 16) & BM_LCDIF_DEBUG1_H_DATA_COUNT)
#else
#define BF_LCDIF_DEBUG1_H_DATA_COUNT(v)                                        \
