...
////////////////////////////////////////////////////////////////////////////////
//// multi-register-define name HW_SIMMEMSEL_CHANn_CFG : base 0x8003C070 : count
/// 2 : offset 0x4
////////////////////////////////////////////////////////////////////////////////
...
#define HW_SIMMEMSEL_CHANn_CFG_ADDR(n)                                         \
    (REGS_SIMMEMSEL_BASE + 0x00000000 + ((n)*0x4))

#ifndef __LANGUAGE_ASM__
#define HW_SIMMEMSEL_CHANn_CFG(n)                                              \
    (*(volatile hw_simmemsel_chann_cfg_t *)HW_SIMMEMSEL_CHANn_CFG_ADDR(n))
...
#define HW_SIMMEMSEL_CHANn_CFG_SET(n, v)                                       \
    (HW_SIMMEMSEL_CHANn_CFG_WR(n, HW_SIMMEMSEL_CHANn_CFG_RD(n) | (v)))
#define HW_SIMMEMSEL_CHANn_CFG_CLR(n, v)                                       \
    (HW_SIMMEMSEL_CHANn_CFG_WR(n, HW_SIMMEMSEL_CHANn_CFG_RD(n) & ~(v)))
#define HW_SIMMEMSEL_CHANn_CFG_TOG(n, v)                                       \
    (HW_SIMMEMSEL_CHANn_CFG_WR(n, HW_SIMMEMSEL_CHANn_CFG_RD(n) ^ (v)))
#endif

//
// constants & macros for individual HW_SIMMEMSEL_CHANn_CFG multi-register
// bitfields
//
...
#ifndef __LANGUAGE_ASM__
#define BF_SIMMEMSEL_CHANn_CFG_WIDTH(v)                                        \
    ((((reg32_t)v) << 24) & BM_SIMMEMSEL_CHANn_CFG_WIDTH)
#else
#define BF_SIMMEMSEL_CHANn_CFG_WIDTH(v)                                        \
    (((v) << 24) & BM_SIMMEMSEL_CHANn_CFG_WIDTH)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_SIMMEMSEL_CHANn_CFG_WIDTH(n, v)                                     \
    (HW_SIMMEMSEL_CHANn_CFG(n).B.WIDTH = (v))
#endif
...
#define BF_SIMMEMSEL_CHANn_CFG_CE_SRC(v)                                       \
    (((v) << 20) & BM_SIMMEMSEL_CHANn_CFG_CE_SRC)

#ifndef __LANGUAGE_ASM__
#define BW_SIMMEMSEL_CHANn_CFG_CE_SRC(n, v)                                    \
    BF_CS1n(SIMMEMSEL_CHANn_CFG, n, CE_SRC, v)
#endif
...
#define BF_SIMMEMSEL_CHANn_CFG_DEV_CLASS(v)                                    \
    (((v) << 16) & BM_SIMMEMSEL_CHANn_CFG_DEV_CLASS)

#ifndef __LANGUAGE_ASM__
#define BW_SIMMEMSEL_CHANn_CFG_DEV_CLASS(n, v)                                 \
    BF_CS1n(SIMMEMSEL_CHANn_CFG, n, DEV_CLASS, v)
#endif
...
#define BF_SIMMEMSEL_CHANn_CFG_DEV_CODE(v)                                     \
    (((v) << 0) & BM_SIMMEMSEL_CHANn_CFG_DEV_CODE)

#ifndef __LANGUAGE_ASM__
#define BW_SIMMEMSEL_CHANn_CFG_DEV_CODE(n, v)                                  \
    (HW_SIMMEMSEL_CHANn_CFG(n).B.DEV_CODE = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_OLD_SIMMEMSEL_REG                                                   \
    (*(volatile hw_old_simmemsel_reg_t *)HW_OLD_SIMMEMSEL_REG_ADDR)
