...
#define HW_SYDMA_CTRL_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_SYDMA_CTRL_SET_ADDR) = (v))
#define HW_SYDMA_CTRL_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_SYDMA_CTRL_CLR_ADDR) = (v))
#define HW_SYDMA_CTRL_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_SYDMA_CTRL_TOG_ADDR) = (v))
#endif
...
#define BF_SYDMA_CTRL_COMPLETE_IRQ_EN(v)                                       \
    (((v) << 9) & BM_SYDMA_CTRL_COMPLETE_IRQ_EN)
...
#ifndef __LANGUAGE_ASM__
#define HW_SYDMA_XFER_COUNT                                                    \
    (*(volatile hw_sydma_xfer_count_t *)HW_SYDMA_XFER_COUNT_ADDR)
#define HW_SYDMA_XFER_COUNT_RD() (HW_SYDMA_XFER_COUNT.U)
#define HW_SYDMA_XFER_COUNT_WR(v) (HW_SYDMA_XFER_COUNT.U = (v))
#define HW_SYDMA_XFER_COUNT_SET(v)                                             \
    (HW_SYDMA_XFER_COUNT_WR(HW_SYDMA_XFER_COUNT_RD() | (v)))
#define HW_SYDMA_XFER_COUNT_CLR(v)                                             \
    (HW_SYDMA_XFER_COUNT_WR(HW_SYDMA_XFER_COUNT_RD() & ~(v)))
#define HW_SYDMA_XFER_COUNT_TOG(v)                                             \
    (HW_SYDMA_XFER_COUNT_WR(HW_SYDMA_XFER_COUNT_RD() ^ (v)))
#endif
...
#define BF_SYDMA_VERSION_MAJOR(v)                                              \
    ((((reg32_t)v) << 24) & BM_SYDMA_VERSION_MAJOR)
#else
