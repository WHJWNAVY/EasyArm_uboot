 ...
 */
*********************************************************************************WARNING
    : THIS FILE IS AUTOMATICALLY GENERATED FROM XML *DO NOT MODIFY THIS FILE
          DIRECTLY.*
    TO REGENERATE,
    CD TO : piano / chip / scripts AND RUN :./
            build_io_map *PLEASE ALSO CHECK IN THE MATCHING piano / chip /
            include /
            chip_io_map.h FILE *************************************************
                ****************************** /
