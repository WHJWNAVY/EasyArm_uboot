...
#ifndef __LANGUAGE_ASM__
#define HW_CLKCTRL_PLLCTRL0                                                    \
    (*(volatile hw_clkctrl_pllctrl0_t *)HW_CLKCTRL_PLLCTRL0_ADDR)
#define HW_CLKCTRL_PLLCTRL0_RD() (HW_CLKCTRL_PLLCTRL0.U)
#define HW_CLKCTRL_PLLCTRL0_WR(v) (HW_CLKCTRL_PLLCTRL0.U = (v))
#define HW_CLKCTRL_PLLCTRL0_SET(v)                                             \
    ((*(volatile reg32_t *)HW_CLKCTRL_PLLCTRL0_SET_ADDR) = (v))
#define HW_CLKCTRL_PLLCTRL0_CLR(v)                                             \
    ((*(volatile reg32_t *)HW_CLKCTRL_PLLCTRL0_CLR_ADDR) = (v))
#define HW_CLKCTRL_PLLCTRL0_TOG(v)                                             \
    ((*(volatile reg32_t *)HW_CLKCTRL_PLLCTRL0_TOG_ADDR) = (v))
#endif
...
#define BF_CLKCTRL_PLLCTRL0_EN_USB_CLKS(v)                                     \
    (((v) << 18) & BM_CLKCTRL_PLLCTRL0_EN_USB_CLKS)

#ifndef __LANGUAGE_ASM__
#define BW_CLKCTRL_PLLCTRL0_EN_USB_CLKS(v)                                     \
    BF_CS1(CLKCTRL_PLLCTRL0, EN_USB_CLKS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_CLKCTRL_PLLCTRL1                                                    \
    (*(volatile hw_clkctrl_pllctrl1_t *)HW_CLKCTRL_PLLCTRL1_ADDR)
#define HW_CLKCTRL_PLLCTRL1_RD() (HW_CLKCTRL_PLLCTRL1.U)
#define HW_CLKCTRL_PLLCTRL1_WR(v) (HW_CLKCTRL_PLLCTRL1.U = (v))
#define HW_CLKCTRL_PLLCTRL1_SET(v)                                             \
    (HW_CLKCTRL_PLLCTRL1_WR(HW_CLKCTRL_PLLCTRL1_RD() | (v)))
#define HW_CLKCTRL_PLLCTRL1_CLR(v)                                             \
    (HW_CLKCTRL_PLLCTRL1_WR(HW_CLKCTRL_PLLCTRL1_RD() & ~(v)))
#define HW_CLKCTRL_PLLCTRL1_TOG(v)                                             \
    (HW_CLKCTRL_PLLCTRL1_WR(HW_CLKCTRL_PLLCTRL1_RD() ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_CLKCTRL_PLLCTRL1_LOCK(v)                                            \
    ((((reg32_t)v) << 31) & BM_CLKCTRL_PLLCTRL1_LOCK)
#else
...
#define BF_CLKCTRL_PLLCTRL1_FORCE_LOCK(v)                                      \
    (((v) << 30) & BM_CLKCTRL_PLLCTRL1_FORCE_LOCK)

#ifndef __LANGUAGE_ASM__
#define BW_CLKCTRL_PLLCTRL1_FORCE_LOCK(v)                                      \
    BF_CS1(CLKCTRL_PLLCTRL1, FORCE_LOCK, v)
#endif
...
#define BF_CLKCTRL_HBUS_DCP_AS_ENABLE(v)                                       \
    (((v) << 28) & BM_CLKCTRL_HBUS_DCP_AS_ENABLE)
...
#define BF_CLKCTRL_HBUS_PXP_AS_ENABLE(v)                                       \
    (((v) << 27) & BM_CLKCTRL_HBUS_PXP_AS_ENABLE)
...
#define BF_CLKCTRL_HBUS_AUTO_SLOW_MODE(v)                                      \
    (((v) << 20) & BM_CLKCTRL_HBUS_AUTO_SLOW_MODE)

#ifndef __LANGUAGE_ASM__
#define BW_CLKCTRL_HBUS_AUTO_SLOW_MODE(v)                                      \
    BF_CS1(CLKCTRL_HBUS, AUTO_SLOW_MODE, v)
#endif
...
#define BF_CLKCTRL_XTAL_FILT_CLK24M_GATE(v)                                    \
    (((v) << 30) & BM_CLKCTRL_XTAL_FILT_CLK24M_GATE)

#ifndef __LANGUAGE_ASM__
#define BW_CLKCTRL_XTAL_FILT_CLK24M_GATE(v)                                    \
    BF_CS1(CLKCTRL_XTAL, FILT_CLK24M_GATE, v)
#endif
...
#define BF_CLKCTRL_XTAL_DRI_CLK24M_GATE(v)                                     \
    (((v) << 28) & BM_CLKCTRL_XTAL_DRI_CLK24M_GATE)

#ifndef __LANGUAGE_ASM__
#define BW_CLKCTRL_XTAL_DRI_CLK24M_GATE(v)                                     \
    BF_CS1(CLKCTRL_XTAL, DRI_CLK24M_GATE, v)
#endif
...
#define BF_CLKCTRL_XTAL_DIGCTRL_CLK1M_GATE(v)                                  \
    (((v) << 27) & BM_CLKCTRL_XTAL_DIGCTRL_CLK1M_GATE)

#ifndef __LANGUAGE_ASM__
#define BW_CLKCTRL_XTAL_DIGCTRL_CLK1M_GATE(v)                                  \
    BF_CS1(CLKCTRL_XTAL, DIGCTRL_CLK1M_GATE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_CLKCTRL_PIX_CLKGATE(v)                                              \
    ((((reg32_t)v) << 31) & BM_CLKCTRL_PIX_CLKGATE)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_CLKCTRL_SSP_CLKGATE(v)                                              \
    ((((reg32_t)v) << 31) & BM_CLKCTRL_SSP_CLKGATE)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_CLKCTRL_SAIF_CLKGATE(v)                                             \
    ((((reg32_t)v) << 31) & BM_CLKCTRL_SAIF_CLKGATE)
#else
...
#define BF_CLKCTRL_SAIF_DIV_FRAC_EN(v)                                         \
    (((v) << 16) & BM_CLKCTRL_SAIF_DIV_FRAC_EN)
...
#ifndef __LANGUAGE_ASM__
#define BF_CLKCTRL_TV_CLK_TV108M_GATE(v)                                       \
    ((((reg32_t)v) << 31) & BM_CLKCTRL_TV_CLK_TV108M_GATE)
#else
#define BF_CLKCTRL_TV_CLK_TV108M_GATE(v)                                       \
    (((v) << 31) & BM_CLKCTRL_TV_CLK_TV108M_GATE)
#endif
...
#define HW_CLKCTRL_FRAC_SET(v)                                                 \
    ((*(volatile reg32_t *)HW_CLKCTRL_FRAC_SET_ADDR) = (v))
#define HW_CLKCTRL_FRAC_CLR(v)                                                 \
    ((*(volatile reg32_t *)HW_CLKCTRL_FRAC_CLR_ADDR) = (v))
#define HW_CLKCTRL_FRAC_TOG(v)                                                 \
    ((*(volatile reg32_t *)HW_CLKCTRL_FRAC_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_CLKCTRL_FRAC_CLKGATEIO(v)                                           \
    ((((reg32_t)v) << 31) & BM_CLKCTRL_FRAC_CLKGATEIO)
#else
...
#ifndef __LANGUAGE_ASM__
#define BF_CLKCTRL_FRAC1_CLKGATEVID(v)                                         \
    ((((reg32_t)v) << 31) & BM_CLKCTRL_FRAC1_CLKGATEVID)
#else
#define BF_CLKCTRL_FRAC1_CLKGATEVID(v)                                         \
    (((v) << 31) & BM_CLKCTRL_FRAC1_CLKGATEVID)
#endif
...
#define BF_CLKCTRL_FRAC1_VID_STABLE(v)                                         \
    (((v) << 30) & BM_CLKCTRL_FRAC1_VID_STABLE)
...
#define BF_CLKCTRL_CLKSEQ_BYPASS_CPU(v)                                        \
    (((v) << 7) & BM_CLKCTRL_CLKSEQ_BYPASS_CPU)
...
#define BF_CLKCTRL_CLKSEQ_BYPASS_EMI(v)                                        \
    (((v) << 6) & BM_CLKCTRL_CLKSEQ_BYPASS_EMI)
...
#define BF_CLKCTRL_CLKSEQ_BYPASS_SSP(v)                                        \
    (((v) << 5) & BM_CLKCTRL_CLKSEQ_BYPASS_SSP)
...
#define BF_CLKCTRL_CLKSEQ_BYPASS_GPMI(v)                                       \
    (((v) << 4) & BM_CLKCTRL_CLKSEQ_BYPASS_GPMI)
...
#define BF_CLKCTRL_CLKSEQ_BYPASS_IR(v)                                         \
    (((v) << 3) & BM_CLKCTRL_CLKSEQ_BYPASS_IR)
...
#define BF_CLKCTRL_CLKSEQ_BYPASS_PIX(v)                                        \
    (((v) << 1) & BM_CLKCTRL_CLKSEQ_BYPASS_PIX)
...
#define BF_CLKCTRL_CLKSEQ_BYPASS_SAIF(v)                                       \
    (((v) << 0) & BM_CLKCTRL_CLKSEQ_BYPASS_SAIF)
