...
#define REGS_UARTAPP_BASE(x)                                                   \
    (x == 1 ? REGS_UARTAPP1_BASE : x == 2 ? REGS_UARTAPP2_BASE : 0xffff0000)
//#endif
...
#define BW_UARTAPP_CTRL0_RXTO_ENABLE(n, v)                                     \
    BF_CS1(UARTAPP_CTRL0, n, RXTO_ENABLE, v)
#endif
...
#define BW_UARTAPP_CTRL2_INVERT_RTS(n, v)                                      \
    BF_CS1(UARTAPP_CTRL2, n, INVERT_RTS, v)
#endif
...
#define BW_UARTAPP_CTRL2_INVERT_CTS(n, v)                                      \
    BF_CS1(UARTAPP_CTRL2, n, INVERT_CTS, v)
#endif
...
#define BW_UARTAPP_CTRL2_RTS_SEMAPHORE(n, v)                                   \
    BF_CS1(UARTAPP_CTRL2, n, RTS_SEMAPHORE, v)
#endif
...
#define BW_UARTAPP_LINECTRL_BAUD_DIVFRAC(n, v)                                 \
    BF_CS1(UARTAPP_LINECTRL, n, BAUD_DIVFRAC, v)
#endif
...
#define BW_UARTAPP_LINECTRL2_BAUD_DIVFRAC(n, v)                                \
    BF_CS1(UARTAPP_LINECTRL2, n, BAUD_DIVFRAC, v)
#endif
...
#define BW_UARTAPP_STAT_RXBYTE_INVALID(n, v)                                   \
    BF_CS1(UARTAPP_STAT, n, RXBYTE_INVALID, v)
#endif
...
#define BW_UARTAPP_AUTOBAUD_UPDATE_TX(n, v)                                    \
    BF_CS1(UARTAPP_AUTOBAUD, n, UPDATE_TX, v)
#endif
...
#define BW_UARTAPP_AUTOBAUD_TWO_REF_CHARS(n, v)                                \
    BF_CS1(UARTAPP_AUTOBAUD, n, TWO_REF_CHARS, v)
#endif
...
#define BW_UARTAPP_AUTOBAUD_START_WITH_RUNBIT(n, v)                            \
    BF_CS1(UARTAPP_AUTOBAUD, n, START_WITH_RUNBIT, v)
#endif
...
#define BW_UARTAPP_AUTOBAUD_START_BAUD_DETECT(n, v)                            \
    BF_CS1(UARTAPP_AUTOBAUD, n, START_BAUD_DETECT, v)
#endif
...
#define BW_UARTAPP_AUTOBAUD_BAUD_DETECT_ENABLE(n, v)                           \
    BF_CS1(UARTAPP_AUTOBAUD, n, BAUD_DETECT_ENABLE, v)
#endif
