...
#define BF_LRADC_CTRL0_SCHEDULE(v)                                             \
    (((v) << BP_LRADC_CTRL0_SCHEDULE) & BM_LRADC_CTRL0_SCHEDULE)
...
#define BF_LRADC_CTRL2_DIVIDE_BY_TWO(v)                                        \
    (((v) << BP_LRADC_CTRL2_DIVIDE_BY_TWO) & BM_LRADC_CTRL2_DIVIDE_BY_TWO)
...
#define BF_LRADC_CTRL2_BL_BRIGHTNESS(v)                                        \
    (((v) << BP_LRADC_CTRL2_BL_BRIGHTNESS) & BM_LRADC_CTRL2_BL_BRIGHTNESS)
...
#define BF_LRADC_CTRL3_CYCLE_TIME(v)                                           \
    (((v) << BP_LRADC_CTRL3_CYCLE_TIME) & BM_LRADC_CTRL3_CYCLE_TIME)
...
#define BF_LRADC_CHn_NUM_SAMPLES(v)                                            \
    (((v) << BP_LRADC_CHn_NUM_SAMPLES) & BM_LRADC_CHn_NUM_SAMPLES)
...
#define BF_LRADC_DELAYn_TRIGGER_DELAYS(v)                                      \
    (((v) << BP_LRADC_DELAYn_TRIGGER_DELAYS) & BM_LRADC_DELAYn_TRIGGER_DELAYS)
...
#define BF_LRADC_DELAYn_TRIGGER_LRADCS(v)                                      \
    (((v) << BP_LRADC_DELAYn_TRIGGER_LRADCS) & BM_LRADC_DELAYn_TRIGGER_LRADCS)
...
#define BF_LRADC_CONVERSION_SCALE_FACTOR(v)                                    \
    (((v) << BP_LRADC_CONVERSION_SCALE_FACTOR) &                               \
     BM_LRADC_CONVERSION_SCALE_FACTOR)
