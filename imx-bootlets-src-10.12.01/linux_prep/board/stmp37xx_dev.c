 ...
 ************************************************/
char cmdline_def[] = "gpmi=g console=ttyAM0,115200n8  ubi.mtd=1 root=ubi0:rootfs rootfstype=ubifs ip=192.168.12.180:192.168.12.48:192.68.12.1:255.255.255.0::eht0: fec_mac= ethact";
