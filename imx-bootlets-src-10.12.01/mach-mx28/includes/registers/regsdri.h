...
#define BF_DRI_CTRL_STOP_ON_OFLOW_ERROR(v)                                     \
    (((v) << 26) & BM_DRI_CTRL_STOP_ON_OFLOW_ERROR)

#ifndef __LANGUAGE_ASM__
#define BW_DRI_CTRL_STOP_ON_OFLOW_ERROR(v)                                     \
    BF_CS1(DRI_CTRL, STOP_ON_OFLOW_ERROR, v)
#endif
...
#define BF_DRI_CTRL_STOP_ON_PILOT_ERROR(v)                                     \
    (((v) << 25) & BM_DRI_CTRL_STOP_ON_PILOT_ERROR)

#ifndef __LANGUAGE_ASM__
#define BW_DRI_CTRL_STOP_ON_PILOT_ERROR(v)                                     \
    BF_CS1(DRI_CTRL, STOP_ON_PILOT_ERROR, v)
#endif
...
#define BF_DRI_CTRL_REACQUIRE_PHASE(v)                                         \
    (((v) << 15) & BM_DRI_CTRL_REACQUIRE_PHASE)
...
#define BF_DRI_CTRL_OVERFLOW_IRQ_EN(v)                                         \
    (((v) << 11) & BM_DRI_CTRL_OVERFLOW_IRQ_EN)
...
#define BF_DRI_CTRL_PILOT_SYNC_LOSS_IRQ_EN(v)                                  \
    (((v) << 10) & BM_DRI_CTRL_PILOT_SYNC_LOSS_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_DRI_CTRL_PILOT_SYNC_LOSS_IRQ_EN(v)                                  \
    BF_CS1(DRI_CTRL, PILOT_SYNC_LOSS_IRQ_EN, v)
#endif
...
#define BF_DRI_CTRL_ATTENTION_IRQ_EN(v)                                        \
    (((v) << 9) & BM_DRI_CTRL_ATTENTION_IRQ_EN)
...
#define BF_DRI_CTRL_PILOT_SYNC_LOSS_IRQ(v)                                     \
    (((v) << 2) & BM_DRI_CTRL_PILOT_SYNC_LOSS_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_DRI_CTRL_PILOT_SYNC_LOSS_IRQ(v)                                     \
    BF_CS1(DRI_CTRL, PILOT_SYNC_LOSS_IRQ, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_DRI_TIMING_GAP_DETECTION_INTERVAL(v)                                \
    (HW_DRI_TIMING.B.GAP_DETECTION_INTERVAL = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_DRI_STAT_DRI_PRESENT(v)                                             \
    ((((reg32_t)v) << 31) & BM_DRI_STAT_DRI_PRESENT)
#else
...
#define BF_DRI_STAT_OVERFLOW_IRQ_SUMMARY(v)                                    \
    (((v) << 3) & BM_DRI_STAT_OVERFLOW_IRQ_SUMMARY)
...
#define BF_DRI_STAT_PILOT_SYNC_LOSS_IRQ_SUMMARY(v)                             \
    (((v) << 2) & BM_DRI_STAT_PILOT_SYNC_LOSS_IRQ_SUMMARY)
...
#define BF_DRI_STAT_ATTENTION_IRQ_SUMMARY(v)                                   \
    (((v) << 1) & BM_DRI_STAT_ATTENTION_IRQ_SUMMARY)
...
#define HW_DRI_DEBUG0_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_DRI_DEBUG0_SET_ADDR) = (v))
#define HW_DRI_DEBUG0_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_DRI_DEBUG0_CLR_ADDR) = (v))
#define HW_DRI_DEBUG0_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_DRI_DEBUG0_TOG_ADDR) = (v))
#endif
...
#define BF_DRI_DEBUG0_DRI_CLK_INPUT(v)                                         \
    (((v) << 29) & BM_DRI_DEBUG0_DRI_CLK_INPUT)
...
#define BF_DRI_DEBUG0_DRI_DATA_INPUT(v)                                        \
    (((v) << 28) & BM_DRI_DEBUG0_DRI_DATA_INPUT)
...
#define BF_DRI_DEBUG0_PILOT_REP_RATE(v)                                        \
    (((v) << 26) & BM_DRI_DEBUG0_PILOT_REP_RATE)
...
#define HW_DRI_DEBUG1_SET(v)                                                   \
    ((*(volatile reg32_t *)HW_DRI_DEBUG1_SET_ADDR) = (v))
#define HW_DRI_DEBUG1_CLR(v)                                                   \
    ((*(volatile reg32_t *)HW_DRI_DEBUG1_CLR_ADDR) = (v))
#define HW_DRI_DEBUG1_TOG(v)                                                   \
    ((*(volatile reg32_t *)HW_DRI_DEBUG1_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_DRI_DEBUG1_INVERT_PILOT(v)                                          \
    ((((reg32_t)v) << 31) & BM_DRI_DEBUG1_INVERT_PILOT)
#else
...
#define BF_DRI_DEBUG1_INVERT_ATTENTION(v)                                      \
    (((v) << 30) & BM_DRI_DEBUG1_INVERT_ATTENTION)

#ifndef __LANGUAGE_ASM__
#define BW_DRI_DEBUG1_INVERT_ATTENTION(v)                                      \
    BF_CS1(DRI_DEBUG1, INVERT_ATTENTION, v)
#endif
...
#define BF_DRI_DEBUG1_INVERT_DRI_DATA(v)                                       \
    (((v) << 29) & BM_DRI_DEBUG1_INVERT_DRI_DATA)
...
#define BF_DRI_DEBUG1_INVERT_DRI_CLOCK(v)                                      \
    (((v) << 28) & BM_DRI_DEBUG1_INVERT_DRI_CLOCK)

#ifndef __LANGUAGE_ASM__
#define BW_DRI_DEBUG1_INVERT_DRI_CLOCK(v)                                      \
    BF_CS1(DRI_DEBUG1, INVERT_DRI_CLOCK, v)
#endif
...
#define BF_DRI_DEBUG1_REVERSE_FRAME(v)                                         \
    (((v) << 27) & BM_DRI_DEBUG1_REVERSE_FRAME)
