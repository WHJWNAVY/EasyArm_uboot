...
#define REGS_USBCTRL_BASE(x)                                                   \
    (x == 0 ? REGS_USBCTRL0_BASE : x == 1 ? REGS_USBCTRL1_BASE : 0xffff0000)
#endif
...
#define BF_USBCTRL_ID_CIVERSION(v)                                             \
    ((((reg32_t)v) << 29) & BM_USBCTRL_ID_CIVERSION)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_HWGENERAL(x)                                                \
    (*(volatile hw_usbctrl_hwgeneral_t *)HW_USBCTRL_HWGENERAL_ADDR(x))
...
#define BF_USBCTRL_HWGENERAL_RSVD(v)                                           \
    ((((reg32_t)v) << 11) & BM_USBCTRL_HWGENERAL_RSVD)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_HWHOST(x)                                                   \
    (*(volatile hw_usbctrl_hwhost_t *)HW_USBCTRL_HWHOST_ADDR(x))
...
#define BF_USBCTRL_HWHOST_TTPER(v)                                             \
    ((((reg32_t)v) << 24) & BM_USBCTRL_HWHOST_TTPER)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_HWDEVICE(x)                                                 \
    (*(volatile hw_usbctrl_hwdevice_t *)HW_USBCTRL_HWDEVICE_ADDR(x))
...
#define BF_USBCTRL_HWDEVICE_RSVD(v)                                            \
    ((((reg32_t)v) << 6) & BM_USBCTRL_HWDEVICE_RSVD)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_HWTXBUF(x)                                                  \
    (*(volatile hw_usbctrl_hwtxbuf_t *)HW_USBCTRL_HWTXBUF_ADDR(x))
...
#ifndef __LANGUAGE_ASM__
#define BF_USBCTRL_HWTXBUF_TXLCR(v)                                            \
    ((((reg32_t)v) << 31) & BM_USBCTRL_HWTXBUF_TXLCR)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_HWRXBUF(x)                                                  \
    (*(volatile hw_usbctrl_hwrxbuf_t *)HW_USBCTRL_HWRXBUF_ADDR(x))
...
#define BF_USBCTRL_HWRXBUF_RSVD(v)                                             \
    ((((reg32_t)v) << 16) & BM_USBCTRL_HWRXBUF_RSVD)
#else
...
/*
 * HW_USBCTRL_GPTIMER0LD - General-Purpose Timer 0 Load (Non-EHCI-Compliant)
 * Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_GPTIMER0LD(x)                                               \
    (*(volatile hw_usbctrl_gptimer0ld_t *)HW_USBCTRL_GPTIMER0LD_ADDR(x))
...
#define HW_USBCTRL_GPTIMER0LD_SET(x, v)                                        \
    (HW_USBCTRL_GPTIMER0LD_WR(x, HW_USBCTRL_GPTIMER0LD_RD(x) | (v)))
#define HW_USBCTRL_GPTIMER0LD_CLR(x, v)                                        \
    (HW_USBCTRL_GPTIMER0LD_WR(x, HW_USBCTRL_GPTIMER0LD_RD(x) & ~(v)))
#define HW_USBCTRL_GPTIMER0LD_TOG(x, v)                                        \
    (HW_USBCTRL_GPTIMER0LD_WR(x, HW_USBCTRL_GPTIMER0LD_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_GPTIMER0LD_RSVD0(v)                                         \
    ((((reg32_t)v) << 24) & BM_USBCTRL_GPTIMER0LD_RSVD0)
#else
#define BF_USBCTRL_GPTIMER0LD_RSVD0(v)                                         \
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_GPTIMER0LD_GPTLD(n, v)                                      \
    BFn_CS1(USBCTRL_GPTIMER0LD, n, GPTLD, v)
#endif

/*
 * HW_USBCTRL_GPTIMER0CTRL - General-Purpose Timer 0 Control
 * (Non-EHCI-Compliant) Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
    reg32_t U;
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_GPTIMER0CTRL(x)                                             \
    (*(volatile hw_usbctrl_gptimer0ctrl_t *)HW_USBCTRL_GPTIMER0CTRL_ADDR(x))
...
#define HW_USBCTRL_GPTIMER0CTRL_SET(x, v)                                      \
    (HW_USBCTRL_GPTIMER0CTRL_WR(x, HW_USBCTRL_GPTIMER0CTRL_RD(x) | (v)))
#define HW_USBCTRL_GPTIMER0CTRL_CLR(x, v)                                      \
    (HW_USBCTRL_GPTIMER0CTRL_WR(x, HW_USBCTRL_GPTIMER0CTRL_RD(x) & ~(v)))
#define HW_USBCTRL_GPTIMER0CTRL_TOG(x, v)                                      \
    (HW_USBCTRL_GPTIMER0CTRL_WR(x, HW_USBCTRL_GPTIMER0CTRL_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_USBCTRL_GPTIMER0CTRL_GPTRUN(v)                                      \
    ((((reg32_t)v) << 31) & BM_USBCTRL_GPTIMER0CTRL_GPTRUN)
#else
#define BF_USBCTRL_GPTIMER0CTRL_GPTRUN(v)                                      \
    (((v) << 31) & BM_USBCTRL_GPTIMER0CTRL_GPTRUN)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_GPTIMER0CTRL_GPTRUN(n, v)                                   \
    BFn_CS1(USBCTRL_GPTIMER0CTRL, n, GPTRUN, v)
#endif
...
#define BF_USBCTRL_GPTIMER0CTRL_GPTRST(v)                                      \
    (((v) << 30) & BM_USBCTRL_GPTIMER0CTRL_GPTRST)
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_GPTIMER0CTRL_GPTRST(n, v)                                   \
    BFn_CS1(USBCTRL_GPTIMER0CTRL, n, GPTRST, v)
#endif
...
#define BF_USBCTRL_GPTIMER0CTRL_GPTMODE(v)                                     \
    (((v) << 24) & BM_USBCTRL_GPTIMER0CTRL_GPTMODE)
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_GPTIMER0CTRL_GPTMODE(n, v)                                  \
    BFn_CS1(USBCTRL_GPTIMER0CTRL, n, GPTMODE, v)
#endif
...
/*
 * HW_USBCTRL_GPTIMER1LD - General-Purpose Timer 1 Load (Non-EHCI-Compliant)
 * Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_GPTIMER1LD(x)                                               \
    (*(volatile hw_usbctrl_gptimer1ld_t *)HW_USBCTRL_GPTIMER1LD_ADDR(x))
...
#define HW_USBCTRL_GPTIMER1LD_SET(x, v)                                        \
    (HW_USBCTRL_GPTIMER1LD_WR(x, HW_USBCTRL_GPTIMER1LD_RD(x) | (v)))
#define HW_USBCTRL_GPTIMER1LD_CLR(x, v)                                        \
    (HW_USBCTRL_GPTIMER1LD_WR(x, HW_USBCTRL_GPTIMER1LD_RD(x) & ~(v)))
#define HW_USBCTRL_GPTIMER1LD_TOG(x, v)                                        \
    (HW_USBCTRL_GPTIMER1LD_WR(x, HW_USBCTRL_GPTIMER1LD_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_GPTIMER1LD_RSVD0(v)                                         \
    ((((reg32_t)v) << 24) & BM_USBCTRL_GPTIMER1LD_RSVD0)
#else
#define BF_USBCTRL_GPTIMER1LD_RSVD0(v)                                         \
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_GPTIMER1LD_GPTLD(n, v)                                      \
    BFn_CS1(USBCTRL_GPTIMER1LD, n, GPTLD, v)
#endif

/*
 * HW_USBCTRL_GPTIMER1CTRL - General-Purpose Timer 1 Control
 * (Non-EHCI-Compliant) Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_GPTIMER1CTRL(x)                                             \
    (*(volatile hw_usbctrl_gptimer1ctrl_t *)HW_USBCTRL_GPTIMER1CTRL_ADDR(x))
...
#define HW_USBCTRL_GPTIMER1CTRL_SET(x, v)                                      \
    (HW_USBCTRL_GPTIMER1CTRL_WR(x, HW_USBCTRL_GPTIMER1CTRL_RD(x) | (v)))
#define HW_USBCTRL_GPTIMER1CTRL_CLR(x, v)                                      \
    (HW_USBCTRL_GPTIMER1CTRL_WR(x, HW_USBCTRL_GPTIMER1CTRL_RD(x) & ~(v)))
#define HW_USBCTRL_GPTIMER1CTRL_TOG(x, v)                                      \
    (HW_USBCTRL_GPTIMER1CTRL_WR(x, HW_USBCTRL_GPTIMER1CTRL_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_USBCTRL_GPTIMER1CTRL_GPTRUN(v)                                      \
    ((((reg32_t)v) << 31) & BM_USBCTRL_GPTIMER1CTRL_GPTRUN)
#else
#define BF_USBCTRL_GPTIMER1CTRL_GPTRUN(v)                                      \
    (((v) << 31) & BM_USBCTRL_GPTIMER1CTRL_GPTRUN)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_GPTIMER1CTRL_GPTRUN(n, v)                                   \
    BFn_CS1(USBCTRL_GPTIMER1CTRL, n, GPTRUN, v)
#endif
...
#define BF_USBCTRL_GPTIMER1CTRL_GPTRST(v)                                      \
    (((v) << 30) & BM_USBCTRL_GPTIMER1CTRL_GPTRST)
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_GPTIMER1CTRL_GPTRST(n, v)                                   \
    BFn_CS1(USBCTRL_GPTIMER1CTRL, n, GPTRST, v)
#endif
...
#define BF_USBCTRL_GPTIMER1CTRL_GPTMODE(v)                                     \
    (((v) << 24) & BM_USBCTRL_GPTIMER1CTRL_GPTMODE)
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_GPTIMER1CTRL_GPTMODE(n, v)                                  \
    BFn_CS1(USBCTRL_GPTIMER1CTRL, n, GPTMODE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_SBUSCFG(x)                                                  \
    (*(volatile hw_usbctrl_sbuscfg_t *)HW_USBCTRL_SBUSCFG_ADDR(x))
#define HW_USBCTRL_SBUSCFG_RD(x) (HW_USBCTRL_SBUSCFG(x).U)
#define HW_USBCTRL_SBUSCFG_WR(x, v) (HW_USBCTRL_SBUSCFG(x).U = (v))
#define HW_USBCTRL_SBUSCFG_SET(x, v)                                           \
    (HW_USBCTRL_SBUSCFG_WR(x, HW_USBCTRL_SBUSCFG_RD(x) | (v)))
#define HW_USBCTRL_SBUSCFG_CLR(x, v)                                           \
    (HW_USBCTRL_SBUSCFG_WR(x, HW_USBCTRL_SBUSCFG_RD(x) & ~(v)))
#define HW_USBCTRL_SBUSCFG_TOG(x, v)                                           \
    (HW_USBCTRL_SBUSCFG_WR(x, HW_USBCTRL_SBUSCFG_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_SBUSCFG_RSVD(v)                                             \
    ((((reg32_t)v) << 3) & BM_USBCTRL_SBUSCFG_RSVD)
#else
...
/*
 * HW_USBCTRL_CAPLENGTH - Capability Length and HCI Version (EHCI-Compliant)
 * Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_CAPLENGTH(x)                                                \
    (*(volatile hw_usbctrl_caplength_t *)HW_USBCTRL_CAPLENGTH_ADDR(x))
...
#define BF_USBCTRL_CAPLENGTH_HCIVERSION(v)                                     \
    ((((reg32_t)v) << 16) & BM_USBCTRL_CAPLENGTH_HCIVERSION)
#else
#define BF_USBCTRL_CAPLENGTH_HCIVERSION(v)                                     \
...
/*
 * HW_USBCTRL_HCSPARAMS - Host Control Structural Parameters (EHCI-Compliant
 * with Extensions) Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
    reg32_t U;
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_HCSPARAMS(x)                                                \
    (*(volatile hw_usbctrl_hcsparams_t *)HW_USBCTRL_HCSPARAMS_ADDR(x))
...
#define BF_USBCTRL_HCSPARAMS_RSVD2(v)                                          \
    ((((reg32_t)v) << 28) & BM_USBCTRL_HCSPARAMS_RSVD2)
#else
...
/*
 * HW_USBCTRL_HCCPARAMS - Host Control Capability Parameters (EHCI-Compliant)
 * Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_HCCPARAMS(x)                                                \
    (*(volatile hw_usbctrl_hccparams_t *)HW_USBCTRL_HCCPARAMS_ADDR(x))
...
#define BF_USBCTRL_HCCPARAMS_RSVD2(v)                                          \
    ((((reg32_t)v) << 16) & BM_USBCTRL_HCCPARAMS_RSVD2)
#else
...
/*
 * HW_USBCTRL_DCIVERSION - Device Interface Version Number (Non-EHCI-Compliant)
 * Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_DCIVERSION(x)                                               \
    (*(volatile hw_usbctrl_dciversion_t *)HW_USBCTRL_DCIVERSION_ADDR(x))
...
#define HW_USBCTRL_DCIVERSION_SET(x, v)                                        \
    (HW_USBCTRL_DCIVERSION_WR(x, HW_USBCTRL_DCIVERSION_RD(x) | (v)))
#define HW_USBCTRL_DCIVERSION_CLR(x, v)                                        \
    (HW_USBCTRL_DCIVERSION_WR(x, HW_USBCTRL_DCIVERSION_RD(x) & ~(v)))
#define HW_USBCTRL_DCIVERSION_TOG(x, v)                                        \
    (HW_USBCTRL_DCIVERSION_WR(x, HW_USBCTRL_DCIVERSION_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_DCIVERSION_RSVD(v)                                          \
    ((((reg32_t)v) << 16) & BM_USBCTRL_DCIVERSION_RSVD)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_DCIVERSION_DCIVERSION(n, v)                                 \
    (HW_USBCTRL_DCIVERSION(n).B.DCIVERSION = (v))
#endif

/*
 * HW_USBCTRL_DCCPARAMS - Device Control Capability Parameters
 * (Non-EHCI-Compliant) Register
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_DCCPARAMS(x)                                                \
    (*(volatile hw_usbctrl_dccparams_t *)HW_USBCTRL_DCCPARAMS_ADDR(x))
...
#define BF_USBCTRL_DCCPARAMS_RSVD1(v)                                          \
    ((((reg32_t)v) << 9) & BM_USBCTRL_DCCPARAMS_RSVD1)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_USBCMD(x)                                                   \
    (*(volatile hw_usbctrl_usbcmd_t *)HW_USBCTRL_USBCMD_ADDR(x))
#define HW_USBCTRL_USBCMD_RD(x) (HW_USBCTRL_USBCMD(x).U)
#define HW_USBCTRL_USBCMD_WR(x, v) (HW_USBCTRL_USBCMD(x).U = (v))
#define HW_USBCTRL_USBCMD_SET(x, v)                                            \
    (HW_USBCTRL_USBCMD_WR(x, HW_USBCTRL_USBCMD_RD(x) | (v)))
#define HW_USBCTRL_USBCMD_CLR(x, v)                                            \
    (HW_USBCTRL_USBCMD_WR(x, HW_USBCTRL_USBCMD_RD(x) & ~(v)))
#define HW_USBCTRL_USBCMD_TOG(x, v)                                            \
    (HW_USBCTRL_USBCMD_WR(x, HW_USBCTRL_USBCMD_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_USBCMD_RSVD3(v)                                             \
    ((((reg32_t)v) << 24) & BM_USBCTRL_USBCMD_RSVD3)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_USBSTS(x)                                                   \
    (*(volatile hw_usbctrl_usbsts_t *)HW_USBCTRL_USBSTS_ADDR(x))
#define HW_USBCTRL_USBSTS_RD(x) (HW_USBCTRL_USBSTS(x).U)
#define HW_USBCTRL_USBSTS_WR(x, v) (HW_USBCTRL_USBSTS(x).U = (v))
#define HW_USBCTRL_USBSTS_SET(x, v)                                            \
    (HW_USBCTRL_USBSTS_WR(x, HW_USBCTRL_USBSTS_RD(x) | (v)))
#define HW_USBCTRL_USBSTS_CLR(x, v)                                            \
    (HW_USBCTRL_USBSTS_WR(x, HW_USBCTRL_USBSTS_RD(x) & ~(v)))
#define HW_USBCTRL_USBSTS_TOG(x, v)                                            \
    (HW_USBCTRL_USBSTS_WR(x, HW_USBCTRL_USBSTS_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_USBSTS_RSVD5(v)                                             \
    ((((reg32_t)v) << 26) & BM_USBCTRL_USBSTS_RSVD5)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_USBINTR(x)                                                  \
    (*(volatile hw_usbctrl_usbintr_t *)HW_USBCTRL_USBINTR_ADDR(x))
#define HW_USBCTRL_USBINTR_RD(x) (HW_USBCTRL_USBINTR(x).U)
#define HW_USBCTRL_USBINTR_WR(x, v) (HW_USBCTRL_USBINTR(x).U = (v))
#define HW_USBCTRL_USBINTR_SET(x, v)                                           \
    (HW_USBCTRL_USBINTR_WR(x, HW_USBCTRL_USBINTR_RD(x) | (v)))
#define HW_USBCTRL_USBINTR_CLR(x, v)                                           \
    (HW_USBCTRL_USBINTR_WR(x, HW_USBCTRL_USBINTR_RD(x) & ~(v)))
#define HW_USBCTRL_USBINTR_TOG(x, v)                                           \
    (HW_USBCTRL_USBINTR_WR(x, HW_USBCTRL_USBINTR_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_USBINTR_RSVD5(v)                                            \
    ((((reg32_t)v) << 26) & BM_USBCTRL_USBINTR_RSVD5)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_FRINDEX(x)                                                  \
    (*(volatile hw_usbctrl_frindex_t *)HW_USBCTRL_FRINDEX_ADDR(x))
#define HW_USBCTRL_FRINDEX_RD(x) (HW_USBCTRL_FRINDEX(x).U)
#define HW_USBCTRL_FRINDEX_WR(x, v) (HW_USBCTRL_FRINDEX(x).U = (v))
#define HW_USBCTRL_FRINDEX_SET(x, v)                                           \
    (HW_USBCTRL_FRINDEX_WR(x, HW_USBCTRL_FRINDEX_RD(x) | (v)))
#define HW_USBCTRL_FRINDEX_CLR(x, v)                                           \
    (HW_USBCTRL_FRINDEX_WR(x, HW_USBCTRL_FRINDEX_RD(x) & ~(v)))
#define HW_USBCTRL_FRINDEX_TOG(x, v)                                           \
    (HW_USBCTRL_FRINDEX_WR(x, HW_USBCTRL_FRINDEX_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_FRINDEX_RSVD(v)                                             \
    ((((reg32_t)v) << 14) & BM_USBCTRL_FRINDEX_RSVD)
#else
...
/*
 * HW_USBCTRL_PERIODICLISTBASE - Frame List Base Address Register (Host
 * Controller mode)
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
/*
 * constants & macros for entire multi-block HW_USBCTRL_PERIODICLISTBASE
 * register
 */
#define HW_USBCTRL_PERIODICLISTBASE_ADDR(x) (REGS_USBCTRL_BASE(x) + 0x154)

#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_PERIODICLISTBASE(x)                                         \
    (*(volatile hw_usbctrl_periodiclistbase_t *)                               \
         HW_USBCTRL_PERIODICLISTBASE_ADDR(x))
#define HW_USBCTRL_PERIODICLISTBASE_RD(x) (HW_USBCTRL_PERIODICLISTBASE(x).U)
#define HW_USBCTRL_PERIODICLISTBASE_WR(x, v)                                   \
    (HW_USBCTRL_PERIODICLISTBASE(x).U = (v))
#define HW_USBCTRL_PERIODICLISTBASE_SET(x, v)                                  \
    (HW_USBCTRL_PERIODICLISTBASE_WR(x, HW_USBCTRL_PERIODICLISTBASE_RD(x) | (v)))
#define HW_USBCTRL_PERIODICLISTBASE_CLR(x, v)                                  \
    (HW_USBCTRL_PERIODICLISTBASE_WR(x,                                         \
                                    HW_USBCTRL_PERIODICLISTBASE_RD(x) & ~(v)))
#define HW_USBCTRL_PERIODICLISTBASE_TOG(x, v)                                  \
    (HW_USBCTRL_PERIODICLISTBASE_WR(x, HW_USBCTRL_PERIODICLISTBASE_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_PERIODICLISTBASE_PERBASE(v)                                 \
    ((((reg32_t)v) << 12) & BM_USBCTRL_PERIODICLISTBASE_PERBASE)
#else
#define BF_USBCTRL_PERIODICLISTBASE_PERBASE(v)                                 \
    (((v) << 12) & BM_USBCTRL_PERIODICLISTBASE_PERBASE)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_PERIODICLISTBASE_PERBASE(n, v)                              \
    BFn_CS1(USBCTRL_PERIODICLISTBASE, n, PERBASE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_DEVICEADDR(x)                                               \
    (*(volatile hw_usbctrl_deviceaddr_t *)HW_USBCTRL_DEVICEADDR_ADDR(x))
...
#define HW_USBCTRL_DEVICEADDR_SET(x, v)                                        \
    (HW_USBCTRL_DEVICEADDR_WR(x, HW_USBCTRL_DEVICEADDR_RD(x) | (v)))
#define HW_USBCTRL_DEVICEADDR_CLR(x, v)                                        \
    (HW_USBCTRL_DEVICEADDR_WR(x, HW_USBCTRL_DEVICEADDR_RD(x) & ~(v)))
#define HW_USBCTRL_DEVICEADDR_TOG(x, v)                                        \
    (HW_USBCTRL_DEVICEADDR_WR(x, HW_USBCTRL_DEVICEADDR_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_DEVICEADDR_USBADR(v)                                        \
    ((((reg32_t)v) << 25) & BM_USBCTRL_DEVICEADDR_USBADR)
#else
#define BF_USBCTRL_DEVICEADDR_USBADR(v)                                        \
    (((v) << 25) & BM_USBCTRL_DEVICEADDR_USBADR)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_DEVICEADDR_USBADR(n, v)                                     \
    BFn_CS1(USBCTRL_DEVICEADDR, n, USBADR, v)
#endif
...
#define BF_USBCTRL_DEVICEADDR_USBADRA(v)                                       \
    (((v) << 24) & BM_USBCTRL_DEVICEADDR_USBADRA)
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_DEVICEADDR_USBADRA(n, v)                                    \
    BFn_CS1(USBCTRL_DEVICEADDR, n, USBADRA, v)
#endif
...
/*
 * HW_USBCTRL_ASYNCLISTADDR - Next Asynchronous Address Register (Host
 * Controller mode)
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ASYNCLISTADDR(x)                                            \
    (*(volatile hw_usbctrl_asynclistaddr_t *)HW_USBCTRL_ASYNCLISTADDR_ADDR(x))
...
#define HW_USBCTRL_ASYNCLISTADDR_SET(x, v)                                     \
    (HW_USBCTRL_ASYNCLISTADDR_WR(x, HW_USBCTRL_ASYNCLISTADDR_RD(x) | (v)))
#define HW_USBCTRL_ASYNCLISTADDR_CLR(x, v)                                     \
    (HW_USBCTRL_ASYNCLISTADDR_WR(x, HW_USBCTRL_ASYNCLISTADDR_RD(x) & ~(v)))
#define HW_USBCTRL_ASYNCLISTADDR_TOG(x, v)                                     \
    (HW_USBCTRL_ASYNCLISTADDR_WR(x, HW_USBCTRL_ASYNCLISTADDR_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ASYNCLISTADDR_ASYBASE(v)                                    \
    ((((reg32_t)v) << 5) & BM_USBCTRL_ASYNCLISTADDR_ASYBASE)
#else
#define BF_USBCTRL_ASYNCLISTADDR_ASYBASE(v)                                    \
    (((v) << 5) & BM_USBCTRL_ASYNCLISTADDR_ASYBASE)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_ASYNCLISTADDR_ASYBASE(n, v)                                 \
    BFn_CS1(USBCTRL_ASYNCLISTADDR, n, ASYBASE, v)
#endif
...
/*
 * HW_USBCTRL_ENDPOINTLISTADDR - Endpoint List Address Register (Device
 * Controller mode)
 */
#ifndef __LANGUAGE_ASM__
typedef union {
...
/*
 * constants & macros for entire multi-block HW_USBCTRL_ENDPOINTLISTADDR
 * register
 */
#define HW_USBCTRL_ENDPOINTLISTADDR_ADDR(x) (REGS_USBCTRL_BASE(x) + 0x158)

#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPOINTLISTADDR(x)                                         \
    (*(volatile hw_usbctrl_endpointlistaddr_t *)                               \
         HW_USBCTRL_ENDPOINTLISTADDR_ADDR(x))
#define HW_USBCTRL_ENDPOINTLISTADDR_RD(x) (HW_USBCTRL_ENDPOINTLISTADDR(x).U)
#define HW_USBCTRL_ENDPOINTLISTADDR_WR(x, v)                                   \
    (HW_USBCTRL_ENDPOINTLISTADDR(x).U = (v))
#define HW_USBCTRL_ENDPOINTLISTADDR_SET(x, v)                                  \
    (HW_USBCTRL_ENDPOINTLISTADDR_WR(x, HW_USBCTRL_ENDPOINTLISTADDR_RD(x) | (v)))
#define HW_USBCTRL_ENDPOINTLISTADDR_CLR(x, v)                                  \
    (HW_USBCTRL_ENDPOINTLISTADDR_WR(x,                                         \
                                    HW_USBCTRL_ENDPOINTLISTADDR_RD(x) & ~(v)))
#define HW_USBCTRL_ENDPOINTLISTADDR_TOG(x, v)                                  \
    (HW_USBCTRL_ENDPOINTLISTADDR_WR(x, HW_USBCTRL_ENDPOINTLISTADDR_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ENDPOINTLISTADDR_EPBASE(v)                                  \
    ((((reg32_t)v) << 11) & BM_USBCTRL_ENDPOINTLISTADDR_EPBASE)
#else
#define BF_USBCTRL_ENDPOINTLISTADDR_EPBASE(v)                                  \
    (((v) << 11) & BM_USBCTRL_ENDPOINTLISTADDR_EPBASE)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_ENDPOINTLISTADDR_EPBASE(n, v)                               \
    BFn_CS1(USBCTRL_ENDPOINTLISTADDR, n, EPBASE, v)
#endif
...
/*
 * HW_USBCTRL_TTCTRL - Embedded TT Asynchronous Buffer Status and Control
 * Register (Host Controller mode)
 */
#ifndef __LANGUAGE_ASM__
typedef union {
    reg32_t U;
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_TTCTRL(x)                                                   \
    (*(volatile hw_usbctrl_ttctrl_t *)HW_USBCTRL_TTCTRL_ADDR(x))
#define HW_USBCTRL_TTCTRL_RD(x) (HW_USBCTRL_TTCTRL(x).U)
#define HW_USBCTRL_TTCTRL_WR(x, v) (HW_USBCTRL_TTCTRL(x).U = (v))
#define HW_USBCTRL_TTCTRL_SET(x, v)                                            \
    (HW_USBCTRL_TTCTRL_WR(x, HW_USBCTRL_TTCTRL_RD(x) | (v)))
#define HW_USBCTRL_TTCTRL_CLR(x, v)                                            \
    (HW_USBCTRL_TTCTRL_WR(x, HW_USBCTRL_TTCTRL_RD(x) & ~(v)))
#define HW_USBCTRL_TTCTRL_TOG(x, v)                                            \
    (HW_USBCTRL_TTCTRL_WR(x, HW_USBCTRL_TTCTRL_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_USBCTRL_TTCTRL_RSVD1(v)                                             \
    ((((reg32_t)v) << 31) & BM_USBCTRL_TTCTRL_RSVD1)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_BURSTSIZE(x)                                                \
    (*(volatile hw_usbctrl_burstsize_t *)HW_USBCTRL_BURSTSIZE_ADDR(x))
#define HW_USBCTRL_BURSTSIZE_RD(x) (HW_USBCTRL_BURSTSIZE(x).U)
#define HW_USBCTRL_BURSTSIZE_WR(x, v) (HW_USBCTRL_BURSTSIZE(x).U = (v))
#define HW_USBCTRL_BURSTSIZE_SET(x, v)                                         \
    (HW_USBCTRL_BURSTSIZE_WR(x, HW_USBCTRL_BURSTSIZE_RD(x) | (v)))
#define HW_USBCTRL_BURSTSIZE_CLR(x, v)                                         \
    (HW_USBCTRL_BURSTSIZE_WR(x, HW_USBCTRL_BURSTSIZE_RD(x) & ~(v)))
#define HW_USBCTRL_BURSTSIZE_TOG(x, v)                                         \
    (HW_USBCTRL_BURSTSIZE_WR(x, HW_USBCTRL_BURSTSIZE_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_BURSTSIZE_RSVD(v)                                           \
    ((((reg32_t)v) << 16) & BM_USBCTRL_BURSTSIZE_RSVD)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_BURSTSIZE_TXPBURST(n, v)                                    \
    (HW_USBCTRL_BURSTSIZE(n).B.TXPBURST = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_BURSTSIZE_RXPBURST(n, v)                                    \
    (HW_USBCTRL_BURSTSIZE(n).B.RXPBURST = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_TXFILLTUNING(x)                                             \
    (*(volatile hw_usbctrl_txfilltuning_t *)HW_USBCTRL_TXFILLTUNING_ADDR(x))
...
#define HW_USBCTRL_TXFILLTUNING_SET(x, v)                                      \
    (HW_USBCTRL_TXFILLTUNING_WR(x, HW_USBCTRL_TXFILLTUNING_RD(x) | (v)))
#define HW_USBCTRL_TXFILLTUNING_CLR(x, v)                                      \
    (HW_USBCTRL_TXFILLTUNING_WR(x, HW_USBCTRL_TXFILLTUNING_RD(x) & ~(v)))
#define HW_USBCTRL_TXFILLTUNING_TOG(x, v)                                      \
    (HW_USBCTRL_TXFILLTUNING_WR(x, HW_USBCTRL_TXFILLTUNING_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_TXFILLTUNING_RSVD2(v)                                       \
    ((((reg32_t)v) << 22) & BM_USBCTRL_TXFILLTUNING_RSVD2)
#else
#define BF_USBCTRL_TXFILLTUNING_RSVD2(v)                                       \
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_TXFILLTUNING_TXFIFOTHRES(n, v)                              \
    BFn_CS1(USBCTRL_TXFILLTUNING, n, TXFIFOTHRES, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_TXFILLTUNING_TXSCHEALTH(n, v)                               \
    BFn_CS1(USBCTRL_TXFILLTUNING, n, TXSCHEALTH, v)
#endif
...
#define BF_USBCTRL_TXFILLTUNING_RSVD0(v)                                       \
    (((v) << 7) & BM_USBCTRL_TXFILLTUNING_RSVD0)
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_TXFILLTUNING_TXSCHOH(n, v)                                  \
    BFn_CS1(USBCTRL_TXFILLTUNING, n, TXSCHOH, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_IC_USB(x)                                                   \
    (*(volatile hw_usbctrl_ic_usb_t *)HW_USBCTRL_IC_USB_ADDR(x))
#define HW_USBCTRL_IC_USB_RD(x) (HW_USBCTRL_IC_USB(x).U)
#define HW_USBCTRL_IC_USB_WR(x, v) (HW_USBCTRL_IC_USB(x).U = (v))
#define HW_USBCTRL_IC_USB_SET(x, v)                                            \
    (HW_USBCTRL_IC_USB_WR(x, HW_USBCTRL_IC_USB_RD(x) | (v)))
#define HW_USBCTRL_IC_USB_CLR(x, v)                                            \
    (HW_USBCTRL_IC_USB_WR(x, HW_USBCTRL_IC_USB_RD(x) & ~(v)))
#define HW_USBCTRL_IC_USB_TOG(x, v)                                            \
    (HW_USBCTRL_IC_USB_WR(x, HW_USBCTRL_IC_USB_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_IC_USB_IC_ENABLE(v)                                         \
    (((v) << 3) & BM_USBCTRL_IC_USB_IC_ENABLE)
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_IC_USB_IC_ENABLE(n, v)                                      \
    BFn_CS1(USBCTRL_IC_USB, n, IC_ENABLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ULPI(x)                                                     \
    (*(volatile hw_usbctrl_ulpi_t *)HW_USBCTRL_ULPI_ADDR(x))
#define HW_USBCTRL_ULPI_RD(x) (HW_USBCTRL_ULPI(x).U)
#define HW_USBCTRL_ULPI_WR(x, v) (HW_USBCTRL_ULPI(x).U = (v))
#define HW_USBCTRL_ULPI_SET(x, v)                                              \
    (HW_USBCTRL_ULPI_WR(x, HW_USBCTRL_ULPI_RD(x) | (v)))
#define HW_USBCTRL_ULPI_CLR(x, v)                                              \
    (HW_USBCTRL_ULPI_WR(x, HW_USBCTRL_ULPI_RD(x) & ~(v)))
#define HW_USBCTRL_ULPI_TOG(x, v)                                              \
    (HW_USBCTRL_ULPI_WR(x, HW_USBCTRL_ULPI_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_USBCTRL_ULPI_ULPIWU(v)                                              \
    ((((reg32_t)v) << 31) & BM_USBCTRL_ULPI_ULPIWU)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTNAK(x)                                                 \
    (*(volatile hw_usbctrl_endptnak_t *)HW_USBCTRL_ENDPTNAK_ADDR(x))
#define HW_USBCTRL_ENDPTNAK_RD(x) (HW_USBCTRL_ENDPTNAK(x).U)
#define HW_USBCTRL_ENDPTNAK_WR(x, v) (HW_USBCTRL_ENDPTNAK(x).U = (v))
#define HW_USBCTRL_ENDPTNAK_SET(x, v)                                          \
    (HW_USBCTRL_ENDPTNAK_WR(x, HW_USBCTRL_ENDPTNAK_RD(x) | (v)))
#define HW_USBCTRL_ENDPTNAK_CLR(x, v)                                          \
    (HW_USBCTRL_ENDPTNAK_WR(x, HW_USBCTRL_ENDPTNAK_RD(x) & ~(v)))
#define HW_USBCTRL_ENDPTNAK_TOG(x, v)                                          \
    (HW_USBCTRL_ENDPTNAK_WR(x, HW_USBCTRL_ENDPTNAK_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ENDPTNAK_RSVD1(v)                                           \
    ((((reg32_t)v) << 24) & BM_USBCTRL_ENDPTNAK_RSVD1)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTNAKEN(x)                                               \
    (*(volatile hw_usbctrl_endptnaken_t *)HW_USBCTRL_ENDPTNAKEN_ADDR(x))
...
#define HW_USBCTRL_ENDPTNAKEN_SET(x, v)                                        \
    (HW_USBCTRL_ENDPTNAKEN_WR(x, HW_USBCTRL_ENDPTNAKEN_RD(x) | (v)))
#define HW_USBCTRL_ENDPTNAKEN_CLR(x, v)                                        \
    (HW_USBCTRL_ENDPTNAKEN_WR(x, HW_USBCTRL_ENDPTNAKEN_RD(x) & ~(v)))
#define HW_USBCTRL_ENDPTNAKEN_TOG(x, v)                                        \
    (HW_USBCTRL_ENDPTNAKEN_WR(x, HW_USBCTRL_ENDPTNAKEN_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ENDPTNAKEN_RSVD1(v)                                         \
    ((((reg32_t)v) << 24) & BM_USBCTRL_ENDPTNAKEN_RSVD1)
#else
#define BF_USBCTRL_ENDPTNAKEN_RSVD1(v)                                         \
    (((v) << 24) & BM_USBCTRL_ENDPTNAKEN_RSVD1)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_ENDPTNAKEN_EPTNE(n, v)                                      \
    (HW_USBCTRL_ENDPTNAKEN(n).B.EPTNE = (v))
#endif
...
#define BF_USBCTRL_ENDPTNAKEN_RSVD0(v)                                         \
    (((v) << 8) & BM_USBCTRL_ENDPTNAKEN_RSVD0)
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_ENDPTNAKEN_EPRNE(n, v)                                      \
    (HW_USBCTRL_ENDPTNAKEN(n).B.EPRNE = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_PORTSC1(x)                                                  \
    (*(volatile hw_usbctrl_portsc1_t *)HW_USBCTRL_PORTSC1_ADDR(x))
#define HW_USBCTRL_PORTSC1_RD(x) (HW_USBCTRL_PORTSC1(x).U)
#define HW_USBCTRL_PORTSC1_WR(x, v) (HW_USBCTRL_PORTSC1(x).U = (v))
#define HW_USBCTRL_PORTSC1_SET(x, v)                                           \
    (HW_USBCTRL_PORTSC1_WR(x, HW_USBCTRL_PORTSC1_RD(x) | (v)))
#define HW_USBCTRL_PORTSC1_CLR(x, v)                                           \
    (HW_USBCTRL_PORTSC1_WR(x, HW_USBCTRL_PORTSC1_RD(x) & ~(v)))
#define HW_USBCTRL_PORTSC1_TOG(x, v)                                           \
    (HW_USBCTRL_PORTSC1_WR(x, HW_USBCTRL_PORTSC1_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_PORTSC1_PTS(v)                                              \
    ((((reg32_t)v) << 30) & BM_USBCTRL_PORTSC1_PTS)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_OTGSC(x)                                                    \
    (*(volatile hw_usbctrl_otgsc_t *)HW_USBCTRL_OTGSC_ADDR(x))
#define HW_USBCTRL_OTGSC_RD(x) (HW_USBCTRL_OTGSC(x).U)
#define HW_USBCTRL_OTGSC_WR(x, v) (HW_USBCTRL_OTGSC(x).U = (v))
#define HW_USBCTRL_OTGSC_SET(x, v)                                             \
    (HW_USBCTRL_OTGSC_WR(x, HW_USBCTRL_OTGSC_RD(x) | (v)))
#define HW_USBCTRL_OTGSC_CLR(x, v)                                             \
    (HW_USBCTRL_OTGSC_WR(x, HW_USBCTRL_OTGSC_RD(x) & ~(v)))
#define HW_USBCTRL_OTGSC_TOG(x, v)                                             \
    (HW_USBCTRL_OTGSC_WR(x, HW_USBCTRL_OTGSC_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_USBCTRL_OTGSC_RSVD2(v)                                              \
    ((((reg32_t)v) << 31) & BM_USBCTRL_OTGSC_RSVD2)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_USBMODE(x)                                                  \
    (*(volatile hw_usbctrl_usbmode_t *)HW_USBCTRL_USBMODE_ADDR(x))
#define HW_USBCTRL_USBMODE_RD(x) (HW_USBCTRL_USBMODE(x).U)
#define HW_USBCTRL_USBMODE_WR(x, v) (HW_USBCTRL_USBMODE(x).U = (v))
#define HW_USBCTRL_USBMODE_SET(x, v)                                           \
    (HW_USBCTRL_USBMODE_WR(x, HW_USBCTRL_USBMODE_RD(x) | (v)))
#define HW_USBCTRL_USBMODE_CLR(x, v)                                           \
    (HW_USBCTRL_USBMODE_WR(x, HW_USBCTRL_USBMODE_RD(x) & ~(v)))
#define HW_USBCTRL_USBMODE_TOG(x, v)                                           \
    (HW_USBCTRL_USBMODE_WR(x, HW_USBCTRL_USBMODE_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_USBCTRL_USBMODE_RSVD1(v)                                            \
    ((((reg32_t)v) << 16) & BM_USBCTRL_USBMODE_RSVD1)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTSETUPSTAT(x)                                           \
    (*(volatile hw_usbctrl_endptsetupstat_t *)HW_USBCTRL_ENDPTSETUPSTAT_ADDR(x))
#define HW_USBCTRL_ENDPTSETUPSTAT_RD(x) (HW_USBCTRL_ENDPTSETUPSTAT(x).U)
#define HW_USBCTRL_ENDPTSETUPSTAT_WR(x, v)                                     \
    (HW_USBCTRL_ENDPTSETUPSTAT(x).U = (v))
#define HW_USBCTRL_ENDPTSETUPSTAT_SET(x, v)                                    \
    (HW_USBCTRL_ENDPTSETUPSTAT_WR(x, HW_USBCTRL_ENDPTSETUPSTAT_RD(x) | (v)))
#define HW_USBCTRL_ENDPTSETUPSTAT_CLR(x, v)                                    \
    (HW_USBCTRL_ENDPTSETUPSTAT_WR(x, HW_USBCTRL_ENDPTSETUPSTAT_RD(x) & ~(v)))
#define HW_USBCTRL_ENDPTSETUPSTAT_TOG(x, v)                                    \
    (HW_USBCTRL_ENDPTSETUPSTAT_WR(x, HW_USBCTRL_ENDPTSETUPSTAT_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ENDPTSETUPSTAT_RSVD(v)                                      \
    ((((reg32_t)v) << 8) & BM_USBCTRL_ENDPTSETUPSTAT_RSVD)
#else
#define BF_USBCTRL_ENDPTSETUPSTAT_RSVD(v)                                      \
    (((v) << 8) & BM_USBCTRL_ENDPTSETUPSTAT_RSVD)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_ENDPTSETUPSTAT_ENDPTSETUPSTAT(n, v)                         \
    (HW_USBCTRL_ENDPTSETUPSTAT(n).B.ENDPTSETUPSTAT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTPRIME(x)                                               \
    (*(volatile hw_usbctrl_endptprime_t *)HW_USBCTRL_ENDPTPRIME_ADDR(x))
...
#define HW_USBCTRL_ENDPTPRIME_SET(x, v)                                        \
    (HW_USBCTRL_ENDPTPRIME_WR(x, HW_USBCTRL_ENDPTPRIME_RD(x) | (v)))
#define HW_USBCTRL_ENDPTPRIME_CLR(x, v)                                        \
    (HW_USBCTRL_ENDPTPRIME_WR(x, HW_USBCTRL_ENDPTPRIME_RD(x) & ~(v)))
#define HW_USBCTRL_ENDPTPRIME_TOG(x, v)                                        \
    (HW_USBCTRL_ENDPTPRIME_WR(x, HW_USBCTRL_ENDPTPRIME_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ENDPTPRIME_RSVD1(v)                                         \
    ((((reg32_t)v) << 24) & BM_USBCTRL_ENDPTPRIME_RSVD1)
#else
#define BF_USBCTRL_ENDPTPRIME_RSVD1(v)                                         \
    (((v) << 24) & BM_USBCTRL_ENDPTPRIME_RSVD1)
#endif
...
#define BF_USBCTRL_ENDPTPRIME_RSVD0(v)                                         \
    (((v) << 8) & BM_USBCTRL_ENDPTPRIME_RSVD0)
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTFLUSH(x)                                               \
    (*(volatile hw_usbctrl_endptflush_t *)HW_USBCTRL_ENDPTFLUSH_ADDR(x))
...
#define HW_USBCTRL_ENDPTFLUSH_SET(x, v)                                        \
    (HW_USBCTRL_ENDPTFLUSH_WR(x, HW_USBCTRL_ENDPTFLUSH_RD(x) | (v)))
#define HW_USBCTRL_ENDPTFLUSH_CLR(x, v)                                        \
    (HW_USBCTRL_ENDPTFLUSH_WR(x, HW_USBCTRL_ENDPTFLUSH_RD(x) & ~(v)))
#define HW_USBCTRL_ENDPTFLUSH_TOG(x, v)                                        \
    (HW_USBCTRL_ENDPTFLUSH_WR(x, HW_USBCTRL_ENDPTFLUSH_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ENDPTFLUSH_RSVD1(v)                                         \
    ((((reg32_t)v) << 24) & BM_USBCTRL_ENDPTFLUSH_RSVD1)
#else
#define BF_USBCTRL_ENDPTFLUSH_RSVD1(v)                                         \
    (((v) << 24) & BM_USBCTRL_ENDPTFLUSH_RSVD1)
#endif
...
#define BF_USBCTRL_ENDPTFLUSH_RSVD0(v)                                         \
    (((v) << 8) & BM_USBCTRL_ENDPTFLUSH_RSVD0)
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTSTAT(x)                                                \
    (*(volatile hw_usbctrl_endptstat_t *)HW_USBCTRL_ENDPTSTAT_ADDR(x))
...
#define BF_USBCTRL_ENDPTSTAT_RSVD1(v)                                          \
    ((((reg32_t)v) << 24) & BM_USBCTRL_ENDPTSTAT_RSVD1)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTCOMPLETE(x)                                            \
    (*(volatile hw_usbctrl_endptcomplete_t *)HW_USBCTRL_ENDPTCOMPLETE_ADDR(x))
...
#define HW_USBCTRL_ENDPTCOMPLETE_SET(x, v)                                     \
    (HW_USBCTRL_ENDPTCOMPLETE_WR(x, HW_USBCTRL_ENDPTCOMPLETE_RD(x) | (v)))
#define HW_USBCTRL_ENDPTCOMPLETE_CLR(x, v)                                     \
    (HW_USBCTRL_ENDPTCOMPLETE_WR(x, HW_USBCTRL_ENDPTCOMPLETE_RD(x) & ~(v)))
#define HW_USBCTRL_ENDPTCOMPLETE_TOG(x, v)                                     \
    (HW_USBCTRL_ENDPTCOMPLETE_WR(x, HW_USBCTRL_ENDPTCOMPLETE_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ENDPTCOMPLETE_RSVD1(v)                                      \
    ((((reg32_t)v) << 24) & BM_USBCTRL_ENDPTCOMPLETE_RSVD1)
#else
#define BF_USBCTRL_ENDPTCOMPLETE_RSVD1(v)                                      \
    (((v) << 24) & BM_USBCTRL_ENDPTCOMPLETE_RSVD1)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_ENDPTCOMPLETE_ETCE(n, v)                                    \
    (HW_USBCTRL_ENDPTCOMPLETE(n).B.ETCE = (v))
#endif
...
#define BF_USBCTRL_ENDPTCOMPLETE_RSVD0(v)                                      \
    (((v) << 8) & BM_USBCTRL_ENDPTCOMPLETE_RSVD0)
...
#ifndef __LANGUAGE_ASM__
#define BW_USBCTRL_ENDPTCOMPLETE_ERCE(n, v)                                    \
    (HW_USBCTRL_ENDPTCOMPLETE(n).B.ERCE = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTCTRL0(x)                                               \
    (*(volatile hw_usbctrl_endptctrl0_t *)HW_USBCTRL_ENDPTCTRL0_ADDR(x))
...
#define HW_USBCTRL_ENDPTCTRL0_SET(x, v)                                        \
    (HW_USBCTRL_ENDPTCTRL0_WR(x, HW_USBCTRL_ENDPTCTRL0_RD(x) | (v)))
#define HW_USBCTRL_ENDPTCTRL0_CLR(x, v)                                        \
    (HW_USBCTRL_ENDPTCTRL0_WR(x, HW_USBCTRL_ENDPTCTRL0_RD(x) & ~(v)))
#define HW_USBCTRL_ENDPTCTRL0_TOG(x, v)                                        \
    (HW_USBCTRL_ENDPTCTRL0_WR(x, HW_USBCTRL_ENDPTCTRL0_RD(x) ^ (v)))
#endif
...
#define BF_USBCTRL_ENDPTCTRL0_RSVD6(v)                                         \
    ((((reg32_t)v) << 24) & BM_USBCTRL_ENDPTCTRL0_RSVD6)
#else
#define BF_USBCTRL_ENDPTCTRL0_RSVD6(v)                                         \
...
#define BF_USBCTRL_ENDPTCTRL0_RSVD4(v)                                         \
    (((v) << 17) & BM_USBCTRL_ENDPTCTRL0_RSVD4)
...
#define BF_USBCTRL_ENDPTCTRL0_RSVD1(v)                                         \
    (((v) << 1) & BM_USBCTRL_ENDPTCTRL0_RSVD1)
...
#endif
/*
 * constants & macros for entire multi-block HW_USBCTRL_ENDPTCTRLn
 * multi-register
 */
#define HW_USBCTRL_ENDPTCTRLn_COUNT 8
#define HW_USBCTRL_ENDPTCTRLn_ADDR(x, n)                                       \
    (REGS_USBCTRL_BASE(x) + 0x1c4 + ((n)*0x4))

#ifndef __LANGUAGE_ASM__
#define HW_USBCTRL_ENDPTCTRLn(x, n)                                            \
    (*(volatile hw_usbctrl_endptctrln_t *)HW_USBCTRL_ENDPTCTRLn_ADDR(x, n))
...
#define HW_USBCTRL_ENDPTCTRLn_SET(x, n, v)                                     \
    (HW_USBCTRL_ENDPTCTRLn_WR(x, n, HW_USBCTRL_ENDPTCTRLn_RD(x, n) | (v)))
#define HW_USBCTRL_ENDPTCTRLn_CLR(x, n, v)                                     \
    (HW_USBCTRL_ENDPTCTRLn_WR(x, n, HW_USBCTRL_ENDPTCTRLn_RD(x, n) & ~(v)))
#define HW_USBCTRL_ENDPTCTRLn_TOG(x, n, v)                                     \
    (HW_USBCTRL_ENDPTCTRLn_WR(x, n, HW_USBCTRL_ENDPTCTRLn_RD(x, n) ^ (v)))
#endif

/*
 * constants & macros for individual HW_USBCTRL_ENDPTCTRLn multi-register
 * bitfields
 */
...
#define BF_USBCTRL_ENDPTCTRLn_RSVD6(v)                                         \
    ((((reg32_t)v) << 24) & BM_USBCTRL_ENDPTCTRLn_RSVD6)
#else
#define BF_USBCTRL_ENDPTCTRLn_RSVD6(v)                                         \
...
#define BF_USBCTRL_ENDPTCTRLn_RSVD5(v)                                         \
    (((v) << 20) & BM_USBCTRL_ENDPTCTRLn_RSVD5)
...
#define BF_USBCTRL_ENDPTCTRLn_RSVD2(v)                                         \
    (((v) << 4) & BM_USBCTRL_ENDPTCTRLn_RSVD2)
