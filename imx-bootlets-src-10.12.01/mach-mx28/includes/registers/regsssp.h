...
#define REGS_SSP_BASE(x)                                                       \
    (x == 0 ? REGS_SSP0_BASE                                                   \
            : x == 1 ? REGS_SSP1_BASE                                          \
                     : x == 2 ? REGS_SSP2_BASE                                 \
                              : x == 3 ? REGS_SSP3_BASE : 0xffff0000)
#endif
...
#define HW_SSP_CTRL0_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SSP_CTRL0_SET_ADDR(x)) = (v))
#define HW_SSP_CTRL0_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SSP_CTRL0_CLR_ADDR(x)) = (v))
#define HW_SSP_CTRL0_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SSP_CTRL0_TOG_ADDR(x)) = (v))
#endif
...
#define BF_SSP_CTRL0_SDIO_IRQ_CHECK(v)                                         \
    (((v) << 28) & BM_SSP_CTRL0_SDIO_IRQ_CHECK)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL0_SDIO_IRQ_CHECK(n, v)                                      \
    BFn_CS1(SSP_CTRL0, n, SDIO_IRQ_CHECK, v)
#endif
...
#define HW_SSP_CMD0_SET(x, v)                                                  \
    ((*(volatile reg32_t *)HW_SSP_CMD0_SET_ADDR(x)) = (v))
#define HW_SSP_CMD0_CLR(x, v)                                                  \
    ((*(volatile reg32_t *)HW_SSP_CMD0_CLR_ADDR(x)) = (v))
#define HW_SSP_CMD0_TOG(x, v)                                                  \
    ((*(volatile reg32_t *)HW_SSP_CMD0_TOG_ADDR(x)) = (v))
#endif
...
#define BF_SSP_CMD0_DBL_DATA_RATE_EN(v)                                        \
    (((v) << 25) & BM_SSP_CMD0_DBL_DATA_RATE_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CMD0_DBL_DATA_RATE_EN(n, v)                                     \
    BFn_CS1(SSP_CMD0, n, DBL_DATA_RATE_EN, v)
#endif
...
#define BF_SSP_CMD0_PRIM_BOOT_OP_EN(v)                                         \
    (((v) << 24) & BM_SSP_CMD0_PRIM_BOOT_OP_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CMD0_PRIM_BOOT_OP_EN(n, v)                                      \
    BFn_CS1(SSP_CMD0, n, PRIM_BOOT_OP_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_SSP_XFER_SIZE(x)                                                    \
    (*(volatile hw_ssp_xfer_size_t *)HW_SSP_XFER_SIZE_ADDR(x))
#define HW_SSP_XFER_SIZE_RD(x) (HW_SSP_XFER_SIZE(x).U)
#define HW_SSP_XFER_SIZE_WR(x, v) (HW_SSP_XFER_SIZE(x).U = (v))
#define HW_SSP_XFER_SIZE_SET(x, v)                                             \
    (HW_SSP_XFER_SIZE_WR(x, HW_SSP_XFER_SIZE_RD(x) | (v)))
#define HW_SSP_XFER_SIZE_CLR(x, v)                                             \
    (HW_SSP_XFER_SIZE_WR(x, HW_SSP_XFER_SIZE_RD(x) & ~(v)))
#define HW_SSP_XFER_SIZE_TOG(x, v)                                             \
    (HW_SSP_XFER_SIZE_WR(x, HW_SSP_XFER_SIZE_RD(x) ^ (v)))
#endif
...
#endif
#ifndef __LANGUAGE_ASM__
#define BW_SSP_XFER_SIZE_XFER_COUNT(n, v)                                      \
    (HW_SSP_XFER_SIZE(n).B.XFER_COUNT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_SSP_BLOCK_SIZE(x)                                                   \
    (*(volatile hw_ssp_block_size_t *)HW_SSP_BLOCK_SIZE_ADDR(x))
#define HW_SSP_BLOCK_SIZE_RD(x) (HW_SSP_BLOCK_SIZE(x).U)
#define HW_SSP_BLOCK_SIZE_WR(x, v) (HW_SSP_BLOCK_SIZE(x).U = (v))
#define HW_SSP_BLOCK_SIZE_SET(x, v)                                            \
    (HW_SSP_BLOCK_SIZE_WR(x, HW_SSP_BLOCK_SIZE_RD(x) | (v)))
#define HW_SSP_BLOCK_SIZE_CLR(x, v)                                            \
    (HW_SSP_BLOCK_SIZE_WR(x, HW_SSP_BLOCK_SIZE_RD(x) & ~(v)))
#define HW_SSP_BLOCK_SIZE_TOG(x, v)                                            \
    (HW_SSP_BLOCK_SIZE_WR(x, HW_SSP_BLOCK_SIZE_RD(x) ^ (v)))
#endif
...
#define BF_SSP_BLOCK_SIZE_RSVD0(v)                                             \
    ((((reg32_t)v) << 28) & BM_SSP_BLOCK_SIZE_RSVD0)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_SSP_BLOCK_SIZE_BLOCK_COUNT(n, v)                                    \
    BFn_CS1(SSP_BLOCK_SIZE, n, BLOCK_COUNT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SSP_BLOCK_SIZE_BLOCK_SIZE(n, v)                                     \
    BFn_CS1(SSP_BLOCK_SIZE, n, BLOCK_SIZE, v)
#endif
...
#define HW_SSP_COMPREF_SET(x, v)                                               \
    (HW_SSP_COMPREF_WR(x, HW_SSP_COMPREF_RD(x) | (v)))
#define HW_SSP_COMPREF_CLR(x, v)                                               \
    (HW_SSP_COMPREF_WR(x, HW_SSP_COMPREF_RD(x) & ~(v)))
#define HW_SSP_COMPREF_TOG(x, v)                                               \
    (HW_SSP_COMPREF_WR(x, HW_SSP_COMPREF_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_SSP_COMPMASK(x)                                                     \
    (*(volatile hw_ssp_compmask_t *)HW_SSP_COMPMASK_ADDR(x))
#define HW_SSP_COMPMASK_RD(x) (HW_SSP_COMPMASK(x).U)
#define HW_SSP_COMPMASK_WR(x, v) (HW_SSP_COMPMASK(x).U = (v))
#define HW_SSP_COMPMASK_SET(x, v)                                              \
    (HW_SSP_COMPMASK_WR(x, HW_SSP_COMPMASK_RD(x) | (v)))
#define HW_SSP_COMPMASK_CLR(x, v)                                              \
    (HW_SSP_COMPMASK_WR(x, HW_SSP_COMPMASK_RD(x) & ~(v)))
#define HW_SSP_COMPMASK_TOG(x, v)                                              \
    (HW_SSP_COMPMASK_WR(x, HW_SSP_COMPMASK_RD(x) ^ (v)))
#endif
...
#define HW_SSP_TIMING_CLR(x, v)                                                \
    (HW_SSP_TIMING_WR(x, HW_SSP_TIMING_RD(x) & ~(v)))
...
#define HW_SSP_CTRL1_SET(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SSP_CTRL1_SET_ADDR(x)) = (v))
#define HW_SSP_CTRL1_CLR(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SSP_CTRL1_CLR_ADDR(x)) = (v))
#define HW_SSP_CTRL1_TOG(x, v)                                                 \
    ((*(volatile reg32_t *)HW_SSP_CTRL1_TOG_ADDR(x)) = (v))
#endif
...
#define BF_SSP_CTRL1_RESP_ERR_IRQ_EN(v)                                        \
    (((v) << 28) & BM_SSP_CTRL1_RESP_ERR_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_RESP_ERR_IRQ_EN(n, v)                                     \
    BFn_CS1(SSP_CTRL1, n, RESP_ERR_IRQ_EN, v)
#endif
...
#define BF_SSP_CTRL1_RESP_TIMEOUT_IRQ(v)                                       \
    (((v) << 27) & BM_SSP_CTRL1_RESP_TIMEOUT_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_RESP_TIMEOUT_IRQ(n, v)                                    \
    BFn_CS1(SSP_CTRL1, n, RESP_TIMEOUT_IRQ, v)
#endif
...
#define BF_SSP_CTRL1_RESP_TIMEOUT_IRQ_EN(v)                                    \
    (((v) << 26) & BM_SSP_CTRL1_RESP_TIMEOUT_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_RESP_TIMEOUT_IRQ_EN(n, v)                                 \
    BFn_CS1(SSP_CTRL1, n, RESP_TIMEOUT_IRQ_EN, v)
#endif
...
#define BF_SSP_CTRL1_DATA_TIMEOUT_IRQ(v)                                       \
    (((v) << 25) & BM_SSP_CTRL1_DATA_TIMEOUT_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_DATA_TIMEOUT_IRQ(n, v)                                    \
    BFn_CS1(SSP_CTRL1, n, DATA_TIMEOUT_IRQ, v)
#endif
...
#define BF_SSP_CTRL1_DATA_TIMEOUT_IRQ_EN(v)                                    \
    (((v) << 24) & BM_SSP_CTRL1_DATA_TIMEOUT_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_DATA_TIMEOUT_IRQ_EN(n, v)                                 \
    BFn_CS1(SSP_CTRL1, n, DATA_TIMEOUT_IRQ_EN, v)
#endif
...
#define BF_SSP_CTRL1_DATA_CRC_IRQ_EN(v)                                        \
    (((v) << 22) & BM_SSP_CTRL1_DATA_CRC_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_DATA_CRC_IRQ_EN(n, v)                                     \
    BFn_CS1(SSP_CTRL1, n, DATA_CRC_IRQ_EN, v)
#endif
...
#define BF_SSP_CTRL1_FIFO_UNDERRUN_IRQ(v)                                      \
    (((v) << 21) & BM_SSP_CTRL1_FIFO_UNDERRUN_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_FIFO_UNDERRUN_IRQ(n, v)                                   \
    BFn_CS1(SSP_CTRL1, n, FIFO_UNDERRUN_IRQ, v)
#endif
...
#define BF_SSP_CTRL1_FIFO_UNDERRUN_EN(v)                                       \
    (((v) << 20) & BM_SSP_CTRL1_FIFO_UNDERRUN_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_FIFO_UNDERRUN_EN(n, v)                                    \
    BFn_CS1(SSP_CTRL1, n, FIFO_UNDERRUN_EN, v)
#endif
...
#define BF_SSP_CTRL1_CEATA_CCS_ERR_IRQ(v)                                      \
    (((v) << 19) & BM_SSP_CTRL1_CEATA_CCS_ERR_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_CEATA_CCS_ERR_IRQ(n, v)                                   \
    BFn_CS1(SSP_CTRL1, n, CEATA_CCS_ERR_IRQ, v)
#endif
...
#define BF_SSP_CTRL1_CEATA_CCS_ERR_IRQ_EN(v)                                   \
    (((v) << 18) & BM_SSP_CTRL1_CEATA_CCS_ERR_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_CEATA_CCS_ERR_IRQ_EN(n, v)                                \
    BFn_CS1(SSP_CTRL1, n, CEATA_CCS_ERR_IRQ_EN, v)
#endif
...
#define BF_SSP_CTRL1_RECV_TIMEOUT_IRQ(v)                                       \
    (((v) << 17) & BM_SSP_CTRL1_RECV_TIMEOUT_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_RECV_TIMEOUT_IRQ(n, v)                                    \
    BFn_CS1(SSP_CTRL1, n, RECV_TIMEOUT_IRQ, v)
#endif
...
#define BF_SSP_CTRL1_RECV_TIMEOUT_IRQ_EN(v)                                    \
    (((v) << 16) & BM_SSP_CTRL1_RECV_TIMEOUT_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_RECV_TIMEOUT_IRQ_EN(n, v)                                 \
    BFn_CS1(SSP_CTRL1, n, RECV_TIMEOUT_IRQ_EN, v)
#endif
...
#define BF_SSP_CTRL1_FIFO_OVERRUN_IRQ(v)                                       \
    (((v) << 15) & BM_SSP_CTRL1_FIFO_OVERRUN_IRQ)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_FIFO_OVERRUN_IRQ(n, v)                                    \
    BFn_CS1(SSP_CTRL1, n, FIFO_OVERRUN_IRQ, v)
#endif
...
#define BF_SSP_CTRL1_FIFO_OVERRUN_IRQ_EN(v)                                    \
    (((v) << 14) & BM_SSP_CTRL1_FIFO_OVERRUN_IRQ_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_FIFO_OVERRUN_IRQ_EN(n, v)                                 \
    BFn_CS1(SSP_CTRL1, n, FIFO_OVERRUN_IRQ_EN, v)
#endif
...
#define BF_SSP_CTRL1_CEATA_CCS_ERR_EN(v)                                       \
    (((v) << 12) & BM_SSP_CTRL1_CEATA_CCS_ERR_EN)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_CEATA_CCS_ERR_EN(n, v)                                    \
    BFn_CS1(SSP_CTRL1, n, CEATA_CCS_ERR_EN, v)
#endif
...
#define BF_SSP_CTRL1_SLAVE_OUT_DISABLE(v)                                      \
    (((v) << 11) & BM_SSP_CTRL1_SLAVE_OUT_DISABLE)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_CTRL1_SLAVE_OUT_DISABLE(n, v)                                   \
    BFn_CS1(SSP_CTRL1, n, SLAVE_OUT_DISABLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_SSP_DDR_CTRL(x)                                                     \
    (*(volatile hw_ssp_ddr_ctrl_t *)HW_SSP_DDR_CTRL_ADDR(x))
#define HW_SSP_DDR_CTRL_RD(x) (HW_SSP_DDR_CTRL(x).U)
#define HW_SSP_DDR_CTRL_WR(x, v) (HW_SSP_DDR_CTRL(x).U = (v))
#define HW_SSP_DDR_CTRL_SET(x, v)                                              \
    (HW_SSP_DDR_CTRL_WR(x, HW_SSP_DDR_CTRL_RD(x) | (v)))
#define HW_SSP_DDR_CTRL_CLR(x, v)                                              \
    (HW_SSP_DDR_CTRL_WR(x, HW_SSP_DDR_CTRL_RD(x) & ~(v)))
#define HW_SSP_DDR_CTRL_TOG(x, v)                                              \
    (HW_SSP_DDR_CTRL_WR(x, HW_SSP_DDR_CTRL_RD(x) ^ (v)))
#endif
...
#define BF_SSP_DDR_CTRL_DMA_BURST_TYPE(v)                                      \
    ((((reg32_t)v) << 30) & BM_SSP_DDR_CTRL_DMA_BURST_TYPE)
#else
#define BF_SSP_DDR_CTRL_DMA_BURST_TYPE(v)                                      \
    (((v) << 30) & BM_SSP_DDR_CTRL_DMA_BURST_TYPE)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DDR_CTRL_DMA_BURST_TYPE(n, v)                                   \
    BFn_CS1(SSP_DDR_CTRL, n, DMA_BURST_TYPE, v)
#endif
...
#define BF_SSP_DDR_CTRL_TXCLK_DELAY_TYPE(v)                                    \
    (((v) << 0) & BM_SSP_DDR_CTRL_TXCLK_DELAY_TYPE)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DDR_CTRL_TXCLK_DELAY_TYPE(n, v)                                 \
    BFn_CS1(SSP_DDR_CTRL, n, TXCLK_DELAY_TYPE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_SSP_DLL_CTRL(x)                                                     \
    (*(volatile hw_ssp_dll_ctrl_t *)HW_SSP_DLL_CTRL_ADDR(x))
#define HW_SSP_DLL_CTRL_RD(x) (HW_SSP_DLL_CTRL(x).U)
#define HW_SSP_DLL_CTRL_WR(x, v) (HW_SSP_DLL_CTRL(x).U = (v))
#define HW_SSP_DLL_CTRL_SET(x, v)                                              \
    (HW_SSP_DLL_CTRL_WR(x, HW_SSP_DLL_CTRL_RD(x) | (v)))
#define HW_SSP_DLL_CTRL_CLR(x, v)                                              \
    (HW_SSP_DLL_CTRL_WR(x, HW_SSP_DLL_CTRL_RD(x) & ~(v)))
#define HW_SSP_DLL_CTRL_TOG(x, v)                                              \
    (HW_SSP_DLL_CTRL_WR(x, HW_SSP_DLL_CTRL_RD(x) ^ (v)))
#endif
...
#define BF_SSP_DLL_CTRL_REF_UPDATE_INT(v)                                      \
    ((((reg32_t)v) << 28) & BM_SSP_DLL_CTRL_REF_UPDATE_INT)
#else
#define BF_SSP_DLL_CTRL_REF_UPDATE_INT(v)                                      \
    (((v) << 28) & BM_SSP_DLL_CTRL_REF_UPDATE_INT)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DLL_CTRL_REF_UPDATE_INT(n, v)                                   \
    BFn_CS1(SSP_DLL_CTRL, n, REF_UPDATE_INT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DLL_CTRL_SLV_UPDATE_INT(n, v)                                   \
    BFn_CS1(SSP_DLL_CTRL, n, SLV_UPDATE_INT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DLL_CTRL_SLV_OVERRIDE_VAL(n, v)                                 \
    BFn_CS1(SSP_DLL_CTRL, n, SLV_OVERRIDE_VAL, v)
#endif
...
#define BF_SSP_DLL_CTRL_SLV_OVERRIDE(v)                                        \
    (((v) << 9) & BM_SSP_DLL_CTRL_SLV_OVERRIDE)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DLL_CTRL_SLV_OVERRIDE(n, v)                                     \
    BFn_CS1(SSP_DLL_CTRL, n, SLV_OVERRIDE, v)
#endif
...
#define BF_SSP_DLL_CTRL_GATE_UPDATE(v)                                         \
    (((v) << 7) & BM_SSP_DLL_CTRL_GATE_UPDATE)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DLL_CTRL_GATE_UPDATE(n, v)                                      \
    BFn_CS1(SSP_DLL_CTRL, n, GATE_UPDATE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DLL_CTRL_SLV_DLY_TARGET(n, v)                                   \
    BFn_CS1(SSP_DLL_CTRL, n, SLV_DLY_TARGET, v)
#endif
...
#define BF_SSP_DLL_CTRL_SLV_FORCE_UPD(v)                                       \
    (((v) << 2) & BM_SSP_DLL_CTRL_SLV_FORCE_UPD)
#ifndef __LANGUAGE_ASM__
#define BW_SSP_DLL_CTRL_SLV_FORCE_UPD(n, v)                                    \
    BFn_CS1(SSP_DLL_CTRL, n, SLV_FORCE_UPD, v)
#endif
...
#define BF_SSP_STATUS_RECV_TIMEOUT_STAT(v)                                     \
    (((v) << 11) & BM_SSP_STATUS_RECV_TIMEOUT_STAT)
...
#define BF_SSP_STATUS_CEATA_CCS_ERR(v)                                         \
    (((v) << 10) & BM_SSP_STATUS_CEATA_CCS_ERR)
...
#define BF_SSP_DEBUG_DATACRC_ERR(v)                                            \
    ((((reg32_t)v) << 28) & BM_SSP_DEBUG_DATACRC_ERR)
#else
