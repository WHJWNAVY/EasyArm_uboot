...
#define REGS_UARTAPP_BASE(x)                                                   \
    (x == 0 ? REGS_UARTAPP0_BASE                                               \
            : x == 1 ? REGS_UARTAPP1_BASE                                      \
                     : x == 2 ? REGS_UARTAPP2_BASE                             \
                              : x == 3 ? REGS_UARTAPP3_BASE                    \
                                       : x == 4 ? REGS_UARTAPP4_BASE           \
                                                : 0xffff0000)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_CTRL0(x)                                                    \
    (*(volatile hw_uartapp_ctrl0_t *)HW_UARTAPP_CTRL0_ADDR(x))
#define HW_UARTAPP_CTRL0_RD(x) (HW_UARTAPP_CTRL0(x).U)
#define HW_UARTAPP_CTRL0_WR(x, v) (HW_UARTAPP_CTRL0(x).U = (v))
#define HW_UARTAPP_CTRL0_SET(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL0_SET_ADDR(x)) = (v))
#define HW_UARTAPP_CTRL0_CLR(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL0_CLR_ADDR(x)) = (v))
#define HW_UARTAPP_CTRL0_TOG(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL0_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_UARTAPP_CTRL0_SFTRST(v)                                             \
    ((((reg32_t)v) << 31) & BM_UARTAPP_CTRL0_SFTRST)
#else
...
#define BF_UARTAPP_CTRL0_RXTO_ENABLE(v)                                        \
    (((v) << 27) & BM_UARTAPP_CTRL0_RXTO_ENABLE)
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_RXTO_ENABLE(n, v)                                     \
    BFn_CS1(UARTAPP_CTRL0, n, RXTO_ENABLE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL0_XFER_COUNT(n, v)                                      \
    (HW_UARTAPP_CTRL0(n).B.XFER_COUNT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_CTRL1(x)                                                    \
    (*(volatile hw_uartapp_ctrl1_t *)HW_UARTAPP_CTRL1_ADDR(x))
#define HW_UARTAPP_CTRL1_RD(x) (HW_UARTAPP_CTRL1(x).U)
#define HW_UARTAPP_CTRL1_WR(x, v) (HW_UARTAPP_CTRL1(x).U = (v))
#define HW_UARTAPP_CTRL1_SET(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL1_SET_ADDR(x)) = (v))
#define HW_UARTAPP_CTRL1_CLR(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL1_CLR_ADDR(x)) = (v))
#define HW_UARTAPP_CTRL1_TOG(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL1_TOG_ADDR(x)) = (v))
#endif
...
#define BF_UARTAPP_CTRL1_RSVD2(v)                                              \
    ((((reg32_t)v) << 29) & BM_UARTAPP_CTRL1_RSVD2)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL1_XFER_COUNT(n, v)                                      \
    (HW_UARTAPP_CTRL1(n).B.XFER_COUNT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_CTRL2(x)                                                    \
    (*(volatile hw_uartapp_ctrl2_t *)HW_UARTAPP_CTRL2_ADDR(x))
#define HW_UARTAPP_CTRL2_RD(x) (HW_UARTAPP_CTRL2(x).U)
#define HW_UARTAPP_CTRL2_WR(x, v) (HW_UARTAPP_CTRL2(x).U = (v))
#define HW_UARTAPP_CTRL2_SET(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL2_SET_ADDR(x)) = (v))
#define HW_UARTAPP_CTRL2_CLR(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL2_CLR_ADDR(x)) = (v))
#define HW_UARTAPP_CTRL2_TOG(x, v)                                             \
    ((*(volatile reg32_t *)HW_UARTAPP_CTRL2_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_UARTAPP_CTRL2_INVERT_RTS(v)                                         \
    ((((reg32_t)v) << 31) & BM_UARTAPP_CTRL2_INVERT_RTS)
#else
#define BF_UARTAPP_CTRL2_INVERT_RTS(v)                                         \
    (((v) << 31) & BM_UARTAPP_CTRL2_INVERT_RTS)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_INVERT_RTS(n, v)                                      \
    BFn_CS1(UARTAPP_CTRL2, n, INVERT_RTS, v)
#endif
...
#define BF_UARTAPP_CTRL2_INVERT_CTS(v)                                         \
    (((v) << 30) & BM_UARTAPP_CTRL2_INVERT_CTS)
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_INVERT_CTS(n, v)                                      \
    BFn_CS1(UARTAPP_CTRL2, n, INVERT_CTS, v)
#endif
...
#define BF_UARTAPP_CTRL2_RTS_SEMAPHORE(v)                                      \
    (((v) << 27) & BM_UARTAPP_CTRL2_RTS_SEMAPHORE)
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_CTRL2_RTS_SEMAPHORE(n, v)                                   \
    BFn_CS1(UARTAPP_CTRL2, n, RTS_SEMAPHORE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_LINECTRL(x)                                                 \
    (*(volatile hw_uartapp_linectrl_t *)HW_UARTAPP_LINECTRL_ADDR(x))
#define HW_UARTAPP_LINECTRL_RD(x) (HW_UARTAPP_LINECTRL(x).U)
#define HW_UARTAPP_LINECTRL_WR(x, v) (HW_UARTAPP_LINECTRL(x).U = (v))
#define HW_UARTAPP_LINECTRL_SET(x, v)                                          \
    ((*(volatile reg32_t *)HW_UARTAPP_LINECTRL_SET_ADDR(x)) = (v))
#define HW_UARTAPP_LINECTRL_CLR(x, v)                                          \
    ((*(volatile reg32_t *)HW_UARTAPP_LINECTRL_CLR_ADDR(x)) = (v))
#define HW_UARTAPP_LINECTRL_TOG(x, v)                                          \
    ((*(volatile reg32_t *)HW_UARTAPP_LINECTRL_TOG_ADDR(x)) = (v))
#endif
...
#define BF_UARTAPP_LINECTRL_BAUD_DIVINT(v)                                     \
    ((((reg32_t)v) << 16) & BM_UARTAPP_LINECTRL_BAUD_DIVINT)
#else
#define BF_UARTAPP_LINECTRL_BAUD_DIVINT(v)                                     \
    (((v) << 16) & BM_UARTAPP_LINECTRL_BAUD_DIVINT)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_BAUD_DIVINT(n, v)                                  \
    (HW_UARTAPP_LINECTRL(n).B.BAUD_DIVINT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL_BAUD_DIVFRAC(n, v)                                 \
    BFn_CS1(UARTAPP_LINECTRL, n, BAUD_DIVFRAC, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_LINECTRL2(x)                                                \
    (*(volatile hw_uartapp_linectrl2_t *)HW_UARTAPP_LINECTRL2_ADDR(x))
#define HW_UARTAPP_LINECTRL2_RD(x) (HW_UARTAPP_LINECTRL2(x).U)
#define HW_UARTAPP_LINECTRL2_WR(x, v) (HW_UARTAPP_LINECTRL2(x).U = (v))
#define HW_UARTAPP_LINECTRL2_SET(x, v)                                         \
    ((*(volatile reg32_t *)HW_UARTAPP_LINECTRL2_SET_ADDR(x)) = (v))
#define HW_UARTAPP_LINECTRL2_CLR(x, v)                                         \
    ((*(volatile reg32_t *)HW_UARTAPP_LINECTRL2_CLR_ADDR(x)) = (v))
#define HW_UARTAPP_LINECTRL2_TOG(x, v)                                         \
    ((*(volatile reg32_t *)HW_UARTAPP_LINECTRL2_TOG_ADDR(x)) = (v))
#endif
...
#define BF_UARTAPP_LINECTRL2_BAUD_DIVINT(v)                                    \
    ((((reg32_t)v) << 16) & BM_UARTAPP_LINECTRL2_BAUD_DIVINT)
#else
#define BF_UARTAPP_LINECTRL2_BAUD_DIVINT(v)                                    \
    (((v) << 16) & BM_UARTAPP_LINECTRL2_BAUD_DIVINT)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_BAUD_DIVINT(n, v)                                 \
    (HW_UARTAPP_LINECTRL2(n).B.BAUD_DIVINT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_LINECTRL2_BAUD_DIVFRAC(n, v)                                \
    BFn_CS1(UARTAPP_LINECTRL2, n, BAUD_DIVFRAC, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_INTR(x)                                                     \
    (*(volatile hw_uartapp_intr_t *)HW_UARTAPP_INTR_ADDR(x))
#define HW_UARTAPP_INTR_RD(x) (HW_UARTAPP_INTR(x).U)
#define HW_UARTAPP_INTR_WR(x, v) (HW_UARTAPP_INTR(x).U = (v))
#define HW_UARTAPP_INTR_SET(x, v)                                              \
    ((*(volatile reg32_t *)HW_UARTAPP_INTR_SET_ADDR(x)) = (v))
#define HW_UARTAPP_INTR_CLR(x, v)                                              \
    ((*(volatile reg32_t *)HW_UARTAPP_INTR_CLR_ADDR(x)) = (v))
#define HW_UARTAPP_INTR_TOG(x, v)                                              \
    ((*(volatile reg32_t *)HW_UARTAPP_INTR_TOG_ADDR(x)) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_DATA(x)                                                     \
    (*(volatile hw_uartapp_data_t *)HW_UARTAPP_DATA_ADDR(x))
#define HW_UARTAPP_DATA_RD(x) (HW_UARTAPP_DATA(x).U)
#define HW_UARTAPP_DATA_WR(x, v) (HW_UARTAPP_DATA(x).U = (v))
#define HW_UARTAPP_DATA_SET(x, v)                                              \
    (HW_UARTAPP_DATA_WR(x, HW_UARTAPP_DATA_RD(x) | (v)))
#define HW_UARTAPP_DATA_CLR(x, v)                                              \
    (HW_UARTAPP_DATA_WR(x, HW_UARTAPP_DATA_RD(x) & ~(v)))
#define HW_UARTAPP_DATA_TOG(x, v)                                              \
    (HW_UARTAPP_DATA_WR(x, HW_UARTAPP_DATA_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_STAT(x)                                                     \
    (*(volatile hw_uartapp_stat_t *)HW_UARTAPP_STAT_ADDR(x))
#define HW_UARTAPP_STAT_RD(x) (HW_UARTAPP_STAT(x).U)
#define HW_UARTAPP_STAT_WR(x, v) (HW_UARTAPP_STAT(x).U = (v))
#define HW_UARTAPP_STAT_SET(x, v)                                              \
    (HW_UARTAPP_STAT_WR(x, HW_UARTAPP_STAT_RD(x) | (v)))
#define HW_UARTAPP_STAT_CLR(x, v)                                              \
    (HW_UARTAPP_STAT_WR(x, HW_UARTAPP_STAT_RD(x) & ~(v)))
#define HW_UARTAPP_STAT_TOG(x, v)                                              \
    (HW_UARTAPP_STAT_WR(x, HW_UARTAPP_STAT_RD(x) ^ (v)))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_UARTAPP_STAT_PRESENT(v)                                             \
    ((((reg32_t)v) << 31) & BM_UARTAPP_STAT_PRESENT)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_STAT_RXBYTE_INVALID(n, v)                                   \
    BFn_CS1(UARTAPP_STAT, n, RXBYTE_INVALID, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_DEBUG(x)                                                    \
    (*(volatile hw_uartapp_debug_t *)HW_UARTAPP_DEBUG_ADDR(x))
...
#define BF_UARTAPP_DEBUG_RXIBAUD_DIV(v)                                        \
    ((((reg32_t)v) << 16) & BM_UARTAPP_DEBUG_RXIBAUD_DIV)
#else
#define BF_UARTAPP_DEBUG_RXIBAUD_DIV(v)                                        \
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_VERSION(x)                                                  \
    (*(volatile hw_uartapp_version_t *)HW_UARTAPP_VERSION_ADDR(x))
...
#define BF_UARTAPP_VERSION_MAJOR(v)                                            \
    ((((reg32_t)v) << 24) & BM_UARTAPP_VERSION_MAJOR)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_UARTAPP_AUTOBAUD(x)                                                 \
    (*(volatile hw_uartapp_autobaud_t *)HW_UARTAPP_AUTOBAUD_ADDR(x))
#define HW_UARTAPP_AUTOBAUD_RD(x) (HW_UARTAPP_AUTOBAUD(x).U)
#define HW_UARTAPP_AUTOBAUD_WR(x, v) (HW_UARTAPP_AUTOBAUD(x).U = (v))
#define HW_UARTAPP_AUTOBAUD_SET(x, v)                                          \
    (HW_UARTAPP_AUTOBAUD_WR(x, HW_UARTAPP_AUTOBAUD_RD(x) | (v)))
#define HW_UARTAPP_AUTOBAUD_CLR(x, v)                                          \
    (HW_UARTAPP_AUTOBAUD_WR(x, HW_UARTAPP_AUTOBAUD_RD(x) & ~(v)))
#define HW_UARTAPP_AUTOBAUD_TOG(x, v)                                          \
    (HW_UARTAPP_AUTOBAUD_WR(x, HW_UARTAPP_AUTOBAUD_RD(x) ^ (v)))
#endif
...
#define BF_UARTAPP_AUTOBAUD_REFCHAR1(v)                                        \
    ((((reg32_t)v) << 24) & BM_UARTAPP_AUTOBAUD_REFCHAR1)
#else
#define BF_UARTAPP_AUTOBAUD_REFCHAR1(v)                                        \
    (((v) << 24) & BM_UARTAPP_AUTOBAUD_REFCHAR1)
#endif
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_AUTOBAUD_REFCHAR1(n, v)                                     \
    (HW_UARTAPP_AUTOBAUD(n).B.REFCHAR1 = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_AUTOBAUD_REFCHAR0(n, v)                                     \
    (HW_UARTAPP_AUTOBAUD(n).B.REFCHAR0 = (v))
#endif
...
#define BF_UARTAPP_AUTOBAUD_UPDATE_TX(v)                                       \
    (((v) << 4) & BM_UARTAPP_AUTOBAUD_UPDATE_TX)
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_AUTOBAUD_UPDATE_TX(n, v)                                    \
    BFn_CS1(UARTAPP_AUTOBAUD, n, UPDATE_TX, v)
#endif
...
#define BF_UARTAPP_AUTOBAUD_TWO_REF_CHARS(v)                                   \
    (((v) << 3) & BM_UARTAPP_AUTOBAUD_TWO_REF_CHARS)
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_AUTOBAUD_TWO_REF_CHARS(n, v)                                \
    BFn_CS1(UARTAPP_AUTOBAUD, n, TWO_REF_CHARS, v)
#endif
...
#define BF_UARTAPP_AUTOBAUD_START_WITH_RUNBIT(v)                               \
    (((v) << 2) & BM_UARTAPP_AUTOBAUD_START_WITH_RUNBIT)
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_AUTOBAUD_START_WITH_RUNBIT(n, v)                            \
    BFn_CS1(UARTAPP_AUTOBAUD, n, START_WITH_RUNBIT, v)
#endif
...
#define BF_UARTAPP_AUTOBAUD_START_BAUD_DETECT(v)                               \
    (((v) << 1) & BM_UARTAPP_AUTOBAUD_START_BAUD_DETECT)
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_AUTOBAUD_START_BAUD_DETECT(n, v)                            \
    BFn_CS1(UARTAPP_AUTOBAUD, n, START_BAUD_DETECT, v)
#endif
...
#define BF_UARTAPP_AUTOBAUD_BAUD_DETECT_ENABLE(v)                              \
    (((v) << 0) & BM_UARTAPP_AUTOBAUD_BAUD_DETECT_ENABLE)
#ifndef __LANGUAGE_ASM__
#define BW_UARTAPP_AUTOBAUD_BAUD_DETECT_ENABLE(n, v)                           \
    BFn_CS1(UARTAPP_AUTOBAUD, n, BAUD_DETECT_ENABLE, v)
#endif
