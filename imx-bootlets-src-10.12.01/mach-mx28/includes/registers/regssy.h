...
#define HW_SY_IBS_DSIZER_SET(v)                                                \
    (HW_SY_IBS_DSIZER_WR(HW_SY_IBS_DSIZER_RD() | (v)))
#define HW_SY_IBS_DSIZER_CLR(v)                                                \
    (HW_SY_IBS_DSIZER_WR(HW_SY_IBS_DSIZER_RD() & ~(v)))
#define HW_SY_IBS_DSIZER_TOG(v)                                                \
    (HW_SY_IBS_DSIZER_WR(HW_SY_IBS_DSIZER_RD() ^ (v)))
#endif
...
#define HW_SY_IBS_WDATAR_SET(v)                                                \
    (HW_SY_IBS_WDATAR_WR(HW_SY_IBS_WDATAR_RD() | (v)))
#define HW_SY_IBS_WDATAR_CLR(v)                                                \
    (HW_SY_IBS_WDATAR_WR(HW_SY_IBS_WDATAR_RD() & ~(v)))
#define HW_SY_IBS_WDATAR_TOG(v)                                                \
    (HW_SY_IBS_WDATAR_WR(HW_SY_IBS_WDATAR_RD() ^ (v)))
#endif
