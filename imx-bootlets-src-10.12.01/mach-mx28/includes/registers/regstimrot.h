...
#define HW_TIMROT_ROTCTRL                                                      \
    (*(volatile hw_timrot_rotctrl_t *)HW_TIMROT_ROTCTRL_ADDR)
#define HW_TIMROT_ROTCTRL_RD() (HW_TIMROT_ROTCTRL.U)
#define HW_TIMROT_ROTCTRL_WR(v) (HW_TIMROT_ROTCTRL.U = (v))
#define HW_TIMROT_ROTCTRL_SET(v)                                               \
    ((*(volatile reg32_t *)HW_TIMROT_ROTCTRL_SET_ADDR) = (v))
#define HW_TIMROT_ROTCTRL_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_TIMROT_ROTCTRL_CLR_ADDR) = (v))
#define HW_TIMROT_ROTCTRL_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_TIMROT_ROTCTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_TIMROT_ROTCTRL_SFTRST(v)                                            \
    ((((reg32_t)v) << 31) & BM_TIMROT_ROTCTRL_SFTRST)
#else
...
#define BF_TIMROT_ROTCTRL_ROTARY_PRESENT(v)                                    \
    (((v) << 29) & BM_TIMROT_ROTCTRL_ROTARY_PRESENT)
...
#define BF_TIMROT_ROTCTRL_TIM3_PRESENT(v)                                      \
    (((v) << 28) & BM_TIMROT_ROTCTRL_TIM3_PRESENT)
...
#define BF_TIMROT_ROTCTRL_TIM2_PRESENT(v)                                      \
    (((v) << 27) & BM_TIMROT_ROTCTRL_TIM2_PRESENT)
...
#define BF_TIMROT_ROTCTRL_TIM1_PRESENT(v)                                      \
    (((v) << 26) & BM_TIMROT_ROTCTRL_TIM1_PRESENT)
...
#define BF_TIMROT_ROTCTRL_TIM0_PRESENT(v)                                      \
    (((v) << 25) & BM_TIMROT_ROTCTRL_TIM0_PRESENT)
...
#define BF_TIMROT_ROTCTRL_POLARITY_B(v)                                        \
    (((v) << 9) & BM_TIMROT_ROTCTRL_POLARITY_B)
#ifndef __LANGUAGE_ASM__
...
#define BF_TIMROT_ROTCTRL_POLARITY_A(v)                                        \
    (((v) << 8) & BM_TIMROT_ROTCTRL_POLARITY_A)
#ifndef __LANGUAGE_ASM__
...
#ifndef __LANGUAGE_ASM__
#define HW_TIMROT_ROTCOUNT                                                     \
    (*(volatile hw_timrot_rotcount_t *)HW_TIMROT_ROTCOUNT_ADDR)
...
#define BF_TIMROT_ROTCOUNT_RSRVD1(v)                                           \
    ((((reg32_t)v) << 16) & BM_TIMROT_ROTCOUNT_RSRVD1)
#else
...
#define HW_TIMROT_TIMCTRLn(n)                                                  \
    (*(volatile hw_timrot_timctrln_t *)HW_TIMROT_TIMCTRLn_ADDR(n))
#define HW_TIMROT_TIMCTRLn_RD(n) (HW_TIMROT_TIMCTRLn(n).U)
#define HW_TIMROT_TIMCTRLn_WR(n, v) (HW_TIMROT_TIMCTRLn(n).U = (v))
#define HW_TIMROT_TIMCTRLn_SET(n, v)                                           \
    ((*(volatile reg32_t *)HW_TIMROT_TIMCTRLn_SET_ADDR(n)) = (v))
#define HW_TIMROT_TIMCTRLn_CLR(n, v)                                           \
    ((*(volatile reg32_t *)HW_TIMROT_TIMCTRLn_CLR_ADDR(n)) = (v))
#define HW_TIMROT_TIMCTRLn_TOG(n, v)                                           \
    ((*(volatile reg32_t *)HW_TIMROT_TIMCTRLn_TOG_ADDR(n)) = (v))
#endif
...
#define BF_TIMROT_TIMCTRLn_RSRVD3(v)                                           \
    ((((reg32_t)v) << 16) & BM_TIMROT_TIMCTRLn_RSRVD3)
#else
...
#define BF_TIMROT_TIMCTRLn_MATCH_MODE(v)                                       \
    (((v) << 11) & BM_TIMROT_TIMCTRLn_MATCH_MODE)
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_TIMCTRLn_MATCH_MODE(n, v)                                    \
    BF_CS1n(TIMROT_TIMCTRLn, n, MATCH_MODE, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_TIMCTRLn_POLARITY(n, v)                                      \
    BF_CS1n(TIMROT_TIMCTRLn, n, POLARITY, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_TIMCTRLn_PRESCALE(n, v)                                      \
    BF_CS1n(TIMROT_TIMCTRLn, n, PRESCALE, v)
#endif
...
#define HW_TIMROT_RUNNING_COUNTn(n)                                            \
    (*(volatile hw_timrot_running_countn_t *)HW_TIMROT_RUNNING_COUNTn_ADDR(n))
#define HW_TIMROT_RUNNING_COUNTn_RD(n) (HW_TIMROT_RUNNING_COUNTn(n).U)
#endif

/*
 * constants & macros for individual HW_TIMROT_RUNNING_COUNTn multi-register
 * bitfields
 */
...
#define HW_TIMROT_FIXED_COUNTn(n)                                              \
    (*(volatile hw_timrot_fixed_countn_t *)HW_TIMROT_FIXED_COUNTn_ADDR(n))
...
#define HW_TIMROT_FIXED_COUNTn_SET(n, v)                                       \
    (HW_TIMROT_FIXED_COUNTn_WR(n, HW_TIMROT_FIXED_COUNTn_RD(n) | (v)))
#define HW_TIMROT_FIXED_COUNTn_CLR(n, v)                                       \
    (HW_TIMROT_FIXED_COUNTn_WR(n, HW_TIMROT_FIXED_COUNTn_RD(n) & ~(v)))
#define HW_TIMROT_FIXED_COUNTn_TOG(n, v)                                       \
    (HW_TIMROT_FIXED_COUNTn_WR(n, HW_TIMROT_FIXED_COUNTn_RD(n) ^ (v)))
#endif

/*
 * constants & macros for individual HW_TIMROT_FIXED_COUNTn multi-register
 * bitfields
 */
...
#endif
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_FIXED_COUNTn_FIXED_COUNT(n, v)                               \
    (HW_TIMROT_FIXED_COUNTn(n).B.FIXED_COUNT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TIMROT_MATCH_COUNTn(n)                                              \
    (*(volatile hw_timrot_match_countn_t *)HW_TIMROT_MATCH_COUNTn_ADDR(n))
...
#define HW_TIMROT_MATCH_COUNTn_SET(n, v)                                       \
    (HW_TIMROT_MATCH_COUNTn_WR(n, HW_TIMROT_MATCH_COUNTn_RD(n) | (v)))
#define HW_TIMROT_MATCH_COUNTn_CLR(n, v)                                       \
    (HW_TIMROT_MATCH_COUNTn_WR(n, HW_TIMROT_MATCH_COUNTn_RD(n) & ~(v)))
#define HW_TIMROT_MATCH_COUNTn_TOG(n, v)                                       \
    (HW_TIMROT_MATCH_COUNTn_WR(n, HW_TIMROT_MATCH_COUNTn_RD(n) ^ (v)))
#endif

/*
 * constants & macros for individual HW_TIMROT_MATCH_COUNTn multi-register
 * bitfields
 */
...
#endif
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_MATCH_COUNTn_MATCH_COUNT(n, v)                               \
    (HW_TIMROT_MATCH_COUNTn(n).B.MATCH_COUNT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TIMROT_TIMCTRL3                                                     \
    (*(volatile hw_timrot_timctrl3_t *)HW_TIMROT_TIMCTRL3_ADDR)
#define HW_TIMROT_TIMCTRL3_RD() (HW_TIMROT_TIMCTRL3.U)
#define HW_TIMROT_TIMCTRL3_WR(v) (HW_TIMROT_TIMCTRL3.U = (v))
#define HW_TIMROT_TIMCTRL3_SET(v)                                              \
    ((*(volatile reg32_t *)HW_TIMROT_TIMCTRL3_SET_ADDR) = (v))
#define HW_TIMROT_TIMCTRL3_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_TIMROT_TIMCTRL3_CLR_ADDR) = (v))
#define HW_TIMROT_TIMCTRL3_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_TIMROT_TIMCTRL3_TOG_ADDR) = (v))
#endif
...
#define BF_TIMROT_TIMCTRL3_RSRVD2(v)                                           \
    ((((reg32_t)v) << 20) & BM_TIMROT_TIMCTRL3_RSRVD2)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_TIMCTRL3_TEST_SIGNAL(v)                                      \
    BF_CS1(TIMROT_TIMCTRL3, TEST_SIGNAL, v)
#endif
...
#define BF_TIMROT_TIMCTRL3_MATCH_MODE(v)                                       \
    (((v) << 11) & BM_TIMROT_TIMCTRL3_MATCH_MODE)
#ifndef __LANGUAGE_ASM__
...
#define BF_TIMROT_TIMCTRL3_DUTY_VALID(v)                                       \
    (((v) << 10) & BM_TIMROT_TIMCTRL3_DUTY_VALID)
...
#define BF_TIMROT_TIMCTRL3_DUTY_CYCLE(v)                                       \
    (((v) << 9) & BM_TIMROT_TIMCTRL3_DUTY_CYCLE)
#ifndef __LANGUAGE_ASM__
...
#define BF_TIMROT_TIMCTRL3_POLARITY(v)                                         \
    (((v) << 8) & BM_TIMROT_TIMCTRL3_POLARITY)
#ifndef __LANGUAGE_ASM__
...
#ifndef __LANGUAGE_ASM__
#define HW_TIMROT_RUNNING_COUNT3                                               \
    (*(volatile hw_timrot_running_count3_t *)HW_TIMROT_RUNNING_COUNT3_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_TIMROT_FIXED_COUNT3                                                 \
    (*(volatile hw_timrot_fixed_count3_t *)HW_TIMROT_FIXED_COUNT3_ADDR)
#define HW_TIMROT_FIXED_COUNT3_RD() (HW_TIMROT_FIXED_COUNT3.U)
#define HW_TIMROT_FIXED_COUNT3_WR(v) (HW_TIMROT_FIXED_COUNT3.U = (v))
#define HW_TIMROT_FIXED_COUNT3_SET(v)                                          \
    (HW_TIMROT_FIXED_COUNT3_WR(HW_TIMROT_FIXED_COUNT3_RD() | (v)))
#define HW_TIMROT_FIXED_COUNT3_CLR(v)                                          \
    (HW_TIMROT_FIXED_COUNT3_WR(HW_TIMROT_FIXED_COUNT3_RD() & ~(v)))
#define HW_TIMROT_FIXED_COUNT3_TOG(v)                                          \
    (HW_TIMROT_FIXED_COUNT3_WR(HW_TIMROT_FIXED_COUNT3_RD() ^ (v)))
#endif
...
#endif
#ifndef __LANGUAGE_ASM__
#define BW_TIMROT_FIXED_COUNT3_HIGH_FIXED_COUNT(v)                             \
    (HW_TIMROT_FIXED_COUNT3.B.HIGH_FIXED_COUNT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_TIMROT_VERSION                                                      \
    (*(volatile hw_timrot_version_t *)HW_TIMROT_VERSION_ADDR)
...
#define BF_TIMROT_VERSION_MAJOR(v)                                             \
    ((((reg32_t)v) << 24) & BM_TIMROT_VERSION_MAJOR)
#else
