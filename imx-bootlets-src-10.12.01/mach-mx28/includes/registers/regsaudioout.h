...
#define HW_AUDIOOUT_CTRL_SET(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_CTRL_SET_ADDR) = (v))
#define HW_AUDIOOUT_CTRL_CLR(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_CTRL_CLR_ADDR) = (v))
#define HW_AUDIOOUT_CTRL_TOG(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_CTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOOUT_CTRL_SFTRST(v)                                             \
    ((((reg32_t)v) << 31) & BM_AUDIOOUT_CTRL_SFTRST)
#else
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_CTRL_DMAWAIT_COUNT(v)                                      \
    BF_CS1(AUDIOOUT_CTRL, DMAWAIT_COUNT, v)
#endif
...
#define BF_AUDIOOUT_CTRL_INVERT_1BIT(v)                                        \
    (((v) << 12) & BM_AUDIOOUT_CTRL_INVERT_1BIT)
...
#define BF_AUDIOOUT_CTRL_WORD_LENGTH(v)                                        \
    (((v) << 6) & BM_AUDIOOUT_CTRL_WORD_LENGTH)
...
#define BF_AUDIOOUT_CTRL_DAC_ZERO_ENABLE(v)                                    \
    (((v) << 5) & BM_AUDIOOUT_CTRL_DAC_ZERO_ENABLE)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_CTRL_DAC_ZERO_ENABLE(v)                                    \
    BF_CS1(AUDIOOUT_CTRL, DAC_ZERO_ENABLE, v)
#endif
...
#define BF_AUDIOOUT_CTRL_FIFO_UNDERFLOW_IRQ(v)                                 \
    (((v) << 3) & BM_AUDIOOUT_CTRL_FIFO_UNDERFLOW_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_CTRL_FIFO_UNDERFLOW_IRQ(v)                                 \
    BF_CS1(AUDIOOUT_CTRL, FIFO_UNDERFLOW_IRQ, v)
#endif
...
#define BF_AUDIOOUT_CTRL_FIFO_OVERFLOW_IRQ(v)                                  \
    (((v) << 2) & BM_AUDIOOUT_CTRL_FIFO_OVERFLOW_IRQ)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_CTRL_FIFO_OVERFLOW_IRQ(v)                                  \
    BF_CS1(AUDIOOUT_CTRL, FIFO_OVERFLOW_IRQ, v)
#endif
...
#define BF_AUDIOOUT_CTRL_FIFO_ERROR_IRQ_EN(v)                                  \
    (((v) << 1) & BM_AUDIOOUT_CTRL_FIFO_ERROR_IRQ_EN)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_CTRL_FIFO_ERROR_IRQ_EN(v)                                  \
    BF_CS1(AUDIOOUT_CTRL, FIFO_ERROR_IRQ_EN, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOOUT_STAT_DAC_PRESENT(v)                                        \
    ((((reg32_t)v) << 31) & BM_AUDIOOUT_STAT_DAC_PRESENT)
#else
#define BF_AUDIOOUT_STAT_DAC_PRESENT(v)                                        \
    (((v) << 31) & BM_AUDIOOUT_STAT_DAC_PRESENT)
#endif
...
#define HW_AUDIOOUT_DACSRR                                                     \
    (*(volatile hw_audioout_dacsrr_t *)HW_AUDIOOUT_DACSRR_ADDR)
#define HW_AUDIOOUT_DACSRR_RD() (HW_AUDIOOUT_DACSRR.U)
#define HW_AUDIOOUT_DACSRR_WR(v) (HW_AUDIOOUT_DACSRR.U = (v))
#define HW_AUDIOOUT_DACSRR_SET(v)                                              \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACSRR_SET_ADDR) = (v))
#define HW_AUDIOOUT_DACSRR_CLR(v)                                              \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACSRR_CLR_ADDR) = (v))
#define HW_AUDIOOUT_DACSRR_TOG(v)                                              \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACSRR_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOOUT_DACSRR_OSR(v)                                              \
    ((((reg32_t)v) << 31) & BM_AUDIOOUT_DACSRR_OSR)
#else
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_DACVOLUME                                                  \
    (*(volatile hw_audioout_dacvolume_t *)HW_AUDIOOUT_DACVOLUME_ADDR)
#define HW_AUDIOOUT_DACVOLUME_RD() (HW_AUDIOOUT_DACVOLUME.U)
#define HW_AUDIOOUT_DACVOLUME_WR(v) (HW_AUDIOOUT_DACVOLUME.U = (v))
#define HW_AUDIOOUT_DACVOLUME_SET(v)                                           \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACVOLUME_SET_ADDR) = (v))
#define HW_AUDIOOUT_DACVOLUME_CLR(v)                                           \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACVOLUME_CLR_ADDR) = (v))
#define HW_AUDIOOUT_DACVOLUME_TOG(v)                                           \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACVOLUME_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOOUT_DACVOLUME_VOLUME_UPDATE_LEFT(v)                            \
    (((v) << 28) & BM_AUDIOOUT_DACVOLUME_VOLUME_UPDATE_LEFT)
...
#define BF_AUDIOOUT_DACVOLUME_EN_ZCD(v)                                        \
    (((v) << 25) & BM_AUDIOOUT_DACVOLUME_EN_ZCD)
...
#define BF_AUDIOOUT_DACVOLUME_MUTE_LEFT(v)                                     \
    (((v) << 24) & BM_AUDIOOUT_DACVOLUME_MUTE_LEFT)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_DACVOLUME_MUTE_LEFT(v)                                     \
    BF_CS1(AUDIOOUT_DACVOLUME, MUTE_LEFT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_DACVOLUME_VOLUME_LEFT(v)                                   \
    (HW_AUDIOOUT_DACVOLUME.B.VOLUME_LEFT = (v))
#endif
...
#define BF_AUDIOOUT_DACVOLUME_VOLUME_UPDATE_RIGHT(v)                           \
    (((v) << 12) & BM_AUDIOOUT_DACVOLUME_VOLUME_UPDATE_RIGHT)
...
#define BF_AUDIOOUT_DACVOLUME_MUTE_RIGHT(v)                                    \
    (((v) << 8) & BM_AUDIOOUT_DACVOLUME_MUTE_RIGHT)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_DACVOLUME_MUTE_RIGHT(v)                                    \
    BF_CS1(AUDIOOUT_DACVOLUME, MUTE_RIGHT, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_DACVOLUME_VOLUME_RIGHT(v)                                  \
    (HW_AUDIOOUT_DACVOLUME.B.VOLUME_RIGHT = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_DACDEBUG                                                   \
    (*(volatile hw_audioout_dacdebug_t *)HW_AUDIOOUT_DACDEBUG_ADDR)
#define HW_AUDIOOUT_DACDEBUG_RD() (HW_AUDIOOUT_DACDEBUG.U)
#define HW_AUDIOOUT_DACDEBUG_WR(v) (HW_AUDIOOUT_DACDEBUG.U = (v))
#define HW_AUDIOOUT_DACDEBUG_SET(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACDEBUG_SET_ADDR) = (v))
#define HW_AUDIOOUT_DACDEBUG_CLR(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACDEBUG_CLR_ADDR) = (v))
#define HW_AUDIOOUT_DACDEBUG_TOG(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DACDEBUG_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOOUT_DACDEBUG_ENABLE_DACDMA(v)                                  \
    ((((reg32_t)v) << 31) & BM_AUDIOOUT_DACDEBUG_ENABLE_DACDMA)
#else
#define BF_AUDIOOUT_DACDEBUG_ENABLE_DACDMA(v)                                  \
    (((v) << 31) & BM_AUDIOOUT_DACDEBUG_ENABLE_DACDMA)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_DACDEBUG_ENABLE_DACDMA(v)                                  \
    BF_CS1(AUDIOOUT_DACDEBUG, ENABLE_DACDMA, v)
#endif
...
#define BF_AUDIOOUT_DACDEBUG_SET_INTERRUPT1_CLK_CROSS(v)                       \
    (((v) << 5) & BM_AUDIOOUT_DACDEBUG_SET_INTERRUPT1_CLK_CROSS)
...
#define BF_AUDIOOUT_DACDEBUG_SET_INTERRUPT0_CLK_CROSS(v)                       \
    (((v) << 4) & BM_AUDIOOUT_DACDEBUG_SET_INTERRUPT0_CLK_CROSS)
...
#define BF_AUDIOOUT_DACDEBUG_SET_INTERRUPT1_HAND_SHAKE(v)                      \
    (((v) << 3) & BM_AUDIOOUT_DACDEBUG_SET_INTERRUPT1_HAND_SHAKE)
...
#define BF_AUDIOOUT_DACDEBUG_SET_INTERRUPT0_HAND_SHAKE(v)                      \
    (((v) << 2) & BM_AUDIOOUT_DACDEBUG_SET_INTERRUPT0_HAND_SHAKE)
...
#define BF_AUDIOOUT_DACDEBUG_DMA_PREQ(v)                                       \
    (((v) << 1) & BM_AUDIOOUT_DACDEBUG_DMA_PREQ)
...
#define BF_AUDIOOUT_DACDEBUG_FIFO_STATUS(v)                                    \
    (((v) << 0) & BM_AUDIOOUT_DACDEBUG_FIFO_STATUS)
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_HPVOL                                                      \
    (*(volatile hw_audioout_hpvol_t *)HW_AUDIOOUT_HPVOL_ADDR)
#define HW_AUDIOOUT_HPVOL_RD() (HW_AUDIOOUT_HPVOL.U)
#define HW_AUDIOOUT_HPVOL_WR(v) (HW_AUDIOOUT_HPVOL.U = (v))
#define HW_AUDIOOUT_HPVOL_SET(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOOUT_HPVOL_SET_ADDR) = (v))
#define HW_AUDIOOUT_HPVOL_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOOUT_HPVOL_CLR_ADDR) = (v))
#define HW_AUDIOOUT_HPVOL_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOOUT_HPVOL_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOOUT_HPVOL_VOLUME_UPDATE_PENDING(v)                             \
    (((v) << 28) & BM_AUDIOOUT_HPVOL_VOLUME_UPDATE_PENDING)
...
#define BF_AUDIOOUT_HPVOL_EN_MSTR_ZCD(v)                                       \
    (((v) << 25) & BM_AUDIOOUT_HPVOL_EN_MSTR_ZCD)
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_RESERVED                                                   \
    (*(volatile hw_audioout_reserved_t *)HW_AUDIOOUT_RESERVED_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_PWRDN                                                      \
    (*(volatile hw_audioout_pwrdn_t *)HW_AUDIOOUT_PWRDN_ADDR)
#define HW_AUDIOOUT_PWRDN_RD() (HW_AUDIOOUT_PWRDN.U)
#define HW_AUDIOOUT_PWRDN_WR(v) (HW_AUDIOOUT_PWRDN.U = (v))
#define HW_AUDIOOUT_PWRDN_SET(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOOUT_PWRDN_SET_ADDR) = (v))
#define HW_AUDIOOUT_PWRDN_CLR(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOOUT_PWRDN_CLR_ADDR) = (v))
#define HW_AUDIOOUT_PWRDN_TOG(v)                                               \
    ((*(volatile reg32_t *)HW_AUDIOOUT_PWRDN_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOOUT_PWRDN_RIGHT_ADC(v)                                         \
    (((v) << 16) & BM_AUDIOOUT_PWRDN_RIGHT_ADC)
...
#define BF_AUDIOOUT_PWRDN_HEADPHONE(v)                                         \
    (((v) << 0) & BM_AUDIOOUT_PWRDN_HEADPHONE)
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_REFCTRL                                                    \
    (*(volatile hw_audioout_refctrl_t *)HW_AUDIOOUT_REFCTRL_ADDR)
#define HW_AUDIOOUT_REFCTRL_RD() (HW_AUDIOOUT_REFCTRL.U)
#define HW_AUDIOOUT_REFCTRL_WR(v) (HW_AUDIOOUT_REFCTRL.U = (v))
#define HW_AUDIOOUT_REFCTRL_SET(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOOUT_REFCTRL_SET_ADDR) = (v))
#define HW_AUDIOOUT_REFCTRL_CLR(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOOUT_REFCTRL_CLR_ADDR) = (v))
#define HW_AUDIOOUT_REFCTRL_TOG(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOOUT_REFCTRL_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOOUT_REFCTRL_FASTSETTLING(v)                                    \
    (((v) << 26) & BM_AUDIOOUT_REFCTRL_FASTSETTLING)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_REFCTRL_FASTSETTLING(v)                                    \
    BF_CS1(AUDIOOUT_REFCTRL, FASTSETTLING, v)
#endif
...
#define BF_AUDIOOUT_REFCTRL_RAISE_REF(v)                                       \
    (((v) << 25) & BM_AUDIOOUT_REFCTRL_RAISE_REF)
...
#define BF_AUDIOOUT_REFCTRL_XTAL_BGR_BIAS(v)                                   \
    (((v) << 24) & BM_AUDIOOUT_REFCTRL_XTAL_BGR_BIAS)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_REFCTRL_XTAL_BGR_BIAS(v)                                   \
    BF_CS1(AUDIOOUT_REFCTRL, XTAL_BGR_BIAS, v)
#endif
...
#define BF_AUDIOOUT_REFCTRL_LOW_PWR(v)                                         \
    (((v) << 19) & BM_AUDIOOUT_REFCTRL_LOW_PWR)
...
#define BF_AUDIOOUT_REFCTRL_VDDXTAL_TO_VDDD(v)                                 \
    (((v) << 14) & BM_AUDIOOUT_REFCTRL_VDDXTAL_TO_VDDD)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_REFCTRL_VDDXTAL_TO_VDDD(v)                                 \
    BF_CS1(AUDIOOUT_REFCTRL, VDDXTAL_TO_VDDD, v)
#endif
...
#define BF_AUDIOOUT_REFCTRL_ADJ_ADC(v)                                         \
    (((v) << 13) & BM_AUDIOOUT_REFCTRL_ADJ_ADC)
...
#define BF_AUDIOOUT_REFCTRL_ADJ_VAG(v)                                         \
    (((v) << 12) & BM_AUDIOOUT_REFCTRL_ADJ_VAG)
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_REFCTRL_ADC_REFVAL(v)                                      \
    BF_CS1(AUDIOOUT_REFCTRL, ADC_REFVAL, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_ANACTRL                                                    \
    (*(volatile hw_audioout_anactrl_t *)HW_AUDIOOUT_ANACTRL_ADDR)
#define HW_AUDIOOUT_ANACTRL_RD() (HW_AUDIOOUT_ANACTRL.U)
#define HW_AUDIOOUT_ANACTRL_WR(v) (HW_AUDIOOUT_ANACTRL.U = (v))
#define HW_AUDIOOUT_ANACTRL_SET(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOOUT_ANACTRL_SET_ADDR) = (v))
#define HW_AUDIOOUT_ANACTRL_CLR(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOOUT_ANACTRL_CLR_ADDR) = (v))
#define HW_AUDIOOUT_ANACTRL_TOG(v)                                             \
    ((*(volatile reg32_t *)HW_AUDIOOUT_ANACTRL_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOOUT_ANACTRL_SHORT_CM_STS(v)                                    \
    (((v) << 28) & BM_AUDIOOUT_ANACTRL_SHORT_CM_STS)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACTRL_SHORT_CM_STS(v)                                    \
    BF_CS1(AUDIOOUT_ANACTRL, SHORT_CM_STS, v)
#endif
...
#define BF_AUDIOOUT_ANACTRL_SHORT_LR_STS(v)                                    \
    (((v) << 24) & BM_AUDIOOUT_ANACTRL_SHORT_LR_STS)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACTRL_SHORT_LR_STS(v)                                    \
    BF_CS1(AUDIOOUT_ANACTRL, SHORT_LR_STS, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACTRL_SHORTMODE_CM(v)                                    \
    BF_CS1(AUDIOOUT_ANACTRL, SHORTMODE_CM, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACTRL_SHORTMODE_LR(v)                                    \
    BF_CS1(AUDIOOUT_ANACTRL, SHORTMODE_LR, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACTRL_SHORT_LVLADJL(v)                                   \
    BF_CS1(AUDIOOUT_ANACTRL, SHORT_LVLADJL, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACTRL_SHORT_LVLADJR(v)                                   \
    BF_CS1(AUDIOOUT_ANACTRL, SHORT_LVLADJR, v)
#endif
...
#define BF_AUDIOOUT_ANACTRL_HP_HOLD_GND(v)                                     \
    (((v) << 5) & BM_AUDIOOUT_ANACTRL_HP_HOLD_GND)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACTRL_HP_HOLD_GND(v)                                     \
    BF_CS1(AUDIOOUT_ANACTRL, HP_HOLD_GND, v)
#endif
...
#define BF_AUDIOOUT_ANACTRL_HP_CLASSAB(v)                                      \
    (((v) << 4) & BM_AUDIOOUT_ANACTRL_HP_CLASSAB)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACTRL_HP_CLASSAB(v)                                      \
    BF_CS1(AUDIOOUT_ANACTRL, HP_CLASSAB, v)
#endif
...
#define HW_AUDIOOUT_TEST_SET(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_TEST_SET_ADDR) = (v))
#define HW_AUDIOOUT_TEST_CLR(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_TEST_CLR_ADDR) = (v))
#define HW_AUDIOOUT_TEST_TOG(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_TEST_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOOUT_TEST_TM_ADCIN_TOHP(v)                                      \
    (((v) << 26) & BM_AUDIOOUT_TEST_TM_ADCIN_TOHP)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_TEST_TM_ADCIN_TOHP(v)                                      \
    BF_CS1(AUDIOOUT_TEST, TM_ADCIN_TOHP, v)
#endif
...
#define BF_AUDIOOUT_TEST_TM_HPCOMMON(v)                                        \
    (((v) << 24) & BM_AUDIOOUT_TEST_TM_HPCOMMON)
...
#define BF_AUDIOOUT_TEST_VAG_CLASSA(v)                                         \
    (((v) << 13) & BM_AUDIOOUT_TEST_VAG_CLASSA)
...
#define BF_AUDIOOUT_TEST_VAG_DOUBLE_I(v)                                       \
    (((v) << 12) & BM_AUDIOOUT_TEST_VAG_DOUBLE_I)
...
#define BF_AUDIOOUT_TEST_ADCTODAC_LOOP(v)                                      \
    (((v) << 3) & BM_AUDIOOUT_TEST_ADCTODAC_LOOP)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_TEST_ADCTODAC_LOOP(v)                                      \
    BF_CS1(AUDIOOUT_TEST, ADCTODAC_LOOP, v)
#endif
...
#define BF_AUDIOOUT_TEST_DAC_CLASSA(v)                                         \
    (((v) << 2) & BM_AUDIOOUT_TEST_DAC_CLASSA)
...
#define BF_AUDIOOUT_TEST_DAC_DOUBLE_I(v)                                       \
    (((v) << 1) & BM_AUDIOOUT_TEST_DAC_DOUBLE_I)
...
#define BF_AUDIOOUT_TEST_DAC_DIS_RTZ(v)                                        \
    (((v) << 0) & BM_AUDIOOUT_TEST_DAC_DIS_RTZ)
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_BISTCTRL                                                   \
    (*(volatile hw_audioout_bistctrl_t *)HW_AUDIOOUT_BISTCTRL_ADDR)
#define HW_AUDIOOUT_BISTCTRL_RD() (HW_AUDIOOUT_BISTCTRL.U)
#define HW_AUDIOOUT_BISTCTRL_WR(v) (HW_AUDIOOUT_BISTCTRL.U = (v))
#define HW_AUDIOOUT_BISTCTRL_SET(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOOUT_BISTCTRL_SET_ADDR) = (v))
#define HW_AUDIOOUT_BISTCTRL_CLR(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOOUT_BISTCTRL_CLR_ADDR) = (v))
#define HW_AUDIOOUT_BISTCTRL_TOG(v)                                            \
    ((*(volatile reg32_t *)HW_AUDIOOUT_BISTCTRL_TOG_ADDR) = (v))
#endif
...
#define HW_AUDIOOUT_BISTSTAT0                                                  \
    (*(volatile hw_audioout_biststat0_t *)HW_AUDIOOUT_BISTSTAT0_ADDR)
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_BISTSTAT1                                                  \
    (*(volatile hw_audioout_biststat1_t *)HW_AUDIOOUT_BISTSTAT1_ADDR)
...
#define HW_AUDIOOUT_ANACLKCTRL                                                 \
    (*(volatile hw_audioout_anaclkctrl_t *)HW_AUDIOOUT_ANACLKCTRL_ADDR)
#define HW_AUDIOOUT_ANACLKCTRL_RD() (HW_AUDIOOUT_ANACLKCTRL.U)
#define HW_AUDIOOUT_ANACLKCTRL_WR(v) (HW_AUDIOOUT_ANACLKCTRL.U = (v))
#define HW_AUDIOOUT_ANACLKCTRL_SET(v)                                          \
    ((*(volatile reg32_t *)HW_AUDIOOUT_ANACLKCTRL_SET_ADDR) = (v))
#define HW_AUDIOOUT_ANACLKCTRL_CLR(v)                                          \
    ((*(volatile reg32_t *)HW_AUDIOOUT_ANACLKCTRL_CLR_ADDR) = (v))
#define HW_AUDIOOUT_ANACLKCTRL_TOG(v)                                          \
    ((*(volatile reg32_t *)HW_AUDIOOUT_ANACLKCTRL_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define BF_AUDIOOUT_ANACLKCTRL_CLKGATE(v)                                      \
    ((((reg32_t)v) << 31) & BM_AUDIOOUT_ANACLKCTRL_CLKGATE)
#else
#define BF_AUDIOOUT_ANACLKCTRL_CLKGATE(v)                                      \
    (((v) << 31) & BM_AUDIOOUT_ANACLKCTRL_CLKGATE)
#endif

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACLKCTRL_CLKGATE(v)                                      \
    BF_CS1(AUDIOOUT_ANACLKCTRL, CLKGATE, v)
#endif
...
#define BF_AUDIOOUT_ANACLKCTRL_INVERT_DACCLK(v)                                \
    (((v) << 4) & BM_AUDIOOUT_ANACLKCTRL_INVERT_DACCLK)

#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_ANACLKCTRL_INVERT_DACCLK(v)                                \
    BF_CS1(AUDIOOUT_ANACLKCTRL, INVERT_DACCLK, v)
#endif
...
#define HW_AUDIOOUT_DATA_SET(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DATA_SET_ADDR) = (v))
#define HW_AUDIOOUT_DATA_CLR(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DATA_CLR_ADDR) = (v))
#define HW_AUDIOOUT_DATA_TOG(v)                                                \
    ((*(volatile reg32_t *)HW_AUDIOOUT_DATA_TOG_ADDR) = (v))
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_SPEAKERCTRL                                                \
    (*(volatile hw_audioout_speakerctrl_t *)HW_AUDIOOUT_SPEAKERCTRL_ADDR)
...
#define HW_AUDIOOUT_SPEAKERCTRL_SET(v)                                         \
    ((*(volatile reg32_t *)HW_AUDIOOUT_SPEAKERCTRL_SET_ADDR) = (v))
#define HW_AUDIOOUT_SPEAKERCTRL_CLR(v)                                         \
    ((*(volatile reg32_t *)HW_AUDIOOUT_SPEAKERCTRL_CLR_ADDR) = (v))
#define HW_AUDIOOUT_SPEAKERCTRL_TOG(v)                                         \
    ((*(volatile reg32_t *)HW_AUDIOOUT_SPEAKERCTRL_TOG_ADDR) = (v))
#endif
...
#define BF_AUDIOOUT_SPEAKERCTRL_MUTE(v)                                        \
    (((v) << 24) & BM_AUDIOOUT_SPEAKERCTRL_MUTE)
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_SPEAKERCTRL_I1_ADJ(v)                                      \
    BF_CS1(AUDIOOUT_SPEAKERCTRL, I1_ADJ, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_SPEAKERCTRL_IALL_ADJ(v)                                    \
    BF_CS1(AUDIOOUT_SPEAKERCTRL, IALL_ADJ, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_SPEAKERCTRL_POSDRIVER(v)                                   \
    BF_CS1(AUDIOOUT_SPEAKERCTRL, POSDRIVER, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define BW_AUDIOOUT_SPEAKERCTRL_NEGDRIVER(v)                                   \
    BF_CS1(AUDIOOUT_SPEAKERCTRL, NEGDRIVER, v)
#endif
...
#ifndef __LANGUAGE_ASM__
#define HW_AUDIOOUT_VERSION                                                    \
    (*(volatile hw_audioout_version_t *)HW_AUDIOOUT_VERSION_ADDR)
...
#define BF_AUDIOOUT_VERSION_MAJOR(v)                                           \
    ((((reg32_t)v) << 24) & BM_AUDIOOUT_VERSION_MAJOR)
#else
