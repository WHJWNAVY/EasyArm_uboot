...
#define BF_PWM_CTRL_OUTPUT_CUTOFF_EN(v)                                        \
    (((v) << 9) & BM_PWM_CTRL_OUTPUT_CUTOFF_EN)
#ifndef __LANGUAGE_ASM__
...
#define BF_PWM_PERIODn_HSADC_CLK_SEL(v)                                        \
    (((v) << 25) & BM_PWM_PERIODn_HSADC_CLK_SEL)
#ifndef __LANGUAGE_ASM__
#define BW_PWM_PERIODn_HSADC_CLK_SEL(n, v)                                     \
    BF_CS1n(PWM_PERIODn, n, HSADC_CLK_SEL, v)
#endif
